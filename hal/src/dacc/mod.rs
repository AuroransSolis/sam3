...
impl Dacc {
    ...
    /// Attempt to set the conversion trigger.
    ///
    ...
    /// Attempt to disable external triggering.
    ///
    /// # Errors
    ///
    /// Fails if write protection is enabled.
    ...
    /// # Errors
    ///
    /// Fails if `TXRDY` flag is not set.
    ...
    /// Attempt to set the refresh period length.
    ///
    ...
    /// Attempt to select the output channel to write CDR values to.
    ///
    /// # Errors
    ///
    /// Fails if write protection is enabled.
    ...
    /// Attempt to enable use of tag bits in CDR halfwords.
    ///
    ...
    /// Attempt to enable max speed mode.
    ///
    ...
    /// Attempt to disable DAC output channels.
    ///
    /// # Errors
    ///
    /// Fails if write protection is enabled.
    ...
    /// Attempt to apply a configuration to the DAC output channels.
    ///
    /// # Errors
    ///
    /// Fails if write protection is enabled.
    ...
    /// Attempt to apply the default bias current control config.
    ///
    /// # Errors
    ///
    /// Fails if write protection is enabled.
