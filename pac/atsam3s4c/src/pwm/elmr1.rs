...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn csel0(&mut self) -> CSEL0_W<ELMR1_SPEC> {
        CSEL0_W::new(self, 0)
    }
    #[doc = "Bit 1 - Comparison 1 Selection"]
    #[inline(always)]
    #[must_use]
    pub fn csel1(&mut self) -> CSEL1_W<ELMR1_SPEC> {
        CSEL1_W::new(self, 1)
    }
    #[doc = "Bit 2 - Comparison 2 Selection"]
    #[inline(always)]
    #[must_use]
    pub fn csel2(&mut self) -> CSEL2_W<ELMR1_SPEC> {
        CSEL2_W::new(self, 2)
    }
    #[doc = "Bit 3 - Comparison 3 Selection"]
    #[inline(always)]
    #[must_use]
    pub fn csel3(&mut self) -> CSEL3_W<ELMR1_SPEC> {
        CSEL3_W::new(self, 3)
    }
    #[doc = "Bit 4 - Comparison 4 Selection"]
    #[inline(always)]
    #[must_use]
    pub fn csel4(&mut self) -> CSEL4_W<ELMR1_SPEC> {
        CSEL4_W::new(self, 4)
    }
    #[doc = "Bit 5 - Comparison 5 Selection"]
    #[inline(always)]
    #[must_use]
    pub fn csel5(&mut self) -> CSEL5_W<ELMR1_SPEC> {
        CSEL5_W::new(self, 5)
    }
    #[doc = "Bit 6 - Comparison 6 Selection"]
    #[inline(always)]
    #[must_use]
    pub fn csel6(&mut self) -> CSEL6_W<ELMR1_SPEC> {
        CSEL6_W::new(self, 6)
    }
    #[doc = "Bit 7 - Comparison 7 Selection"]
    #[inline(always)]
    #[must_use]
    pub fn csel7(&mut self) -> CSEL7_W<ELMR1_SPEC> {
        CSEL7_W::new(self, 7)
    }
