...
pub type R = crate::R<FIFO204_SPEC>;
#[doc = "Register `FIFO204` writer"]
pub type W = crate::W<FIFO204_SPEC>;
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        write!(f, "{}", self.bits())
    }
}
impl core::fmt::Debug for crate::generic::Reg<FIFO204_SPEC> {
...
pub struct FIFO204_SPEC;
impl crate::RegisterSpec for FIFO204_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`fifo204::R`](R) reader structure"]
impl crate::Readable for FIFO204_SPEC {}
#[doc = "`write(|w| ..)` method takes [`fifo204::W`](W) writer structure"]
impl crate::Writable for FIFO204_SPEC {
