...
pub type R = crate::R<FIFO237_SPEC>;
#[doc = "Register `FIFO237` writer"]
pub type W = crate::W<FIFO237_SPEC>;
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        write!(f, "{}", self.bits())
    }
}
impl core::fmt::Debug for crate::generic::Reg<FIFO237_SPEC> {
...
pub struct FIFO237_SPEC;
impl crate::RegisterSpec for FIFO237_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`fifo237::R`](R) reader structure"]
impl crate::Readable for FIFO237_SPEC {}
#[doc = "`write(|w| ..)` method takes [`fifo237::W`](W) writer structure"]
impl crate::Writable for FIFO237_SPEC {
