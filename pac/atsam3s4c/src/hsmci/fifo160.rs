...
pub type R = crate::R<FIFO160_SPEC>;
#[doc = "Register `FIFO160` writer"]
pub type W = crate::W<FIFO160_SPEC>;
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        write!(f, "{}", self.bits())
    }
}
impl core::fmt::Debug for crate::generic::Reg<FIFO160_SPEC> {
...
pub struct FIFO160_SPEC;
impl crate::RegisterSpec for FIFO160_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`fifo160::R`](R) reader structure"]
impl crate::Readable for FIFO160_SPEC {}
#[doc = "`write(|w| ..)` method takes [`fifo160::W`](W) writer structure"]
impl crate::Writable for FIFO160_SPEC {
