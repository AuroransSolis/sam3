...
pub type R = crate::R<FIFO140_SPEC>;
#[doc = "Register `FIFO140` writer"]
pub type W = crate::W<FIFO140_SPEC>;
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        write!(f, "{}", self.bits())
    }
}
impl core::fmt::Debug for crate::generic::Reg<FIFO140_SPEC> {
...
pub struct FIFO140_SPEC;
impl crate::RegisterSpec for FIFO140_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`fifo140::R`](R) reader structure"]
impl crate::Readable for FIFO140_SPEC {}
#[doc = "`write(|w| ..)` method takes [`fifo140::W`](W) writer structure"]
impl crate::Writable for FIFO140_SPEC {
