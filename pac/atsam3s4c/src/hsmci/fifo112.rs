...
pub type R = crate::R<FIFO112_SPEC>;
#[doc = "Register `FIFO112` writer"]
pub type W = crate::W<FIFO112_SPEC>;
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        write!(f, "{}", self.bits())
    }
}
impl core::fmt::Debug for crate::generic::Reg<FIFO112_SPEC> {
...
pub struct FIFO112_SPEC;
impl crate::RegisterSpec for FIFO112_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`fifo112::R`](R) reader structure"]
impl crate::Readable for FIFO112_SPEC {}
#[doc = "`write(|w| ..)` method takes [`fifo112::W`](W) writer structure"]
impl crate::Writable for FIFO112_SPEC {
