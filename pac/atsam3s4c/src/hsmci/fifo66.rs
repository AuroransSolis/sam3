...
pub type R = crate::R<FIFO66_SPEC>;
#[doc = "Register `FIFO66` writer"]
pub type W = crate::W<FIFO66_SPEC>;
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        write!(f, "{}", self.bits())
    }
}
impl core::fmt::Debug for crate::generic::Reg<FIFO66_SPEC> {
...
pub struct FIFO66_SPEC;
impl crate::RegisterSpec for FIFO66_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`fifo66::R`](R) reader structure"]
impl crate::Readable for FIFO66_SPEC {}
#[doc = "`write(|w| ..)` method takes [`fifo66::W`](W) writer structure"]
impl crate::Writable for FIFO66_SPEC {
