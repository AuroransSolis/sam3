...
pub type R = crate::R<FIFO106_SPEC>;
#[doc = "Register `FIFO106` writer"]
pub type W = crate::W<FIFO106_SPEC>;
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        write!(f, "{}", self.bits())
    }
}
impl core::fmt::Debug for crate::generic::Reg<FIFO106_SPEC> {
...
pub struct FIFO106_SPEC;
impl crate::RegisterSpec for FIFO106_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`fifo106::R`](R) reader structure"]
impl crate::Readable for FIFO106_SPEC {}
#[doc = "`write(|w| ..)` method takes [`fifo106::W`](W) writer structure"]
impl crate::Writable for FIFO106_SPEC {
