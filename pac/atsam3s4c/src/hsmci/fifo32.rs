...
impl core::fmt::Debug for crate::generic::Reg<FIFO32_SPEC> {
...
#[doc = "FIFO Memory Aperture0 32\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`fifo32::R`](R).  You can [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`fifo32::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
