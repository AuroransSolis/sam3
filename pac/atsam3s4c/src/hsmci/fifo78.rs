...
pub type R = crate::R<FIFO78_SPEC>;
#[doc = "Register `FIFO78` writer"]
pub type W = crate::W<FIFO78_SPEC>;
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        write!(f, "{}", self.bits())
    }
}
impl core::fmt::Debug for crate::generic::Reg<FIFO78_SPEC> {
...
pub struct FIFO78_SPEC;
impl crate::RegisterSpec for FIFO78_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`fifo78::R`](R) reader structure"]
impl crate::Readable for FIFO78_SPEC {}
#[doc = "`write(|w| ..)` method takes [`fifo78::W`](W) writer structure"]
impl crate::Writable for FIFO78_SPEC {
