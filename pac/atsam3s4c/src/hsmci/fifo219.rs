...
pub type R = crate::R<FIFO219_SPEC>;
#[doc = "Register `FIFO219` writer"]
pub type W = crate::W<FIFO219_SPEC>;
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        write!(f, "{}", self.bits())
    }
}
impl core::fmt::Debug for crate::generic::Reg<FIFO219_SPEC> {
...
pub struct FIFO219_SPEC;
impl crate::RegisterSpec for FIFO219_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`fifo219::R`](R) reader structure"]
impl crate::Readable for FIFO219_SPEC {}
#[doc = "`write(|w| ..)` method takes [`fifo219::W`](W) writer structure"]
impl crate::Writable for FIFO219_SPEC {
