...
pub type R = crate::R<FIFO248_SPEC>;
#[doc = "Register `FIFO248` writer"]
pub type W = crate::W<FIFO248_SPEC>;
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        write!(f, "{}", self.bits())
    }
}
impl core::fmt::Debug for crate::generic::Reg<FIFO248_SPEC> {
...
pub struct FIFO248_SPEC;
impl crate::RegisterSpec for FIFO248_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`fifo248::R`](R) reader structure"]
impl crate::Readable for FIFO248_SPEC {}
#[doc = "`write(|w| ..)` method takes [`fifo248::W`](W) writer structure"]
impl crate::Writable for FIFO248_SPEC {
