...
pub type R = crate::R<FIFO209_SPEC>;
#[doc = "Register `FIFO209` writer"]
pub type W = crate::W<FIFO209_SPEC>;
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        write!(f, "{}", self.bits())
    }
}
impl core::fmt::Debug for crate::generic::Reg<FIFO209_SPEC> {
...
pub struct FIFO209_SPEC;
impl crate::RegisterSpec for FIFO209_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`fifo209::R`](R) reader structure"]
impl crate::Readable for FIFO209_SPEC {}
#[doc = "`write(|w| ..)` method takes [`fifo209::W`](W) writer structure"]
impl crate::Writable for FIFO209_SPEC {
