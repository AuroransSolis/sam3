...
pub type R = crate::R<FIFO239_SPEC>;
#[doc = "Register `FIFO239` writer"]
pub type W = crate::W<FIFO239_SPEC>;
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        write!(f, "{}", self.bits())
    }
}
impl core::fmt::Debug for crate::generic::Reg<FIFO239_SPEC> {
...
pub struct FIFO239_SPEC;
impl crate::RegisterSpec for FIFO239_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`fifo239::R`](R) reader structure"]
impl crate::Readable for FIFO239_SPEC {}
#[doc = "`write(|w| ..)` method takes [`fifo239::W`](W) writer structure"]
impl crate::Writable for FIFO239_SPEC {
