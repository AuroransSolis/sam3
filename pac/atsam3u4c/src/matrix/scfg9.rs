...
pub type R = crate::R<Scfg9Spec>;
#[doc = "Register `SCFG9` writer"]
pub type W = crate::W<Scfg9Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn slot_cycle(&mut self) -> SlotCycleW<Scfg9Spec> {
        SlotCycleW::new(self, 0)
    }
    #[doc = "Bits 16:17 - Default Master Type"]
    #[inline(always)]
    #[must_use]
    pub fn defmstr_type(&mut self) -> DefmstrTypeW<Scfg9Spec> {
        DefmstrTypeW::new(self, 16)
    }
    #[doc = "Bits 18:20 - Fixed Default Master"]
    #[inline(always)]
    #[must_use]
    pub fn fixed_defmstr(&mut self) -> FixedDefmstrW<Scfg9Spec> {
        FixedDefmstrW::new(self, 18)
    }
    #[doc = "Bits 24:25 - Arbitration Type"]
    #[inline(always)]
    #[must_use]
    pub fn arbt(&mut self) -> ArbtW<Scfg9Spec> {
        ArbtW::new(self, 24)
    }
}
...
pub struct Scfg9Spec;
impl crate::RegisterSpec for Scfg9Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`scfg9::R`](R) reader structure"]
impl crate::Readable for Scfg9Spec {}
#[doc = "`write(|w| ..)` method takes [`scfg9::W`](W) writer structure"]
impl crate::Writable for Scfg9Spec {
