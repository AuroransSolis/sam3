...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn ept_size(&mut self) -> EPT_SIZE_W<EPTCFG4_SPEC> {
        EPT_SIZE_W::new(self, 0)
    }
    #[doc = "Bit 3 - Endpoint Direction"]
    #[inline(always)]
    #[must_use]
    pub fn ept_dir(&mut self) -> EPT_DIR_W<EPTCFG4_SPEC> {
        EPT_DIR_W::new(self, 3)
    }
    #[doc = "Bits 4:5 - Endpoint Type"]
    #[inline(always)]
    #[must_use]
    pub fn ept_type(&mut self) -> EPT_TYPE_W<EPTCFG4_SPEC> {
        EPT_TYPE_W::new(self, 4)
    }
    #[doc = "Bits 6:7 - Number of Banks"]
    #[inline(always)]
    #[must_use]
    pub fn bk_number(&mut self) -> BK_NUMBER_W<EPTCFG4_SPEC> {
        BK_NUMBER_W::new(self, 6)
    }
    #[doc = "Bits 8:9 - Number Of Transaction per Microframe"]
    #[inline(always)]
    #[must_use]
    pub fn nb_trans(&mut self) -> NB_TRANS_W<EPTCFG4_SPEC> {
        NB_TRANS_W::new(self, 8)
    }
    #[doc = "Bit 31 - Endpoint Mapped"]
    #[inline(always)]
    #[must_use]
    pub fn ept_mapd(&mut self) -> EPT_MAPD_W<EPTCFG4_SPEC> {
