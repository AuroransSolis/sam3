...
pub struct R(crate::R<DMANXTDSC3_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<DMANXTDSC3_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<DMANXTDSC3_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<DMANXTDSC3_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `DMANXTDSC3` writer"]
pub struct W(crate::W<DMANXTDSC3_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<DMANXTDSC3_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<DMANXTDSC3_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<DMANXTDSC3_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type NXT_DSC_ADD_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, DMANXTDSC3_SPEC, u32, u32, 32, O>;
impl R {
...
#[doc = "UDPHS DMA Next Descriptor Address Register (channel = 3)\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [dmanxtdsc3](index.html) module"]
pub struct DMANXTDSC3_SPEC;
impl crate::RegisterSpec for DMANXTDSC3_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [dmanxtdsc3::R](R) reader structure"]
impl crate::Readable for DMANXTDSC3_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [dmanxtdsc3::W](W) writer structure"]
impl crate::Writable for DMANXTDSC3_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets DMANXTDSC3 to value 0"]
impl crate::Resettable for DMANXTDSC3_SPEC {
    #[inline(always)]
