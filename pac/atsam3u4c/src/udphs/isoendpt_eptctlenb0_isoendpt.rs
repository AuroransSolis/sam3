...
#[doc = "UDPHS Endpoint Control Enable Register (endpoint = 0)\n\nYou can [`write_with_zero`](crate::Reg::write_with_zero) this register using [`isoendpt_eptctlenb0_isoendpt::W`](W). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
