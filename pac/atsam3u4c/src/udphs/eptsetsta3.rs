...
pub struct W(crate::W<EPTSETSTA3_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<EPTSETSTA3_SPEC>;
    #[inline(always)]
...
impl From<crate::W<EPTSETSTA3_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<EPTSETSTA3_SPEC>) -> Self {
        W(writer)
    }
}
#[doc = "Field `FRCESTALL` writer - Stall Handshake Request Set"]
pub type FRCESTALL_W<'a, const O: u8> = crate::BitWriter<'a, u32, EPTSETSTA3_SPEC, bool, O>;
#[doc = "Field `RXRDY_TXKL` writer - KILL Bank Set (for IN Endpoint)"]
pub type RXRDY_TXKL_W<'a, const O: u8> = crate::BitWriter<'a, u32, EPTSETSTA3_SPEC, bool, O>;
#[doc = "Field `TXRDY` writer - TX Packet Ready Set"]
pub type TXRDY_W<'a, const O: u8> = crate::BitWriter<'a, u32, EPTSETSTA3_SPEC, bool, O>;
impl W {
