...
pub type R = crate::R<IsoendptEptsta0IsoendptSpec>;
...
#[doc = "UDPHS Endpoint Status Register (endpoint = 0)\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`isoendpt_eptsta0_isoendpt::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct IsoendptEptsta0IsoendptSpec;
impl crate::RegisterSpec for IsoendptEptsta0IsoendptSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`isoendpt_eptsta0_isoendpt::R`](R) reader structure"]
impl crate::Readable for IsoendptEptsta0IsoendptSpec {}
#[doc = "`reset()` method sets EPTSTA0_ISOENDPT to value 0x40"]
impl crate::Resettable for IsoendptEptsta0IsoendptSpec {
