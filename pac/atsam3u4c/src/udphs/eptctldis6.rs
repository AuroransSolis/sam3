...
pub type W = crate::W<Eptctldis6Spec>;
...
pub struct Eptctldis6Spec;
impl crate::RegisterSpec for Eptctldis6Spec {
    type Ux = u32;
}
#[doc = "`write(|w| ..)` method takes [`eptctldis6::W`](W) writer structure"]
impl crate::Writable for Eptctldis6Spec {
