...
pub type R = crate::R<Eptctl6Spec>;
...
#[doc = "UDPHS Endpoint Control Register (endpoint = 6)\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`eptctl6::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Eptctl6Spec;
impl crate::RegisterSpec for Eptctl6Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`eptctl6::R`](R) reader structure"]
impl crate::Readable for Eptctl6Spec {}
#[doc = "`reset()` method sets EPTCTL6 to value 0"]
impl crate::Resettable for Eptctl6Spec {
