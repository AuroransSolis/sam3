...
pub type W = crate::W<ISOENDPT_EPTSETSTA1_ISOENDPT_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn rxrdy_txkl(&mut self) -> RXRDY_TXKL_W<ISOENDPT_EPTSETSTA1_ISOENDPT_SPEC, 9> {
        RXRDY_TXKL_W::new(self)
    }
    #[doc = "Bit 11 - TX Packet Ready Set"]
    #[inline(always)]
    #[must_use]
    pub fn txrdy_trer(&mut self) -> TXRDY_TRER_W<ISOENDPT_EPTSETSTA1_ISOENDPT_SPEC, 11> {
...
pub struct ISOENDPT_EPTSETSTA1_ISOENDPT_SPEC;
impl crate::RegisterSpec for ISOENDPT_EPTSETSTA1_ISOENDPT_SPEC {
    type Ux = u32;
}
