...
pub type R = crate::R<ISOENDPT_EPTSTA4_ISOENDPT_SPEC>;
...
#[doc = "UDPHS Endpoint Status Register (endpoint = 4)\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`isoendpt_eptsta4_isoendpt::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
