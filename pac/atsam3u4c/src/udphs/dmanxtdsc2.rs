...
pub struct R(crate::R<DMANXTDSC2_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<DMANXTDSC2_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<DMANXTDSC2_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<DMANXTDSC2_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `DMANXTDSC2` writer"]
pub struct W(crate::W<DMANXTDSC2_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<DMANXTDSC2_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<DMANXTDSC2_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<DMANXTDSC2_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type NXT_DSC_ADD_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, DMANXTDSC2_SPEC, u32, u32, 32, O>;
impl R {
