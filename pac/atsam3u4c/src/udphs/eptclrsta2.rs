...
pub struct W(crate::W<EPTCLRSTA2_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<EPTCLRSTA2_SPEC>;
    #[inline(always)]
...
impl From<crate::W<EPTCLRSTA2_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<EPTCLRSTA2_SPEC>) -> Self {
        W(writer)
    }
}
#[doc = "Field `FRCESTALL` writer - Stall Handshake Request Clear"]
pub type FRCESTALL_W<'a, const O: u8> = crate::BitWriter<'a, u32, EPTCLRSTA2_SPEC, bool, O>;
#[doc = "Field `TOGGLESQ` writer - Data Toggle Clear"]
pub type TOGGLESQ_W<'a, const O: u8> = crate::BitWriter<'a, u32, EPTCLRSTA2_SPEC, bool, O>;
#[doc = "Field `RXRDY_TXKL` writer - Received OUT Data Clear"]
pub type RXRDY_TXKL_W<'a, const O: u8> = crate::BitWriter<'a, u32, EPTCLRSTA2_SPEC, bool, O>;
#[doc = "Field `TX_COMPLT` writer - Transmitted IN Data Complete Clear"]
pub type TX_COMPLT_W<'a, const O: u8> = crate::BitWriter<'a, u32, EPTCLRSTA2_SPEC, bool, O>;
#[doc = "Field `RX_SETUP` writer - Received SETUP Clear"]
pub type RX_SETUP_W<'a, const O: u8> = crate::BitWriter<'a, u32, EPTCLRSTA2_SPEC, bool, O>;
#[doc = "Field `STALL_SNT` writer - Stall Sent Clear"]
pub type STALL_SNT_W<'a, const O: u8> = crate::BitWriter<'a, u32, EPTCLRSTA2_SPEC, bool, O>;
#[doc = "Field `NAK_IN` writer - NAKIN Clear"]
pub type NAK_IN_W<'a, const O: u8> = crate::BitWriter<'a, u32, EPTCLRSTA2_SPEC, bool, O>;
#[doc = "Field `NAK_OUT` writer - NAKOUT Clear"]
pub type NAK_OUT_W<'a, const O: u8> = crate::BitWriter<'a, u32, EPTCLRSTA2_SPEC, bool, O>;
impl W {
