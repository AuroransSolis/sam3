...
pub type R = crate::R<Eptctl4Spec>;
...
#[doc = "UDPHS Endpoint Control Register (endpoint = 4)\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`eptctl4::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Eptctl4Spec;
impl crate::RegisterSpec for Eptctl4Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`eptctl4::R`](R) reader structure"]
impl crate::Readable for Eptctl4Spec {}
#[doc = "`reset()` method sets EPTCTL4 to value 0"]
impl crate::Resettable for Eptctl4Spec {
