...
pub struct R(crate::R<EPTCFG3_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<EPTCFG3_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<EPTCFG3_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<EPTCFG3_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `EPTCFG3` writer"]
pub struct W(crate::W<EPTCFG3_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<EPTCFG3_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<EPTCFG3_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<EPTCFG3_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type EPT_SIZE_W<'a, const O: u8> =
    crate::FieldWriterSafe<'a, u32, EPTCFG3_SPEC, u8, EPT_SIZE_A, 3, O>;
...
pub type EPT_DIR_W<'a, const O: u8> = crate::BitWriter<'a, u32, EPTCFG3_SPEC, bool, O>;
...
pub type EPT_TYPE_W<'a, const O: u8> =
    crate::FieldWriterSafe<'a, u32, EPTCFG3_SPEC, u8, EPT_TYPE_A, 2, O>;
...
pub type BK_NUMBER_W<'a, const O: u8> =
    crate::FieldWriterSafe<'a, u32, EPTCFG3_SPEC, u8, BK_NUMBER_A, 2, O>;
...
pub type NB_TRANS_W<'a, const O: u8> = crate::FieldWriter<'a, u32, EPTCFG3_SPEC, u8, u8, 2, O>;
...
pub type EPT_MAPD_W<'a, const O: u8> = crate::BitWriter<'a, u32, EPTCFG3_SPEC, bool, O>;
impl R {
