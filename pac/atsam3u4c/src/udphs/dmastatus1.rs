#[doc = "Register `DMASTATUS1` reader"]
pub struct R(crate::R<DMASTATUS1_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<DMASTATUS1_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<DMASTATUS1_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<DMASTATUS1_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `DMASTATUS1` writer"]
pub struct W(crate::W<DMASTATUS1_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<DMASTATUS1_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<DMASTATUS1_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<DMASTATUS1_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type CHANN_ENB_W<'a, const O: u8> = crate::BitWriter<'a, u32, DMASTATUS1_SPEC, bool, O>;
...
pub type CHANN_ACT_W<'a, const O: u8> = crate::BitWriter<'a, u32, DMASTATUS1_SPEC, bool, O>;
...
pub type END_TR_ST_W<'a, const O: u8> = crate::BitWriter<'a, u32, DMASTATUS1_SPEC, bool, O>;
...
pub type END_BF_ST_W<'a, const O: u8> = crate::BitWriter<'a, u32, DMASTATUS1_SPEC, bool, O>;
...
pub type DESC_LDST_W<'a, const O: u8> = crate::BitWriter<'a, u32, DMASTATUS1_SPEC, bool, O>;
...
pub type BUFF_COUNT_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, DMASTATUS1_SPEC, u16, u16, 16, O>;
impl R {
...
#[doc = "UDPHS DMA Channel Status Register (channel = 1)\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [dmastatus1](index.html) module"]
pub struct DMASTATUS1_SPEC;
impl crate::RegisterSpec for DMASTATUS1_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [dmastatus1::R](R) reader structure"]
impl crate::Readable for DMASTATUS1_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [dmastatus1::W](W) writer structure"]
impl crate::Writable for DMASTATUS1_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets DMASTATUS1 to value 0"]
impl crate::Resettable for DMASTATUS1_SPEC {
    #[inline(always)]
