...
pub type R = crate::R<IsoendptEptsta5IsoendptSpec>;
...
#[doc = "UDPHS Endpoint Status Register (endpoint = 5)\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`isoendpt_eptsta5_isoendpt::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct IsoendptEptsta5IsoendptSpec;
impl crate::RegisterSpec for IsoendptEptsta5IsoendptSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`isoendpt_eptsta5_isoendpt::R`](R) reader structure"]
impl crate::Readable for IsoendptEptsta5IsoendptSpec {}
#[doc = "`reset()` method sets EPTSTA5_ISOENDPT to value 0x40"]
impl crate::Resettable for IsoendptEptsta5IsoendptSpec {
