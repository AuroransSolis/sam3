...
pub type R = crate::R<Eptctl2Spec>;
...
pub struct Eptctl2Spec;
impl crate::RegisterSpec for Eptctl2Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`eptctl2::R`](R) reader structure"]
impl crate::Readable for Eptctl2Spec {}
#[doc = "`reset()` method sets EPTCTL2 to value 0"]
impl crate::Resettable for Eptctl2Spec {
