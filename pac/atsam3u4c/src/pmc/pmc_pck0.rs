...
pub type R = crate::R<PMC_PCK0_SPEC>;
#[doc = "Register `PMC_PCK0` writer"]
pub type W = crate::W<PMC_PCK0_SPEC>;
...
pub struct PMC_PCK0_SPEC;
impl crate::RegisterSpec for PMC_PCK0_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`pmc_pck0::R`](R) reader structure"]
impl crate::Readable for PMC_PCK0_SPEC {}
#[doc = "`write(|w| ..)` method takes [`pmc_pck0::W`](W) writer structure"]
impl crate::Writable for PMC_PCK0_SPEC {
