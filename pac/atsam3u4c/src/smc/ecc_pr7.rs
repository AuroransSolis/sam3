...
#[doc = "SMC ECC parity 7 Register\n\nYou can [`read`](crate::Reg::read) this register and get [`ecc_pr7::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct EccPr7Spec;
impl crate::RegisterSpec for EccPr7Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ecc_pr7::R`](R) reader structure"]
impl crate::Readable for EccPr7Spec {}
#[doc = "`reset()` method sets ECC_PR7 to value 0"]
impl crate::Resettable for EccPr7Spec {
