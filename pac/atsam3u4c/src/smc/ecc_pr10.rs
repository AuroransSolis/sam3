...
pub type R = crate::R<EccPr10Spec>;
...
#[doc = "SMC ECC parity 10 Register\n\nYou can [`read`](crate::Reg::read) this register and get [`ecc_pr10::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct EccPr10Spec;
impl crate::RegisterSpec for EccPr10Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ecc_pr10::R`](R) reader structure"]
impl crate::Readable for EccPr10Spec {}
#[doc = "`reset()` method sets ECC_PR10 to value 0"]
impl crate::Resettable for EccPr10Spec {
