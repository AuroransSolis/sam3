...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn tclr(&mut self) -> TCLR_W<TIMINGS2_SPEC> {
        TCLR_W::new(self, 0)
    }
    #[doc = "Bits 4:7 - ALE to Data Start"]
    #[inline(always)]
    #[must_use]
    pub fn tadl(&mut self) -> TADL_W<TIMINGS2_SPEC> {
        TADL_W::new(self, 4)
    }
    #[doc = "Bits 8:11 - ALE to REN Low Delay"]
    #[inline(always)]
    #[must_use]
    pub fn tar(&mut self) -> TAR_W<TIMINGS2_SPEC> {
        TAR_W::new(self, 8)
    }
    #[doc = "Bit 12 - Off Chip Memory Scrambling Enable"]
    #[inline(always)]
    #[must_use]
    pub fn ocms(&mut self) -> OCMS_W<TIMINGS2_SPEC> {
        OCMS_W::new(self, 12)
    }
    #[doc = "Bits 16:19 - Ready to REN Low Delay"]
    #[inline(always)]
    #[must_use]
    pub fn trr(&mut self) -> TRR_W<TIMINGS2_SPEC> {
        TRR_W::new(self, 16)
    }
    #[doc = "Bits 24:27 - WEN High to REN to Busy"]
    #[inline(always)]
    #[must_use]
    pub fn twb(&mut self) -> TWB_W<TIMINGS2_SPEC> {
        TWB_W::new(self, 24)
    }
    #[doc = "Bits 28:30 - Ready/Busy Line Selection"]
    #[inline(always)]
    #[must_use]
    pub fn rbnsel(&mut self) -> RBNSEL_W<TIMINGS2_SPEC> {
        RBNSEL_W::new(self, 28)
    }
    #[doc = "Bit 31 - NAND Flash Selection"]
    #[inline(always)]
    #[must_use]
    pub fn nfsel(&mut self) -> NFSEL_W<TIMINGS2_SPEC> {
        NFSEL_W::new(self, 31)
    }
