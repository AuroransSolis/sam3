#[doc = "Register `DEVEPTCFG7` reader"]
pub type R = crate::R<DEVEPTCFG7_SPEC>;
#[doc = "Register `DEVEPTCFG7` writer"]
pub type W = crate::W<DEVEPTCFG7_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn alloc(&mut self) -> ALLOC_W<DEVEPTCFG7_SPEC, 1> {
        ALLOC_W::new(self)
    }
    #[doc = "Bits 2:3 - Endpoint Banks"]
    #[inline(always)]
    #[must_use]
    pub fn epbk(&mut self) -> EPBK_W<DEVEPTCFG7_SPEC, 2> {
        EPBK_W::new(self)
    }
    #[doc = "Bits 4:6 - Endpoint Size"]
    #[inline(always)]
    #[must_use]
    pub fn epsize(&mut self) -> EPSIZE_W<DEVEPTCFG7_SPEC, 4> {
        EPSIZE_W::new(self)
    }
    #[doc = "Bit 8 - Endpoint Direction"]
    #[inline(always)]
    #[must_use]
    pub fn epdir(&mut self) -> EPDIR_W<DEVEPTCFG7_SPEC, 8> {
        EPDIR_W::new(self)
    }
    #[doc = "Bit 9 - Automatic Switch"]
    #[inline(always)]
    #[must_use]
    pub fn autosw(&mut self) -> AUTOSW_W<DEVEPTCFG7_SPEC, 9> {
        AUTOSW_W::new(self)
    }
    #[doc = "Bits 11:12 - Endpoint Type"]
    #[inline(always)]
    #[must_use]
    pub fn eptype(&mut self) -> EPTYPE_W<DEVEPTCFG7_SPEC, 11> {
        EPTYPE_W::new(self)
    }
    #[doc = "Bits 13:14 - Number of transaction per microframe for isochronous endpoint"]
    #[inline(always)]
    #[must_use]
    pub fn nbtrans(&mut self) -> NBTRANS_W<DEVEPTCFG7_SPEC, 13> {
        NBTRANS_W::new(self)
    }
...
pub struct DEVEPTCFG7_SPEC;
impl crate::RegisterSpec for DEVEPTCFG7_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`deveptcfg7::R`](R) reader structure"]
impl crate::Readable for DEVEPTCFG7_SPEC {}
#[doc = "`write(|w| ..)` method takes [`deveptcfg7::W`](W) writer structure"]
impl crate::Writable for DEVEPTCFG7_SPEC {
