...
pub type R = crate::R<Deveptcfg7Spec>;
#[doc = "Register `DEVEPTCFG7` writer"]
pub type W = crate::W<Deveptcfg7Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn alloc(&mut self) -> AllocW<Deveptcfg7Spec> {
        AllocW::new(self, 1)
    }
    #[doc = "Bits 2:3 - Endpoint Banks"]
    #[inline(always)]
    #[must_use]
    pub fn epbk(&mut self) -> EpbkW<Deveptcfg7Spec> {
        EpbkW::new(self, 2)
    }
    #[doc = "Bits 4:6 - Endpoint Size"]
    #[inline(always)]
    #[must_use]
    pub fn epsize(&mut self) -> EpsizeW<Deveptcfg7Spec> {
        EpsizeW::new(self, 4)
    }
    #[doc = "Bit 8 - Endpoint Direction"]
    #[inline(always)]
    #[must_use]
    pub fn epdir(&mut self) -> EpdirW<Deveptcfg7Spec> {
        EpdirW::new(self, 8)
    }
    #[doc = "Bit 9 - Automatic Switch"]
    #[inline(always)]
    #[must_use]
    pub fn autosw(&mut self) -> AutoswW<Deveptcfg7Spec> {
        AutoswW::new(self, 9)
    }
    #[doc = "Bits 11:12 - Endpoint Type"]
    #[inline(always)]
    #[must_use]
    pub fn eptype(&mut self) -> EptypeW<Deveptcfg7Spec> {
        EptypeW::new(self, 11)
    }
    #[doc = "Bits 13:14 - Number of transaction per microframe for isochronous endpoint"]
    #[inline(always)]
    #[must_use]
    pub fn nbtrans(&mut self) -> NbtransW<Deveptcfg7Spec> {
...
impl crate::Readable for Deveptcfg7Spec {}
#[doc = "`write(|w| ..)` method takes [`deveptcfg7::W`](W) writer structure"]
impl crate::Writable for Deveptcfg7Spec {
