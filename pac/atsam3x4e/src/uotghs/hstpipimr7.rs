#[doc = "Register `HSTPIPIMR7` reader"]
pub type R = crate::R<HSTPIPIMR7_SPEC>;
...
#[doc = "Host Pipe Mask Register (n = 0) 7\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`hstpipimr7::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct HSTPIPIMR7_SPEC;
impl crate::RegisterSpec for HSTPIPIMR7_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`hstpipimr7::R`](R) reader structure"]
impl crate::Readable for HSTPIPIMR7_SPEC {}
