...
pub type R = crate::R<Hstpiperr3Spec>;
#[doc = "Register `HSTPIPERR3` writer"]
pub type W = crate::W<Hstpiperr3Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn datatgl(&mut self) -> DatatglW<Hstpiperr3Spec> {
        DatatglW::new(self, 0)
    }
    #[doc = "Bit 1 - Data PID Error"]
    #[inline(always)]
    #[must_use]
    pub fn datapid(&mut self) -> DatapidW<Hstpiperr3Spec> {
        DatapidW::new(self, 1)
    }
    #[doc = "Bit 2 - PID Error"]
    #[inline(always)]
    #[must_use]
    pub fn pid(&mut self) -> PidW<Hstpiperr3Spec> {
        PidW::new(self, 2)
    }
    #[doc = "Bit 3 - Time-Out Error"]
    #[inline(always)]
    #[must_use]
    pub fn timeout(&mut self) -> TimeoutW<Hstpiperr3Spec> {
        TimeoutW::new(self, 3)
    }
    #[doc = "Bit 4 - CRC16 Error"]
    #[inline(always)]
    #[must_use]
    pub fn crc16(&mut self) -> Crc16W<Hstpiperr3Spec> {
        Crc16W::new(self, 4)
    }
    #[doc = "Bits 5:6 - Error Counter"]
    #[inline(always)]
    #[must_use]
    pub fn counter(&mut self) -> CounterW<Hstpiperr3Spec> {
        CounterW::new(self, 5)
    }
}
#[doc = "Host Pipe Error Register (n = 0) 3\n\nYou can [`read`](crate::Reg::read) this register and get [`hstpiperr3::R`](R). You can [`write_with_zero`](crate::Reg::write_with_zero) this register using [`hstpiperr3::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Hstpiperr3Spec;
impl crate::RegisterSpec for Hstpiperr3Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`hstpiperr3::R`](R) reader structure"]
impl crate::Readable for Hstpiperr3Spec {}
#[doc = "`write(|w| ..)` method takes [`hstpiperr3::W`](W) writer structure"]
impl crate::Writable for Hstpiperr3Spec {
