...
pub type R = crate::R<Hstpipcfg7Spec>;
#[doc = "Register `HSTPIPCFG7` writer"]
pub type W = crate::W<Hstpipcfg7Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn alloc(&mut self) -> AllocW<Hstpipcfg7Spec> {
        AllocW::new(self, 1)
    }
    #[doc = "Bits 2:3 - Pipe Banks"]
    #[inline(always)]
    #[must_use]
    pub fn pbk(&mut self) -> PbkW<Hstpipcfg7Spec> {
        PbkW::new(self, 2)
    }
    #[doc = "Bits 4:6 - Pipe Size"]
    #[inline(always)]
    #[must_use]
    pub fn psize(&mut self) -> PsizeW<Hstpipcfg7Spec> {
        PsizeW::new(self, 4)
    }
    #[doc = "Bits 8:9 - Pipe Token"]
    #[inline(always)]
    #[must_use]
    pub fn ptoken(&mut self) -> PtokenW<Hstpipcfg7Spec> {
        PtokenW::new(self, 8)
    }
    #[doc = "Bit 10 - Automatic Switch"]
    #[inline(always)]
    #[must_use]
    pub fn autosw(&mut self) -> AutoswW<Hstpipcfg7Spec> {
        AutoswW::new(self, 10)
    }
    #[doc = "Bits 12:13 - Pipe Type"]
    #[inline(always)]
    #[must_use]
    pub fn ptype(&mut self) -> PtypeW<Hstpipcfg7Spec> {
        PtypeW::new(self, 12)
    }
    #[doc = "Bits 16:19 - Pipe Endpoint Number"]
    #[inline(always)]
    #[must_use]
    pub fn pepnum(&mut self) -> PepnumW<Hstpipcfg7Spec> {
        PepnumW::new(self, 16)
    }
    #[doc = "Bits 24:31 - Pipe Interrupt Request Frequency"]
    #[inline(always)]
    #[must_use]
    pub fn intfrq(&mut self) -> IntfrqW<Hstpipcfg7Spec> {
        IntfrqW::new(self, 24)
    }
}
...
pub struct Hstpipcfg7Spec;
impl crate::RegisterSpec for Hstpipcfg7Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`hstpipcfg7::R`](R) reader structure"]
impl crate::Readable for Hstpipcfg7Spec {}
#[doc = "`write(|w| ..)` method takes [`hstpipcfg7::W`](W) writer structure"]
impl crate::Writable for Hstpipcfg7Spec {
