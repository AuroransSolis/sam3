...
pub type R = crate::R<Hstpipcfg9Spec>;
#[doc = "Register `HSTPIPCFG9` writer"]
pub type W = crate::W<Hstpipcfg9Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn alloc(&mut self) -> AllocW<Hstpipcfg9Spec> {
        AllocW::new(self, 1)
    }
    #[doc = "Bits 2:3 - Pipe Banks"]
    #[inline(always)]
    #[must_use]
    pub fn pbk(&mut self) -> PbkW<Hstpipcfg9Spec> {
        PbkW::new(self, 2)
    }
    #[doc = "Bits 4:6 - Pipe Size"]
    #[inline(always)]
    #[must_use]
    pub fn psize(&mut self) -> PsizeW<Hstpipcfg9Spec> {
        PsizeW::new(self, 4)
    }
    #[doc = "Bits 8:9 - Pipe Token"]
    #[inline(always)]
    #[must_use]
    pub fn ptoken(&mut self) -> PtokenW<Hstpipcfg9Spec> {
        PtokenW::new(self, 8)
    }
    #[doc = "Bit 10 - Automatic Switch"]
    #[inline(always)]
    #[must_use]
    pub fn autosw(&mut self) -> AutoswW<Hstpipcfg9Spec> {
        AutoswW::new(self, 10)
    }
    #[doc = "Bits 12:13 - Pipe Type"]
    #[inline(always)]
    #[must_use]
    pub fn ptype(&mut self) -> PtypeW<Hstpipcfg9Spec> {
        PtypeW::new(self, 12)
    }
    #[doc = "Bits 16:19 - Pipe Endpoint Number"]
    #[inline(always)]
    #[must_use]
    pub fn pepnum(&mut self) -> PepnumW<Hstpipcfg9Spec> {
        PepnumW::new(self, 16)
    }
    #[doc = "Bits 24:31 - Pipe Interrupt Request Frequency"]
    #[inline(always)]
    #[must_use]
    pub fn intfrq(&mut self) -> IntfrqW<Hstpipcfg9Spec> {
        IntfrqW::new(self, 24)
    }
}
...
pub struct Hstpipcfg9Spec;
impl crate::RegisterSpec for Hstpipcfg9Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`hstpipcfg9::R`](R) reader structure"]
impl crate::Readable for Hstpipcfg9Spec {}
#[doc = "`write(|w| ..)` method takes [`hstpipcfg9::W`](W) writer structure"]
impl crate::Writable for Hstpipcfg9Spec {
