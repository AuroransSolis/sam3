...
pub type R = crate::R<Hstpiperr2Spec>;
#[doc = "Register `HSTPIPERR2` writer"]
pub type W = crate::W<Hstpiperr2Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn datatgl(&mut self) -> DatatglW<Hstpiperr2Spec> {
        DatatglW::new(self, 0)
    }
    #[doc = "Bit 1 - Data PID Error"]
    #[inline(always)]
    #[must_use]
    pub fn datapid(&mut self) -> DatapidW<Hstpiperr2Spec> {
        DatapidW::new(self, 1)
    }
    #[doc = "Bit 2 - PID Error"]
    #[inline(always)]
    #[must_use]
    pub fn pid(&mut self) -> PidW<Hstpiperr2Spec> {
        PidW::new(self, 2)
    }
    #[doc = "Bit 3 - Time-Out Error"]
    #[inline(always)]
    #[must_use]
    pub fn timeout(&mut self) -> TimeoutW<Hstpiperr2Spec> {
        TimeoutW::new(self, 3)
    }
    #[doc = "Bit 4 - CRC16 Error"]
    #[inline(always)]
    #[must_use]
    pub fn crc16(&mut self) -> Crc16W<Hstpiperr2Spec> {
        Crc16W::new(self, 4)
    }
    #[doc = "Bits 5:6 - Error Counter"]
    #[inline(always)]
    #[must_use]
    pub fn counter(&mut self) -> CounterW<Hstpiperr2Spec> {
        CounterW::new(self, 5)
    }
}
...
pub struct Hstpiperr2Spec;
impl crate::RegisterSpec for Hstpiperr2Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`hstpiperr2::R`](R) reader structure"]
impl crate::Readable for Hstpiperr2Spec {}
#[doc = "`write(|w| ..)` method takes [`hstpiperr2::W`](W) writer structure"]
impl crate::Writable for Hstpiperr2Spec {
