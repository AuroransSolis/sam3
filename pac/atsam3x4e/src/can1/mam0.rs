...
pub type R = crate::R<Mam0Spec>;
#[doc = "Register `MAM0` writer"]
pub type W = crate::W<Mam0Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn midv_b(&mut self) -> MidvBW<Mam0Spec> {
        MidvBW::new(self, 0)
    }
    #[doc = "Bits 18:28 - Identifier for standard frame mode"]
    #[inline(always)]
    #[must_use]
    pub fn midv_a(&mut self) -> MidvAW<Mam0Spec> {
        MidvAW::new(self, 18)
    }
    #[doc = "Bit 29 - Identifier Version"]
    #[inline(always)]
    #[must_use]
    pub fn mide(&mut self) -> MideW<Mam0Spec> {
        MideW::new(self, 29)
    }
}
#[doc = "Mailbox Acceptance Mask Register (MB = 0)\n\nYou can [`read`](crate::Reg::read) this register and get [`mam0::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`mam0::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Mam0Spec;
impl crate::RegisterSpec for Mam0Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`mam0::R`](R) reader structure"]
impl crate::Readable for Mam0Spec {}
#[doc = "`write(|w| ..)` method takes [`mam0::W`](W) writer structure"]
impl crate::Writable for Mam0Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets MAM0 to value 0"]
impl crate::Resettable for Mam0Spec {
