...
pub type R = crate::R<SMMR2_SPEC>;
#[doc = "Register `SMMR2` writer"]
pub type W = crate::W<SMMR2_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn gcen(&mut self) -> GCEN_W<SMMR2_SPEC, 0> {
        GCEN_W::new(self)
    }
    #[doc = "Bit 1 - DOWN Count"]
    #[inline(always)]
    #[must_use]
    pub fn down(&mut self) -> DOWN_W<SMMR2_SPEC, 1> {
        DOWN_W::new(self)
    }
...
#[doc = "Stepper Motor Mode Register (channel = 2)\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`smmr2::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`smmr2::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
