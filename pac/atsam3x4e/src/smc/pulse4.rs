...
pub type R = crate::R<PULSE4_SPEC>;
#[doc = "Register `PULSE4` writer"]
pub type W = crate::W<PULSE4_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn nwe_pulse(&mut self) -> NWE_PULSE_W<PULSE4_SPEC, 0> {
        NWE_PULSE_W::new(self)
    }
    #[doc = "Bits 8:14 - NCS Pulse Length in WRITE Access"]
    #[inline(always)]
    #[must_use]
    pub fn ncs_wr_pulse(&mut self) -> NCS_WR_PULSE_W<PULSE4_SPEC, 8> {
        NCS_WR_PULSE_W::new(self)
    }
    #[doc = "Bits 16:22 - NRD Pulse Length"]
    #[inline(always)]
    #[must_use]
    pub fn nrd_pulse(&mut self) -> NRD_PULSE_W<PULSE4_SPEC, 16> {
        NRD_PULSE_W::new(self)
    }
    #[doc = "Bits 24:30 - NCS Pulse Length in READ Access"]
    #[inline(always)]
    #[must_use]
    pub fn ncs_rd_pulse(&mut self) -> NCS_RD_PULSE_W<PULSE4_SPEC, 24> {
...
pub struct PULSE4_SPEC;
impl crate::RegisterSpec for PULSE4_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`pulse4::R`](R) reader structure"]
impl crate::Readable for PULSE4_SPEC {}
