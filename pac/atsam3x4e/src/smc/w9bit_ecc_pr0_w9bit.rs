...
pub type R = crate::R<W9bitEccPr0W9bitSpec>;
...
#[doc = "SMC ECC Parity 0 Register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`w9bit_ecc_pr0_w9bit::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct W9bitEccPr0W9bitSpec;
impl crate::RegisterSpec for W9bitEccPr0W9bitSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`w9bit_ecc_pr0_w9bit::R`](R) reader structure"]
impl crate::Readable for W9bitEccPr0W9bitSpec {}
#[doc = "`reset()` method sets ECC_PR0_W9BIT to value 0"]
impl crate::Resettable for W9bitEccPr0W9bitSpec {
