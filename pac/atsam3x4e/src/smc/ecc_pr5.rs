...
pub type R = crate::R<ECC_PR5_SPEC>;
...
#[doc = "SMC ECC parity 5 Register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`ecc_pr5::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
