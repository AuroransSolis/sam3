...
pub struct R(crate::R<CYCLE4_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<CYCLE4_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<CYCLE4_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<CYCLE4_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `CYCLE4` writer"]
pub struct W(crate::W<CYCLE4_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<CYCLE4_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<CYCLE4_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<CYCLE4_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type NWE_CYCLE_W<'a, const O: u8> = crate::FieldWriter<'a, u32, CYCLE4_SPEC, u16, u16, 9, O>;
...
pub type NRD_CYCLE_W<'a, const O: u8> = crate::FieldWriter<'a, u32, CYCLE4_SPEC, u16, u16, 9, O>;
impl R {
...
#[doc = "SMC Cycle Register (CS_number = 4)\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [cycle4](index.html) module"]
pub struct CYCLE4_SPEC;
impl crate::RegisterSpec for CYCLE4_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [cycle4::R](R) reader structure"]
impl crate::Readable for CYCLE4_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [cycle4::W](W) writer structure"]
impl crate::Writable for CYCLE4_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets CYCLE4 to value 0x0003_0003"]
impl crate::Resettable for CYCLE4_SPEC {
    #[inline(always)]
