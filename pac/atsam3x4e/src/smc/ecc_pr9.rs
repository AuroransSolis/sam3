...
pub struct EccPr9Spec;
impl crate::RegisterSpec for EccPr9Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ecc_pr9::R`](R) reader structure"]
impl crate::Readable for EccPr9Spec {}
#[doc = "`reset()` method sets ECC_PR9 to value 0"]
impl crate::Resettable for EccPr9Spec {
