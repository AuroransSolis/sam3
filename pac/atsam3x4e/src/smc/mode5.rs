...
pub type R = crate::R<Mode5Spec>;
#[doc = "Register `MODE5` writer"]
pub type W = crate::W<Mode5Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn read_mode(&mut self) -> ReadModeW<Mode5Spec> {
        ReadModeW::new(self, 0)
    }
    #[doc = "Bit 1 - Selection of the Control Signal for Write Operation"]
    #[inline(always)]
    #[must_use]
    pub fn write_mode(&mut self) -> WriteModeW<Mode5Spec> {
        WriteModeW::new(self, 1)
    }
    #[doc = "Bits 4:5 - NWAIT Mode"]
    #[inline(always)]
    #[must_use]
    pub fn exnw_mode(&mut self) -> ExnwModeW<Mode5Spec> {
        ExnwModeW::new(self, 4)
    }
    #[doc = "Bit 8 - Byte Access Type"]
    #[inline(always)]
    #[must_use]
    pub fn bat(&mut self) -> BatW<Mode5Spec> {
        BatW::new(self, 8)
    }
    #[doc = "Bit 12 - Data Bus Width"]
    #[inline(always)]
    #[must_use]
    pub fn dbw(&mut self) -> DbwW<Mode5Spec> {
        DbwW::new(self, 12)
    }
    #[doc = "Bits 16:19 - Data Float Time"]
    #[inline(always)]
    #[must_use]
    pub fn tdf_cycles(&mut self) -> TdfCyclesW<Mode5Spec> {
        TdfCyclesW::new(self, 16)
    }
    #[doc = "Bit 20 - TDF Optimization"]
    #[inline(always)]
    #[must_use]
    pub fn tdf_mode(&mut self) -> TdfModeW<Mode5Spec> {
        TdfModeW::new(self, 20)
    }
}
#[doc = "SMC Mode Register (CS_number = 5)\n\nYou can [`read`](crate::Reg::read) this register and get [`mode5::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`mode5::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Mode5Spec;
impl crate::RegisterSpec for Mode5Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`mode5::R`](R) reader structure"]
impl crate::Readable for Mode5Spec {}
#[doc = "`write(|w| ..)` method takes [`mode5::W`](W) writer structure"]
impl crate::Writable for Mode5Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets MODE5 to value 0x1000_0003"]
impl crate::Resettable for Mode5Spec {
