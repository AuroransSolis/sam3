...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn btc4(&mut self) -> Btc4W<EbcierSpec> {
        Btc4W::new(self, 4)
    }
    #[doc = "Bit 5 - Buffer Transfer Completed \\[5:0\\]"]
    #[inline(always)]
    #[must_use]
    pub fn btc5(&mut self) -> Btc5W<EbcierSpec> {
        Btc5W::new(self, 5)
    }
    ...
    #[inline(always)]
    #[must_use]
    pub fn cbtc4(&mut self) -> Cbtc4W<EbcierSpec> {
        Cbtc4W::new(self, 12)
    }
    #[doc = "Bit 13 - Chained Buffer Transfer Completed \\[5:0\\]"]
    #[inline(always)]
    #[must_use]
    pub fn cbtc5(&mut self) -> Cbtc5W<EbcierSpec> {
        Cbtc5W::new(self, 13)
    }
    ...
    #[inline(always)]
    #[must_use]
    pub fn err4(&mut self) -> Err4W<EbcierSpec> {
        Err4W::new(self, 20)
    }
    #[doc = "Bit 21 - Access Error \\[5:0\\]"]
    #[inline(always)]
    #[must_use]
    pub fn err5(&mut self) -> Err5W<EbcierSpec> {
        Err5W::new(self, 21)
    }
}
#[doc = "DMAC Error, Chained Buffer Transfer Completed Interrupt and Buffer Transfer Completed Interrupt Enable register.\n\nYou can [`write_with_zero`](crate::Reg::write_with_zero) this register using [`ebcier::W`](W). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
