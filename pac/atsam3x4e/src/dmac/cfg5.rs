#[doc = "Register `CFG5` reader"]
pub struct R(crate::R<CFG5_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<CFG5_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<CFG5_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<CFG5_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `CFG5` writer"]
pub struct W(crate::W<CFG5_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<CFG5_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<CFG5_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<CFG5_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type SRC_PER_W<'a, const O: u8> = crate::FieldWriter<'a, u32, CFG5_SPEC, u8, u8, 4, O>;
...
pub type DST_PER_W<'a, const O: u8> = crate::FieldWriter<'a, u32, CFG5_SPEC, u8, u8, 4, O>;
...
pub type SRC_H2SEL_W<'a, const O: u8> = crate::BitWriter<'a, u32, CFG5_SPEC, SRC_H2SEL_A, O>;
...
pub type DST_H2SEL_W<'a, const O: u8> = crate::BitWriter<'a, u32, CFG5_SPEC, DST_H2SEL_A, O>;
...
pub type SOD_W<'a, const O: u8> = crate::BitWriter<'a, u32, CFG5_SPEC, SOD_A, O>;
...
pub type LOCK_IF_W<'a, const O: u8> = crate::BitWriter<'a, u32, CFG5_SPEC, LOCK_IF_A, O>;
...
pub type LOCK_B_W<'a, const O: u8> = crate::BitWriter<'a, u32, CFG5_SPEC, LOCK_B_A, O>;
...
pub type LOCK_IF_L_W<'a, const O: u8> = crate::BitWriter<'a, u32, CFG5_SPEC, LOCK_IF_L_A, O>;
...
pub type AHB_PROT_W<'a, const O: u8> = crate::FieldWriter<'a, u32, CFG5_SPEC, u8, u8, 3, O>;
...
pub type FIFOCFG_W<'a, const O: u8> = crate::FieldWriter<'a, u32, CFG5_SPEC, u8, FIFOCFG_A, 2, O>;
...
#[doc = "DMAC Channel Configuration Register (ch_num = 5)\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [cfg5](index.html) module"]
pub struct CFG5_SPEC;
impl crate::RegisterSpec for CFG5_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [cfg5::R](R) reader structure"]
impl crate::Readable for CFG5_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [cfg5::W](W) writer structure"]
impl crate::Writable for CFG5_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets CFG5 to value 0x0100_0000"]
impl crate::Resettable for CFG5_SPEC {
    #[inline(always)]
