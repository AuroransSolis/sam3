...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn btc0(&mut self) -> BTC0_W<EBCIDR_SPEC> {
        BTC0_W::new(self, 0)
    }
    #[doc = "Bit 1 - Buffer Transfer Completed \\[5:0\\]"]
    #[inline(always)]
    #[must_use]
    pub fn btc1(&mut self) -> BTC1_W<EBCIDR_SPEC> {
        BTC1_W::new(self, 1)
    }
    #[doc = "Bit 2 - Buffer Transfer Completed \\[5:0\\]"]
    #[inline(always)]
    #[must_use]
    pub fn btc2(&mut self) -> BTC2_W<EBCIDR_SPEC> {
        BTC2_W::new(self, 2)
    }
    #[doc = "Bit 3 - Buffer Transfer Completed \\[5:0\\]"]
    #[inline(always)]
    #[must_use]
    pub fn btc3(&mut self) -> BTC3_W<EBCIDR_SPEC> {
        BTC3_W::new(self, 3)
    }
    #[doc = "Bit 4 - Buffer Transfer Completed \\[5:0\\]"]
    #[inline(always)]
    #[must_use]
    pub fn btc4(&mut self) -> BTC4_W<EBCIDR_SPEC> {
        BTC4_W::new(self, 4)
    }
    #[doc = "Bit 5 - Buffer Transfer Completed \\[5:0\\]"]
    #[inline(always)]
    #[must_use]
    pub fn btc5(&mut self) -> BTC5_W<EBCIDR_SPEC> {
        BTC5_W::new(self, 5)
    }
    #[doc = "Bit 8 - Chained Buffer Transfer Completed \\[5:0\\]"]
    #[inline(always)]
    #[must_use]
    pub fn cbtc0(&mut self) -> CBTC0_W<EBCIDR_SPEC> {
        CBTC0_W::new(self, 8)
    }
    #[doc = "Bit 9 - Chained Buffer Transfer Completed \\[5:0\\]"]
    #[inline(always)]
    #[must_use]
    pub fn cbtc1(&mut self) -> CBTC1_W<EBCIDR_SPEC> {
        CBTC1_W::new(self, 9)
    }
    #[doc = "Bit 10 - Chained Buffer Transfer Completed \\[5:0\\]"]
    #[inline(always)]
    #[must_use]
    pub fn cbtc2(&mut self) -> CBTC2_W<EBCIDR_SPEC> {
        CBTC2_W::new(self, 10)
    }
    #[doc = "Bit 11 - Chained Buffer Transfer Completed \\[5:0\\]"]
    #[inline(always)]
    #[must_use]
    pub fn cbtc3(&mut self) -> CBTC3_W<EBCIDR_SPEC> {
        CBTC3_W::new(self, 11)
    }
    #[doc = "Bit 12 - Chained Buffer Transfer Completed \\[5:0\\]"]
    #[inline(always)]
    #[must_use]
    pub fn cbtc4(&mut self) -> CBTC4_W<EBCIDR_SPEC> {
        CBTC4_W::new(self, 12)
    }
    #[doc = "Bit 13 - Chained Buffer Transfer Completed \\[5:0\\]"]
    #[inline(always)]
    #[must_use]
    pub fn cbtc5(&mut self) -> CBTC5_W<EBCIDR_SPEC> {
        CBTC5_W::new(self, 13)
    }
    #[doc = "Bit 16 - Access Error \\[5:0\\]"]
    #[inline(always)]
    #[must_use]
    pub fn err0(&mut self) -> ERR0_W<EBCIDR_SPEC> {
        ERR0_W::new(self, 16)
    }
    #[doc = "Bit 17 - Access Error \\[5:0\\]"]
    #[inline(always)]
    #[must_use]
    pub fn err1(&mut self) -> ERR1_W<EBCIDR_SPEC> {
        ERR1_W::new(self, 17)
    }
    #[doc = "Bit 18 - Access Error \\[5:0\\]"]
    #[inline(always)]
    #[must_use]
    pub fn err2(&mut self) -> ERR2_W<EBCIDR_SPEC> {
        ERR2_W::new(self, 18)
    }
    #[doc = "Bit 19 - Access Error \\[5:0\\]"]
    #[inline(always)]
    #[must_use]
    pub fn err3(&mut self) -> ERR3_W<EBCIDR_SPEC> {
        ERR3_W::new(self, 19)
    }
    #[doc = "Bit 20 - Access Error \\[5:0\\]"]
    #[inline(always)]
    #[must_use]
    pub fn err4(&mut self) -> ERR4_W<EBCIDR_SPEC> {
        ERR4_W::new(self, 20)
    }
    #[doc = "Bit 21 - Access Error \\[5:0\\]"]
    #[inline(always)]
    #[must_use]
    pub fn err5(&mut self) -> ERR5_W<EBCIDR_SPEC> {
        ERR5_W::new(self, 21)
    }
