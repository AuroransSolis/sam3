...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn src_per(&mut self) -> SRC_PER_W<CFG5_SPEC> {
        SRC_PER_W::new(self, 0)
    }
    #[doc = "Bits 4:7 - Destination with Peripheral identifier"]
    #[inline(always)]
    #[must_use]
    pub fn dst_per(&mut self) -> DST_PER_W<CFG5_SPEC> {
        DST_PER_W::new(self, 4)
    }
    #[doc = "Bit 9 - Software or Hardware Selection for the Source"]
    #[inline(always)]
    #[must_use]
    pub fn src_h2sel(&mut self) -> SRC_H2SEL_W<CFG5_SPEC> {
        SRC_H2SEL_W::new(self, 9)
    }
    #[doc = "Bit 13 - Software or Hardware Selection for the Destination"]
    #[inline(always)]
    #[must_use]
    pub fn dst_h2sel(&mut self) -> DST_H2SEL_W<CFG5_SPEC> {
        DST_H2SEL_W::new(self, 13)
    }
    #[doc = "Bit 16 - Stop On Done"]
    #[inline(always)]
    #[must_use]
    pub fn sod(&mut self) -> SOD_W<CFG5_SPEC> {
        SOD_W::new(self, 16)
    }
    #[doc = "Bit 20 - Interface Lock"]
    #[inline(always)]
    #[must_use]
    pub fn lock_if(&mut self) -> LOCK_IF_W<CFG5_SPEC> {
        LOCK_IF_W::new(self, 20)
    }
    #[doc = "Bit 21 - Bus Lock"]
    #[inline(always)]
    #[must_use]
    pub fn lock_b(&mut self) -> LOCK_B_W<CFG5_SPEC> {
        LOCK_B_W::new(self, 21)
    }
    #[doc = "Bit 22 - Master Interface Arbiter Lock"]
    #[inline(always)]
    #[must_use]
    pub fn lock_if_l(&mut self) -> LOCK_IF_L_W<CFG5_SPEC> {
        LOCK_IF_L_W::new(self, 22)
    }
    #[doc = "Bits 24:26 - AHB Protection"]
    #[inline(always)]
    #[must_use]
    pub fn ahb_prot(&mut self) -> AHB_PROT_W<CFG5_SPEC> {
        AHB_PROT_W::new(self, 24)
    }
    #[doc = "Bits 28:29 - FIFO Configuration"]
    #[inline(always)]
    #[must_use]
    pub fn fifocfg(&mut self) -> FIFOCFG_W<CFG5_SPEC> {
