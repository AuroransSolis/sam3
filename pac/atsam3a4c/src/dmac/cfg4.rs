...
pub type R = crate::R<CFG4_SPEC>;
#[doc = "Register `CFG4` writer"]
pub type W = crate::W<CFG4_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn src_per(&mut self) -> SRC_PER_W<CFG4_SPEC, 0> {
        SRC_PER_W::new(self)
    }
    #[doc = "Bits 4:7 - Destination with Peripheral identifier"]
    #[inline(always)]
    #[must_use]
    pub fn dst_per(&mut self) -> DST_PER_W<CFG4_SPEC, 4> {
        DST_PER_W::new(self)
    }
    #[doc = "Bit 9 - Software or Hardware Selection for the Source"]
    #[inline(always)]
    #[must_use]
    pub fn src_h2sel(&mut self) -> SRC_H2SEL_W<CFG4_SPEC, 9> {
        SRC_H2SEL_W::new(self)
    }
    #[doc = "Bit 13 - Software or Hardware Selection for the Destination"]
    #[inline(always)]
    #[must_use]
    pub fn dst_h2sel(&mut self) -> DST_H2SEL_W<CFG4_SPEC, 13> {
        DST_H2SEL_W::new(self)
    }
    #[doc = "Bit 16 - Stop On Done"]
    #[inline(always)]
    #[must_use]
    pub fn sod(&mut self) -> SOD_W<CFG4_SPEC, 16> {
        SOD_W::new(self)
    }
    #[doc = "Bit 20 - Interface Lock"]
    #[inline(always)]
    #[must_use]
    pub fn lock_if(&mut self) -> LOCK_IF_W<CFG4_SPEC, 20> {
        LOCK_IF_W::new(self)
    }
    #[doc = "Bit 21 - Bus Lock"]
    #[inline(always)]
    #[must_use]
    pub fn lock_b(&mut self) -> LOCK_B_W<CFG4_SPEC, 21> {
        LOCK_B_W::new(self)
    }
    #[doc = "Bit 22 - Master Interface Arbiter Lock"]
    #[inline(always)]
    #[must_use]
    pub fn lock_if_l(&mut self) -> LOCK_IF_L_W<CFG4_SPEC, 22> {
        LOCK_IF_L_W::new(self)
    }
    #[doc = "Bits 24:26 - AHB Protection"]
    #[inline(always)]
    #[must_use]
    pub fn ahb_prot(&mut self) -> AHB_PROT_W<CFG4_SPEC, 24> {
        AHB_PROT_W::new(self)
    }
    #[doc = "Bits 28:29 - FIFO Configuration"]
    #[inline(always)]
    #[must_use]
    pub fn fifocfg(&mut self) -> FIFOCFG_W<CFG4_SPEC, 28> {
        FIFOCFG_W::new(self)
    }
...
#[doc = "DMAC Channel Configuration Register (ch_num = 4)\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`cfg4::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`cfg4::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
