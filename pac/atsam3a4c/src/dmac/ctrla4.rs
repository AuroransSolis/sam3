...
pub type R = crate::R<CTRLA4_SPEC>;
#[doc = "Register `CTRLA4` writer"]
pub type W = crate::W<CTRLA4_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn btsize(&mut self) -> BTSIZE_W<CTRLA4_SPEC, 0> {
        BTSIZE_W::new(self)
    }
    #[doc = "Bits 16:18 - Source Chunk Transfer Size."]
    #[inline(always)]
    #[must_use]
    pub fn scsize(&mut self) -> SCSIZE_W<CTRLA4_SPEC, 16> {
        SCSIZE_W::new(self)
    }
    #[doc = "Bits 20:22 - Destination Chunk Transfer Size"]
    #[inline(always)]
    #[must_use]
    pub fn dcsize(&mut self) -> DCSIZE_W<CTRLA4_SPEC, 20> {
        DCSIZE_W::new(self)
    }
    #[doc = "Bits 24:25 - Transfer Width for the Source"]
    #[inline(always)]
    #[must_use]
    pub fn src_width(&mut self) -> SRC_WIDTH_W<CTRLA4_SPEC, 24> {
        SRC_WIDTH_W::new(self)
    }
    #[doc = "Bits 28:29 - Transfer Width for the Destination"]
    #[inline(always)]
    #[must_use]
    pub fn dst_width(&mut self) -> DST_WIDTH_W<CTRLA4_SPEC, 28> {
        DST_WIDTH_W::new(self)
    }
    #[doc = "Bit 31 - Current Descriptor Stop Command and Transfer Completed Memory Indicator"]
    #[inline(always)]
    #[must_use]
    pub fn done(&mut self) -> DONE_W<CTRLA4_SPEC, 31> {
        DONE_W::new(self)
    }
