...
pub type SDIOIRQFOR_SLOT_A_W<'a, const O: u8> = crate::BitWriter<'a, u32, IER_SPEC, bool, O>;
#[doc = "Field `SDIOIRQforSlotB` writer - "]
pub type SDIOIRQFOR_SLOT_B_W<'a, const O: u8> = crate::BitWriter<'a, u32, IER_SPEC, bool, O>;
...
pub type DMADONE_W<'a, const O: u8> = crate::BitWriter<'a, u32, IER_SPEC, bool, O>;
