...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn mb0(&mut self) -> MB0_W<ACR_SPEC> {
        MB0_W::new(self, 0)
    }
    #[doc = "Bit 1 - Abort Request for Mailbox 1"]
    #[inline(always)]
    #[must_use]
    pub fn mb1(&mut self) -> MB1_W<ACR_SPEC> {
        MB1_W::new(self, 1)
    }
    #[doc = "Bit 2 - Abort Request for Mailbox 2"]
    #[inline(always)]
    #[must_use]
    pub fn mb2(&mut self) -> MB2_W<ACR_SPEC> {
        MB2_W::new(self, 2)
    }
    #[doc = "Bit 3 - Abort Request for Mailbox 3"]
    #[inline(always)]
    #[must_use]
    pub fn mb3(&mut self) -> MB3_W<ACR_SPEC> {
        MB3_W::new(self, 3)
    }
    #[doc = "Bit 4 - Abort Request for Mailbox 4"]
    #[inline(always)]
    #[must_use]
    pub fn mb4(&mut self) -> MB4_W<ACR_SPEC> {
        MB4_W::new(self, 4)
    }
    #[doc = "Bit 5 - Abort Request for Mailbox 5"]
    #[inline(always)]
    #[must_use]
    pub fn mb5(&mut self) -> MB5_W<ACR_SPEC> {
        MB5_W::new(self, 5)
    }
    #[doc = "Bit 6 - Abort Request for Mailbox 6"]
    #[inline(always)]
    #[must_use]
    pub fn mb6(&mut self) -> MB6_W<ACR_SPEC> {
        MB6_W::new(self, 6)
    }
    #[doc = "Bit 7 - Abort Request for Mailbox 7"]
    #[inline(always)]
    #[must_use]
    pub fn mb7(&mut self) -> MB7_W<ACR_SPEC> {
        MB7_W::new(self, 7)
    }
