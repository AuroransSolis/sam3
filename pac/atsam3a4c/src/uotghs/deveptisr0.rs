#[doc = "Register `DEVEPTISR0` reader"]
pub type R = crate::R<DEVEPTISR0_SPEC>;
...
#[doc = "Device Endpoint Status Register (n = 0) 0\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`deveptisr0::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DEVEPTISR0_SPEC;
impl crate::RegisterSpec for DEVEPTISR0_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`deveptisr0::R`](R) reader structure"]
impl crate::Readable for DEVEPTISR0_SPEC {}
