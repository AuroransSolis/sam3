...
pub type R = crate::R<HSTDMANXTDSC2_SPEC>;
#[doc = "Register `HSTDMANXTDSC2` writer"]
pub type W = crate::W<HSTDMANXTDSC2_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn nxt_dsc_add(&mut self) -> NXT_DSC_ADD_W<HSTDMANXTDSC2_SPEC, 0> {
...
#[doc = "Host DMA Channel Next Descriptor Address Register (n = 2)\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`hstdmanxtdsc2::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`hstdmanxtdsc2::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
