#[doc = "Register `HSTPIPISR9` reader"]
pub type R = crate::R<HSTPIPISR9_SPEC>;
...
#[doc = "Host Pipe Status Register (n = 0) 9\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`hstpipisr9::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct HSTPIPISR9_SPEC;
impl crate::RegisterSpec for HSTPIPISR9_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`hstpipisr9::R`](R) reader structure"]
impl crate::Readable for HSTPIPISR9_SPEC {}
