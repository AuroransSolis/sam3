...
pub type CHANN_ENB_W<'a, const O: u8> = crate::BitWriter<'a, u32, DEVDMASTATUS6_SPEC, bool, O>;
...
pub type CHANN_ACT_W<'a, const O: u8> = crate::BitWriter<'a, u32, DEVDMASTATUS6_SPEC, bool, O>;
...
pub type END_TR_ST_W<'a, const O: u8> = crate::BitWriter<'a, u32, DEVDMASTATUS6_SPEC, bool, O>;
...
pub type END_BF_ST_W<'a, const O: u8> = crate::BitWriter<'a, u32, DEVDMASTATUS6_SPEC, bool, O>;
...
pub type DESC_LDST_W<'a, const O: u8> = crate::BitWriter<'a, u32, DEVDMASTATUS6_SPEC, bool, O>;
...
pub type BUFF_COUNT_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, DEVDMASTATUS6_SPEC, u16, u16, 16, O>;
impl R {
