#[doc = "Register `DEVEPTIMR3` reader"]
pub type R = crate::R<DEVEPTIMR3_SPEC>;
...
#[doc = "Device Endpoint Mask Register (n = 0) 3\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`deveptimr3::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DEVEPTIMR3_SPEC;
impl crate::RegisterSpec for DEVEPTIMR3_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`deveptimr3::R`](R) reader structure"]
impl crate::Readable for DEVEPTIMR3_SPEC {}
