...
pub type R = crate::R<HSTDMASTATUS1_SPEC>;
#[doc = "Register `HSTDMASTATUS1` writer"]
pub type W = crate::W<HSTDMASTATUS1_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn chann_enb(&mut self) -> CHANN_ENB_W<HSTDMASTATUS1_SPEC, 0> {
        CHANN_ENB_W::new(self)
    }
    #[doc = "Bit 1 - Channel Active Status"]
    #[inline(always)]
    #[must_use]
    pub fn chann_act(&mut self) -> CHANN_ACT_W<HSTDMASTATUS1_SPEC, 1> {
        CHANN_ACT_W::new(self)
    }
    #[doc = "Bit 4 - End of Channel Transfer Status"]
    #[inline(always)]
    #[must_use]
    pub fn end_tr_st(&mut self) -> END_TR_ST_W<HSTDMASTATUS1_SPEC, 4> {
        END_TR_ST_W::new(self)
    }
    #[doc = "Bit 5 - End of Channel Buffer Status"]
    #[inline(always)]
    #[must_use]
    pub fn end_bf_st(&mut self) -> END_BF_ST_W<HSTDMASTATUS1_SPEC, 5> {
        END_BF_ST_W::new(self)
    }
    #[doc = "Bit 6 - Descriptor Loaded Status"]
    #[inline(always)]
    #[must_use]
    pub fn desc_ldst(&mut self) -> DESC_LDST_W<HSTDMASTATUS1_SPEC, 6> {
        DESC_LDST_W::new(self)
    }
    #[doc = "Bits 16:31 - Buffer Byte Count"]
    #[inline(always)]
    #[must_use]
    pub fn buff_count(&mut self) -> BUFF_COUNT_W<HSTDMASTATUS1_SPEC, 16> {
...
#[doc = "Host DMA Channel Status Register (n = 1)\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`hstdmastatus1::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`hstdmastatus1::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
