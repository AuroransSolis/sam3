...
#[doc = "Host Pipe Configuration Register (n = 0) 6\n\nYou can [`read`](crate::Reg::read) this register and get [`hstpipcfg6::R`](R). You can [`write_with_zero`](crate::Reg::write_with_zero) this register using [`hstpipcfg6::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
