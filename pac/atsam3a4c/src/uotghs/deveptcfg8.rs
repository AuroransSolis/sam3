...
pub type R = crate::R<Deveptcfg8Spec>;
#[doc = "Register `DEVEPTCFG8` writer"]
pub type W = crate::W<Deveptcfg8Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn alloc(&mut self) -> AllocW<Deveptcfg8Spec> {
        AllocW::new(self, 1)
    }
    #[doc = "Bits 2:3 - Endpoint Banks"]
    #[inline(always)]
    #[must_use]
    pub fn epbk(&mut self) -> EpbkW<Deveptcfg8Spec> {
        EpbkW::new(self, 2)
    }
    #[doc = "Bits 4:6 - Endpoint Size"]
    #[inline(always)]
    #[must_use]
    pub fn epsize(&mut self) -> EpsizeW<Deveptcfg8Spec> {
        EpsizeW::new(self, 4)
    }
    #[doc = "Bit 8 - Endpoint Direction"]
    #[inline(always)]
    #[must_use]
    pub fn epdir(&mut self) -> EpdirW<Deveptcfg8Spec> {
        EpdirW::new(self, 8)
    }
    #[doc = "Bit 9 - Automatic Switch"]
    #[inline(always)]
    #[must_use]
    pub fn autosw(&mut self) -> AutoswW<Deveptcfg8Spec> {
        AutoswW::new(self, 9)
    }
    #[doc = "Bits 11:12 - Endpoint Type"]
    #[inline(always)]
    #[must_use]
    pub fn eptype(&mut self) -> EptypeW<Deveptcfg8Spec> {
        EptypeW::new(self, 11)
    }
    #[doc = "Bits 13:14 - Number of transaction per microframe for isochronous endpoint"]
    #[inline(always)]
    #[must_use]
    pub fn nbtrans(&mut self) -> NbtransW<Deveptcfg8Spec> {
...
pub struct Deveptcfg8Spec;
impl crate::RegisterSpec for Deveptcfg8Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`deveptcfg8::R`](R) reader structure"]
impl crate::Readable for Deveptcfg8Spec {}
#[doc = "`write(|w| ..)` method takes [`deveptcfg8::W`](W) writer structure"]
impl crate::Writable for Deveptcfg8Spec {
