...
pub type R = crate::R<CMPM1_SPEC>;
#[doc = "Register `CMPM1` writer"]
pub type W = crate::W<CMPM1_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn cen(&mut self) -> CEN_W<CMPM1_SPEC, 0> {
        CEN_W::new(self)
    }
    #[doc = "Bits 4:7 - Comparison x Trigger"]
    #[inline(always)]
    #[must_use]
    pub fn ctr(&mut self) -> CTR_W<CMPM1_SPEC, 4> {
        CTR_W::new(self)
    }
    #[doc = "Bits 8:11 - Comparison x Period"]
    #[inline(always)]
    #[must_use]
    pub fn cpr(&mut self) -> CPR_W<CMPM1_SPEC, 8> {
        CPR_W::new(self)
    }
    #[doc = "Bits 12:15 - Comparison x Period Counter"]
    #[inline(always)]
    #[must_use]
    pub fn cprcnt(&mut self) -> CPRCNT_W<CMPM1_SPEC, 12> {
        CPRCNT_W::new(self)
    }
    #[doc = "Bits 16:19 - Comparison x Update Period"]
    #[inline(always)]
    #[must_use]
    pub fn cupr(&mut self) -> CUPR_W<CMPM1_SPEC, 16> {
        CUPR_W::new(self)
    }
    #[doc = "Bits 20:23 - Comparison x Update Period Counter"]
    #[inline(always)]
    #[must_use]
    pub fn cuprcnt(&mut self) -> CUPRCNT_W<CMPM1_SPEC, 20> {
        CUPRCNT_W::new(self)
    }
