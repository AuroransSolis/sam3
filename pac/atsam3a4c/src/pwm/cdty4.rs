...
pub struct R(crate::R<CDTY4_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<CDTY4_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<CDTY4_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<CDTY4_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `CDTY4` writer"]
pub struct W(crate::W<CDTY4_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<CDTY4_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<CDTY4_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<CDTY4_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type CDTY_W<'a, const O: u8> = crate::FieldWriter<'a, u32, CDTY4_SPEC, u32, u32, 24, O>;
impl R {
