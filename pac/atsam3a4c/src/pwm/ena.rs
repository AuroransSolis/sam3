...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn chid4(&mut self) -> CHID4_W<ENA_SPEC> {
        CHID4_W::new(self, 4)
    }
    #[doc = "Bit 5 - Channel ID"]
    #[inline(always)]
    #[must_use]
    pub fn chid5(&mut self) -> CHID5_W<ENA_SPEC> {
        CHID5_W::new(self, 5)
    }
    #[doc = "Bit 6 - Channel ID"]
    #[inline(always)]
    #[must_use]
    pub fn chid6(&mut self) -> CHID6_W<ENA_SPEC> {
        CHID6_W::new(self, 6)
    }
    #[doc = "Bit 7 - Channel ID"]
    #[inline(always)]
    #[must_use]
    pub fn chid7(&mut self) -> CHID7_W<ENA_SPEC> {
        CHID7_W::new(self, 7)
    }
