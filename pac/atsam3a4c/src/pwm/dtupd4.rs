...
pub struct W(crate::W<DTUPD4_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<DTUPD4_SPEC>;
    #[inline(always)]
...
impl From<crate::W<DTUPD4_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<DTUPD4_SPEC>) -> Self {
        W(writer)
    }
}
#[doc = "Field `DTHUPD` writer - Dead-Time Value Update for PWMHx Output"]
pub type DTHUPD_W<'a, const O: u8> = crate::FieldWriter<'a, u32, DTUPD4_SPEC, u16, u16, 16, O>;
#[doc = "Field `DTLUPD` writer - Dead-Time Value Update for PWMLx Output"]
pub type DTLUPD_W<'a, const O: u8> = crate::FieldWriter<'a, u32, DTUPD4_SPEC, u16, u16, 16, O>;
impl W {
...
#[doc = "PWM Channel Dead Time Update Register (ch_num = 4)\n\nThis register you can [`write_with_zero`](crate::generic::Reg::write_with_zero). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [dtupd4](index.html) module"]
pub struct DTUPD4_SPEC;
impl crate::RegisterSpec for DTUPD4_SPEC {
    type Ux = u32;
}
