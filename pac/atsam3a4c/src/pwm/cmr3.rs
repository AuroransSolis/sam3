...
pub type R = crate::R<CMR3_SPEC>;
#[doc = "Register `CMR3` writer"]
pub type W = crate::W<CMR3_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn ces(&mut self) -> CES_W<CMR3_SPEC> {
        CES_W::new(self, 10)
    }
    #[doc = "Bit 16 - Dead-Time Generator Enable"]
    #[inline(always)]
    #[must_use]
    pub fn dte(&mut self) -> DTE_W<CMR3_SPEC> {
        DTE_W::new(self, 16)
    }
    #[doc = "Bit 17 - Dead-Time PWMHx Output Inverted"]
    #[inline(always)]
    #[must_use]
    pub fn dthi(&mut self) -> DTHI_W<CMR3_SPEC> {
        DTHI_W::new(self, 17)
    }
    #[doc = "Bit 18 - Dead-Time PWMLx Output Inverted"]
    #[inline(always)]
    #[must_use]
    pub fn dtli(&mut self) -> DTLI_W<CMR3_SPEC> {
        DTLI_W::new(self, 18)
    }
