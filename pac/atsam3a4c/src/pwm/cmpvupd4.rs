...
pub type W = crate::W<CMPVUPD4_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn cvupd(&mut self) -> CVUPD_W<CMPVUPD4_SPEC, 0> {
        CVUPD_W::new(self)
    }
    #[doc = "Bit 24 - Comparison x Value Mode Update"]
    #[inline(always)]
    #[must_use]
    pub fn cvmupd(&mut self) -> CVMUPD_W<CMPVUPD4_SPEC, 24> {
        CVMUPD_W::new(self)
    }
...
#[doc = "PWM Comparison 4 Value Update Register\n\nYou can [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`cmpvupd4::W`](W). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
