...
pub type R = crate::R<Mid3Spec>;
#[doc = "Register `MID3` writer"]
pub type W = crate::W<Mid3Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn midv_b(&mut self) -> MidvBW<Mid3Spec> {
        MidvBW::new(self, 0)
    }
    #[doc = "Bits 18:28 - Identifier for standard frame mode"]
    #[inline(always)]
    #[must_use]
    pub fn midv_a(&mut self) -> MidvAW<Mid3Spec> {
        MidvAW::new(self, 18)
    }
    #[doc = "Bit 29 - Identifier Version"]
    #[inline(always)]
    #[must_use]
    pub fn mide(&mut self) -> MideW<Mid3Spec> {
        MideW::new(self, 29)
    }
}
#[doc = "Mailbox ID Register (MB = 3)\n\nYou can [`read`](crate::Reg::read) this register and get [`mid3::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`mid3::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Mid3Spec;
impl crate::RegisterSpec for Mid3Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`mid3::R`](R) reader structure"]
impl crate::Readable for Mid3Spec {}
#[doc = "`write(|w| ..)` method takes [`mid3::W`](W) writer structure"]
impl crate::Writable for Mid3Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets MID3 to value 0"]
impl crate::Resettable for Mid3Spec {
