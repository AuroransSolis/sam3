...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn lockb(&mut self) -> LockbW<PmcIerSpec> {
        LockbW::new(self, 2)
    }
...
#[doc = "Interrupt Enable Register\n\nYou can [`write_with_zero`](crate::Reg::write_with_zero) this register using [`pmc_ier::W`](W). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
