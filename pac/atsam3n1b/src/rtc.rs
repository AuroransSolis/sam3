...
pub mod calr;
#[doc = "TIMALR (rw) register accessor: Time Alarm Register\n\nYou can [`read`](crate::Reg::read) this register and get [`timalr::R`]. You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`timalr::W`]. You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@timalr`]
module"]
#[doc(alias = "TIMALR")]
pub type Timalr = crate::Reg<timalr::TimalrSpec>;
#[doc = "Time Alarm Register"]
pub mod timalr;
#[doc = "CALALR (rw) register accessor: Calendar Alarm Register\n\nYou can [`read`](crate::Reg::read) this register and get [`calalr::R`]. You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`calalr::W`]. You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@calalr`]
module"]
#[doc(alias = "CALALR")]
...
#[doc = "Status Register"]
pub mod sr;
#[doc = "SCCR (w) register accessor: Status Clear Command Register\n\nYou can [`write_with_zero`](crate::Reg::write_with_zero) this register using [`sccr::W`]. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@sccr`]
module"]
#[doc(alias = "SCCR")]
