...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn p0(&mut self) -> P0_W<SODR_SPEC> {
        P0_W::new(self, 0)
    }
    #[doc = "Bit 1 - Set Output Data"]
    #[inline(always)]
    #[must_use]
    pub fn p1(&mut self) -> P1_W<SODR_SPEC> {
        P1_W::new(self, 1)
    }
    #[doc = "Bit 2 - Set Output Data"]
    #[inline(always)]
    #[must_use]
    pub fn p2(&mut self) -> P2_W<SODR_SPEC> {
        P2_W::new(self, 2)
    }
    #[doc = "Bit 3 - Set Output Data"]
    #[inline(always)]
    #[must_use]
    pub fn p3(&mut self) -> P3_W<SODR_SPEC> {
        P3_W::new(self, 3)
    }
    #[doc = "Bit 4 - Set Output Data"]
    #[inline(always)]
    #[must_use]
    pub fn p4(&mut self) -> P4_W<SODR_SPEC> {
        P4_W::new(self, 4)
    }
    #[doc = "Bit 5 - Set Output Data"]
    #[inline(always)]
    #[must_use]
    pub fn p5(&mut self) -> P5_W<SODR_SPEC> {
        P5_W::new(self, 5)
    }
    #[doc = "Bit 6 - Set Output Data"]
    #[inline(always)]
    #[must_use]
    pub fn p6(&mut self) -> P6_W<SODR_SPEC> {
        P6_W::new(self, 6)
    }
    #[doc = "Bit 7 - Set Output Data"]
    #[inline(always)]
    #[must_use]
    pub fn p7(&mut self) -> P7_W<SODR_SPEC> {
        P7_W::new(self, 7)
    }
    #[doc = "Bit 8 - Set Output Data"]
    #[inline(always)]
    #[must_use]
    pub fn p8(&mut self) -> P8_W<SODR_SPEC> {
        P8_W::new(self, 8)
    }
    #[doc = "Bit 9 - Set Output Data"]
    #[inline(always)]
    #[must_use]
    pub fn p9(&mut self) -> P9_W<SODR_SPEC> {
        P9_W::new(self, 9)
    }
    #[doc = "Bit 10 - Set Output Data"]
    #[inline(always)]
    #[must_use]
    pub fn p10(&mut self) -> P10_W<SODR_SPEC> {
        P10_W::new(self, 10)
    }
    #[doc = "Bit 11 - Set Output Data"]
    #[inline(always)]
    #[must_use]
    pub fn p11(&mut self) -> P11_W<SODR_SPEC> {
        P11_W::new(self, 11)
    }
    #[doc = "Bit 12 - Set Output Data"]
    #[inline(always)]
    #[must_use]
    pub fn p12(&mut self) -> P12_W<SODR_SPEC> {
        P12_W::new(self, 12)
    }
    #[doc = "Bit 13 - Set Output Data"]
    #[inline(always)]
    #[must_use]
    pub fn p13(&mut self) -> P13_W<SODR_SPEC> {
        P13_W::new(self, 13)
    }
    #[doc = "Bit 14 - Set Output Data"]
    #[inline(always)]
    #[must_use]
    pub fn p14(&mut self) -> P14_W<SODR_SPEC> {
        P14_W::new(self, 14)
    }
    #[doc = "Bit 15 - Set Output Data"]
    #[inline(always)]
    #[must_use]
    pub fn p15(&mut self) -> P15_W<SODR_SPEC> {
        P15_W::new(self, 15)
    }
    #[doc = "Bit 16 - Set Output Data"]
    #[inline(always)]
    #[must_use]
    pub fn p16(&mut self) -> P16_W<SODR_SPEC> {
        P16_W::new(self, 16)
    }
    #[doc = "Bit 17 - Set Output Data"]
    #[inline(always)]
    #[must_use]
    pub fn p17(&mut self) -> P17_W<SODR_SPEC> {
        P17_W::new(self, 17)
    }
    #[doc = "Bit 18 - Set Output Data"]
    #[inline(always)]
    #[must_use]
    pub fn p18(&mut self) -> P18_W<SODR_SPEC> {
        P18_W::new(self, 18)
    }
    #[doc = "Bit 19 - Set Output Data"]
    #[inline(always)]
    #[must_use]
    pub fn p19(&mut self) -> P19_W<SODR_SPEC> {
        P19_W::new(self, 19)
    }
    #[doc = "Bit 20 - Set Output Data"]
    #[inline(always)]
    #[must_use]
    pub fn p20(&mut self) -> P20_W<SODR_SPEC> {
        P20_W::new(self, 20)
    }
    #[doc = "Bit 21 - Set Output Data"]
    #[inline(always)]
    #[must_use]
    pub fn p21(&mut self) -> P21_W<SODR_SPEC> {
        P21_W::new(self, 21)
    }
    #[doc = "Bit 22 - Set Output Data"]
    #[inline(always)]
    #[must_use]
    pub fn p22(&mut self) -> P22_W<SODR_SPEC> {
        P22_W::new(self, 22)
    }
    #[doc = "Bit 23 - Set Output Data"]
    #[inline(always)]
    #[must_use]
    pub fn p23(&mut self) -> P23_W<SODR_SPEC> {
        P23_W::new(self, 23)
    }
    #[doc = "Bit 24 - Set Output Data"]
    #[inline(always)]
    #[must_use]
    pub fn p24(&mut self) -> P24_W<SODR_SPEC> {
        P24_W::new(self, 24)
    }
    #[doc = "Bit 25 - Set Output Data"]
    #[inline(always)]
    #[must_use]
    pub fn p25(&mut self) -> P25_W<SODR_SPEC> {
        P25_W::new(self, 25)
    }
    #[doc = "Bit 26 - Set Output Data"]
    #[inline(always)]
    #[must_use]
    pub fn p26(&mut self) -> P26_W<SODR_SPEC> {
        P26_W::new(self, 26)
    }
    #[doc = "Bit 27 - Set Output Data"]
    #[inline(always)]
    #[must_use]
    pub fn p27(&mut self) -> P27_W<SODR_SPEC> {
        P27_W::new(self, 27)
    }
    #[doc = "Bit 28 - Set Output Data"]
    #[inline(always)]
    #[must_use]
    pub fn p28(&mut self) -> P28_W<SODR_SPEC> {
        P28_W::new(self, 28)
    }
    #[doc = "Bit 29 - Set Output Data"]
    #[inline(always)]
    #[must_use]
    pub fn p29(&mut self) -> P29_W<SODR_SPEC> {
        P29_W::new(self, 29)
    }
    #[doc = "Bit 30 - Set Output Data"]
    #[inline(always)]
    #[must_use]
    pub fn p30(&mut self) -> P30_W<SODR_SPEC> {
        P30_W::new(self, 30)
    }
    #[doc = "Bit 31 - Set Output Data"]
    #[inline(always)]
    #[must_use]
    pub fn p31(&mut self) -> P31_W<SODR_SPEC> {
        P31_W::new(self, 31)
    }
...
#[doc = "Set Output Data Register\n\nYou can [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`sodr::W`](W). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
