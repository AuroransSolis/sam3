...
pub type R = crate::R<FIFO136_SPEC>;
#[doc = "Register `FIFO136` writer"]
pub type W = crate::W<FIFO136_SPEC>;
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        write!(f, "{}", self.bits())
    }
}
impl core::fmt::Debug for crate::generic::Reg<FIFO136_SPEC> {
...
pub struct FIFO136_SPEC;
impl crate::RegisterSpec for FIFO136_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`fifo136::R`](R) reader structure"]
impl crate::Readable for FIFO136_SPEC {}
#[doc = "`write(|w| ..)` method takes [`fifo136::W`](W) writer structure"]
impl crate::Writable for FIFO136_SPEC {
