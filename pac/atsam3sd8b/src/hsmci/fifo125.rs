...
pub type R = crate::R<FIFO125_SPEC>;
#[doc = "Register `FIFO125` writer"]
pub type W = crate::W<FIFO125_SPEC>;
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        write!(f, "{}", self.bits())
    }
}
impl core::fmt::Debug for crate::generic::Reg<FIFO125_SPEC> {
...
pub struct FIFO125_SPEC;
impl crate::RegisterSpec for FIFO125_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`fifo125::R`](R) reader structure"]
impl crate::Readable for FIFO125_SPEC {}
#[doc = "`write(|w| ..)` method takes [`fifo125::W`](W) writer structure"]
impl crate::Writable for FIFO125_SPEC {
