...
pub type R = crate::R<FIFO240_SPEC>;
#[doc = "Register `FIFO240` writer"]
pub type W = crate::W<FIFO240_SPEC>;
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        write!(f, "{}", self.bits())
    }
}
impl core::fmt::Debug for crate::generic::Reg<FIFO240_SPEC> {
...
pub struct FIFO240_SPEC;
impl crate::RegisterSpec for FIFO240_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`fifo240::R`](R) reader structure"]
impl crate::Readable for FIFO240_SPEC {}
#[doc = "`write(|w| ..)` method takes [`fifo240::W`](W) writer structure"]
impl crate::Writable for FIFO240_SPEC {
