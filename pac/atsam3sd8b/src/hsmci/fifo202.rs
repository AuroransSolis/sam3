...
pub type R = crate::R<FIFO202_SPEC>;
#[doc = "Register `FIFO202` writer"]
pub type W = crate::W<FIFO202_SPEC>;
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        write!(f, "{}", self.bits())
    }
}
impl core::fmt::Debug for crate::generic::Reg<FIFO202_SPEC> {
...
pub struct FIFO202_SPEC;
impl crate::RegisterSpec for FIFO202_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`fifo202::R`](R) reader structure"]
impl crate::Readable for FIFO202_SPEC {}
#[doc = "`write(|w| ..)` method takes [`fifo202::W`](W) writer structure"]
impl crate::Writable for FIFO202_SPEC {
