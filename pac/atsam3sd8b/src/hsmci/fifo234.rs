...
pub type R = crate::R<FIFO234_SPEC>;
#[doc = "Register `FIFO234` writer"]
pub type W = crate::W<FIFO234_SPEC>;
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        write!(f, "{}", self.bits())
    }
}
impl core::fmt::Debug for crate::generic::Reg<FIFO234_SPEC> {
...
pub struct FIFO234_SPEC;
impl crate::RegisterSpec for FIFO234_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`fifo234::R`](R) reader structure"]
impl crate::Readable for FIFO234_SPEC {}
#[doc = "`write(|w| ..)` method takes [`fifo234::W`](W) writer structure"]
impl crate::Writable for FIFO234_SPEC {
