...
pub type R = crate::R<FIFO85_SPEC>;
#[doc = "Register `FIFO85` writer"]
pub type W = crate::W<FIFO85_SPEC>;
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        write!(f, "{}", self.bits())
    }
}
impl core::fmt::Debug for crate::generic::Reg<FIFO85_SPEC> {
...
pub struct FIFO85_SPEC;
impl crate::RegisterSpec for FIFO85_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`fifo85::R`](R) reader structure"]
impl crate::Readable for FIFO85_SPEC {}
#[doc = "`write(|w| ..)` method takes [`fifo85::W`](W) writer structure"]
impl crate::Writable for FIFO85_SPEC {
