...
pub type R = crate::R<FIFO77_SPEC>;
#[doc = "Register `FIFO77` writer"]
pub type W = crate::W<FIFO77_SPEC>;
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        write!(f, "{}", self.bits())
    }
}
impl core::fmt::Debug for crate::generic::Reg<FIFO77_SPEC> {
...
pub struct FIFO77_SPEC;
impl crate::RegisterSpec for FIFO77_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`fifo77::R`](R) reader structure"]
impl crate::Readable for FIFO77_SPEC {}
#[doc = "`write(|w| ..)` method takes [`fifo77::W`](W) writer structure"]
impl crate::Writable for FIFO77_SPEC {
