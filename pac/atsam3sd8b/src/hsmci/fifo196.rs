...
pub type R = crate::R<FIFO196_SPEC>;
#[doc = "Register `FIFO196` writer"]
pub type W = crate::W<FIFO196_SPEC>;
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        write!(f, "{}", self.bits())
    }
}
impl core::fmt::Debug for crate::generic::Reg<FIFO196_SPEC> {
...
pub struct FIFO196_SPEC;
impl crate::RegisterSpec for FIFO196_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`fifo196::R`](R) reader structure"]
impl crate::Readable for FIFO196_SPEC {}
#[doc = "`write(|w| ..)` method takes [`fifo196::W`](W) writer structure"]
impl crate::Writable for FIFO196_SPEC {
