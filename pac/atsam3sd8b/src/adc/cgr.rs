...
pub type GAIN12_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 2, O>;
...
pub type GAIN13_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 2, O>;
...
pub type GAIN14_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 2, O>;
...
pub type GAIN15_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 2, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn gain12(&mut self) -> GAIN12_W<CGR_SPEC, 24> {
        GAIN12_W::new(self)
    }
    #[doc = "Bits 26:27 - Gain for channel 13"]
    #[inline(always)]
    #[must_use]
    pub fn gain13(&mut self) -> GAIN13_W<CGR_SPEC, 26> {
        GAIN13_W::new(self)
    }
    #[doc = "Bits 28:29 - Gain for channel 14"]
    #[inline(always)]
    #[must_use]
    pub fn gain14(&mut self) -> GAIN14_W<CGR_SPEC, 28> {
        GAIN14_W::new(self)
    }
    #[doc = "Bits 30:31 - Gain for channel 15"]
    #[inline(always)]
    #[must_use]
    pub fn gain15(&mut self) -> GAIN15_W<CGR_SPEC, 30> {
        GAIN15_W::new(self)
    }
