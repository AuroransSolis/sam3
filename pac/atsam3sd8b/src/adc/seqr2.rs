...
pub type USCH9_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 3, O>;
...
pub type USCH10_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 3, O>;
...
pub type USCH11_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 3, O>;
...
pub type USCH12_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 3, O>;
...
pub type USCH13_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 3, O>;
...
pub type USCH14_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 3, O>;
...
pub type USCH15_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 3, O>;
...
pub type USCH16_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 3, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn usch16(&mut self) -> USCH16_W<SEQR2_SPEC, 28> {
        USCH16_W::new(self)
    }
