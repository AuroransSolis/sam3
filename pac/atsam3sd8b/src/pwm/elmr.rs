...
#[doc = "PWM Event Line 0 Mode Register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`elmr::R`](R).  You can [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`elmr::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
