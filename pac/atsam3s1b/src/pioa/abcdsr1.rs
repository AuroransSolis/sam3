#[doc = "Register `ABCDSR1` reader"]
pub type R = crate::R<ABCDSR1_SPEC>;
#[doc = "Register `ABCDSR1` writer"]
pub type W = crate::W<ABCDSR1_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn p0(&mut self) -> P0_W<ABCDSR1_SPEC, 0> {
        P0_W::new(self)
    }
    #[doc = "Bit 1 - Peripheral Select."]
    #[inline(always)]
    #[must_use]
    pub fn p1(&mut self) -> P1_W<ABCDSR1_SPEC, 1> {
        P1_W::new(self)
    }
    #[doc = "Bit 2 - Peripheral Select."]
    #[inline(always)]
    #[must_use]
    pub fn p2(&mut self) -> P2_W<ABCDSR1_SPEC, 2> {
        P2_W::new(self)
    }
    #[doc = "Bit 3 - Peripheral Select."]
    #[inline(always)]
    #[must_use]
    pub fn p3(&mut self) -> P3_W<ABCDSR1_SPEC, 3> {
        P3_W::new(self)
    }
    #[doc = "Bit 4 - Peripheral Select."]
    #[inline(always)]
    #[must_use]
    pub fn p4(&mut self) -> P4_W<ABCDSR1_SPEC, 4> {
        P4_W::new(self)
    }
    #[doc = "Bit 5 - Peripheral Select."]
    #[inline(always)]
    #[must_use]
    pub fn p5(&mut self) -> P5_W<ABCDSR1_SPEC, 5> {
        P5_W::new(self)
    }
    #[doc = "Bit 6 - Peripheral Select."]
    #[inline(always)]
    #[must_use]
    pub fn p6(&mut self) -> P6_W<ABCDSR1_SPEC, 6> {
        P6_W::new(self)
    }
    #[doc = "Bit 7 - Peripheral Select."]
    #[inline(always)]
    #[must_use]
    pub fn p7(&mut self) -> P7_W<ABCDSR1_SPEC, 7> {
        P7_W::new(self)
    }
    #[doc = "Bit 8 - Peripheral Select."]
    #[inline(always)]
    #[must_use]
    pub fn p8(&mut self) -> P8_W<ABCDSR1_SPEC, 8> {
        P8_W::new(self)
    }
    #[doc = "Bit 9 - Peripheral Select."]
    #[inline(always)]
    #[must_use]
    pub fn p9(&mut self) -> P9_W<ABCDSR1_SPEC, 9> {
        P9_W::new(self)
    }
    #[doc = "Bit 10 - Peripheral Select."]
    #[inline(always)]
    #[must_use]
    pub fn p10(&mut self) -> P10_W<ABCDSR1_SPEC, 10> {
        P10_W::new(self)
    }
    #[doc = "Bit 11 - Peripheral Select."]
    #[inline(always)]
    #[must_use]
    pub fn p11(&mut self) -> P11_W<ABCDSR1_SPEC, 11> {
        P11_W::new(self)
    }
    #[doc = "Bit 12 - Peripheral Select."]
    #[inline(always)]
    #[must_use]
    pub fn p12(&mut self) -> P12_W<ABCDSR1_SPEC, 12> {
        P12_W::new(self)
    }
    #[doc = "Bit 13 - Peripheral Select."]
    #[inline(always)]
    #[must_use]
    pub fn p13(&mut self) -> P13_W<ABCDSR1_SPEC, 13> {
        P13_W::new(self)
    }
    #[doc = "Bit 14 - Peripheral Select."]
    #[inline(always)]
    #[must_use]
    pub fn p14(&mut self) -> P14_W<ABCDSR1_SPEC, 14> {
        P14_W::new(self)
    }
    #[doc = "Bit 15 - Peripheral Select."]
    #[inline(always)]
    #[must_use]
    pub fn p15(&mut self) -> P15_W<ABCDSR1_SPEC, 15> {
        P15_W::new(self)
    }
    #[doc = "Bit 16 - Peripheral Select."]
    #[inline(always)]
    #[must_use]
    pub fn p16(&mut self) -> P16_W<ABCDSR1_SPEC, 16> {
        P16_W::new(self)
    }
    #[doc = "Bit 17 - Peripheral Select."]
    #[inline(always)]
    #[must_use]
    pub fn p17(&mut self) -> P17_W<ABCDSR1_SPEC, 17> {
        P17_W::new(self)
    }
    #[doc = "Bit 18 - Peripheral Select."]
    #[inline(always)]
    #[must_use]
    pub fn p18(&mut self) -> P18_W<ABCDSR1_SPEC, 18> {
        P18_W::new(self)
    }
    #[doc = "Bit 19 - Peripheral Select."]
    #[inline(always)]
    #[must_use]
    pub fn p19(&mut self) -> P19_W<ABCDSR1_SPEC, 19> {
        P19_W::new(self)
    }
    #[doc = "Bit 20 - Peripheral Select."]
    #[inline(always)]
    #[must_use]
    pub fn p20(&mut self) -> P20_W<ABCDSR1_SPEC, 20> {
        P20_W::new(self)
    }
    #[doc = "Bit 21 - Peripheral Select."]
    #[inline(always)]
    #[must_use]
    pub fn p21(&mut self) -> P21_W<ABCDSR1_SPEC, 21> {
        P21_W::new(self)
    }
    #[doc = "Bit 22 - Peripheral Select."]
    #[inline(always)]
    #[must_use]
    pub fn p22(&mut self) -> P22_W<ABCDSR1_SPEC, 22> {
        P22_W::new(self)
    }
    #[doc = "Bit 23 - Peripheral Select."]
    #[inline(always)]
    #[must_use]
    pub fn p23(&mut self) -> P23_W<ABCDSR1_SPEC, 23> {
        P23_W::new(self)
    }
    #[doc = "Bit 24 - Peripheral Select."]
    #[inline(always)]
    #[must_use]
    pub fn p24(&mut self) -> P24_W<ABCDSR1_SPEC, 24> {
        P24_W::new(self)
    }
    #[doc = "Bit 25 - Peripheral Select."]
    #[inline(always)]
    #[must_use]
    pub fn p25(&mut self) -> P25_W<ABCDSR1_SPEC, 25> {
        P25_W::new(self)
    }
    #[doc = "Bit 26 - Peripheral Select."]
    #[inline(always)]
    #[must_use]
    pub fn p26(&mut self) -> P26_W<ABCDSR1_SPEC, 26> {
        P26_W::new(self)
    }
    #[doc = "Bit 27 - Peripheral Select."]
    #[inline(always)]
    #[must_use]
    pub fn p27(&mut self) -> P27_W<ABCDSR1_SPEC, 27> {
        P27_W::new(self)
    }
    #[doc = "Bit 28 - Peripheral Select."]
    #[inline(always)]
    #[must_use]
    pub fn p28(&mut self) -> P28_W<ABCDSR1_SPEC, 28> {
        P28_W::new(self)
    }
    #[doc = "Bit 29 - Peripheral Select."]
    #[inline(always)]
    #[must_use]
    pub fn p29(&mut self) -> P29_W<ABCDSR1_SPEC, 29> {
        P29_W::new(self)
    }
    #[doc = "Bit 30 - Peripheral Select."]
    #[inline(always)]
    #[must_use]
    pub fn p30(&mut self) -> P30_W<ABCDSR1_SPEC, 30> {
        P30_W::new(self)
    }
    #[doc = "Bit 31 - Peripheral Select."]
    #[inline(always)]
    #[must_use]
    pub fn p31(&mut self) -> P31_W<ABCDSR1_SPEC, 31> {
        P31_W::new(self)
    }
...
#[doc = "Peripheral Select Register 1\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`abcdsr1::R`](R).  You can [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`abcdsr1::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct ABCDSR1_SPEC;
impl crate::RegisterSpec for ABCDSR1_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`abcdsr1::R`](R) reader structure"]
impl crate::Readable for ABCDSR1_SPEC {}
#[doc = "`write(|w| ..)` method takes [`abcdsr1::W`](W) writer structure"]
impl crate::Writable for ABCDSR1_SPEC {
