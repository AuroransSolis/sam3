...
pub type R = crate::R<FIFO128_SPEC>;
#[doc = "Register `FIFO128` writer"]
pub type W = crate::W<FIFO128_SPEC>;
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        write!(f, "{}", self.bits())
    }
}
impl core::fmt::Debug for crate::generic::Reg<FIFO128_SPEC> {
...
pub struct FIFO128_SPEC;
impl crate::RegisterSpec for FIFO128_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`fifo128::R`](R) reader structure"]
impl crate::Readable for FIFO128_SPEC {}
#[doc = "`write(|w| ..)` method takes [`fifo128::W`](W) writer structure"]
impl crate::Writable for FIFO128_SPEC {
