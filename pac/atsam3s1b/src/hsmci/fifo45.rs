...
pub type R = crate::R<FIFO45_SPEC>;
#[doc = "Register `FIFO45` writer"]
pub type W = crate::W<FIFO45_SPEC>;
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        write!(f, "{}", self.bits())
    }
}
impl core::fmt::Debug for crate::generic::Reg<FIFO45_SPEC> {
...
pub struct FIFO45_SPEC;
impl crate::RegisterSpec for FIFO45_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`fifo45::R`](R) reader structure"]
impl crate::Readable for FIFO45_SPEC {}
#[doc = "`write(|w| ..)` method takes [`fifo45::W`](W) writer structure"]
impl crate::Writable for FIFO45_SPEC {
