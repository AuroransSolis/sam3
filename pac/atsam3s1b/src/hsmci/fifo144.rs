...
pub type R = crate::R<FIFO144_SPEC>;
#[doc = "Register `FIFO144` writer"]
pub type W = crate::W<FIFO144_SPEC>;
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        write!(f, "{}", self.bits())
    }
}
impl core::fmt::Debug for crate::generic::Reg<FIFO144_SPEC> {
...
pub struct FIFO144_SPEC;
impl crate::RegisterSpec for FIFO144_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`fifo144::R`](R) reader structure"]
impl crate::Readable for FIFO144_SPEC {}
#[doc = "`write(|w| ..)` method takes [`fifo144::W`](W) writer structure"]
impl crate::Writable for FIFO144_SPEC {
