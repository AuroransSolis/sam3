...
pub type R = crate::R<FIFO11_SPEC>;
#[doc = "Register `FIFO11` writer"]
pub type W = crate::W<FIFO11_SPEC>;
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        write!(f, "{}", self.bits())
    }
}
impl core::fmt::Debug for crate::generic::Reg<FIFO11_SPEC> {
...
pub struct FIFO11_SPEC;
impl crate::RegisterSpec for FIFO11_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`fifo11::R`](R) reader structure"]
impl crate::Readable for FIFO11_SPEC {}
#[doc = "`write(|w| ..)` method takes [`fifo11::W`](W) writer structure"]
impl crate::Writable for FIFO11_SPEC {
