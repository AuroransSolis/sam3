...
pub type R = crate::R<FIFO99_SPEC>;
#[doc = "Register `FIFO99` writer"]
pub type W = crate::W<FIFO99_SPEC>;
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        write!(f, "{}", self.bits())
    }
}
impl core::fmt::Debug for crate::generic::Reg<FIFO99_SPEC> {
...
pub struct FIFO99_SPEC;
impl crate::RegisterSpec for FIFO99_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`fifo99::R`](R) reader structure"]
impl crate::Readable for FIFO99_SPEC {}
#[doc = "`write(|w| ..)` method takes [`fifo99::W`](W) writer structure"]
impl crate::Writable for FIFO99_SPEC {
