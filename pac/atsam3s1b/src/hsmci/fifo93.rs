...
pub type R = crate::R<FIFO93_SPEC>;
#[doc = "Register `FIFO93` writer"]
pub type W = crate::W<FIFO93_SPEC>;
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        write!(f, "{}", self.bits())
    }
}
impl core::fmt::Debug for crate::generic::Reg<FIFO93_SPEC> {
...
pub struct FIFO93_SPEC;
impl crate::RegisterSpec for FIFO93_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`fifo93::R`](R) reader structure"]
impl crate::Readable for FIFO93_SPEC {}
#[doc = "`write(|w| ..)` method takes [`fifo93::W`](W) writer structure"]
impl crate::Writable for FIFO93_SPEC {
