...
pub type R = crate::R<FIFO231_SPEC>;
#[doc = "Register `FIFO231` writer"]
pub type W = crate::W<FIFO231_SPEC>;
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        write!(f, "{}", self.bits())
    }
}
impl core::fmt::Debug for crate::generic::Reg<FIFO231_SPEC> {
...
pub struct FIFO231_SPEC;
impl crate::RegisterSpec for FIFO231_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`fifo231::R`](R) reader structure"]
impl crate::Readable for FIFO231_SPEC {}
#[doc = "`write(|w| ..)` method takes [`fifo231::W`](W) writer structure"]
impl crate::Writable for FIFO231_SPEC {
