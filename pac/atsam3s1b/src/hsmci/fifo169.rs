...
pub type R = crate::R<FIFO169_SPEC>;
#[doc = "Register `FIFO169` writer"]
pub type W = crate::W<FIFO169_SPEC>;
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        write!(f, "{}", self.bits())
    }
}
impl core::fmt::Debug for crate::generic::Reg<FIFO169_SPEC> {
...
pub struct FIFO169_SPEC;
impl crate::RegisterSpec for FIFO169_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`fifo169::R`](R) reader structure"]
impl crate::Readable for FIFO169_SPEC {}
#[doc = "`write(|w| ..)` method takes [`fifo169::W`](W) writer structure"]
impl crate::Writable for FIFO169_SPEC {
