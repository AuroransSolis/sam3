...
pub type R = crate::R<FIFO138_SPEC>;
#[doc = "Register `FIFO138` writer"]
pub type W = crate::W<FIFO138_SPEC>;
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        write!(f, "{}", self.bits())
    }
}
impl core::fmt::Debug for crate::generic::Reg<FIFO138_SPEC> {
...
pub struct FIFO138_SPEC;
impl crate::RegisterSpec for FIFO138_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`fifo138::R`](R) reader structure"]
impl crate::Readable for FIFO138_SPEC {}
#[doc = "`write(|w| ..)` method takes [`fifo138::W`](W) writer structure"]
impl crate::Writable for FIFO138_SPEC {
