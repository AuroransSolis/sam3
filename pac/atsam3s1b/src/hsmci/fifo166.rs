...
pub type R = crate::R<FIFO166_SPEC>;
#[doc = "Register `FIFO166` writer"]
pub type W = crate::W<FIFO166_SPEC>;
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        write!(f, "{}", self.bits())
    }
}
impl core::fmt::Debug for crate::generic::Reg<FIFO166_SPEC> {
...
pub struct FIFO166_SPEC;
impl crate::RegisterSpec for FIFO166_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`fifo166::R`](R) reader structure"]
impl crate::Readable for FIFO166_SPEC {}
#[doc = "`write(|w| ..)` method takes [`fifo166::W`](W) writer structure"]
impl crate::Writable for FIFO166_SPEC {
