...
pub type R = crate::R<FIFO153_SPEC>;
#[doc = "Register `FIFO153` writer"]
pub type W = crate::W<FIFO153_SPEC>;
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        write!(f, "{}", self.bits())
    }
}
impl core::fmt::Debug for crate::generic::Reg<FIFO153_SPEC> {
...
pub struct FIFO153_SPEC;
impl crate::RegisterSpec for FIFO153_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`fifo153::R`](R) reader structure"]
impl crate::Readable for FIFO153_SPEC {}
#[doc = "`write(|w| ..)` method takes [`fifo153::W`](W) writer structure"]
impl crate::Writable for FIFO153_SPEC {
