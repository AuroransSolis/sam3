...
pub type R = crate::R<FIFO227_SPEC>;
#[doc = "Register `FIFO227` writer"]
pub type W = crate::W<FIFO227_SPEC>;
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        write!(f, "{}", self.bits())
    }
}
impl core::fmt::Debug for crate::generic::Reg<FIFO227_SPEC> {
...
pub struct FIFO227_SPEC;
impl crate::RegisterSpec for FIFO227_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`fifo227::R`](R) reader structure"]
impl crate::Readable for FIFO227_SPEC {}
#[doc = "`write(|w| ..)` method takes [`fifo227::W`](W) writer structure"]
impl crate::Writable for FIFO227_SPEC {
