...
pub type R = crate::R<FIFO69_SPEC>;
#[doc = "Register `FIFO69` writer"]
pub type W = crate::W<FIFO69_SPEC>;
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        write!(f, "{}", self.bits())
    }
}
impl core::fmt::Debug for crate::generic::Reg<FIFO69_SPEC> {
...
pub struct FIFO69_SPEC;
impl crate::RegisterSpec for FIFO69_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`fifo69::R`](R) reader structure"]
impl crate::Readable for FIFO69_SPEC {}
#[doc = "`write(|w| ..)` method takes [`fifo69::W`](W) writer structure"]
impl crate::Writable for FIFO69_SPEC {
