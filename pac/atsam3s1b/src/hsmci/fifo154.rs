...
pub type R = crate::R<FIFO154_SPEC>;
#[doc = "Register `FIFO154` writer"]
pub type W = crate::W<FIFO154_SPEC>;
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        write!(f, "{}", self.bits())
    }
}
impl core::fmt::Debug for crate::generic::Reg<FIFO154_SPEC> {
...
pub struct FIFO154_SPEC;
impl crate::RegisterSpec for FIFO154_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`fifo154::R`](R) reader structure"]
impl crate::Readable for FIFO154_SPEC {}
#[doc = "`write(|w| ..)` method takes [`fifo154::W`](W) writer structure"]
impl crate::Writable for FIFO154_SPEC {
