...
pub type R = crate::R<FIFO13_SPEC>;
#[doc = "Register `FIFO13` writer"]
pub type W = crate::W<FIFO13_SPEC>;
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        write!(f, "{}", self.bits())
    }
}
impl core::fmt::Debug for crate::generic::Reg<FIFO13_SPEC> {
...
pub struct FIFO13_SPEC;
impl crate::RegisterSpec for FIFO13_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`fifo13::R`](R) reader structure"]
impl crate::Readable for FIFO13_SPEC {}
#[doc = "`write(|w| ..)` method takes [`fifo13::W`](W) writer structure"]
impl crate::Writable for FIFO13_SPEC {
