...
pub type R = crate::R<FIFO163_SPEC>;
#[doc = "Register `FIFO163` writer"]
pub type W = crate::W<FIFO163_SPEC>;
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        write!(f, "{}", self.bits())
    }
}
impl core::fmt::Debug for crate::generic::Reg<FIFO163_SPEC> {
...
pub struct FIFO163_SPEC;
impl crate::RegisterSpec for FIFO163_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`fifo163::R`](R) reader structure"]
impl crate::Readable for FIFO163_SPEC {}
#[doc = "`write(|w| ..)` method takes [`fifo163::W`](W) writer structure"]
impl crate::Writable for FIFO163_SPEC {
