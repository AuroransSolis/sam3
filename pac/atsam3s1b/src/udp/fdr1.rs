...
pub type R = crate::R<Fdr1Spec>;
#[doc = "Register `FDR1` writer"]
pub type W = crate::W<Fdr1Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn fifo_data(&mut self) -> FifoDataW<Fdr1Spec> {
        FifoDataW::new(self, 0)
    }
}
#[doc = "Endpoint FIFO Data Register 1\n\nYou can [`read`](crate::Reg::read) this register and get [`fdr1::R`](R). You can [`write_with_zero`](crate::Reg::write_with_zero) this register using [`fdr1::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Fdr1Spec;
impl crate::RegisterSpec for Fdr1Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`fdr1::R`](R) reader structure"]
impl crate::Readable for Fdr1Spec {}
#[doc = "`write(|w| ..)` method takes [`fdr1::W`](W) writer structure"]
impl crate::Writable for Fdr1Spec {
