...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn txcomp(&mut self) -> TxcompW<Csr0Spec> {
        TxcompW::new(self, 0)
    }
    #[doc = "Bit 1 - Receive Data Bank 0"]
    #[inline(always)]
    #[must_use]
    pub fn rx_data_bk0(&mut self) -> RxDataBk0W<Csr0Spec> {
        RxDataBk0W::new(self, 1)
    }
    #[doc = "Bit 2 - Received Setup"]
    #[inline(always)]
    #[must_use]
    pub fn rxsetup(&mut self) -> RxsetupW<Csr0Spec> {
        RxsetupW::new(self, 2)
    }
    #[doc = "Bit 3 - Stall Sent"]
    #[inline(always)]
    #[must_use]
    pub fn stallsent(&mut self) -> StallsentW<Csr0Spec> {
        StallsentW::new(self, 3)
    }
    #[doc = "Bit 4 - Transmit Packet Ready"]
    #[inline(always)]
    #[must_use]
    pub fn txpktrdy(&mut self) -> TxpktrdyW<Csr0Spec> {
        TxpktrdyW::new(self, 4)
    }
    #[doc = "Bit 5 - Force Stall (used by Control, Bulk and Isochronous Endpoints)"]
    #[inline(always)]
    #[must_use]
    pub fn forcestall(&mut self) -> ForcestallW<Csr0Spec> {
        ForcestallW::new(self, 5)
    }
    #[doc = "Bit 6 - Receive Data Bank 1 (only used by endpoints with ping-pong attributes)"]
    #[inline(always)]
    #[must_use]
    pub fn rx_data_bk1(&mut self) -> RxDataBk1W<Csr0Spec> {
        RxDataBk1W::new(self, 6)
    }
    #[doc = "Bit 7 - Transfer Direction (only available for control endpoints)"]
    #[inline(always)]
    #[must_use]
    pub fn dir(&mut self) -> DirW<Csr0Spec> {
        DirW::new(self, 7)
    }
    #[doc = "Bits 8:10 - Endpoint Type"]
    #[inline(always)]
    #[must_use]
    pub fn eptype(&mut self) -> EptypeW<Csr0Spec> {
        EptypeW::new(self, 8)
    }
    #[doc = "Bit 11 - Data Toggle"]
    #[inline(always)]
    #[must_use]
    pub fn dtgle(&mut self) -> DtgleW<Csr0Spec> {
        DtgleW::new(self, 11)
    }
    #[doc = "Bit 15 - Endpoint Enable Disable"]
    #[inline(always)]
    #[must_use]
    pub fn epeds(&mut self) -> EpedsW<Csr0Spec> {
        EpedsW::new(self, 15)
    }
    #[doc = "Bits 16:26 - Number of Bytes Available in the FIFO"]
    #[inline(always)]
    #[must_use]
    pub fn rxbytecnt(&mut self) -> RxbytecntW<Csr0Spec> {
