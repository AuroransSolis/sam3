...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn nc(&mut self) -> NC_W<CR1_SPEC> {
        NC_W::new(self, 0)
    }
    #[doc = "Bits 2:3 - Number of Row Bits"]
    #[inline(always)]
    #[must_use]
    pub fn nr(&mut self) -> NR_W<CR1_SPEC> {
        NR_W::new(self, 2)
    }
    #[doc = "Bit 4 - Number of Banks"]
    #[inline(always)]
    #[must_use]
    pub fn nb(&mut self) -> NB_W<CR1_SPEC> {
        NB_W::new(self, 4)
    }
    #[doc = "Bits 5:6 - CAS Latency"]
    #[inline(always)]
    #[must_use]
    pub fn cas(&mut self) -> CAS_W<CR1_SPEC> {
        CAS_W::new(self, 5)
    }
    #[doc = "Bit 7 - Data Bus Width"]
    #[inline(always)]
    #[must_use]
    pub fn dbw(&mut self) -> DBW_W<CR1_SPEC> {
        DBW_W::new(self, 7)
    }
    #[doc = "Bits 8:11 - Write Recovery Delay"]
    #[inline(always)]
    #[must_use]
    pub fn twr(&mut self) -> TWR_W<CR1_SPEC> {
        TWR_W::new(self, 8)
    }
    #[doc = "Bits 12:15 - Row Cycle Delay and Row Refresh Cycle"]
    #[inline(always)]
    #[must_use]
    pub fn trc_trfc(&mut self) -> TRC_TRFC_W<CR1_SPEC> {
        TRC_TRFC_W::new(self, 12)
    }
    #[doc = "Bits 16:19 - Row Precharge Delay"]
    #[inline(always)]
    #[must_use]
    pub fn trp(&mut self) -> TRP_W<CR1_SPEC> {
        TRP_W::new(self, 16)
    }
    #[doc = "Bits 20:23 - Row to Column Delay"]
    #[inline(always)]
    #[must_use]
    pub fn trcd(&mut self) -> TRCD_W<CR1_SPEC> {
        TRCD_W::new(self, 20)
    }
    #[doc = "Bits 24:27 - Active to Precharge Delay"]
    #[inline(always)]
    #[must_use]
    pub fn tras(&mut self) -> TRAS_W<CR1_SPEC> {
        TRAS_W::new(self, 24)
    }
    #[doc = "Bits 28:31 - Exit Self Refresh to Active Delay"]
    #[inline(always)]
    #[must_use]
    pub fn txsr(&mut self) -> TXSR_W<CR1_SPEC> {
        TXSR_W::new(self, 28)
    }
