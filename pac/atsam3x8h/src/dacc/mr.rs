...
impl From<TrgselA> for u8 {
    #[inline(always)]
    fn from(variant: TrgselA) -> Self {
        variant as _
    }
}
impl crate::FieldSpec for TrgselA {
    type Ux = u8;
}
impl crate::IsEnum for TrgselA {}
#[doc = "Field `TRGSEL` reader - Trigger Selection"]
pub type TrgselR = crate::FieldReader<TrgselA>;
impl TrgselR {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub const fn variant(&self) -> TrgselA {
        match self.bits {
            0 => TrgselA::External,
            1 => TrgselA::Tiootcc0,
            2 => TrgselA::Tiootcc1,
...
pub type TrgselW<'a, REG> = crate::FieldWriter<'a, REG, 3, TrgselA>;
