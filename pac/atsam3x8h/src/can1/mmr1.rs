...
pub type R = crate::R<MMR1_SPEC>;
#[doc = "Register `MMR1` writer"]
pub type W = crate::W<MMR1_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn mtimemark(&mut self) -> MTIMEMARK_W<MMR1_SPEC, 0> {
        MTIMEMARK_W::new(self)
    }
    #[doc = "Bits 16:19 - Mailbox Priority"]
    #[inline(always)]
    #[must_use]
    pub fn prior(&mut self) -> PRIOR_W<MMR1_SPEC, 16> {
        PRIOR_W::new(self)
    }
    #[doc = "Bits 24:26 - Mailbox Object Type"]
    #[inline(always)]
    #[must_use]
    pub fn mot(&mut self) -> MOT_W<MMR1_SPEC, 24> {
        MOT_W::new(self)
    }
