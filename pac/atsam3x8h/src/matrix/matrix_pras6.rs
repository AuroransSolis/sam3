...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn m0pr(&mut self) -> M0PR_W<MATRIX_PRAS6_SPEC, 0> {
        M0PR_W::new(self)
    }
    #[doc = "Bits 4:5 - Master 1 Priority"]
    #[inline(always)]
    #[must_use]
    pub fn m1pr(&mut self) -> M1PR_W<MATRIX_PRAS6_SPEC, 4> {
        M1PR_W::new(self)
    }
    #[doc = "Bits 8:9 - Master 2 Priority"]
    #[inline(always)]
    #[must_use]
    pub fn m2pr(&mut self) -> M2PR_W<MATRIX_PRAS6_SPEC, 8> {
        M2PR_W::new(self)
    }
    #[doc = "Bits 12:13 - Master 3 Priority"]
    #[inline(always)]
    #[must_use]
    pub fn m3pr(&mut self) -> M3PR_W<MATRIX_PRAS6_SPEC, 12> {
        M3PR_W::new(self)
    }
    #[doc = "Bits 16:17 - Master 4 Priority"]
    #[inline(always)]
    #[must_use]
    pub fn m4pr(&mut self) -> M4PR_W<MATRIX_PRAS6_SPEC, 16> {
        M4PR_W::new(self)
    }
    #[doc = "Bits 20:21 - Master 5 Priority"]
    #[inline(always)]
    #[must_use]
    pub fn m5pr(&mut self) -> M5PR_W<MATRIX_PRAS6_SPEC, 20> {
        M5PR_W::new(self)
    }
