...
pub mod fpv;
#[doc = "FPE1 (rw) register accessor: an alias for `Reg<FPE1_SPEC>`"]
pub type FPE1 = crate::Reg<fpe1::FPE1_SPEC>;
#[doc = "PWM Fault Protection Enable Register 1"]
pub mod fpe1;
#[doc = "FPE2 (rw) register accessor: an alias for `Reg<FPE2_SPEC>`"]
