#[doc = "Register `TIMINGS5` reader"]
pub struct R(crate::R<TIMINGS5_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<TIMINGS5_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<TIMINGS5_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<TIMINGS5_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `TIMINGS5` writer"]
pub struct W(crate::W<TIMINGS5_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<TIMINGS5_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<TIMINGS5_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<TIMINGS5_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type OCMS_W<'a, const O: u8> = crate::BitWriter<'a, u32, TIMINGS5_SPEC, bool, O>;
...
pub type TRR_W<'a, const O: u8> = crate::FieldWriter<'a, u32, TIMINGS5_SPEC, u8, u8, 4, O>;
...
pub type TWB_W<'a, const O: u8> = crate::FieldWriter<'a, u32, TIMINGS5_SPEC, u8, u8, 4, O>;
...
pub type RBNSEL_W<'a, const O: u8> = crate::FieldWriter<'a, u32, TIMINGS5_SPEC, u8, u8, 3, O>;
...
pub type NFSEL_W<'a, const O: u8> = crate::BitWriter<'a, u32, TIMINGS5_SPEC, bool, O>;
impl R {
...
#[doc = "SMC Timings Register (CS_number = 5)\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [timings5](index.html) module"]
pub struct TIMINGS5_SPEC;
impl crate::RegisterSpec for TIMINGS5_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [timings5::R](R) reader structure"]
impl crate::Readable for TIMINGS5_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [timings5::W](W) writer structure"]
impl crate::Writable for TIMINGS5_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets TIMINGS5 to value 0"]
impl crate::Resettable for TIMINGS5_SPEC {
    #[inline(always)]
