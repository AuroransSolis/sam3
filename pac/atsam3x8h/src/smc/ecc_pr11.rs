...
pub type R = crate::R<EccPr11Spec>;
...
#[doc = "SMC ECC parity 11 Register\n\nYou can [`read`](crate::Reg::read) this register and get [`ecc_pr11::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct EccPr11Spec;
impl crate::RegisterSpec for EccPr11Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ecc_pr11::R`](R) reader structure"]
impl crate::Readable for EccPr11Spec {}
#[doc = "`reset()` method sets ECC_PR11 to value 0"]
impl crate::Resettable for EccPr11Spec {
