...
pub struct R(crate::R<TIMINGS7_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<TIMINGS7_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<TIMINGS7_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<TIMINGS7_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `TIMINGS7` writer"]
pub struct W(crate::W<TIMINGS7_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<TIMINGS7_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<TIMINGS7_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<TIMINGS7_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type OCMS_W<'a, const O: u8> = crate::BitWriter<'a, u32, TIMINGS7_SPEC, bool, O>;
...
pub type TRR_W<'a, const O: u8> = crate::FieldWriter<'a, u32, TIMINGS7_SPEC, u8, u8, 4, O>;
...
pub type TWB_W<'a, const O: u8> = crate::FieldWriter<'a, u32, TIMINGS7_SPEC, u8, u8, 4, O>;
...
pub type RBNSEL_W<'a, const O: u8> = crate::FieldWriter<'a, u32, TIMINGS7_SPEC, u8, u8, 3, O>;
...
pub type NFSEL_W<'a, const O: u8> = crate::BitWriter<'a, u32, TIMINGS7_SPEC, bool, O>;
impl R {
