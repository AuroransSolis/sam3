...
pub struct R(crate::R<RBQP_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<RBQP_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<RBQP_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<RBQP_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `RBQP` writer"]
pub struct W(crate::W<RBQP_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<RBQP_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<RBQP_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<RBQP_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type ADDR_W<'a, const O: u8> = crate::FieldWriter<'a, u32, RBQP_SPEC, u32, u32, 30, O>;
impl R {
