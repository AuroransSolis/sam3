...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn pid35(&mut self) -> PID35_W<PMC_PCDR1_SPEC> {
        PID35_W::new(self, 3)
    }
    #[doc = "Bit 4 - Peripheral Clock 36 Disable"]
    #[inline(always)]
    #[must_use]
    pub fn pid36(&mut self) -> PID36_W<PMC_PCDR1_SPEC> {
        PID36_W::new(self, 4)
    }
    #[doc = "Bit 5 - Peripheral Clock 37 Disable"]
    #[inline(always)]
    #[must_use]
    pub fn pid37(&mut self) -> PID37_W<PMC_PCDR1_SPEC> {
        PID37_W::new(self, 5)
    }
    #[doc = "Bit 6 - Peripheral Clock 38 Disable"]
    #[inline(always)]
    #[must_use]
    pub fn pid38(&mut self) -> PID38_W<PMC_PCDR1_SPEC> {
        PID38_W::new(self, 6)
    }
    #[doc = "Bit 7 - Peripheral Clock 39 Disable"]
    #[inline(always)]
    #[must_use]
    pub fn pid39(&mut self) -> PID39_W<PMC_PCDR1_SPEC> {
        PID39_W::new(self, 7)
    }
    #[doc = "Bit 8 - Peripheral Clock 40 Disable"]
    #[inline(always)]
    #[must_use]
    pub fn pid40(&mut self) -> PID40_W<PMC_PCDR1_SPEC> {
        PID40_W::new(self, 8)
    }
    #[doc = "Bit 9 - Peripheral Clock 41 Disable"]
    #[inline(always)]
    #[must_use]
    pub fn pid41(&mut self) -> PID41_W<PMC_PCDR1_SPEC> {
        PID41_W::new(self, 9)
    }
    #[doc = "Bit 10 - Peripheral Clock 42 Disable"]
    #[inline(always)]
    #[must_use]
    pub fn pid42(&mut self) -> PID42_W<PMC_PCDR1_SPEC> {
        PID42_W::new(self, 10)
    }
    #[doc = "Bit 11 - Peripheral Clock 43 Disable"]
    #[inline(always)]
    #[must_use]
    pub fn pid43(&mut self) -> PID43_W<PMC_PCDR1_SPEC> {
        PID43_W::new(self, 11)
    }
    #[doc = "Bit 12 - Peripheral Clock 44 Disable"]
    #[inline(always)]
    #[must_use]
    pub fn pid44(&mut self) -> PID44_W<PMC_PCDR1_SPEC> {
        PID44_W::new(self, 12)
    }
