...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn p0(&mut self) -> P0W<OwerSpec> {
        P0W::new(self, 0)
    }
    #[doc = "Bit 1 - Output Write Enable."]
    #[inline(always)]
    #[must_use]
    pub fn p1(&mut self) -> P1W<OwerSpec> {
        P1W::new(self, 1)
    }
    #[doc = "Bit 2 - Output Write Enable."]
    #[inline(always)]
    #[must_use]
    pub fn p2(&mut self) -> P2W<OwerSpec> {
        P2W::new(self, 2)
    }
    #[doc = "Bit 3 - Output Write Enable."]
    #[inline(always)]
    #[must_use]
    pub fn p3(&mut self) -> P3W<OwerSpec> {
        P3W::new(self, 3)
    }
    #[doc = "Bit 4 - Output Write Enable."]
    #[inline(always)]
    #[must_use]
    pub fn p4(&mut self) -> P4W<OwerSpec> {
        P4W::new(self, 4)
    }
    #[doc = "Bit 5 - Output Write Enable."]
    #[inline(always)]
    #[must_use]
    pub fn p5(&mut self) -> P5W<OwerSpec> {
        P5W::new(self, 5)
    }
    #[doc = "Bit 6 - Output Write Enable."]
    #[inline(always)]
    #[must_use]
    pub fn p6(&mut self) -> P6W<OwerSpec> {
        P6W::new(self, 6)
    }
    #[doc = "Bit 7 - Output Write Enable."]
    #[inline(always)]
    #[must_use]
    pub fn p7(&mut self) -> P7W<OwerSpec> {
        P7W::new(self, 7)
    }
    #[doc = "Bit 8 - Output Write Enable."]
    #[inline(always)]
    #[must_use]
    pub fn p8(&mut self) -> P8W<OwerSpec> {
        P8W::new(self, 8)
    }
    #[doc = "Bit 9 - Output Write Enable."]
    #[inline(always)]
    #[must_use]
    pub fn p9(&mut self) -> P9W<OwerSpec> {
        P9W::new(self, 9)
    }
    #[doc = "Bit 10 - Output Write Enable."]
    #[inline(always)]
    #[must_use]
    pub fn p10(&mut self) -> P10W<OwerSpec> {
        P10W::new(self, 10)
    }
    #[doc = "Bit 11 - Output Write Enable."]
    #[inline(always)]
    #[must_use]
    pub fn p11(&mut self) -> P11W<OwerSpec> {
        P11W::new(self, 11)
    }
    #[doc = "Bit 12 - Output Write Enable."]
    #[inline(always)]
    #[must_use]
    pub fn p12(&mut self) -> P12W<OwerSpec> {
        P12W::new(self, 12)
    }
    #[doc = "Bit 13 - Output Write Enable."]
    #[inline(always)]
    #[must_use]
    pub fn p13(&mut self) -> P13W<OwerSpec> {
        P13W::new(self, 13)
    }
    #[doc = "Bit 14 - Output Write Enable."]
    #[inline(always)]
    #[must_use]
    pub fn p14(&mut self) -> P14W<OwerSpec> {
        P14W::new(self, 14)
    }
    #[doc = "Bit 15 - Output Write Enable."]
    #[inline(always)]
    #[must_use]
    pub fn p15(&mut self) -> P15W<OwerSpec> {
        P15W::new(self, 15)
    }
    #[doc = "Bit 16 - Output Write Enable."]
    #[inline(always)]
    #[must_use]
    pub fn p16(&mut self) -> P16W<OwerSpec> {
        P16W::new(self, 16)
    }
    #[doc = "Bit 17 - Output Write Enable."]
    #[inline(always)]
    #[must_use]
    pub fn p17(&mut self) -> P17W<OwerSpec> {
        P17W::new(self, 17)
    }
    #[doc = "Bit 18 - Output Write Enable."]
    #[inline(always)]
    #[must_use]
    pub fn p18(&mut self) -> P18W<OwerSpec> {
        P18W::new(self, 18)
    }
    #[doc = "Bit 19 - Output Write Enable."]
    #[inline(always)]
    #[must_use]
    pub fn p19(&mut self) -> P19W<OwerSpec> {
        P19W::new(self, 19)
    }
    #[doc = "Bit 20 - Output Write Enable."]
    #[inline(always)]
    #[must_use]
    pub fn p20(&mut self) -> P20W<OwerSpec> {
        P20W::new(self, 20)
    }
    #[doc = "Bit 21 - Output Write Enable."]
    #[inline(always)]
    #[must_use]
    pub fn p21(&mut self) -> P21W<OwerSpec> {
        P21W::new(self, 21)
    }
    #[doc = "Bit 22 - Output Write Enable."]
    #[inline(always)]
    #[must_use]
    pub fn p22(&mut self) -> P22W<OwerSpec> {
        P22W::new(self, 22)
    }
    #[doc = "Bit 23 - Output Write Enable."]
    #[inline(always)]
    #[must_use]
    pub fn p23(&mut self) -> P23W<OwerSpec> {
        P23W::new(self, 23)
    }
    #[doc = "Bit 24 - Output Write Enable."]
    #[inline(always)]
    #[must_use]
    pub fn p24(&mut self) -> P24W<OwerSpec> {
        P24W::new(self, 24)
    }
    #[doc = "Bit 25 - Output Write Enable."]
    #[inline(always)]
    #[must_use]
    pub fn p25(&mut self) -> P25W<OwerSpec> {
        P25W::new(self, 25)
    }
    #[doc = "Bit 26 - Output Write Enable."]
    #[inline(always)]
    #[must_use]
    pub fn p26(&mut self) -> P26W<OwerSpec> {
        P26W::new(self, 26)
    }
    #[doc = "Bit 27 - Output Write Enable."]
    #[inline(always)]
    #[must_use]
    pub fn p27(&mut self) -> P27W<OwerSpec> {
        P27W::new(self, 27)
    }
    #[doc = "Bit 28 - Output Write Enable."]
    #[inline(always)]
    #[must_use]
    pub fn p28(&mut self) -> P28W<OwerSpec> {
        P28W::new(self, 28)
    }
    #[doc = "Bit 29 - Output Write Enable."]
    #[inline(always)]
    #[must_use]
    pub fn p29(&mut self) -> P29W<OwerSpec> {
        P29W::new(self, 29)
    }
    #[doc = "Bit 30 - Output Write Enable."]
    #[inline(always)]
    #[must_use]
    pub fn p30(&mut self) -> P30W<OwerSpec> {
        P30W::new(self, 30)
    }
    #[doc = "Bit 31 - Output Write Enable."]
    #[inline(always)]
    #[must_use]
    pub fn p31(&mut self) -> P31W<OwerSpec> {
        P31W::new(self, 31)
    }
}
#[doc = "Output Write Enable\n\nYou can [`write_with_zero`](crate::Reg::write_with_zero) this register using [`ower::W`](W). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct OwerSpec;
impl crate::RegisterSpec for OwerSpec {
    type Ux = u32;
}
#[doc = "`write(|w| ..)` method takes [`ower::W`](W) writer structure"]
impl crate::Writable for OwerSpec {
