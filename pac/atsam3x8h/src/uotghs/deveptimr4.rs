#[doc = "Register `DEVEPTIMR4` reader"]
pub type R = crate::R<DEVEPTIMR4_SPEC>;
...
#[doc = "Device Endpoint Mask Register (n = 0) 4\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`deveptimr4::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DEVEPTIMR4_SPEC;
impl crate::RegisterSpec for DEVEPTIMR4_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`deveptimr4::R`](R) reader structure"]
impl crate::Readable for DEVEPTIMR4_SPEC {}
