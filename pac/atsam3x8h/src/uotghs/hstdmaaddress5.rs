...
pub type R = crate::R<HSTDMAADDRESS5_SPEC>;
#[doc = "Register `HSTDMAADDRESS5` writer"]
pub type W = crate::W<HSTDMAADDRESS5_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn buff_add(&mut self) -> BUFF_ADD_W<HSTDMAADDRESS5_SPEC, 0> {
        BUFF_ADD_W::new(self)
    }
...
#[doc = "Host DMA Channel Address Register (n = 5)\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`hstdmaaddress5::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`hstdmaaddress5::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
