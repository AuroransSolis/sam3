#[doc = "Register `DEVEPTIMR8` reader"]
pub type R = crate::R<DEVEPTIMR8_SPEC>;
...
#[doc = "Device Endpoint Mask Register (n = 0) 8\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`deveptimr8::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DEVEPTIMR8_SPEC;
impl crate::RegisterSpec for DEVEPTIMR8_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`deveptimr8::R`](R) reader structure"]
impl crate::Readable for DEVEPTIMR8_SPEC {}
