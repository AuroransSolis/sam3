...
pub type R = crate::R<INTPIPES_HSTPIPISR0_INTPIPES_SPEC>;
...
#[doc = "Host Pipe Status Register (n = 0)\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`intpipes_hstpipisr0_intpipes::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct INTPIPES_HSTPIPISR0_INTPIPES_SPEC;
impl crate::RegisterSpec for INTPIPES_HSTPIPISR0_INTPIPES_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`intpipes_hstpipisr0_intpipes::R`](R) reader structure"]
impl crate::Readable for INTPIPES_HSTPIPISR0_INTPIPES_SPEC {}
