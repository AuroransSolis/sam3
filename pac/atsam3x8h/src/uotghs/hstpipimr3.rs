#[doc = "Register `HSTPIPIMR3` reader"]
pub type R = crate::R<HSTPIPIMR3_SPEC>;
...
#[doc = "Host Pipe Mask Register (n = 0) 3\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`hstpipimr3::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct HSTPIPIMR3_SPEC;
impl crate::RegisterSpec for HSTPIPIMR3_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`hstpipimr3::R`](R) reader structure"]
impl crate::Readable for HSTPIPIMR3_SPEC {}
