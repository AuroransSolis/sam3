#[doc = "Register `HSTPIPISR3` reader"]
pub type R = crate::R<HSTPIPISR3_SPEC>;
...
#[doc = "Host Pipe Status Register (n = 0) 3\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`hstpipisr3::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct HSTPIPISR3_SPEC;
impl crate::RegisterSpec for HSTPIPISR3_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`hstpipisr3::R`](R) reader structure"]
impl crate::Readable for HSTPIPISR3_SPEC {}
