#[doc = "Register `HSTPIPISR0_ISOPIPES` reader"]
pub struct R(crate::R<ISOPIPES_HSTPIPISR0_ISOPIPES_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<ISOPIPES_HSTPIPISR0_ISOPIPES_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<ISOPIPES_HSTPIPISR0_ISOPIPES_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<ISOPIPES_HSTPIPISR0_ISOPIPES_SPEC>) -> Self {
        R(reader)
    }
}
...
#[doc = "Host Pipe Status Register (n = 0)\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [isopipes_hstpipisr0_isopipes](index.html) module"]
pub struct ISOPIPES_HSTPIPISR0_ISOPIPES_SPEC;
impl crate::RegisterSpec for ISOPIPES_HSTPIPISR0_ISOPIPES_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [isopipes_hstpipisr0_isopipes::R](R) reader structure"]
impl crate::Readable for ISOPIPES_HSTPIPISR0_ISOPIPES_SPEC {
    type Reader = R;
}
