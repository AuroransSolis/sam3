#[doc = "Register `HSTPIPIMR9` reader"]
pub type R = crate::R<HSTPIPIMR9_SPEC>;
...
#[doc = "Host Pipe Mask Register (n = 0) 9\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`hstpipimr9::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct HSTPIPIMR9_SPEC;
impl crate::RegisterSpec for HSTPIPIMR9_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`hstpipimr9::R`](R) reader structure"]
impl crate::Readable for HSTPIPIMR9_SPEC {}
