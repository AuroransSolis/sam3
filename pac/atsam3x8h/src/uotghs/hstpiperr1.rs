...
pub type R = crate::R<HSTPIPERR1_SPEC>;
#[doc = "Register `HSTPIPERR1` writer"]
pub type W = crate::W<HSTPIPERR1_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn datatgl(&mut self) -> DATATGL_W<HSTPIPERR1_SPEC, 0> {
        DATATGL_W::new(self)
    }
    #[doc = "Bit 1 - Data PID Error"]
    #[inline(always)]
    #[must_use]
    pub fn datapid(&mut self) -> DATAPID_W<HSTPIPERR1_SPEC, 1> {
        DATAPID_W::new(self)
    }
    #[doc = "Bit 2 - PID Error"]
    #[inline(always)]
    #[must_use]
    pub fn pid(&mut self) -> PID_W<HSTPIPERR1_SPEC, 2> {
        PID_W::new(self)
    }
    #[doc = "Bit 3 - Time-Out Error"]
    #[inline(always)]
    #[must_use]
    pub fn timeout(&mut self) -> TIMEOUT_W<HSTPIPERR1_SPEC, 3> {
        TIMEOUT_W::new(self)
    }
    #[doc = "Bit 4 - CRC16 Error"]
    #[inline(always)]
    #[must_use]
    pub fn crc16(&mut self) -> CRC16_W<HSTPIPERR1_SPEC, 4> {
        CRC16_W::new(self)
    }
    #[doc = "Bits 5:6 - Error Counter"]
    #[inline(always)]
    #[must_use]
    pub fn counter(&mut self) -> COUNTER_W<HSTPIPERR1_SPEC, 5> {
        COUNTER_W::new(self)
    }
...
pub struct HSTPIPERR1_SPEC;
impl crate::RegisterSpec for HSTPIPERR1_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`hstpiperr1::R`](R) reader structure"]
impl crate::Readable for HSTPIPERR1_SPEC {}
#[doc = "`write(|w| ..)` method takes [`hstpiperr1::W`](W) writer structure"]
impl crate::Writable for HSTPIPERR1_SPEC {
