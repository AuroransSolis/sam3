#[doc = "Register `DEVEPTCFG5` reader"]
pub type R = crate::R<DEVEPTCFG5_SPEC>;
#[doc = "Register `DEVEPTCFG5` writer"]
pub type W = crate::W<DEVEPTCFG5_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn alloc(&mut self) -> ALLOC_W<DEVEPTCFG5_SPEC, 1> {
        ALLOC_W::new(self)
    }
    #[doc = "Bits 2:3 - Endpoint Banks"]
    #[inline(always)]
    #[must_use]
    pub fn epbk(&mut self) -> EPBK_W<DEVEPTCFG5_SPEC, 2> {
        EPBK_W::new(self)
    }
    #[doc = "Bits 4:6 - Endpoint Size"]
    #[inline(always)]
    #[must_use]
    pub fn epsize(&mut self) -> EPSIZE_W<DEVEPTCFG5_SPEC, 4> {
        EPSIZE_W::new(self)
    }
    #[doc = "Bit 8 - Endpoint Direction"]
    #[inline(always)]
    #[must_use]
    pub fn epdir(&mut self) -> EPDIR_W<DEVEPTCFG5_SPEC, 8> {
        EPDIR_W::new(self)
    }
    #[doc = "Bit 9 - Automatic Switch"]
    #[inline(always)]
    #[must_use]
    pub fn autosw(&mut self) -> AUTOSW_W<DEVEPTCFG5_SPEC, 9> {
        AUTOSW_W::new(self)
    }
    #[doc = "Bits 11:12 - Endpoint Type"]
    #[inline(always)]
    #[must_use]
    pub fn eptype(&mut self) -> EPTYPE_W<DEVEPTCFG5_SPEC, 11> {
        EPTYPE_W::new(self)
    }
    #[doc = "Bits 13:14 - Number of transaction per microframe for isochronous endpoint"]
    #[inline(always)]
    #[must_use]
    pub fn nbtrans(&mut self) -> NBTRANS_W<DEVEPTCFG5_SPEC, 13> {
        NBTRANS_W::new(self)
    }
...
#[doc = "Device Endpoint Configuration Register (n = 0) 5\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`deveptcfg5::R`](R).  You can [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`deveptcfg5::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DEVEPTCFG5_SPEC;
impl crate::RegisterSpec for DEVEPTCFG5_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`deveptcfg5::R`](R) reader structure"]
impl crate::Readable for DEVEPTCFG5_SPEC {}
#[doc = "`write(|w| ..)` method takes [`deveptcfg5::W`](W) writer structure"]
impl crate::Writable for DEVEPTCFG5_SPEC {
