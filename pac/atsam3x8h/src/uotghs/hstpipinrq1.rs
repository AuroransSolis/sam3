...
pub type R = crate::R<HSTPIPINRQ1_SPEC>;
#[doc = "Register `HSTPIPINRQ1` writer"]
pub type W = crate::W<HSTPIPINRQ1_SPEC>;
...
pub struct HSTPIPINRQ1_SPEC;
impl crate::RegisterSpec for HSTPIPINRQ1_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`hstpipinrq1::R`](R) reader structure"]
impl crate::Readable for HSTPIPINRQ1_SPEC {}
#[doc = "`write(|w| ..)` method takes [`hstpipinrq1::W`](W) writer structure"]
impl crate::Writable for HSTPIPINRQ1_SPEC {
