...
pub struct W(crate::W<INTPIPES_HSTPIPIER0_INTPIPES_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<INTPIPES_HSTPIPIER0_INTPIPES_SPEC>;
    #[inline(always)]
...
impl From<crate::W<INTPIPES_HSTPIPIER0_INTPIPES_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<INTPIPES_HSTPIPIER0_INTPIPES_SPEC>) -> Self {
        W(writer)
    }
}
#[doc = "Field `RXINES` writer - Received IN Data Interrupt Enable"]
pub type RXINES_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, INTPIPES_HSTPIPIER0_INTPIPES_SPEC, bool, O>;
...
#[doc = "Host Pipe Enable Register (n = 0)\n\nThis register you can [`write_with_zero`](crate::generic::Reg::write_with_zero). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [intpipes_hstpipier0_intpipes](index.html) module"]
