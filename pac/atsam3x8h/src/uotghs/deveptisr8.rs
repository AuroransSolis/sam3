#[doc = "Register `DEVEPTISR8` reader"]
pub type R = crate::R<DEVEPTISR8_SPEC>;
...
#[doc = "Device Endpoint Status Register (n = 0) 8\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`deveptisr8::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DEVEPTISR8_SPEC;
impl crate::RegisterSpec for DEVEPTISR8_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`deveptisr8::R`](R) reader structure"]
impl crate::Readable for DEVEPTISR8_SPEC {}
