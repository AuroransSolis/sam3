#[doc = "Register `DEVEPTISR6` reader"]
pub type R = crate::R<DEVEPTISR6_SPEC>;
...
#[doc = "Device Endpoint Status Register (n = 0) 6\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`deveptisr6::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DEVEPTISR6_SPEC;
impl crate::RegisterSpec for DEVEPTISR6_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`deveptisr6::R`](R) reader structure"]
impl crate::Readable for DEVEPTISR6_SPEC {}
