#[doc = "Register `DEVEPTISR3` reader"]
pub type R = crate::R<DEVEPTISR3_SPEC>;
...
#[doc = "Device Endpoint Status Register (n = 0) 3\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`deveptisr3::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DEVEPTISR3_SPEC;
impl crate::RegisterSpec for DEVEPTISR3_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`deveptisr3::R`](R) reader structure"]
impl crate::Readable for DEVEPTISR3_SPEC {}
