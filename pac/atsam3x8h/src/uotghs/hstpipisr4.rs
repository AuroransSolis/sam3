#[doc = "Register `HSTPIPISR4` reader"]
pub type R = crate::R<HSTPIPISR4_SPEC>;
...
#[doc = "Host Pipe Status Register (n = 0) 4\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`hstpipisr4::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct HSTPIPISR4_SPEC;
impl crate::RegisterSpec for HSTPIPISR4_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`hstpipisr4::R`](R) reader structure"]
impl crate::Readable for HSTPIPISR4_SPEC {}
