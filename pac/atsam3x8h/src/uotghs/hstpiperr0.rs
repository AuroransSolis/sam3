...
#[doc = "Host Pipe Error Register (n = 0) 0\n\nYou can [`read`](crate::Reg::read) this register and get [`hstpiperr0::R`](R). You can [`write_with_zero`](crate::Reg::write_with_zero) this register using [`hstpiperr0::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
