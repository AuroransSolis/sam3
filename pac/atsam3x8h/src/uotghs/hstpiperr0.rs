#[doc = "Register `HSTPIPERR0` reader"]
pub type R = crate::R<Hstpiperr0Spec>;
#[doc = "Register `HSTPIPERR0` writer"]
pub type W = crate::W<Hstpiperr0Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn datatgl(&mut self) -> DatatglW<Hstpiperr0Spec> {
        DatatglW::new(self, 0)
    }
    #[doc = "Bit 1 - Data PID Error"]
    #[inline(always)]
    #[must_use]
    pub fn datapid(&mut self) -> DatapidW<Hstpiperr0Spec> {
        DatapidW::new(self, 1)
    }
    #[doc = "Bit 2 - PID Error"]
    #[inline(always)]
    #[must_use]
    pub fn pid(&mut self) -> PidW<Hstpiperr0Spec> {
        PidW::new(self, 2)
    }
    #[doc = "Bit 3 - Time-Out Error"]
    #[inline(always)]
    #[must_use]
    pub fn timeout(&mut self) -> TimeoutW<Hstpiperr0Spec> {
        TimeoutW::new(self, 3)
    }
    #[doc = "Bit 4 - CRC16 Error"]
    #[inline(always)]
    #[must_use]
    pub fn crc16(&mut self) -> Crc16W<Hstpiperr0Spec> {
        Crc16W::new(self, 4)
    }
    #[doc = "Bits 5:6 - Error Counter"]
    #[inline(always)]
    #[must_use]
    pub fn counter(&mut self) -> CounterW<Hstpiperr0Spec> {
        CounterW::new(self, 5)
    }
}
#[doc = "Host Pipe Error Register (n = 0) 0\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`hstpiperr0::R`](R).  You can [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`hstpiperr0::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Hstpiperr0Spec;
impl crate::RegisterSpec for Hstpiperr0Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`hstpiperr0::R`](R) reader structure"]
impl crate::Readable for Hstpiperr0Spec {}
#[doc = "`write(|w| ..)` method takes [`hstpiperr0::W`](W) writer structure"]
impl crate::Writable for Hstpiperr0Spec {
