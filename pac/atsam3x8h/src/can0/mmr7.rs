...
pub type R = crate::R<Mmr7Spec>;
#[doc = "Register `MMR7` writer"]
pub type W = crate::W<Mmr7Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn mtimemark(&mut self) -> MtimemarkW<Mmr7Spec> {
        MtimemarkW::new(self, 0)
    }
    #[doc = "Bits 16:19 - Mailbox Priority"]
    #[inline(always)]
    #[must_use]
    pub fn prior(&mut self) -> PriorW<Mmr7Spec> {
        PriorW::new(self, 16)
    }
    #[doc = "Bits 24:26 - Mailbox Object Type"]
    #[inline(always)]
    #[must_use]
    pub fn mot(&mut self) -> MotW<Mmr7Spec> {
        MotW::new(self, 24)
    }
}
