...
pub type R = crate::R<Cmr6Spec>;
#[doc = "Register `CMR6` writer"]
pub type W = crate::W<Cmr6Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn cpre(&mut self) -> CpreW<Cmr6Spec> {
        CpreW::new(self, 0)
    }
    #[doc = "Bit 8 - Channel Alignment"]
    #[inline(always)]
    #[must_use]
    pub fn calg(&mut self) -> CalgW<Cmr6Spec> {
        CalgW::new(self, 8)
    }
    #[doc = "Bit 9 - Channel Polarity"]
    #[inline(always)]
    #[must_use]
    pub fn cpol(&mut self) -> CpolW<Cmr6Spec> {
        CpolW::new(self, 9)
    }
    #[doc = "Bit 10 - Counter Event Selection"]
    #[inline(always)]
    #[must_use]
    pub fn ces(&mut self) -> CesW<Cmr6Spec> {
        CesW::new(self, 10)
    }
    #[doc = "Bit 16 - Dead-Time Generator Enable"]
    #[inline(always)]
    #[must_use]
    pub fn dte(&mut self) -> DteW<Cmr6Spec> {
        DteW::new(self, 16)
    }
    #[doc = "Bit 17 - Dead-Time PWMHx Output Inverted"]
    #[inline(always)]
    #[must_use]
    pub fn dthi(&mut self) -> DthiW<Cmr6Spec> {
        DthiW::new(self, 17)
    }
    #[doc = "Bit 18 - Dead-Time PWMLx Output Inverted"]
    #[inline(always)]
    #[must_use]
    pub fn dtli(&mut self) -> DtliW<Cmr6Spec> {
        DtliW::new(self, 18)
    }
}
#[doc = "PWM Channel Mode Register (ch_num = 6)\n\nYou can [`read`](crate::Reg::read) this register and get [`cmr6::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`cmr6::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Cmr6Spec;
impl crate::RegisterSpec for Cmr6Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`cmr6::R`](R) reader structure"]
impl crate::Readable for Cmr6Spec {}
#[doc = "`write(|w| ..)` method takes [`cmr6::W`](W) writer structure"]
impl crate::Writable for Cmr6Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets CMR6 to value 0"]
impl crate::Resettable for Cmr6Spec {
