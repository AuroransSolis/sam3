...
impl core::ops::Deref for R {
    type Target = crate::R<FPE1_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<FPE1_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<FPE1_SPEC>) -> Self {
        R(reader)
    }
}
...
impl From<crate::W<FPE1_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<FPE1_SPEC>) -> Self {
        W(writer)
    }
}
