...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn dthupd(&mut self) -> DthupdW<Dtupd6Spec> {
        DthupdW::new(self, 0)
    }
    #[doc = "Bits 16:31 - Dead-Time Value Update for PWMLx Output"]
    #[inline(always)]
    #[must_use]
    pub fn dtlupd(&mut self) -> DtlupdW<Dtupd6Spec> {
        DtlupdW::new(self, 16)
    }
}
#[doc = "PWM Channel Dead Time Update Register (ch_num = 6)\n\nYou can [`write_with_zero`](crate::Reg::write_with_zero) this register using [`dtupd6::W`](W). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Dtupd6Spec;
impl crate::RegisterSpec for Dtupd6Spec {
    type Ux = u32;
}
#[doc = "`write(|w| ..)` method takes [`dtupd6::W`](W) writer structure"]
impl crate::Writable for Dtupd6Spec {
