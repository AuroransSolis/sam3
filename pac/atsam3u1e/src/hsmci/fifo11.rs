...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn data(&mut self) -> DataW<Fifo11Spec> {
        DataW::new(self, 0)
    }
}
#[doc = "FIFO Memory Aperture0 11\n\nYou can [`read`](crate::Reg::read) this register and get [`fifo11::R`](R). You can [`write_with_zero`](crate::Reg::write_with_zero) this register using [`fifo11::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
