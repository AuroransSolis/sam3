...
pub struct MCI_SDIOIRQA_W<'a> {
    w: &'a mut W,
}
impl<'a> MCI_SDIOIRQA_W<'a> {
    #[doc = r"Sets the field bit"]
    #[inline(always)]
    pub fn set_bit(self) -> &'a mut W {
        self.bit(true)
...
impl W {
    ...
    #[doc = "Bit 8"]
    #[inline(always)]
    pub fn mci_sdioirqa(&mut self) -> MCI_SDIOIRQA_W {
        MCI_SDIOIRQA_W { w: self }
    }
    ...
    #[inline(always)]
    pub fn dmadone(&mut self) -> DMADONE_W {
        DMADONE_W { w: self }
    }
