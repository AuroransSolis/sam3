...
pub type MciSdioirqaW<'a, REG> = crate::BitWriter<'a, REG>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn mci_sdioirqa(&mut self) -> MciSdioirqaW<IerSpec> {
        MciSdioirqaW::new(self, 8)
    }
    ...
    #[inline(always)]
    #[must_use]
    pub fn blkovre(&mut self) -> BlkovreW<IerSpec> {
        BlkovreW::new(self, 24)
    }
    #[doc = "Bit 25 - DMA Transfer completed Interrupt Enable"]
    #[inline(always)]
    #[must_use]
    pub fn dmadone(&mut self) -> DmadoneW<IerSpec> {
