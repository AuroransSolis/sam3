...
pub type R = crate::R<WaveformModeCmr1WaveformModeSpec>;
#[doc = "Register `CMR1_WAVEFORM_MODE` writer"]
pub type W = crate::W<WaveformModeCmr1WaveformModeSpec>;
#[doc = "Clock Selection\n\nValue on reset: 0"]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn tcclks(&mut self) -> TcclksW<WaveformModeCmr1WaveformModeSpec> {
        TcclksW::new(self, 0)
    }
    #[doc = "Bit 3 - Clock Invert"]
    #[inline(always)]
    #[must_use]
    pub fn clki(&mut self) -> ClkiW<WaveformModeCmr1WaveformModeSpec> {
        ClkiW::new(self, 3)
    }
    #[doc = "Bits 4:5 - Burst Signal Selection"]
    #[inline(always)]
    #[must_use]
    pub fn burst(&mut self) -> BurstW<WaveformModeCmr1WaveformModeSpec> {
        BurstW::new(self, 4)
    }
    #[doc = "Bit 6 - Counter Clock Stopped with RC Compare"]
    #[inline(always)]
    #[must_use]
    pub fn cpcstop(&mut self) -> CpcstopW<WaveformModeCmr1WaveformModeSpec> {
        CpcstopW::new(self, 6)
    }
    #[doc = "Bit 7 - Counter Clock Disable with RC Compare"]
    #[inline(always)]
    #[must_use]
    pub fn cpcdis(&mut self) -> CpcdisW<WaveformModeCmr1WaveformModeSpec> {
        CpcdisW::new(self, 7)
    }
    #[doc = "Bits 8:9 - External Event Edge Selection"]
    #[inline(always)]
    #[must_use]
    pub fn eevtedg(&mut self) -> EevtedgW<WaveformModeCmr1WaveformModeSpec> {
        EevtedgW::new(self, 8)
    }
    #[doc = "Bits 10:11 - External Event Selection"]
    #[inline(always)]
    #[must_use]
    pub fn eevt(&mut self) -> EevtW<WaveformModeCmr1WaveformModeSpec> {
        EevtW::new(self, 10)
    }
    #[doc = "Bit 12 - External Event Trigger Enable"]
    #[inline(always)]
    #[must_use]
    pub fn enetrg(&mut self) -> EnetrgW<WaveformModeCmr1WaveformModeSpec> {
        EnetrgW::new(self, 12)
    }
    #[doc = "Bits 13:14 - Waveform Selection"]
    #[inline(always)]
    #[must_use]
    pub fn wavsel(&mut self) -> WavselW<WaveformModeCmr1WaveformModeSpec> {
        WavselW::new(self, 13)
    }
    #[doc = "Bit 15 - Waveform Mode"]
    #[inline(always)]
    #[must_use]
    pub fn wave(&mut self) -> WaveW<WaveformModeCmr1WaveformModeSpec> {
        WaveW::new(self, 15)
    }
    #[doc = "Bits 16:17 - RA Compare Effect on TIOA"]
    #[inline(always)]
    #[must_use]
    pub fn acpa(&mut self) -> AcpaW<WaveformModeCmr1WaveformModeSpec> {
        AcpaW::new(self, 16)
    }
    #[doc = "Bits 18:19 - RC Compare Effect on TIOA"]
    #[inline(always)]
    #[must_use]
    pub fn acpc(&mut self) -> AcpcW<WaveformModeCmr1WaveformModeSpec> {
        AcpcW::new(self, 18)
    }
    #[doc = "Bits 20:21 - External Event Effect on TIOA"]
    #[inline(always)]
    #[must_use]
    pub fn aeevt(&mut self) -> AeevtW<WaveformModeCmr1WaveformModeSpec> {
        AeevtW::new(self, 20)
    }
    #[doc = "Bits 22:23 - Software Trigger Effect on TIOA"]
    #[inline(always)]
    #[must_use]
    pub fn aswtrg(&mut self) -> AswtrgW<WaveformModeCmr1WaveformModeSpec> {
        AswtrgW::new(self, 22)
    }
    #[doc = "Bits 24:25 - RB Compare Effect on TIOB"]
    #[inline(always)]
    #[must_use]
    pub fn bcpb(&mut self) -> BcpbW<WaveformModeCmr1WaveformModeSpec> {
        BcpbW::new(self, 24)
    }
    #[doc = "Bits 26:27 - RC Compare Effect on TIOB"]
    #[inline(always)]
    #[must_use]
    pub fn bcpc(&mut self) -> BcpcW<WaveformModeCmr1WaveformModeSpec> {
        BcpcW::new(self, 26)
    }
    #[doc = "Bits 28:29 - External Event Effect on TIOB"]
    #[inline(always)]
    #[must_use]
    pub fn beevt(&mut self) -> BeevtW<WaveformModeCmr1WaveformModeSpec> {
        BeevtW::new(self, 28)
    }
    #[doc = "Bits 30:31 - Software Trigger Effect on TIOB"]
    #[inline(always)]
    #[must_use]
    pub fn bswtrg(&mut self) -> BswtrgW<WaveformModeCmr1WaveformModeSpec> {
        BswtrgW::new(self, 30)
    }
}
...
pub struct WaveformModeCmr1WaveformModeSpec;
impl crate::RegisterSpec for WaveformModeCmr1WaveformModeSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`waveform_mode_cmr1_waveform_mode::R`](R) reader structure"]
impl crate::Readable for WaveformModeCmr1WaveformModeSpec {}
#[doc = "`write(|w| ..)` method takes [`waveform_mode_cmr1_waveform_mode::W`](W) writer structure"]
impl crate::Writable for WaveformModeCmr1WaveformModeSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets CMR1_WAVEFORM_MODE to value 0"]
impl crate::Resettable for WaveformModeCmr1WaveformModeSpec {
