...
pub type R = crate::R<Cmpm4Spec>;
#[doc = "Register `CMPM4` writer"]
pub type W = crate::W<Cmpm4Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn cen(&mut self) -> CenW<Cmpm4Spec> {
        CenW::new(self, 0)
    }
    #[doc = "Bits 4:7 - Comparison x Trigger"]
    #[inline(always)]
    #[must_use]
    pub fn ctr(&mut self) -> CtrW<Cmpm4Spec> {
        CtrW::new(self, 4)
    }
    #[doc = "Bits 8:11 - Comparison x Period"]
    #[inline(always)]
    #[must_use]
    pub fn cpr(&mut self) -> CprW<Cmpm4Spec> {
        CprW::new(self, 8)
    }
    #[doc = "Bits 12:15 - Comparison x Period Counter"]
    #[inline(always)]
    #[must_use]
    pub fn cprcnt(&mut self) -> CprcntW<Cmpm4Spec> {
        CprcntW::new(self, 12)
    }
    #[doc = "Bits 16:19 - Comparison x Update Period"]
    #[inline(always)]
    #[must_use]
    pub fn cupr(&mut self) -> CuprW<Cmpm4Spec> {
        CuprW::new(self, 16)
    }
    #[doc = "Bits 20:23 - Comparison x Update Period Counter"]
    #[inline(always)]
    #[must_use]
    pub fn cuprcnt(&mut self) -> CuprcntW<Cmpm4Spec> {
        CuprcntW::new(self, 20)
    }
}
#[doc = "PWM Comparison 4 Mode Register\n\nYou can [`read`](crate::Reg::read) this register and get [`cmpm4::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`cmpm4::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Cmpm4Spec;
impl crate::RegisterSpec for Cmpm4Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`cmpm4::R`](R) reader structure"]
impl crate::Readable for Cmpm4Spec {}
#[doc = "`write(|w| ..)` method takes [`cmpm4::W`](W) writer structure"]
impl crate::Writable for Cmpm4Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets CMPM4 to value 0"]
impl crate::Resettable for Cmpm4Spec {
