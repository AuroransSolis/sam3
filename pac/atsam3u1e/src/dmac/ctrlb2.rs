...
pub type R = crate::R<Ctrlb2Spec>;
#[doc = "Register `CTRLB2` writer"]
pub type W = crate::W<Ctrlb2Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn src_dscr(&mut self) -> SrcDscrW<Ctrlb2Spec> {
        SrcDscrW::new(self, 16)
    }
    #[doc = "Bit 20 - Destination Address Descriptor"]
    #[inline(always)]
    #[must_use]
    pub fn dst_dscr(&mut self) -> DstDscrW<Ctrlb2Spec> {
        DstDscrW::new(self, 20)
    }
    #[doc = "Bits 21:22 - Flow Control"]
    #[inline(always)]
    #[must_use]
    pub fn fc(&mut self) -> FcW<Ctrlb2Spec> {
        FcW::new(self, 21)
    }
    #[doc = "Bits 24:25 - Incrementing, Decrementing or Fixed Address for the Source"]
    #[inline(always)]
    #[must_use]
    pub fn src_incr(&mut self) -> SrcIncrW<Ctrlb2Spec> {
        SrcIncrW::new(self, 24)
    }
    #[doc = "Bits 28:29 - Incrementing, Decrementing or Fixed Address for the Destination"]
    #[inline(always)]
    #[must_use]
    pub fn dst_incr(&mut self) -> DstIncrW<Ctrlb2Spec> {
        DstIncrW::new(self, 28)
    }
    #[doc = "Bit 30 - Interrupt Enable Not"]
    #[inline(always)]
    #[must_use]
    pub fn ien(&mut self) -> IenW<Ctrlb2Spec> {
        IenW::new(self, 30)
    }
}
#[doc = "DMAC Channel Control B Register (ch_num = 2)\n\nYou can [`read`](crate::Reg::read) this register and get [`ctrlb2::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`ctrlb2::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Ctrlb2Spec;
impl crate::RegisterSpec for Ctrlb2Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ctrlb2::R`](R) reader structure"]
impl crate::Readable for Ctrlb2Spec {}
#[doc = "`write(|w| ..)` method takes [`ctrlb2::W`](W) writer structure"]
impl crate::Writable for Ctrlb2Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets CTRLB2 to value 0"]
impl crate::Resettable for Ctrlb2Spec {
