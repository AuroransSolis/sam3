...
pub type R = crate::R<Dmastatus2Spec>;
#[doc = "Register `DMASTATUS2` writer"]
pub type W = crate::W<Dmastatus2Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn chann_enb(&mut self) -> ChannEnbW<Dmastatus2Spec> {
        ChannEnbW::new(self, 0)
    }
    #[doc = "Bit 1 - Channel Active Status"]
    #[inline(always)]
    #[must_use]
    pub fn chann_act(&mut self) -> ChannActW<Dmastatus2Spec> {
        ChannActW::new(self, 1)
    }
    #[doc = "Bit 4 - End of Channel Transfer Status"]
    #[inline(always)]
    #[must_use]
    pub fn end_tr_st(&mut self) -> EndTrStW<Dmastatus2Spec> {
        EndTrStW::new(self, 4)
    }
    #[doc = "Bit 5 - End of Channel Buffer Status"]
    #[inline(always)]
    #[must_use]
    pub fn end_bf_st(&mut self) -> EndBfStW<Dmastatus2Spec> {
        EndBfStW::new(self, 5)
    }
    #[doc = "Bit 6 - Descriptor Loaded Status"]
    #[inline(always)]
    #[must_use]
    pub fn desc_ldst(&mut self) -> DescLdstW<Dmastatus2Spec> {
        DescLdstW::new(self, 6)
    }
    #[doc = "Bits 16:31 - Buffer Byte Count"]
    #[inline(always)]
    #[must_use]
    pub fn buff_count(&mut self) -> BuffCountW<Dmastatus2Spec> {
        BuffCountW::new(self, 16)
    }
}
#[doc = "UDPHS DMA Channel Status Register (channel = 2)\n\nYou can [`read`](crate::Reg::read) this register and get [`dmastatus2::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`dmastatus2::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Dmastatus2Spec;
impl crate::RegisterSpec for Dmastatus2Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`dmastatus2::R`](R) reader structure"]
impl crate::Readable for Dmastatus2Spec {}
#[doc = "`write(|w| ..)` method takes [`dmastatus2::W`](W) writer structure"]
impl crate::Writable for Dmastatus2Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DMASTATUS2 to value 0"]
impl crate::Resettable for Dmastatus2Spec {
