...
pub type R = crate::R<IsoendptEptctl6IsoendptSpec>;
...
#[doc = "UDPHS Endpoint Control Register (endpoint = 6)\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`isoendpt_eptctl6_isoendpt::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct IsoendptEptctl6IsoendptSpec;
impl crate::RegisterSpec for IsoendptEptctl6IsoendptSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`isoendpt_eptctl6_isoendpt::R`](R) reader structure"]
impl crate::Readable for IsoendptEptctl6IsoendptSpec {}
#[doc = "`reset()` method sets EPTCTL6_ISOENDPT to value 0"]
impl crate::Resettable for IsoendptEptctl6IsoendptSpec {
