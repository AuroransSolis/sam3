...
pub type W = crate::W<Eptctlenb0Spec>;
...
pub struct Eptctlenb0Spec;
impl crate::RegisterSpec for Eptctlenb0Spec {
    type Ux = u32;
}
#[doc = "`write(|w| ..)` method takes [`eptctlenb0::W`](W) writer structure"]
impl crate::Writable for Eptctlenb0Spec {
