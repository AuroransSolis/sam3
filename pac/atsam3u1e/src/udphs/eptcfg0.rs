...
pub type EPT_SIZE_W<'a, const O: u8> =
    crate::FieldWriterSafe<'a, u32, EPTCFG0_SPEC, u8, EPT_SIZE_A, 3, O>;
...
pub type EPT_DIR_W<'a, const O: u8> = crate::BitWriter<'a, u32, EPTCFG0_SPEC, bool, O>;
...
pub type EPT_TYPE_W<'a, const O: u8> =
    crate::FieldWriterSafe<'a, u32, EPTCFG0_SPEC, u8, EPT_TYPE_A, 2, O>;
...
pub type BK_NUMBER_W<'a, const O: u8> =
    crate::FieldWriterSafe<'a, u32, EPTCFG0_SPEC, u8, BK_NUMBER_A, 2, O>;
...
pub type NB_TRANS_W<'a, const O: u8> = crate::FieldWriter<'a, u32, EPTCFG0_SPEC, u8, u8, 2, O>;
...
pub type EPT_MAPD_W<'a, const O: u8> = crate::BitWriter<'a, u32, EPTCFG0_SPEC, bool, O>;
impl R {
