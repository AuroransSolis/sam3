...
pub type W = crate::W<Eptctlenb3Spec>;
...
pub struct Eptctlenb3Spec;
impl crate::RegisterSpec for Eptctlenb3Spec {
    type Ux = u32;
}
#[doc = "`write(|w| ..)` method takes [`eptctlenb3::W`](W) writer structure"]
impl crate::Writable for Eptctlenb3Spec {
