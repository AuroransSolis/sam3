...
pub type R = crate::R<ISOENDPT_EPTSTA2_ISOENDPT_SPEC>;
...
#[doc = "UDPHS Endpoint Status Register (endpoint = 2)\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`isoendpt_eptsta2_isoendpt::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
