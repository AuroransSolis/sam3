...
pub type R = crate::R<IsoendptEptctl4IsoendptSpec>;
...
pub struct IsoendptEptctl4IsoendptSpec;
impl crate::RegisterSpec for IsoendptEptctl4IsoendptSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`isoendpt_eptctl4_isoendpt::R`](R) reader structure"]
impl crate::Readable for IsoendptEptctl4IsoendptSpec {}
#[doc = "`reset()` method sets EPTCTL4_ISOENDPT to value 0"]
impl crate::Resettable for IsoendptEptctl4IsoendptSpec {
