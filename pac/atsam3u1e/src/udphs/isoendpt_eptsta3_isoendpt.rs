...
pub struct R(crate::R<ISOENDPT_EPTSTA3_ISOENDPT_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<ISOENDPT_EPTSTA3_ISOENDPT_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<ISOENDPT_EPTSTA3_ISOENDPT_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<ISOENDPT_EPTSTA3_ISOENDPT_SPEC>) -> Self {
        R(reader)
    }
}
...
#[doc = "UDPHS Endpoint Status Register (endpoint = 3)\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [isoendpt_eptsta3_isoendpt](index.html) module"]
