...
pub type R = crate::R<Eptsta3Spec>;
...
#[doc = "UDPHS Endpoint Status Register (endpoint = 3)\n\nYou can [`read`](crate::Reg::read) this register and get [`eptsta3::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Eptsta3Spec;
impl crate::RegisterSpec for Eptsta3Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`eptsta3::R`](R) reader structure"]
impl crate::Readable for Eptsta3Spec {}
#[doc = "`reset()` method sets EPTSTA3 to value 0x40"]
impl crate::Resettable for Eptsta3Spec {
