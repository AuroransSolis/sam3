...
#[doc = "UDPHS Endpoint Set Status Register (endpoint = 5)\n\nYou can [`write_with_zero`](crate::Reg::write_with_zero) this register using [`isoendpt_eptsetsta5_isoendpt::W`](W). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
