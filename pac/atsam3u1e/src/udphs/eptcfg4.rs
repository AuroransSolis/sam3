...
pub type R = crate::R<EPTCFG4_SPEC>;
#[doc = "Register `EPTCFG4` writer"]
pub type W = crate::W<EPTCFG4_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn ept_size(&mut self) -> EPT_SIZE_W<EPTCFG4_SPEC, 0> {
        EPT_SIZE_W::new(self)
    }
    #[doc = "Bit 3 - Endpoint Direction"]
    #[inline(always)]
    #[must_use]
    pub fn ept_dir(&mut self) -> EPT_DIR_W<EPTCFG4_SPEC, 3> {
        EPT_DIR_W::new(self)
    }
    #[doc = "Bits 4:5 - Endpoint Type"]
    #[inline(always)]
    #[must_use]
    pub fn ept_type(&mut self) -> EPT_TYPE_W<EPTCFG4_SPEC, 4> {
        EPT_TYPE_W::new(self)
    }
    #[doc = "Bits 6:7 - Number of Banks"]
    #[inline(always)]
    #[must_use]
    pub fn bk_number(&mut self) -> BK_NUMBER_W<EPTCFG4_SPEC, 6> {
        BK_NUMBER_W::new(self)
    }
    #[doc = "Bits 8:9 - Number Of Transaction per Microframe"]
    #[inline(always)]
    #[must_use]
    pub fn nb_trans(&mut self) -> NB_TRANS_W<EPTCFG4_SPEC, 8> {
        NB_TRANS_W::new(self)
    }
    #[doc = "Bit 31 - Endpoint Mapped"]
    #[inline(always)]
    #[must_use]
    pub fn ept_mapd(&mut self) -> EPT_MAPD_W<EPTCFG4_SPEC, 31> {
        EPT_MAPD_W::new(self)
    }
