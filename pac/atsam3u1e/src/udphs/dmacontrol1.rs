#[doc = "Register `DMACONTROL1` reader"]
pub struct R(crate::R<DMACONTROL1_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<DMACONTROL1_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<DMACONTROL1_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<DMACONTROL1_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `DMACONTROL1` writer"]
pub struct W(crate::W<DMACONTROL1_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<DMACONTROL1_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<DMACONTROL1_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<DMACONTROL1_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type CHANN_ENB_W<'a, const O: u8> = crate::BitWriter<'a, u32, DMACONTROL1_SPEC, bool, O>;
...
pub type LDNXT_DSC_W<'a, const O: u8> = crate::BitWriter<'a, u32, DMACONTROL1_SPEC, bool, O>;
...
pub type END_TR_EN_W<'a, const O: u8> = crate::BitWriter<'a, u32, DMACONTROL1_SPEC, bool, O>;
...
pub type END_B_EN_W<'a, const O: u8> = crate::BitWriter<'a, u32, DMACONTROL1_SPEC, bool, O>;
...
pub type END_TR_IT_W<'a, const O: u8> = crate::BitWriter<'a, u32, DMACONTROL1_SPEC, bool, O>;
...
pub type END_BUFFIT_W<'a, const O: u8> = crate::BitWriter<'a, u32, DMACONTROL1_SPEC, bool, O>;
...
pub type DESC_LD_IT_W<'a, const O: u8> = crate::BitWriter<'a, u32, DMACONTROL1_SPEC, bool, O>;
...
pub type BURST_LCK_W<'a, const O: u8> = crate::BitWriter<'a, u32, DMACONTROL1_SPEC, bool, O>;
...
pub type BUFF_LENGTH_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, DMACONTROL1_SPEC, u16, u16, 16, O>;
impl R {
...
#[doc = "UDPHS DMA Channel Control Register (channel = 1)\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [dmacontrol1](index.html) module"]
pub struct DMACONTROL1_SPEC;
impl crate::RegisterSpec for DMACONTROL1_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [dmacontrol1::R](R) reader structure"]
impl crate::Readable for DMACONTROL1_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [dmacontrol1::W](W) writer structure"]
impl crate::Writable for DMACONTROL1_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets DMACONTROL1 to value 0"]
impl crate::Resettable for DMACONTROL1_SPEC {
    #[inline(always)]
