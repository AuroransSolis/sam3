...
pub type R = crate::R<Eptctl0Spec>;
...
#[doc = "UDPHS Endpoint Control Register (endpoint = 0)\n\nYou can [`read`](crate::Reg::read) this register and get [`eptctl0::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Eptctl0Spec;
impl crate::RegisterSpec for Eptctl0Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`eptctl0::R`](R) reader structure"]
impl crate::Readable for Eptctl0Spec {}
#[doc = "`reset()` method sets EPTCTL0 to value 0"]
impl crate::Resettable for Eptctl0Spec {
