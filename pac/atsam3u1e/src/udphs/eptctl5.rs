...
pub struct R(crate::R<EPTCTL5_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<EPTCTL5_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<EPTCTL5_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<EPTCTL5_SPEC>) -> Self {
        R(reader)
    }
}
...
#[doc = "UDPHS Endpoint Control Register (endpoint = 5)\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [eptctl5](index.html) module"]
pub struct EPTCTL5_SPEC;
impl crate::RegisterSpec for EPTCTL5_SPEC {
    type Ux = u32;
}
