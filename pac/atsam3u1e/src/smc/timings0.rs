...
pub type R = crate::R<TIMINGS0_SPEC>;
#[doc = "Register `TIMINGS0` writer"]
pub type W = crate::W<TIMINGS0_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn tclr(&mut self) -> TCLR_W<TIMINGS0_SPEC, 0> {
        TCLR_W::new(self)
    }
    #[doc = "Bits 4:7 - ALE to Data Start"]
    #[inline(always)]
    #[must_use]
    pub fn tadl(&mut self) -> TADL_W<TIMINGS0_SPEC, 4> {
        TADL_W::new(self)
    }
    #[doc = "Bits 8:11 - ALE to REN Low Delay"]
    #[inline(always)]
    #[must_use]
    pub fn tar(&mut self) -> TAR_W<TIMINGS0_SPEC, 8> {
        TAR_W::new(self)
    }
    #[doc = "Bit 12 - Off Chip Memory Scrambling Enable"]
    #[inline(always)]
    #[must_use]
    pub fn ocms(&mut self) -> OCMS_W<TIMINGS0_SPEC, 12> {
        OCMS_W::new(self)
    }
    #[doc = "Bits 16:19 - Ready to REN Low Delay"]
    #[inline(always)]
    #[must_use]
    pub fn trr(&mut self) -> TRR_W<TIMINGS0_SPEC, 16> {
        TRR_W::new(self)
    }
    #[doc = "Bits 24:27 - WEN High to REN to Busy"]
    #[inline(always)]
    #[must_use]
    pub fn twb(&mut self) -> TWB_W<TIMINGS0_SPEC, 24> {
        TWB_W::new(self)
    }
    #[doc = "Bits 28:30 - Ready/Busy Line Selection"]
    #[inline(always)]
    #[must_use]
    pub fn rbnsel(&mut self) -> RBNSEL_W<TIMINGS0_SPEC, 28> {
        RBNSEL_W::new(self)
    }
    #[doc = "Bit 31 - NAND Flash Selection"]
    #[inline(always)]
    #[must_use]
    pub fn nfsel(&mut self) -> NFSEL_W<TIMINGS0_SPEC, 31> {
        NFSEL_W::new(self)
    }
...
#[doc = "SMC Timings Register (CS_number = 0)\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`timings0::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`timings0::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
