...
pub type Eccerr0R = crate::FieldReader;
...
pub type Eccerr4R = crate::FieldReader;
...
pub type Eccerr5R = crate::FieldReader;
...
pub type Eccerr6R = crate::FieldReader;
...
pub type Eccerr7R = crate::FieldReader;
impl R {
    ...
    pub fn eccerr0(&self) -> Eccerr0R {
        Eccerr0R::new(((self.bits >> 1) & 3) as u8)
    }
    ...
    pub fn eccerr4(&self) -> Eccerr4R {
        Eccerr4R::new(((self.bits >> 17) & 3) as u8)
    }
    ...
    pub fn eccerr5(&self) -> Eccerr5R {
        Eccerr5R::new(((self.bits >> 21) & 3) as u8)
    }
    ...
    pub fn eccerr6(&self) -> Eccerr6R {
        Eccerr6R::new(((self.bits >> 25) & 3) as u8)
    }
    ...
    pub fn eccerr7(&self) -> Eccerr7R {
        Eccerr7R::new(((self.bits >> 29) & 3) as u8)
    }
}
