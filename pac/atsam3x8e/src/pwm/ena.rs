...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn chid4(&mut self) -> CHID4_W<ENA_SPEC, 4> {
        CHID4_W::new(self)
    }
    #[doc = "Bit 5 - Channel ID"]
    #[inline(always)]
    #[must_use]
    pub fn chid5(&mut self) -> CHID5_W<ENA_SPEC, 5> {
        CHID5_W::new(self)
    }
    #[doc = "Bit 6 - Channel ID"]
    #[inline(always)]
    #[must_use]
    pub fn chid6(&mut self) -> CHID6_W<ENA_SPEC, 6> {
        CHID6_W::new(self)
    }
    #[doc = "Bit 7 - Channel ID"]
    #[inline(always)]
    #[must_use]
    pub fn chid7(&mut self) -> CHID7_W<ENA_SPEC, 7> {
        CHID7_W::new(self)
    }
