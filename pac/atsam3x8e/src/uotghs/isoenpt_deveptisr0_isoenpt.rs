...
pub struct R(crate::R<ISOENPT_DEVEPTISR0_ISOENPT_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<ISOENPT_DEVEPTISR0_ISOENPT_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<ISOENPT_DEVEPTISR0_ISOENPT_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<ISOENPT_DEVEPTISR0_ISOENPT_SPEC>) -> Self {
        R(reader)
    }
}
...
#[doc = "Device Endpoint Status Register (n = 0)\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [isoenpt_deveptisr0_isoenpt](index.html) module"]
