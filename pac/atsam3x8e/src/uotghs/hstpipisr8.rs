#[doc = "Register `HSTPIPISR8` reader"]
pub type R = crate::R<HSTPIPISR8_SPEC>;
...
#[doc = "Host Pipe Status Register (n = 0) 8\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`hstpipisr8::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct HSTPIPISR8_SPEC;
impl crate::RegisterSpec for HSTPIPISR8_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`hstpipisr8::R`](R) reader structure"]
impl crate::Readable for HSTPIPISR8_SPEC {}
