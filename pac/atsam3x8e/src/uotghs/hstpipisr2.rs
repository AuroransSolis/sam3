#[doc = "Register `HSTPIPISR2` reader"]
pub type R = crate::R<HSTPIPISR2_SPEC>;
...
#[doc = "Host Pipe Status Register (n = 0) 2\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`hstpipisr2::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct HSTPIPISR2_SPEC;
impl crate::RegisterSpec for HSTPIPISR2_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`hstpipisr2::R`](R) reader structure"]
impl crate::Readable for HSTPIPISR2_SPEC {}
