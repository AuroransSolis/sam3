...
pub struct W(crate::W<ISOPIPES_HSTPIPIER0_ISOPIPES_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<ISOPIPES_HSTPIPIER0_ISOPIPES_SPEC>;
    #[inline(always)]
...
impl From<crate::W<ISOPIPES_HSTPIPIER0_ISOPIPES_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<ISOPIPES_HSTPIPIER0_ISOPIPES_SPEC>) -> Self {
        W(writer)
    }
}
#[doc = "Field `RXINES` writer - Received IN Data Interrupt Enable"]
pub type RXINES_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, ISOPIPES_HSTPIPIER0_ISOPIPES_SPEC, bool, O>;
...
pub type PERRES_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, ISOPIPES_HSTPIPIER0_ISOPIPES_SPEC, bool, O>;
...
#[doc = "Host Pipe Enable Register (n = 0)\n\nThis register you can [`write_with_zero`](crate::generic::Reg::write_with_zero). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [isopipes_hstpipier0_isopipes](index.html) module"]
