...
impl core::ops::Deref for W {
    type Target = crate::W<ISOENPT_DEVEPTIDR0_ISOENPT_SPEC>;
    #[inline(always)]
...
impl From<crate::W<ISOENPT_DEVEPTIDR0_ISOENPT_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<ISOENPT_DEVEPTIDR0_ISOENPT_SPEC>) -> Self {
        W(writer)
    }
}
