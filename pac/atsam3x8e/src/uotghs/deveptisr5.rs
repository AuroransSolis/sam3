...
pub type R = crate::R<Deveptisr5Spec>;
...
#[doc = "Device Endpoint Status Register (n = 0) 5\n\nYou can [`read`](crate::Reg::read) this register and get [`deveptisr5::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Deveptisr5Spec;
impl crate::RegisterSpec for Deveptisr5Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`deveptisr5::R`](R) reader structure"]
impl crate::Readable for Deveptisr5Spec {}
