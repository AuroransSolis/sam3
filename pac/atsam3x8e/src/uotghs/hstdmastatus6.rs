#[doc = "Register `HSTDMASTATUS6` reader"]
pub struct R(crate::R<HSTDMASTATUS6_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<HSTDMASTATUS6_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<HSTDMASTATUS6_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<HSTDMASTATUS6_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `HSTDMASTATUS6` writer"]
pub struct W(crate::W<HSTDMASTATUS6_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<HSTDMASTATUS6_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<HSTDMASTATUS6_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<HSTDMASTATUS6_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type CHANN_ENB_W<'a, const O: u8> = crate::BitWriter<'a, u32, HSTDMASTATUS6_SPEC, bool, O>;
...
pub type CHANN_ACT_W<'a, const O: u8> = crate::BitWriter<'a, u32, HSTDMASTATUS6_SPEC, bool, O>;
...
pub type END_TR_ST_W<'a, const O: u8> = crate::BitWriter<'a, u32, HSTDMASTATUS6_SPEC, bool, O>;
...
pub type END_BF_ST_W<'a, const O: u8> = crate::BitWriter<'a, u32, HSTDMASTATUS6_SPEC, bool, O>;
...
pub type DESC_LDST_W<'a, const O: u8> = crate::BitWriter<'a, u32, HSTDMASTATUS6_SPEC, bool, O>;
...
pub type BUFF_COUNT_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, HSTDMASTATUS6_SPEC, u16, u16, 16, O>;
impl R {
...
#[doc = "Host DMA Channel Status Register (n = 6)\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [hstdmastatus6](index.html) module"]
pub struct HSTDMASTATUS6_SPEC;
impl crate::RegisterSpec for HSTDMASTATUS6_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [hstdmastatus6::R](R) reader structure"]
