...
pub type R = crate::R<HSTPIPINRQ7_SPEC>;
#[doc = "Register `HSTPIPINRQ7` writer"]
pub type W = crate::W<HSTPIPINRQ7_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn inrq(&mut self) -> INRQ_W<HSTPIPINRQ7_SPEC, 0> {
        INRQ_W::new(self)
    }
    #[doc = "Bit 8 - IN Request Mode"]
    #[inline(always)]
    #[must_use]
    pub fn inmode(&mut self) -> INMODE_W<HSTPIPINRQ7_SPEC, 8> {
        INMODE_W::new(self)
    }
...
pub struct HSTPIPINRQ7_SPEC;
impl crate::RegisterSpec for HSTPIPINRQ7_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`hstpipinrq7::R`](R) reader structure"]
impl crate::Readable for HSTPIPINRQ7_SPEC {}
#[doc = "`write(|w| ..)` method takes [`hstpipinrq7::W`](W) writer structure"]
impl crate::Writable for HSTPIPINRQ7_SPEC {
