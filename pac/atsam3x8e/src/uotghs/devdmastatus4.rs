...
pub type R = crate::R<Devdmastatus4Spec>;
#[doc = "Register `DEVDMASTATUS4` writer"]
pub type W = crate::W<Devdmastatus4Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn chann_enb(&mut self) -> ChannEnbW<Devdmastatus4Spec> {
        ChannEnbW::new(self, 0)
    }
    #[doc = "Bit 1 - Channel Active Status"]
    #[inline(always)]
    #[must_use]
    pub fn chann_act(&mut self) -> ChannActW<Devdmastatus4Spec> {
        ChannActW::new(self, 1)
    }
    #[doc = "Bit 4 - End of Channel Transfer Status"]
    #[inline(always)]
    #[must_use]
    pub fn end_tr_st(&mut self) -> EndTrStW<Devdmastatus4Spec> {
        EndTrStW::new(self, 4)
    }
    #[doc = "Bit 5 - End of Channel Buffer Status"]
    #[inline(always)]
    #[must_use]
    pub fn end_bf_st(&mut self) -> EndBfStW<Devdmastatus4Spec> {
        EndBfStW::new(self, 5)
    }
    #[doc = "Bit 6 - Descriptor Loaded Status"]
    #[inline(always)]
    #[must_use]
    pub fn desc_ldst(&mut self) -> DescLdstW<Devdmastatus4Spec> {
        DescLdstW::new(self, 6)
    }
    #[doc = "Bits 16:31 - Buffer Byte Count"]
    #[inline(always)]
    #[must_use]
    pub fn buff_count(&mut self) -> BuffCountW<Devdmastatus4Spec> {
        BuffCountW::new(self, 16)
    }
}
#[doc = "Device DMA Channel Status Register (n = 4)\n\nYou can [`read`](crate::Reg::read) this register and get [`devdmastatus4::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`devdmastatus4::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Devdmastatus4Spec;
impl crate::RegisterSpec for Devdmastatus4Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`devdmastatus4::R`](R) reader structure"]
impl crate::Readable for Devdmastatus4Spec {}
#[doc = "`write(|w| ..)` method takes [`devdmastatus4::W`](W) writer structure"]
impl crate::Writable for Devdmastatus4Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DEVDMASTATUS4 to value 0"]
impl crate::Resettable for Devdmastatus4Spec {
