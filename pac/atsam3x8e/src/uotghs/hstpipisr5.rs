#[doc = "Register `HSTPIPISR5` reader"]
pub type R = crate::R<HSTPIPISR5_SPEC>;
...
#[doc = "Host Pipe Status Register (n = 0) 5\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`hstpipisr5::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct HSTPIPISR5_SPEC;
impl crate::RegisterSpec for HSTPIPISR5_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`hstpipisr5::R`](R) reader structure"]
impl crate::Readable for HSTPIPISR5_SPEC {}
