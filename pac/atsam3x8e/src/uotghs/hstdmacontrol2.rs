...
pub type R = crate::R<HSTDMACONTROL2_SPEC>;
#[doc = "Register `HSTDMACONTROL2` writer"]
pub type W = crate::W<HSTDMACONTROL2_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn chann_enb(&mut self) -> CHANN_ENB_W<HSTDMACONTROL2_SPEC, 0> {
        CHANN_ENB_W::new(self)
    }
    #[doc = "Bit 1 - Load Next Channel Transfer Descriptor Enable Command"]
    #[inline(always)]
    #[must_use]
    pub fn ldnxt_dsc(&mut self) -> LDNXT_DSC_W<HSTDMACONTROL2_SPEC, 1> {
        LDNXT_DSC_W::new(self)
    }
    #[doc = "Bit 2 - End of Transfer Enable (Control)"]
    #[inline(always)]
    #[must_use]
    pub fn end_tr_en(&mut self) -> END_TR_EN_W<HSTDMACONTROL2_SPEC, 2> {
        END_TR_EN_W::new(self)
    }
    #[doc = "Bit 3 - End of Buffer Enable Control"]
    #[inline(always)]
    #[must_use]
    pub fn end_b_en(&mut self) -> END_B_EN_W<HSTDMACONTROL2_SPEC, 3> {
        END_B_EN_W::new(self)
    }
    #[doc = "Bit 4 - End of Transfer Interrupt Enable"]
    #[inline(always)]
    #[must_use]
    pub fn end_tr_it(&mut self) -> END_TR_IT_W<HSTDMACONTROL2_SPEC, 4> {
        END_TR_IT_W::new(self)
    }
    #[doc = "Bit 5 - End of Buffer Interrupt Enable"]
    #[inline(always)]
    #[must_use]
    pub fn end_buffit(&mut self) -> END_BUFFIT_W<HSTDMACONTROL2_SPEC, 5> {
        END_BUFFIT_W::new(self)
    }
    #[doc = "Bit 6 - Descriptor Loaded Interrupt Enable"]
    #[inline(always)]
    #[must_use]
    pub fn desc_ld_it(&mut self) -> DESC_LD_IT_W<HSTDMACONTROL2_SPEC, 6> {
        DESC_LD_IT_W::new(self)
    }
    #[doc = "Bit 7 - Burst Lock Enable"]
    #[inline(always)]
    #[must_use]
    pub fn burst_lck(&mut self) -> BURST_LCK_W<HSTDMACONTROL2_SPEC, 7> {
        BURST_LCK_W::new(self)
    }
    #[doc = "Bits 16:31 - Buffer Byte Length (Write-only)"]
    #[inline(always)]
    #[must_use]
    pub fn buff_length(&mut self) -> BUFF_LENGTH_W<HSTDMACONTROL2_SPEC, 16> {
...
#[doc = "Host DMA Channel Control Register (n = 2)\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`hstdmacontrol2::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`hstdmacontrol2::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
