...
pub struct R(crate::R<HSTDMANXTDSC5_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<HSTDMANXTDSC5_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<HSTDMANXTDSC5_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<HSTDMANXTDSC5_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `HSTDMANXTDSC5` writer"]
pub struct W(crate::W<HSTDMANXTDSC5_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<HSTDMANXTDSC5_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<HSTDMANXTDSC5_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<HSTDMANXTDSC5_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type NXT_DSC_ADD_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, HSTDMANXTDSC5_SPEC, u32, u32, 32, O>;
impl R {
