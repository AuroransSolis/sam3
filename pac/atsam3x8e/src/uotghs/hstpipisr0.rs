#[doc = "Register `HSTPIPISR0` reader"]
pub type R = crate::R<HSTPIPISR0_SPEC>;
...
#[doc = "Host Pipe Status Register (n = 0) 0\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`hstpipisr0::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct HSTPIPISR0_SPEC;
impl crate::RegisterSpec for HSTPIPISR0_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`hstpipisr0::R`](R) reader structure"]
impl crate::Readable for HSTPIPISR0_SPEC {}
