...
#[doc = "Host Pipe IN Request Register (n = 0)\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`hstpipinrq::R`](R).  You can [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`hstpipinrq::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
