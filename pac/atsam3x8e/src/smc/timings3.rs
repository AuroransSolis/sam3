...
pub type R = crate::R<Timings3Spec>;
#[doc = "Register `TIMINGS3` writer"]
pub type W = crate::W<Timings3Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn tclr(&mut self) -> TclrW<Timings3Spec> {
        TclrW::new(self, 0)
    }
    #[doc = "Bits 4:7 - ALE to Data Start"]
    #[inline(always)]
    #[must_use]
    pub fn tadl(&mut self) -> TadlW<Timings3Spec> {
        TadlW::new(self, 4)
    }
    #[doc = "Bits 8:11 - ALE to REN Low Delay"]
    #[inline(always)]
    #[must_use]
    pub fn tar(&mut self) -> TarW<Timings3Spec> {
        TarW::new(self, 8)
    }
    #[doc = "Bit 12 - Off Chip Memory Scrambling Enable"]
    #[inline(always)]
    #[must_use]
    pub fn ocms(&mut self) -> OcmsW<Timings3Spec> {
        OcmsW::new(self, 12)
    }
    #[doc = "Bits 16:19 - Ready to REN Low Delay"]
    #[inline(always)]
    #[must_use]
    pub fn trr(&mut self) -> TrrW<Timings3Spec> {
        TrrW::new(self, 16)
    }
    #[doc = "Bits 24:27 - WEN High to REN to Busy"]
    #[inline(always)]
    #[must_use]
    pub fn twb(&mut self) -> TwbW<Timings3Spec> {
        TwbW::new(self, 24)
    }
    #[doc = "Bits 28:30 - Ready/Busy Line Selection"]
    #[inline(always)]
    #[must_use]
    pub fn rbnsel(&mut self) -> RbnselW<Timings3Spec> {
        RbnselW::new(self, 28)
    }
    #[doc = "Bit 31 - NAND Flash Selection"]
    #[inline(always)]
    #[must_use]
    pub fn nfsel(&mut self) -> NfselW<Timings3Spec> {
        NfselW::new(self, 31)
    }
}
#[doc = "SMC Timings Register (CS_number = 3)\n\nYou can [`read`](crate::Reg::read) this register and get [`timings3::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`timings3::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Timings3Spec;
impl crate::RegisterSpec for Timings3Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`timings3::R`](R) reader structure"]
impl crate::Readable for Timings3Spec {}
#[doc = "`write(|w| ..)` method takes [`timings3::W`](W) writer structure"]
impl crate::Writable for Timings3Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets TIMINGS3 to value 0"]
impl crate::Resettable for Timings3Spec {
