...
impl core::ops::Deref for R {
    type Target = crate::R<PULSE6_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<PULSE6_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<PULSE6_SPEC>) -> Self {
        R(reader)
    }
}
...
impl core::ops::Deref for W {
    type Target = crate::W<PULSE6_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<PULSE6_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<PULSE6_SPEC>) -> Self {
        W(writer)
    }
}
