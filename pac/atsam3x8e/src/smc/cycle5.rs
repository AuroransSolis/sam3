...
pub struct R(crate::R<CYCLE5_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<CYCLE5_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<CYCLE5_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<CYCLE5_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `CYCLE5` writer"]
pub struct W(crate::W<CYCLE5_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<CYCLE5_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<CYCLE5_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<CYCLE5_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type NWE_CYCLE_W<'a, const O: u8> = crate::FieldWriter<'a, u32, CYCLE5_SPEC, u16, u16, 9, O>;
...
pub type NRD_CYCLE_W<'a, const O: u8> = crate::FieldWriter<'a, u32, CYCLE5_SPEC, u16, u16, 9, O>;
impl R {
