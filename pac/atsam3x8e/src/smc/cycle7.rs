...
pub type R = crate::R<Cycle7Spec>;
#[doc = "Register `CYCLE7` writer"]
pub type W = crate::W<Cycle7Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn nwe_cycle(&mut self) -> NweCycleW<Cycle7Spec> {
        NweCycleW::new(self, 0)
    }
    #[doc = "Bits 16:24 - Total Read Cycle Length"]
    #[inline(always)]
    #[must_use]
    pub fn nrd_cycle(&mut self) -> NrdCycleW<Cycle7Spec> {
        NrdCycleW::new(self, 16)
    }
}
#[doc = "SMC Cycle Register (CS_number = 7)\n\nYou can [`read`](crate::Reg::read) this register and get [`cycle7::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`cycle7::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Cycle7Spec;
impl crate::RegisterSpec for Cycle7Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`cycle7::R`](R) reader structure"]
impl crate::Readable for Cycle7Spec {}
#[doc = "`write(|w| ..)` method takes [`cycle7::W`](W) writer structure"]
impl crate::Writable for Cycle7Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets CYCLE7 to value 0x0003_0003"]
impl crate::Resettable for Cycle7Spec {
