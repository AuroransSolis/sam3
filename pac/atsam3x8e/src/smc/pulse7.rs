...
pub type R = crate::R<PULSE7_SPEC>;
#[doc = "Register `PULSE7` writer"]
pub type W = crate::W<PULSE7_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn nwe_pulse(&mut self) -> NWE_PULSE_W<PULSE7_SPEC, 0> {
        NWE_PULSE_W::new(self)
    }
    #[doc = "Bits 8:14 - NCS Pulse Length in WRITE Access"]
    #[inline(always)]
    #[must_use]
    pub fn ncs_wr_pulse(&mut self) -> NCS_WR_PULSE_W<PULSE7_SPEC, 8> {
        NCS_WR_PULSE_W::new(self)
    }
    #[doc = "Bits 16:22 - NRD Pulse Length"]
    #[inline(always)]
    #[must_use]
    pub fn nrd_pulse(&mut self) -> NRD_PULSE_W<PULSE7_SPEC, 16> {
        NRD_PULSE_W::new(self)
    }
    #[doc = "Bits 24:30 - NCS Pulse Length in READ Access"]
    #[inline(always)]
    #[must_use]
    pub fn ncs_rd_pulse(&mut self) -> NCS_RD_PULSE_W<PULSE7_SPEC, 24> {
...
#[doc = "SMC Pulse Register (CS_number = 7)\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`pulse7::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`pulse7::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
