...
pub type READ_MODE_W<'a, const O: u8> = crate::BitWriter<'a, u32, MODE1_SPEC, READ_MODE_A, O>;
...
pub type WRITE_MODE_W<'a, const O: u8> = crate::BitWriter<'a, u32, MODE1_SPEC, WRITE_MODE_A, O>;
...
pub type BAT_W<'a, const O: u8> = crate::BitWriter<'a, u32, MODE1_SPEC, bool, O>;
...
pub type DBW_W<'a, const O: u8> = crate::BitWriter<'a, u32, MODE1_SPEC, DBW_A, O>;
