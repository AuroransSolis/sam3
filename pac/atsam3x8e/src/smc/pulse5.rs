...
pub struct R(crate::R<PULSE5_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<PULSE5_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<PULSE5_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<PULSE5_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `PULSE5` writer"]
pub struct W(crate::W<PULSE5_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<PULSE5_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<PULSE5_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<PULSE5_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type NWE_PULSE_W<'a, const O: u8> = crate::FieldWriter<'a, u32, PULSE5_SPEC, u8, u8, 7, O>;
...
pub type NCS_WR_PULSE_W<'a, const O: u8> = crate::FieldWriter<'a, u32, PULSE5_SPEC, u8, u8, 7, O>;
...
pub type NRD_PULSE_W<'a, const O: u8> = crate::FieldWriter<'a, u32, PULSE5_SPEC, u8, u8, 7, O>;
...
pub type NCS_RD_PULSE_W<'a, const O: u8> = crate::FieldWriter<'a, u32, PULSE5_SPEC, u8, u8, 7, O>;
impl R {
...
#[doc = "SMC Pulse Register (CS_number = 5)\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [pulse5](index.html) module"]
pub struct PULSE5_SPEC;
impl crate::RegisterSpec for PULSE5_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [pulse5::R](R) reader structure"]
impl crate::Readable for PULSE5_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [pulse5::W](W) writer structure"]
impl crate::Writable for PULSE5_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets PULSE5 to value 0x0101_0101"]
impl crate::Resettable for PULSE5_SPEC {
    #[inline(always)]
