...
pub type R = crate::R<Ctrla2Spec>;
#[doc = "Register `CTRLA2` writer"]
pub type W = crate::W<Ctrla2Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn btsize(&mut self) -> BtsizeW<Ctrla2Spec> {
        BtsizeW::new(self, 0)
    }
    #[doc = "Bits 16:18 - Source Chunk Transfer Size."]
    #[inline(always)]
    #[must_use]
    pub fn scsize(&mut self) -> ScsizeW<Ctrla2Spec> {
        ScsizeW::new(self, 16)
    }
    #[doc = "Bits 20:22 - Destination Chunk Transfer Size"]
    #[inline(always)]
    #[must_use]
    pub fn dcsize(&mut self) -> DcsizeW<Ctrla2Spec> {
        DcsizeW::new(self, 20)
    }
    #[doc = "Bits 24:25 - Transfer Width for the Source"]
    #[inline(always)]
    #[must_use]
    pub fn src_width(&mut self) -> SrcWidthW<Ctrla2Spec> {
        SrcWidthW::new(self, 24)
    }
    #[doc = "Bits 28:29 - Transfer Width for the Destination"]
    #[inline(always)]
    #[must_use]
    pub fn dst_width(&mut self) -> DstWidthW<Ctrla2Spec> {
        DstWidthW::new(self, 28)
    }
    #[doc = "Bit 31 - Current Descriptor Stop Command and Transfer Completed Memory Indicator"]
    #[inline(always)]
    #[must_use]
    pub fn done(&mut self) -> DoneW<Ctrla2Spec> {
        DoneW::new(self, 31)
    }
}
#[doc = "DMAC Channel Control A Register (ch_num = 2)\n\nYou can [`read`](crate::Reg::read) this register and get [`ctrla2::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`ctrla2::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Ctrla2Spec;
impl crate::RegisterSpec for Ctrla2Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ctrla2::R`](R) reader structure"]
impl crate::Readable for Ctrla2Spec {}
#[doc = "`write(|w| ..)` method takes [`ctrla2::W`](W) writer structure"]
impl crate::Writable for Ctrla2Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets CTRLA2 to value 0"]
impl crate::Resettable for Ctrla2Spec {
