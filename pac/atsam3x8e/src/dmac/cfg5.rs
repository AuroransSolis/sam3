...
pub type R = crate::R<Cfg5Spec>;
#[doc = "Register `CFG5` writer"]
pub type W = crate::W<Cfg5Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn src_per(&mut self) -> SrcPerW<Cfg5Spec> {
        SrcPerW::new(self, 0)
    }
    #[doc = "Bits 4:7 - Destination with Peripheral identifier"]
    #[inline(always)]
    #[must_use]
    pub fn dst_per(&mut self) -> DstPerW<Cfg5Spec> {
        DstPerW::new(self, 4)
    }
    #[doc = "Bit 9 - Software or Hardware Selection for the Source"]
    #[inline(always)]
    #[must_use]
    pub fn src_h2sel(&mut self) -> SrcH2selW<Cfg5Spec> {
        SrcH2selW::new(self, 9)
    }
    #[doc = "Bit 13 - Software or Hardware Selection for the Destination"]
    #[inline(always)]
    #[must_use]
    pub fn dst_h2sel(&mut self) -> DstH2selW<Cfg5Spec> {
        DstH2selW::new(self, 13)
    }
    #[doc = "Bit 16 - Stop On Done"]
    #[inline(always)]
    #[must_use]
    pub fn sod(&mut self) -> SodW<Cfg5Spec> {
        SodW::new(self, 16)
    }
    #[doc = "Bit 20 - Interface Lock"]
    #[inline(always)]
    #[must_use]
    pub fn lock_if(&mut self) -> LockIfW<Cfg5Spec> {
        LockIfW::new(self, 20)
    }
    #[doc = "Bit 21 - Bus Lock"]
    #[inline(always)]
    #[must_use]
    pub fn lock_b(&mut self) -> LockBW<Cfg5Spec> {
        LockBW::new(self, 21)
    }
    #[doc = "Bit 22 - Master Interface Arbiter Lock"]
    #[inline(always)]
    #[must_use]
    pub fn lock_if_l(&mut self) -> LockIfLW<Cfg5Spec> {
        LockIfLW::new(self, 22)
    }
    #[doc = "Bits 24:26 - AHB Protection"]
    #[inline(always)]
    #[must_use]
    pub fn ahb_prot(&mut self) -> AhbProtW<Cfg5Spec> {
        AhbProtW::new(self, 24)
    }
    #[doc = "Bits 28:29 - FIFO Configuration"]
    #[inline(always)]
    #[must_use]
    pub fn fifocfg(&mut self) -> FifocfgW<Cfg5Spec> {
        FifocfgW::new(self, 28)
    }
}
#[doc = "DMAC Channel Configuration Register (ch_num = 5)\n\nYou can [`read`](crate::Reg::read) this register and get [`cfg5::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`cfg5::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Cfg5Spec;
impl crate::RegisterSpec for Cfg5Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`cfg5::R`](R) reader structure"]
impl crate::Readable for Cfg5Spec {}
#[doc = "`write(|w| ..)` method takes [`cfg5::W`](W) writer structure"]
impl crate::Writable for Cfg5Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets CFG5 to value 0x0100_0000"]
impl crate::Resettable for Cfg5Spec {
