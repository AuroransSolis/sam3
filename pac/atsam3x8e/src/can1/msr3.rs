...
#[doc = "Mailbox Status Register (MB = 3)\n\nYou can [`read`](crate::Reg::read) this register and get [`msr3::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Msr3Spec;
impl crate::RegisterSpec for Msr3Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`msr3::R`](R) reader structure"]
impl crate::Readable for Msr3Spec {}
#[doc = "`reset()` method sets MSR3 to value 0"]
impl crate::Resettable for Msr3Spec {
