...
impl USART_MODE_R {
    ...
    pub fn variant(&self) -> Option<USART_MODE_A> {
        match self.bits {
            ...
            10 => Some(USART_MODE_A::LinMaster),
            11 => Some(USART_MODE_A::LinSlave),
    ...
    #[doc = "Checks if the value of the field is `LinMaster`"]
    #[inline(always)]
    pub fn is_lin_master(&self) -> bool {
        *self == USART_MODE_A::LinMaster
    }
    #[doc = "Checks if the value of the field is `LinSlave`"]
    #[inline(always)]
    pub fn is_lin_slave(&self) -> bool {
        *self == USART_MODE_A::LinSlave
    }
...
impl<'a, const O: u8> USART_MODE_W<'a, O> {
    ...
    pub fn lin_master(self) -> &'a mut W {
        self.variant(USART_MODE_A::LinMaster)
    }
    #[doc = "LIN Slave"]
    #[inline(always)]
    pub fn lin_slave(self) -> &'a mut W {
        self.variant(USART_MODE_A::LinSlave)
    }
    #[doc = "SPI master"]
    #[inline(always)]
