...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn endrx(&mut self) -> ENDRX_W<SPI_MODE_IER_SPI_MODE_SPEC> {
        ENDRX_W::new(self, 3)
    }
    #[doc = "Bit 4"]
    #[inline(always)]
    #[must_use]
    pub fn endtx(&mut self) -> ENDTX_W<SPI_MODE_IER_SPI_MODE_SPEC> {
        ENDTX_W::new(self, 4)
    }
    ...
    #[inline(always)]
    #[must_use]
    pub fn txbufe(&mut self) -> TXBUFE_W<SPI_MODE_IER_SPI_MODE_SPEC> {
        TXBUFE_W::new(self, 11)
    }
    #[doc = "Bit 12"]
    #[inline(always)]
    #[must_use]
    pub fn rxbuff(&mut self) -> RXBUFF_W<SPI_MODE_IER_SPI_MODE_SPEC> {
