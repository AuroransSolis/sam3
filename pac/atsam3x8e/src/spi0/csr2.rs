...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn cpol(&mut self) -> CPOL_W<CSR2_SPEC> {
        CPOL_W::new(self, 0)
    }
    #[doc = "Bit 1 - Clock Phase"]
    #[inline(always)]
    #[must_use]
    pub fn ncpha(&mut self) -> NCPHA_W<CSR2_SPEC> {
        NCPHA_W::new(self, 1)
    }
    #[doc = "Bit 2 - Chip Select Not Active After Transfer (Ignored if CSAAT = 1)"]
    #[inline(always)]
    #[must_use]
    pub fn csnaat(&mut self) -> CSNAAT_W<CSR2_SPEC> {
        CSNAAT_W::new(self, 2)
    }
    #[doc = "Bit 3 - Chip Select Active After Transfer"]
    #[inline(always)]
    #[must_use]
    pub fn csaat(&mut self) -> CSAAT_W<CSR2_SPEC> {
        CSAAT_W::new(self, 3)
    }
    #[doc = "Bits 4:7 - Bits Per Transfer"]
    #[inline(always)]
    #[must_use]
    pub fn bits_(&mut self) -> BITS_W<CSR2_SPEC> {
        BITS_W::new(self, 4)
    }
    #[doc = "Bits 8:15 - Serial Clock Baud Rate"]
    #[inline(always)]
    #[must_use]
    pub fn scbr(&mut self) -> SCBR_W<CSR2_SPEC> {
        SCBR_W::new(self, 8)
    }
    #[doc = "Bits 16:23 - Delay Before SPCK"]
    #[inline(always)]
    #[must_use]
    pub fn dlybs(&mut self) -> DLYBS_W<CSR2_SPEC> {
        DLYBS_W::new(self, 16)
    }
    #[doc = "Bits 24:31 - Delay Between Consecutive Transfers"]
    #[inline(always)]
    #[must_use]
    pub fn dlybct(&mut self) -> DLYBCT_W<CSR2_SPEC> {
