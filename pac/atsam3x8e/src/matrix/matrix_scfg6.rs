...
pub type R = crate::R<MatrixScfg6Spec>;
#[doc = "Register `MATRIX_SCFG6` writer"]
pub type W = crate::W<MatrixScfg6Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn slot_cycle(&mut self) -> SlotCycleW<MatrixScfg6Spec> {
        SlotCycleW::new(self, 0)
    }
    #[doc = "Bits 16:17 - Default Master Type"]
    #[inline(always)]
    #[must_use]
    pub fn defmstr_type(&mut self) -> DefmstrTypeW<MatrixScfg6Spec> {
        DefmstrTypeW::new(self, 16)
    }
    #[doc = "Bits 18:20 - Fixed Default Master"]
    #[inline(always)]
    #[must_use]
    pub fn fixed_defmstr(&mut self) -> FixedDefmstrW<MatrixScfg6Spec> {
        FixedDefmstrW::new(self, 18)
    }
    #[doc = "Bits 24:25 - Arbitration Type"]
    #[inline(always)]
    #[must_use]
    pub fn arbt(&mut self) -> ArbtW<MatrixScfg6Spec> {
        ArbtW::new(self, 24)
    }
}
#[doc = "Slave Configuration Register 6\n\nYou can [`read`](crate::Reg::read) this register and get [`matrix_scfg6::R`](R). You can [`write_with_zero`](crate::Reg::write_with_zero) this register using [`matrix_scfg6::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct MatrixScfg6Spec;
impl crate::RegisterSpec for MatrixScfg6Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`matrix_scfg6::R`](R) reader structure"]
impl crate::Readable for MatrixScfg6Spec {}
#[doc = "`write(|w| ..)` method takes [`matrix_scfg6::W`](W) writer structure"]
impl crate::Writable for MatrixScfg6Spec {
