...
pub type SdioirqforSlotAR = crate::BitReader;
#[doc = "Field `SDIOIRQforSlotB` reader - "]
pub type SdioirqforSlotBR = crate::BitReader;
...
impl R {
    ...
    #[doc = "Bit 8"]
    #[inline(always)]
    pub fn sdioirqfor_slot_a(&self) -> SdioirqforSlotAR {
        SdioirqforSlotAR::new(((self.bits >> 8) & 1) != 0)
    }
    #[doc = "Bit 9"]
    #[inline(always)]
    pub fn sdioirqfor_slot_b(&self) -> SdioirqforSlotBR {
        SdioirqforSlotBR::new(((self.bits >> 9) & 1) != 0)
    }
