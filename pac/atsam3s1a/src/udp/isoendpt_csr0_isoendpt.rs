...
pub type R = crate::R<ISOENDPT_CSR0_ISOENDPT_SPEC>;
#[doc = "Register `CSR0_ISOENDPT` writer"]
pub type W = crate::W<ISOENDPT_CSR0_ISOENDPT_SPEC>;
...
pub type TXPKTRDY_W<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type FORCESTALL_W<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type RX_DATA_BK1_W<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type EPTYPE_W<'a, REG> = crate::FieldWriter<'a, REG, 3, EPTYPE_A>;
...
pub type DTGLE_W<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type EPEDS_W<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type RXBYTECNT_W<'a, REG> = crate::FieldWriter<'a, REG, 11, u16>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn txcomp(&mut self) -> TXCOMP_W<ISOENDPT_CSR0_ISOENDPT_SPEC> {
        TXCOMP_W::new(self, 0)
    }
    #[doc = "Bit 1 - Receive Data Bank 0"]
    #[inline(always)]
    #[must_use]
    pub fn rx_data_bk0(&mut self) -> RX_DATA_BK0_W<ISOENDPT_CSR0_ISOENDPT_SPEC> {
        RX_DATA_BK0_W::new(self, 1)
    }
    #[doc = "Bit 2 - Received Setup"]
    #[inline(always)]
    #[must_use]
    pub fn rxsetup(&mut self) -> RXSETUP_W<ISOENDPT_CSR0_ISOENDPT_SPEC> {
        RXSETUP_W::new(self, 2)
    }
    #[doc = "Bit 3 - A CRC error has been detected in an isochronous transfer"]
    #[inline(always)]
    #[must_use]
    pub fn isoerror(&mut self) -> ISOERROR_W<ISOENDPT_CSR0_ISOENDPT_SPEC> {
        ISOERROR_W::new(self, 3)
    }
    #[doc = "Bit 4 - Transmit Packet Ready"]
    #[inline(always)]
    #[must_use]
    pub fn txpktrdy(&mut self) -> TXPKTRDY_W<ISOENDPT_CSR0_ISOENDPT_SPEC> {
        TXPKTRDY_W::new(self, 4)
    }
    #[doc = "Bit 5 - Force Stall (used by Control, Bulk and Isochronous Endpoints)"]
    #[inline(always)]
    #[must_use]
    pub fn forcestall(&mut self) -> FORCESTALL_W<ISOENDPT_CSR0_ISOENDPT_SPEC> {
        FORCESTALL_W::new(self, 5)
    }
    #[doc = "Bit 6 - Receive Data Bank 1 (only used by endpoints with ping-pong attributes)"]
    #[inline(always)]
    #[must_use]
    pub fn rx_data_bk1(&mut self) -> RX_DATA_BK1_W<ISOENDPT_CSR0_ISOENDPT_SPEC> {
        RX_DATA_BK1_W::new(self, 6)
    }
    #[doc = "Bit 7 - Transfer Direction (only available for control endpoints)"]
    #[inline(always)]
    #[must_use]
    pub fn dir(&mut self) -> DIR_W<ISOENDPT_CSR0_ISOENDPT_SPEC> {
        DIR_W::new(self, 7)
    }
    #[doc = "Bits 8:10 - Endpoint Type"]
    #[inline(always)]
    #[must_use]
    pub fn eptype(&mut self) -> EPTYPE_W<ISOENDPT_CSR0_ISOENDPT_SPEC> {
        EPTYPE_W::new(self, 8)
    }
    #[doc = "Bit 11 - Data Toggle"]
    #[inline(always)]
    #[must_use]
    pub fn dtgle(&mut self) -> DTGLE_W<ISOENDPT_CSR0_ISOENDPT_SPEC> {
        DTGLE_W::new(self, 11)
    }
    #[doc = "Bit 15 - Endpoint Enable Disable"]
    #[inline(always)]
    #[must_use]
    pub fn epeds(&mut self) -> EPEDS_W<ISOENDPT_CSR0_ISOENDPT_SPEC> {
        EPEDS_W::new(self, 15)
    }
    #[doc = "Bits 16:26 - Number of Bytes Available in the FIFO"]
    #[inline(always)]
    #[must_use]
    pub fn rxbytecnt(&mut self) -> RXBYTECNT_W<ISOENDPT_CSR0_ISOENDPT_SPEC> {
        RXBYTECNT_W::new(self, 16)
    }
