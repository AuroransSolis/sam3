...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn tcclks(&mut self) -> TCCLKS_W<WAVE_EQ_1_CMR1_WAVE_EQ_1_SPEC> {
        TCCLKS_W::new(self, 0)
    }
    #[doc = "Bit 3 - Clock Invert"]
    #[inline(always)]
    #[must_use]
    pub fn clki(&mut self) -> CLKI_W<WAVE_EQ_1_CMR1_WAVE_EQ_1_SPEC> {
        CLKI_W::new(self, 3)
    }
    #[doc = "Bits 4:5 - Burst Signal Selection"]
    #[inline(always)]
    #[must_use]
    pub fn burst(&mut self) -> BURST_W<WAVE_EQ_1_CMR1_WAVE_EQ_1_SPEC> {
        BURST_W::new(self, 4)
    }
    #[doc = "Bit 6 - Counter Clock Stopped with RC Compare"]
    #[inline(always)]
    #[must_use]
    pub fn cpcstop(&mut self) -> CPCSTOP_W<WAVE_EQ_1_CMR1_WAVE_EQ_1_SPEC> {
        CPCSTOP_W::new(self, 6)
    }
    #[doc = "Bit 7 - Counter Clock Disable with RC Compare"]
    #[inline(always)]
    #[must_use]
    pub fn cpcdis(&mut self) -> CPCDIS_W<WAVE_EQ_1_CMR1_WAVE_EQ_1_SPEC> {
        CPCDIS_W::new(self, 7)
    }
    #[doc = "Bits 8:9 - External Event Edge Selection"]
    #[inline(always)]
    #[must_use]
    pub fn eevtedg(&mut self) -> EEVTEDG_W<WAVE_EQ_1_CMR1_WAVE_EQ_1_SPEC> {
        EEVTEDG_W::new(self, 8)
    }
    #[doc = "Bits 10:11 - External Event Selection"]
    #[inline(always)]
    #[must_use]
    pub fn eevt(&mut self) -> EEVT_W<WAVE_EQ_1_CMR1_WAVE_EQ_1_SPEC> {
        EEVT_W::new(self, 10)
    }
    #[doc = "Bit 12 - External Event Trigger Enable"]
    #[inline(always)]
    #[must_use]
    pub fn enetrg(&mut self) -> ENETRG_W<WAVE_EQ_1_CMR1_WAVE_EQ_1_SPEC> {
        ENETRG_W::new(self, 12)
    }
    #[doc = "Bits 13:14 - Waveform Selection"]
    #[inline(always)]
    #[must_use]
    pub fn wavsel(&mut self) -> WAVSEL_W<WAVE_EQ_1_CMR1_WAVE_EQ_1_SPEC> {
        WAVSEL_W::new(self, 13)
    }
    #[doc = "Bit 15 - Waveform Mode"]
    #[inline(always)]
    #[must_use]
    pub fn wave(&mut self) -> WAVE_W<WAVE_EQ_1_CMR1_WAVE_EQ_1_SPEC> {
        WAVE_W::new(self, 15)
    }
    #[doc = "Bits 16:17 - RA Compare Effect on TIOA"]
    #[inline(always)]
    #[must_use]
    pub fn acpa(&mut self) -> ACPA_W<WAVE_EQ_1_CMR1_WAVE_EQ_1_SPEC> {
        ACPA_W::new(self, 16)
    }
    #[doc = "Bits 18:19 - RC Compare Effect on TIOA"]
    #[inline(always)]
    #[must_use]
    pub fn acpc(&mut self) -> ACPC_W<WAVE_EQ_1_CMR1_WAVE_EQ_1_SPEC> {
        ACPC_W::new(self, 18)
    }
    #[doc = "Bits 20:21 - External Event Effect on TIOA"]
    #[inline(always)]
    #[must_use]
    pub fn aeevt(&mut self) -> AEEVT_W<WAVE_EQ_1_CMR1_WAVE_EQ_1_SPEC> {
        AEEVT_W::new(self, 20)
    }
    #[doc = "Bits 22:23 - Software Trigger Effect on TIOA"]
    #[inline(always)]
    #[must_use]
    pub fn aswtrg(&mut self) -> ASWTRG_W<WAVE_EQ_1_CMR1_WAVE_EQ_1_SPEC> {
        ASWTRG_W::new(self, 22)
    }
    #[doc = "Bits 24:25 - RB Compare Effect on TIOB"]
    #[inline(always)]
    #[must_use]
    pub fn bcpb(&mut self) -> BCPB_W<WAVE_EQ_1_CMR1_WAVE_EQ_1_SPEC> {
        BCPB_W::new(self, 24)
    }
    #[doc = "Bits 26:27 - RC Compare Effect on TIOB"]
    #[inline(always)]
    #[must_use]
    pub fn bcpc(&mut self) -> BCPC_W<WAVE_EQ_1_CMR1_WAVE_EQ_1_SPEC> {
        BCPC_W::new(self, 26)
    }
    #[doc = "Bits 28:29 - External Event Effect on TIOB"]
    #[inline(always)]
    #[must_use]
    pub fn beevt(&mut self) -> BEEVT_W<WAVE_EQ_1_CMR1_WAVE_EQ_1_SPEC> {
        BEEVT_W::new(self, 28)
    }
    #[doc = "Bits 30:31 - Software Trigger Effect on TIOB"]
    #[inline(always)]
    #[must_use]
    pub fn bswtrg(&mut self) -> BSWTRG_W<WAVE_EQ_1_CMR1_WAVE_EQ_1_SPEC> {
