...
pub type W = crate::W<REHLSR_SPEC>;
...
#[doc = "Rising Edge/ High Level Select Register\n\nYou can [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`rehlsr::W`](W). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
