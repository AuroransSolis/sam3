...
pub type PLLBDIV2_R = crate::BitReader;
#[doc = "Field `PLLBDIV2` writer - PLLB Divisor by 2"]
pub type PLLBDIV2_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn pllbdiv2(&mut self) -> PLLBDIV2_W<PMC_MCKR_SPEC> {
        PLLBDIV2_W::new(self, 13)
    }
