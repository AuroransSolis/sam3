...
pub type R = crate::R<WaveEq1Cmr2WaveEq1Spec>;
#[doc = "Register `CMR2_WAVE_EQ_1` writer"]
pub type W = crate::W<WaveEq1Cmr2WaveEq1Spec>;
#[doc = "Clock Selection\n\nValue on reset: 0"]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn tcclks(&mut self) -> TcclksW<WaveEq1Cmr2WaveEq1Spec> {
        TcclksW::new(self, 0)
    }
    #[doc = "Bit 3 - Clock Invert"]
    #[inline(always)]
    #[must_use]
    pub fn clki(&mut self) -> ClkiW<WaveEq1Cmr2WaveEq1Spec> {
        ClkiW::new(self, 3)
    }
    #[doc = "Bits 4:5 - Burst Signal Selection"]
    #[inline(always)]
    #[must_use]
    pub fn burst(&mut self) -> BurstW<WaveEq1Cmr2WaveEq1Spec> {
        BurstW::new(self, 4)
    }
    #[doc = "Bit 6 - Counter Clock Stopped with RC Compare"]
    #[inline(always)]
    #[must_use]
    pub fn cpcstop(&mut self) -> CpcstopW<WaveEq1Cmr2WaveEq1Spec> {
        CpcstopW::new(self, 6)
    }
    #[doc = "Bit 7 - Counter Clock Disable with RC Compare"]
    #[inline(always)]
    #[must_use]
    pub fn cpcdis(&mut self) -> CpcdisW<WaveEq1Cmr2WaveEq1Spec> {
        CpcdisW::new(self, 7)
    }
    #[doc = "Bits 8:9 - External Event Edge Selection"]
    #[inline(always)]
    #[must_use]
    pub fn eevtedg(&mut self) -> EevtedgW<WaveEq1Cmr2WaveEq1Spec> {
        EevtedgW::new(self, 8)
    }
    #[doc = "Bits 10:11 - External Event Selection"]
    #[inline(always)]
    #[must_use]
    pub fn eevt(&mut self) -> EevtW<WaveEq1Cmr2WaveEq1Spec> {
        EevtW::new(self, 10)
    }
    #[doc = "Bit 12 - External Event Trigger Enable"]
    #[inline(always)]
    #[must_use]
    pub fn enetrg(&mut self) -> EnetrgW<WaveEq1Cmr2WaveEq1Spec> {
        EnetrgW::new(self, 12)
    }
    #[doc = "Bits 13:14 - Waveform Selection"]
    #[inline(always)]
    #[must_use]
    pub fn wavsel(&mut self) -> WavselW<WaveEq1Cmr2WaveEq1Spec> {
        WavselW::new(self, 13)
    }
    #[doc = "Bit 15 - Waveform Mode"]
    #[inline(always)]
    #[must_use]
    pub fn wave(&mut self) -> WaveW<WaveEq1Cmr2WaveEq1Spec> {
        WaveW::new(self, 15)
    }
    #[doc = "Bits 16:17 - RA Compare Effect on TIOA"]
    #[inline(always)]
    #[must_use]
    pub fn acpa(&mut self) -> AcpaW<WaveEq1Cmr2WaveEq1Spec> {
        AcpaW::new(self, 16)
    }
    #[doc = "Bits 18:19 - RC Compare Effect on TIOA"]
    #[inline(always)]
    #[must_use]
    pub fn acpc(&mut self) -> AcpcW<WaveEq1Cmr2WaveEq1Spec> {
        AcpcW::new(self, 18)
    }
    #[doc = "Bits 20:21 - External Event Effect on TIOA"]
    #[inline(always)]
    #[must_use]
    pub fn aeevt(&mut self) -> AeevtW<WaveEq1Cmr2WaveEq1Spec> {
        AeevtW::new(self, 20)
    }
    #[doc = "Bits 22:23 - Software Trigger Effect on TIOA"]
    #[inline(always)]
    #[must_use]
    pub fn aswtrg(&mut self) -> AswtrgW<WaveEq1Cmr2WaveEq1Spec> {
        AswtrgW::new(self, 22)
    }
    #[doc = "Bits 24:25 - RB Compare Effect on TIOB"]
    #[inline(always)]
    #[must_use]
    pub fn bcpb(&mut self) -> BcpbW<WaveEq1Cmr2WaveEq1Spec> {
        BcpbW::new(self, 24)
    }
    #[doc = "Bits 26:27 - RC Compare Effect on TIOB"]
    #[inline(always)]
    #[must_use]
    pub fn bcpc(&mut self) -> BcpcW<WaveEq1Cmr2WaveEq1Spec> {
        BcpcW::new(self, 26)
    }
    #[doc = "Bits 28:29 - External Event Effect on TIOB"]
    #[inline(always)]
    #[must_use]
    pub fn beevt(&mut self) -> BeevtW<WaveEq1Cmr2WaveEq1Spec> {
        BeevtW::new(self, 28)
    }
    #[doc = "Bits 30:31 - Software Trigger Effect on TIOB"]
    #[inline(always)]
    #[must_use]
    pub fn bswtrg(&mut self) -> BswtrgW<WaveEq1Cmr2WaveEq1Spec> {
        BswtrgW::new(self, 30)
    }
}
...
pub struct WaveEq1Cmr2WaveEq1Spec;
impl crate::RegisterSpec for WaveEq1Cmr2WaveEq1Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`wave_eq_1_cmr2_wave_eq_1::R`](R) reader structure"]
impl crate::Readable for WaveEq1Cmr2WaveEq1Spec {}
#[doc = "`write(|w| ..)` method takes [`wave_eq_1_cmr2_wave_eq_1::W`](W) writer structure"]
impl crate::Writable for WaveEq1Cmr2WaveEq1Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets CMR2_WAVE_EQ_1 to value 0"]
impl crate::Resettable for WaveEq1Cmr2WaveEq1Spec {
