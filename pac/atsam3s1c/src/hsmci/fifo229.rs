...
pub type R = crate::R<FIFO229_SPEC>;
#[doc = "Register `FIFO229` writer"]
pub type W = crate::W<FIFO229_SPEC>;
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        write!(f, "{}", self.bits())
    }
}
impl core::fmt::Debug for crate::generic::Reg<FIFO229_SPEC> {
...
pub struct FIFO229_SPEC;
impl crate::RegisterSpec for FIFO229_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`fifo229::R`](R) reader structure"]
impl crate::Readable for FIFO229_SPEC {}
#[doc = "`write(|w| ..)` method takes [`fifo229::W`](W) writer structure"]
impl crate::Writable for FIFO229_SPEC {
