...
pub type R = crate::R<FIFO251_SPEC>;
#[doc = "Register `FIFO251` writer"]
pub type W = crate::W<FIFO251_SPEC>;
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        write!(f, "{}", self.bits())
    }
}
impl core::fmt::Debug for crate::generic::Reg<FIFO251_SPEC> {
...
pub struct FIFO251_SPEC;
impl crate::RegisterSpec for FIFO251_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`fifo251::R`](R) reader structure"]
impl crate::Readable for FIFO251_SPEC {}
#[doc = "`write(|w| ..)` method takes [`fifo251::W`](W) writer structure"]
impl crate::Writable for FIFO251_SPEC {
