...
pub type R = crate::R<FIFO35_SPEC>;
#[doc = "Register `FIFO35` writer"]
pub type W = crate::W<FIFO35_SPEC>;
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        write!(f, "{}", self.bits())
    }
}
impl core::fmt::Debug for crate::generic::Reg<FIFO35_SPEC> {
...
pub struct FIFO35_SPEC;
impl crate::RegisterSpec for FIFO35_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`fifo35::R`](R) reader structure"]
impl crate::Readable for FIFO35_SPEC {}
#[doc = "`write(|w| ..)` method takes [`fifo35::W`](W) writer structure"]
impl crate::Writable for FIFO35_SPEC {
