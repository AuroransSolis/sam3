...
pub type R = crate::R<FIFO126_SPEC>;
#[doc = "Register `FIFO126` writer"]
pub type W = crate::W<FIFO126_SPEC>;
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        write!(f, "{}", self.bits())
    }
}
impl core::fmt::Debug for crate::generic::Reg<FIFO126_SPEC> {
...
pub struct FIFO126_SPEC;
impl crate::RegisterSpec for FIFO126_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`fifo126::R`](R) reader structure"]
impl crate::Readable for FIFO126_SPEC {}
#[doc = "`write(|w| ..)` method takes [`fifo126::W`](W) writer structure"]
impl crate::Writable for FIFO126_SPEC {
