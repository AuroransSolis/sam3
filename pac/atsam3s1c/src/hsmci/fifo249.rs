...
pub type R = crate::R<FIFO249_SPEC>;
#[doc = "Register `FIFO249` writer"]
pub type W = crate::W<FIFO249_SPEC>;
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        write!(f, "{}", self.bits())
    }
}
impl core::fmt::Debug for crate::generic::Reg<FIFO249_SPEC> {
...
pub struct FIFO249_SPEC;
impl crate::RegisterSpec for FIFO249_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`fifo249::R`](R) reader structure"]
impl crate::Readable for FIFO249_SPEC {}
#[doc = "`write(|w| ..)` method takes [`fifo249::W`](W) writer structure"]
impl crate::Writable for FIFO249_SPEC {
