...
pub type R = crate::R<FIFO127_SPEC>;
#[doc = "Register `FIFO127` writer"]
pub type W = crate::W<FIFO127_SPEC>;
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        write!(f, "{}", self.bits())
    }
}
impl core::fmt::Debug for crate::generic::Reg<FIFO127_SPEC> {
...
pub struct FIFO127_SPEC;
impl crate::RegisterSpec for FIFO127_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`fifo127::R`](R) reader structure"]
impl crate::Readable for FIFO127_SPEC {}
#[doc = "`write(|w| ..)` method takes [`fifo127::W`](W) writer structure"]
impl crate::Writable for FIFO127_SPEC {
