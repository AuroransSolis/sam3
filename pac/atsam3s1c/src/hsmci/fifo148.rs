...
pub type R = crate::R<FIFO148_SPEC>;
#[doc = "Register `FIFO148` writer"]
pub type W = crate::W<FIFO148_SPEC>;
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        write!(f, "{}", self.bits())
    }
}
impl core::fmt::Debug for crate::generic::Reg<FIFO148_SPEC> {
...
pub struct FIFO148_SPEC;
impl crate::RegisterSpec for FIFO148_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`fifo148::R`](R) reader structure"]
impl crate::Readable for FIFO148_SPEC {}
#[doc = "`write(|w| ..)` method takes [`fifo148::W`](W) writer structure"]
impl crate::Writable for FIFO148_SPEC {
