...
pub type R = crate::R<Fifo206Spec>;
#[doc = "Register `FIFO206` writer"]
pub type W = crate::W<Fifo206Spec>;
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        write!(f, "{}", self.bits())
    }
}
impl core::fmt::Debug for crate::generic::Reg<Fifo206Spec> {
...
impl crate::Readable for Fifo206Spec {}
#[doc = "`write(|w| ..)` method takes [`fifo206::W`](W) writer structure"]
impl crate::Writable for Fifo206Spec {
