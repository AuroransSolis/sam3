...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn slot_cycle(&mut self) -> SLOT_CYCLE_W<MATRIX_SCFG4_SPEC> {
        SLOT_CYCLE_W::new(self, 0)
    }
    #[doc = "Bits 16:17 - Default Master Type"]
    #[inline(always)]
    #[must_use]
    pub fn defmstr_type(&mut self) -> DEFMSTR_TYPE_W<MATRIX_SCFG4_SPEC> {
        DEFMSTR_TYPE_W::new(self, 16)
    }
    #[doc = "Bits 18:20 - Fixed Default Master"]
    #[inline(always)]
    #[must_use]
    pub fn fixed_defmstr(&mut self) -> FIXED_DEFMSTR_W<MATRIX_SCFG4_SPEC> {
        FIXED_DEFMSTR_W::new(self, 18)
    }
    #[doc = "Bits 24:25 - Arbitration Type"]
    #[inline(always)]
    #[must_use]
    pub fn arbt(&mut self) -> ARBT_W<MATRIX_SCFG4_SPEC> {
        ARBT_W::new(self, 24)
    }
