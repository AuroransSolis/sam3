...
impl RegisterBlock {
    ...
    #[inline(always)]
    pub fn waveform_mode_cmr0_waveform_mode(
        &self,
        ...
        unsafe {
            &*(((self as *const Self) as *const u8).add(4usize)
                as *const crate::Reg<
                    waveform_mode_cmr0_waveform_mode::WAVEFORM_MODE_CMR0_WAVEFORM_MODE_SPEC,
                >)
        }
    }
    #[doc = "0x04 - Channel Mode Register (channel = 0)"]
    ...
    #[inline(always)]
    pub fn waveform_mode_cmr1_waveform_mode(
        &self,
        ...
        unsafe {
            &*(((self as *const Self) as *const u8).add(68usize)
                as *const crate::Reg<
                    waveform_mode_cmr1_waveform_mode::WAVEFORM_MODE_CMR1_WAVEFORM_MODE_SPEC,
                >)
        }
    }
    #[doc = "0x44 - Channel Mode Register (channel = 1)"]
    ...
    #[inline(always)]
    pub fn waveform_mode_cmr2_waveform_mode(
        &self,
        ...
        unsafe {
            &*(((self as *const Self) as *const u8).add(132usize)
                as *const crate::Reg<
                    waveform_mode_cmr2_waveform_mode::WAVEFORM_MODE_CMR2_WAVEFORM_MODE_SPEC,
                >)
        }
    }
    #[doc = "0x84 - Channel Mode Register (channel = 2)"]
...
pub mod cmr0;
#[doc = "WAVEFORM_MODE_CMR0_WAVEFORM_MODE register accessor: an alias for `Reg<WAVEFORM_MODE_CMR0_WAVEFORM_MODE_SPEC>`"]
...
pub mod cmr1;
#[doc = "WAVEFORM_MODE_CMR1_WAVEFORM_MODE register accessor: an alias for `Reg<WAVEFORM_MODE_CMR1_WAVEFORM_MODE_SPEC>`"]
...
pub mod cmr2;
#[doc = "WAVEFORM_MODE_CMR2_WAVEFORM_MODE register accessor: an alias for `Reg<WAVEFORM_MODE_CMR2_WAVEFORM_MODE_SPEC>`"]
