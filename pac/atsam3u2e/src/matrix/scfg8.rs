...
pub type R = crate::R<Scfg8Spec>;
#[doc = "Register `SCFG8` writer"]
pub type W = crate::W<Scfg8Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn slot_cycle(&mut self) -> SlotCycleW<Scfg8Spec> {
        SlotCycleW::new(self, 0)
    }
    #[doc = "Bits 16:17 - Default Master Type"]
    #[inline(always)]
    #[must_use]
    pub fn defmstr_type(&mut self) -> DefmstrTypeW<Scfg8Spec> {
        DefmstrTypeW::new(self, 16)
    }
    #[doc = "Bits 18:20 - Fixed Default Master"]
    #[inline(always)]
    #[must_use]
    pub fn fixed_defmstr(&mut self) -> FixedDefmstrW<Scfg8Spec> {
        FixedDefmstrW::new(self, 18)
    }
    #[doc = "Bits 24:25 - Arbitration Type"]
    #[inline(always)]
    #[must_use]
    pub fn arbt(&mut self) -> ArbtW<Scfg8Spec> {
        ArbtW::new(self, 24)
    }
}
...
pub struct Scfg8Spec;
impl crate::RegisterSpec for Scfg8Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`scfg8::R`](R) reader structure"]
impl crate::Readable for Scfg8Spec {}
#[doc = "`write(|w| ..)` method takes [`scfg8::W`](W) writer structure"]
impl crate::Writable for Scfg8Spec {
