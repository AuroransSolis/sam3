...
pub type R = crate::R<Eptcfg4Spec>;
#[doc = "Register `EPTCFG4` writer"]
pub type W = crate::W<Eptcfg4Spec>;
#[doc = "Endpoint Size\n\nValue on reset: 0"]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn ept_size(&mut self) -> EptSizeW<Eptcfg4Spec> {
        EptSizeW::new(self, 0)
    }
    #[doc = "Bit 3 - Endpoint Direction"]
    #[inline(always)]
    #[must_use]
    pub fn ept_dir(&mut self) -> EptDirW<Eptcfg4Spec> {
        EptDirW::new(self, 3)
    }
    #[doc = "Bits 4:5 - Endpoint Type"]
    #[inline(always)]
    #[must_use]
    pub fn ept_type(&mut self) -> EptTypeW<Eptcfg4Spec> {
        EptTypeW::new(self, 4)
    }
    #[doc = "Bits 6:7 - Number of Banks"]
    #[inline(always)]
    #[must_use]
    pub fn bk_number(&mut self) -> BkNumberW<Eptcfg4Spec> {
        BkNumberW::new(self, 6)
    }
    #[doc = "Bits 8:9 - Number Of Transaction per Microframe"]
    #[inline(always)]
    #[must_use]
    pub fn nb_trans(&mut self) -> NbTransW<Eptcfg4Spec> {
        NbTransW::new(self, 8)
    }
    #[doc = "Bit 31 - Endpoint Mapped"]
    #[inline(always)]
    #[must_use]
    pub fn ept_mapd(&mut self) -> EptMapdW<Eptcfg4Spec> {
        EptMapdW::new(self, 31)
    }
}
#[doc = "UDPHS Endpoint Configuration Register (endpoint = 4)\n\nYou can [`read`](crate::Reg::read) this register and get [`eptcfg4::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`eptcfg4::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Eptcfg4Spec;
impl crate::RegisterSpec for Eptcfg4Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`eptcfg4::R`](R) reader structure"]
impl crate::Readable for Eptcfg4Spec {}
#[doc = "`write(|w| ..)` method takes [`eptcfg4::W`](W) writer structure"]
impl crate::Writable for Eptcfg4Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets EPTCFG4 to value 0"]
impl crate::Resettable for Eptcfg4Spec {
