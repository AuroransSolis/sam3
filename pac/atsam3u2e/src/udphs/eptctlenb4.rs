...
pub struct W(crate::W<EPTCTLENB4_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<EPTCTLENB4_SPEC>;
    #[inline(always)]
...
impl From<crate::W<EPTCTLENB4_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<EPTCTLENB4_SPEC>) -> Self {
        W(writer)
    }
}
#[doc = "Field `EPT_ENABL` writer - Endpoint Enable"]
pub type EPT_ENABL_W<'a, const O: u8> = crate::BitWriter<'a, u32, EPTCTLENB4_SPEC, bool, O>;
#[doc = "Field `AUTO_VALID` writer - Packet Auto-Valid Enable"]
pub type AUTO_VALID_W<'a, const O: u8> = crate::BitWriter<'a, u32, EPTCTLENB4_SPEC, bool, O>;
#[doc = "Field `INTDIS_DMA` writer - Interrupts Disable DMA"]
pub type INTDIS_DMA_W<'a, const O: u8> = crate::BitWriter<'a, u32, EPTCTLENB4_SPEC, bool, O>;
#[doc = "Field `NYET_DIS` writer - NYET Disable (Only for High Speed Bulk OUT endpoints)"]
pub type NYET_DIS_W<'a, const O: u8> = crate::BitWriter<'a, u32, EPTCTLENB4_SPEC, bool, O>;
#[doc = "Field `ERR_OVFLW` writer - Overflow Error Interrupt Enable"]
pub type ERR_OVFLW_W<'a, const O: u8> = crate::BitWriter<'a, u32, EPTCTLENB4_SPEC, bool, O>;
#[doc = "Field `RXRDY_TXKL` writer - Received OUT Data Interrupt Enable"]
pub type RXRDY_TXKL_W<'a, const O: u8> = crate::BitWriter<'a, u32, EPTCTLENB4_SPEC, bool, O>;
#[doc = "Field `TX_COMPLT` writer - Transmitted IN Data Complete Interrupt Enable"]
pub type TX_COMPLT_W<'a, const O: u8> = crate::BitWriter<'a, u32, EPTCTLENB4_SPEC, bool, O>;
#[doc = "Field `TXRDY` writer - TX Packet Ready Interrupt Enable"]
pub type TXRDY_W<'a, const O: u8> = crate::BitWriter<'a, u32, EPTCTLENB4_SPEC, bool, O>;
#[doc = "Field `RX_SETUP` writer - Received SETUP"]
pub type RX_SETUP_W<'a, const O: u8> = crate::BitWriter<'a, u32, EPTCTLENB4_SPEC, bool, O>;
#[doc = "Field `STALL_SNT` writer - Stall Sent Interrupt Enable"]
pub type STALL_SNT_W<'a, const O: u8> = crate::BitWriter<'a, u32, EPTCTLENB4_SPEC, bool, O>;
#[doc = "Field `NAK_IN` writer - NAKIN Interrupt Enable"]
pub type NAK_IN_W<'a, const O: u8> = crate::BitWriter<'a, u32, EPTCTLENB4_SPEC, bool, O>;
#[doc = "Field `NAK_OUT` writer - NAKOUT Interrupt Enable"]
pub type NAK_OUT_W<'a, const O: u8> = crate::BitWriter<'a, u32, EPTCTLENB4_SPEC, bool, O>;
#[doc = "Field `BUSY_BANK` writer - Busy Bank Interrupt Enable"]
pub type BUSY_BANK_W<'a, const O: u8> = crate::BitWriter<'a, u32, EPTCTLENB4_SPEC, bool, O>;
#[doc = "Field `SHRT_PCKT` writer - Short Packet Send/Short Packet Interrupt Enable"]
pub type SHRT_PCKT_W<'a, const O: u8> = crate::BitWriter<'a, u32, EPTCTLENB4_SPEC, bool, O>;
impl W {
