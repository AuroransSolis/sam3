...
pub type R = crate::R<IsoendptEptsta4IsoendptSpec>;
...
pub struct IsoendptEptsta4IsoendptSpec;
impl crate::RegisterSpec for IsoendptEptsta4IsoendptSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`isoendpt_eptsta4_isoendpt::R`](R) reader structure"]
impl crate::Readable for IsoendptEptsta4IsoendptSpec {}
#[doc = "`reset()` method sets EPTSTA4_ISOENDPT to value 0x40"]
impl crate::Resettable for IsoendptEptsta4IsoendptSpec {
