...
pub struct W(crate::W<ISOENDPT_EPTCLRSTA0_ISOENDPT_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<ISOENDPT_EPTCLRSTA0_ISOENDPT_SPEC>;
    #[inline(always)]
...
impl From<crate::W<ISOENDPT_EPTCLRSTA0_ISOENDPT_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<ISOENDPT_EPTCLRSTA0_ISOENDPT_SPEC>) -> Self {
        W(writer)
    }
}
#[doc = "Field `TOGGLESQ` writer - Data Toggle Clear"]
pub type TOGGLESQ_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, ISOENDPT_EPTCLRSTA0_ISOENDPT_SPEC, bool, O>;
...
#[doc = "UDPHS Endpoint Clear Status Register (endpoint = 0)\n\nThis register you can [`write_with_zero`](crate::generic::Reg::write_with_zero). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [isoendpt_eptclrsta0_isoendpt](index.html) module"]
