...
pub type R = crate::R<Eptcfg6Spec>;
#[doc = "Register `EPTCFG6` writer"]
pub type W = crate::W<Eptcfg6Spec>;
#[doc = "Endpoint Size\n\nValue on reset: 0"]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn ept_size(&mut self) -> EptSizeW<Eptcfg6Spec> {
        EptSizeW::new(self, 0)
    }
    #[doc = "Bit 3 - Endpoint Direction"]
    #[inline(always)]
    #[must_use]
    pub fn ept_dir(&mut self) -> EptDirW<Eptcfg6Spec> {
        EptDirW::new(self, 3)
    }
    #[doc = "Bits 4:5 - Endpoint Type"]
    #[inline(always)]
    #[must_use]
    pub fn ept_type(&mut self) -> EptTypeW<Eptcfg6Spec> {
        EptTypeW::new(self, 4)
    }
    #[doc = "Bits 6:7 - Number of Banks"]
    #[inline(always)]
    #[must_use]
    pub fn bk_number(&mut self) -> BkNumberW<Eptcfg6Spec> {
        BkNumberW::new(self, 6)
    }
    #[doc = "Bits 8:9 - Number Of Transaction per Microframe"]
    #[inline(always)]
    #[must_use]
    pub fn nb_trans(&mut self) -> NbTransW<Eptcfg6Spec> {
        NbTransW::new(self, 8)
    }
    #[doc = "Bit 31 - Endpoint Mapped"]
    #[inline(always)]
    #[must_use]
    pub fn ept_mapd(&mut self) -> EptMapdW<Eptcfg6Spec> {
        EptMapdW::new(self, 31)
    }
}
#[doc = "UDPHS Endpoint Configuration Register (endpoint = 6)\n\nYou can [`read`](crate::Reg::read) this register and get [`eptcfg6::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`eptcfg6::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Eptcfg6Spec;
impl crate::RegisterSpec for Eptcfg6Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`eptcfg6::R`](R) reader structure"]
impl crate::Readable for Eptcfg6Spec {}
#[doc = "`write(|w| ..)` method takes [`eptcfg6::W`](W) writer structure"]
impl crate::Writable for Eptcfg6Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets EPTCFG6 to value 0"]
impl crate::Resettable for Eptcfg6Spec {
