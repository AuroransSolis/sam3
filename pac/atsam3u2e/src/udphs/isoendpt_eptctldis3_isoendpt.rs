...
#[doc = "UDPHS Endpoint Control Disable Register (endpoint = 3)\n\nYou can [`write_with_zero`](crate::Reg::write_with_zero) this register using [`isoendpt_eptctldis3_isoendpt::W`](W). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
