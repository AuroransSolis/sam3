#[doc = "Register `EPTCTL2` reader"]
pub struct R(crate::R<EPTCTL2_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<EPTCTL2_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<EPTCTL2_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<EPTCTL2_SPEC>) -> Self {
        R(reader)
    }
}
...
#[doc = "UDPHS Endpoint Control Register (endpoint = 2)\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [eptctl2](index.html) module"]
pub struct EPTCTL2_SPEC;
impl crate::RegisterSpec for EPTCTL2_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [eptctl2::R](R) reader structure"]
impl crate::Readable for EPTCTL2_SPEC {
    type Reader = R;
}
#[doc = "`reset()` method sets EPTCTL2 to value 0"]
impl crate::Resettable for EPTCTL2_SPEC {
    #[inline(always)]
