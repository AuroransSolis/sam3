...
impl core::ops::Deref for R {
    type Target = crate::R<ISOENDPT_EPTCTL3_ISOENDPT_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<ISOENDPT_EPTCTL3_ISOENDPT_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<ISOENDPT_EPTCTL3_ISOENDPT_SPEC>) -> Self {
        R(reader)
    }
}
