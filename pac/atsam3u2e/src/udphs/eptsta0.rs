...
pub type R = crate::R<Eptsta0Spec>;
...
pub struct Eptsta0Spec;
impl crate::RegisterSpec for Eptsta0Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`eptsta0::R`](R) reader structure"]
impl crate::Readable for Eptsta0Spec {}
#[doc = "`reset()` method sets EPTSTA0 to value 0x40"]
impl crate::Resettable for Eptsta0Spec {
