...
pub type R = crate::R<IsoendptEptsta6IsoendptSpec>;
...
impl crate::Readable for IsoendptEptsta6IsoendptSpec {}
#[doc = "`reset()` method sets EPTSTA6_ISOENDPT to value 0x40"]
impl crate::Resettable for IsoendptEptsta6IsoendptSpec {
