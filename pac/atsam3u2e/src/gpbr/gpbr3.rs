...
pub type R = crate::R<GPBR3_SPEC>;
#[doc = "Register `GPBR3` writer"]
pub type W = crate::W<GPBR3_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn gpbr_value(&mut self) -> GPBR_VALUE_W<GPBR3_SPEC, 0> {
...
pub struct GPBR3_SPEC;
impl crate::RegisterSpec for GPBR3_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`gpbr3::R`](R) reader structure"]
impl crate::Readable for GPBR3_SPEC {}
#[doc = "`write(|w| ..)` method takes [`gpbr3::W`](W) writer structure"]
impl crate::Writable for GPBR3_SPEC {
