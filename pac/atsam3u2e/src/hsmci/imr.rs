...
pub struct MCI_SDIOIRQA_R(crate::FieldReader<bool, bool>);
impl MCI_SDIOIRQA_R {
    #[inline(always)]
    pub(crate) fn new(bits: bool) -> Self {
        MCI_SDIOIRQA_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for MCI_SDIOIRQA_R {
    type Target = crate::FieldReader<bool, bool>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
...
impl R {
    ...
    #[doc = "Bit 8"]
    #[inline(always)]
    pub fn mci_sdioirqa(&self) -> MCI_SDIOIRQA_R {
        MCI_SDIOIRQA_R::new(((self.bits >> 8) & 0x01) != 0)
    }
