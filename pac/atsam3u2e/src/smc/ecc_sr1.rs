...
pub struct ECCERR0_R(crate::FieldReader<u8, u8>);
impl ECCERR0_R {
    #[inline(always)]
...
pub struct ECCERR4_R(crate::FieldReader<u8, u8>);
impl ECCERR4_R {
    #[inline(always)]
    pub(crate) fn new(bits: u8) -> Self {
...
pub struct ECCERR5_R(crate::FieldReader<u8, u8>);
impl ECCERR5_R {
    #[inline(always)]
    pub(crate) fn new(bits: u8) -> Self {
...
pub struct ECCERR6_R(crate::FieldReader<u8, u8>);
impl ECCERR6_R {
    #[inline(always)]
    pub(crate) fn new(bits: u8) -> Self {
...
pub struct ECCERR7_R(crate::FieldReader<u8, u8>);
impl ECCERR7_R {
    #[inline(always)]
    pub(crate) fn new(bits: u8) -> Self {
...
impl R {
    ...
    pub fn eccerr0(&self) -> ECCERR0_R {
        ECCERR0_R::new(((self.bits >> 1) & 0x03) as u8)
    }
    ...
    pub fn eccerr4(&self) -> ECCERR4_R {
        ECCERR4_R::new(((self.bits >> 17) & 0x03) as u8)
    }
    ...
    pub fn eccerr5(&self) -> ECCERR5_R {
        ECCERR5_R::new(((self.bits >> 21) & 0x03) as u8)
    }
    ...
    pub fn eccerr6(&self) -> ECCERR6_R {
        ECCERR6_R::new(((self.bits >> 25) & 0x03) as u8)
    }
    ...
    pub fn eccerr7(&self) -> ECCERR7_R {
        ECCERR7_R::new(((self.bits >> 29) & 0x03) as u8)
    }
}
