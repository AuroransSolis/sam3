#[doc = "Register `ECC_PR0_W9BIT` reader"]
pub struct R(crate::R<W9BIT_ECC_PR0_W9BIT_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<W9BIT_ECC_PR0_W9BIT_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<W9BIT_ECC_PR0_W9BIT_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<W9BIT_ECC_PR0_W9BIT_SPEC>) -> Self {
        R(reader)
    }
}
...
#[doc = "SMC ECC Parity 0 Register\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [w9bit_ecc_pr0_w9bit](index.html) module"]
pub struct W9BIT_ECC_PR0_W9BIT_SPEC;
impl crate::RegisterSpec for W9BIT_ECC_PR0_W9BIT_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [w9bit_ecc_pr0_w9bit::R](R) reader structure"]
impl crate::Readable for W9BIT_ECC_PR0_W9BIT_SPEC {
    type Reader = R;
}
