...
pub type R = crate::R<W8bitEccPr4W8bitSpec>;
...
#[doc = "SMC ECC parity 4 Register\n\nYou can [`read`](crate::Reg::read) this register and get [`w8bit_ecc_pr4_w8bit::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct W8bitEccPr4W8bitSpec;
impl crate::RegisterSpec for W8bitEccPr4W8bitSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`w8bit_ecc_pr4_w8bit::R`](R) reader structure"]
impl crate::Readable for W8bitEccPr4W8bitSpec {}
#[doc = "`reset()` method sets ECC_PR4_W8BIT to value 0"]
impl crate::Resettable for W8bitEccPr4W8bitSpec {
