#[doc = "Register `ECC_PR2_W8BIT` reader"]
pub struct R(crate::R<W8BIT_ECC_PR2_W8BIT_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<W8BIT_ECC_PR2_W8BIT_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<W8BIT_ECC_PR2_W8BIT_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<W8BIT_ECC_PR2_W8BIT_SPEC>) -> Self {
        R(reader)
    }
}
...
#[doc = "SMC ECC parity 2 Register\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [w8bit_ecc_pr2_w8bit](index.html) module"]
pub struct W8BIT_ECC_PR2_W8BIT_SPEC;
impl crate::RegisterSpec for W8BIT_ECC_PR2_W8BIT_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [w8bit_ecc_pr2_w8bit::R](R) reader structure"]
impl crate::Readable for W8BIT_ECC_PR2_W8BIT_SPEC {
    type Reader = R;
}
#[doc = "`reset()` method sets ECC_PR2_W8BIT to value 0"]
impl crate::Resettable for W8BIT_ECC_PR2_W8BIT_SPEC {
    #[inline(always)]
