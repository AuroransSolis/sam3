...
pub type R = crate::R<ECC_PR9_SPEC>;
...
#[doc = "SMC ECC parity 9 Register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`ecc_pr9::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
