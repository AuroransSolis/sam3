...
impl TrgselR {
    ...
    pub const fn variant(&self) -> Option<Trgsel> {
        match self.bits {
            ...
            4 => Some(Trgsel::Trgsel4),
            5 => Some(Trgsel::Trgsel5),
            _ => None,
        }
    }
    ...
    REG::Ux: From<u8>,
{
    ...
    pub fn trgsel4(self) -> &'a mut crate::W<REG> {
        self.variant(Trgsel::Trgsel4)
    }
    #[doc = "PWM Event Line 1"]
    #[inline(always)]
    pub fn trgsel5(self) -> &'a mut crate::W<REG> {
        self.variant(Trgsel::Trgsel5)
    }
}
#[doc = "Word Transfer\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
    ...
    REG: crate::Writable + crate::RegisterSpec,
{
    ...
    pub fn disabled(self) -> &'a mut crate::W<REG> {
        self.variant(Sleep::Disabled)
    }
    #[doc = "Sleep Mode: The DAC Core and/or reference voltage circuitry are OFF between conversions."]
    #[inline(always)]
    pub fn enabled(self) -> &'a mut crate::W<REG> {
        self.variant(Sleep::Enabled)
    }
}
...
pub enum Fastwkup {
    ...
    Stamode = 0,
    #[doc = "1: Fast Wake up after Sleep Mode: the voltage reference is kept ON between conversions but DAC Core is OFF"]
    Fastwakeup = 1,
}
impl From<Fastwkup> for bool {
    #[inline(always)]
    fn from(variant: Fastwkup) -> Self {
        variant as u8 != 0
    }
}
#[doc = "Field `FASTWKUP` reader - Fast Wake up Mode"]
pub type FastwkupR = crate::BitReader<Fastwkup>;
impl FastwkupR {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub const fn variant(&self) -> Fastwkup {
        match self.bits {
            false => Fastwkup::Stamode,
            true => Fastwkup::Fastwakeup,
        }
    }
    ...
    pub fn is_stamode(&self) -> bool {
        *self == Fastwkup::Stamode
    }
    #[doc = "Fast Wake up after Sleep Mode: the voltage reference is kept ON between conversions but DAC Core is OFF"]
    #[inline(always)]
    pub fn is_fastwakeup(&self) -> bool {
        *self == Fastwkup::Fastwakeup
    }
}
#[doc = "Field `FASTWKUP` writer - Fast Wake up Mode"]
pub type FastwkupW<'a, REG> = crate::BitWriter<'a, REG, Fastwkup>;
    ...
    REG: crate::Writable + crate::RegisterSpec,
{
    #[doc = "Normal Sleep Mode: The sleep mode is defined by the SLEEP bit. Voltage reference is OFF between conversions."]
    #[inline(always)]
    pub fn stamode(self) -> &'a mut crate::W<REG> {
        self.variant(Fastwkup::Stamode)
    }
    #[doc = "Fast Wake up after Sleep Mode: the voltage reference is kept ON between conversions but DAC Core is OFF"]
    #[inline(always)]
    pub fn fastwakeup(self) -> &'a mut crate::W<REG> {
        self.variant(Fastwkup::Fastwakeup)
    }
}
