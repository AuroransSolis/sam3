...
pub type R = crate::R<FIFO221_SPEC>;
#[doc = "Register `FIFO221` writer"]
pub type W = crate::W<FIFO221_SPEC>;
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        write!(f, "{}", self.bits())
    }
}
impl core::fmt::Debug for crate::generic::Reg<FIFO221_SPEC> {
...
pub struct FIFO221_SPEC;
impl crate::RegisterSpec for FIFO221_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`fifo221::R`](R) reader structure"]
impl crate::Readable for FIFO221_SPEC {}
#[doc = "`write(|w| ..)` method takes [`fifo221::W`](W) writer structure"]
impl crate::Writable for FIFO221_SPEC {
