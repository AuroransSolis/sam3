...
pub type R = crate::R<FIFO198_SPEC>;
#[doc = "Register `FIFO198` writer"]
pub type W = crate::W<FIFO198_SPEC>;
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        write!(f, "{}", self.bits())
    }
}
impl core::fmt::Debug for crate::generic::Reg<FIFO198_SPEC> {
...
pub struct FIFO198_SPEC;
impl crate::RegisterSpec for FIFO198_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`fifo198::R`](R) reader structure"]
impl crate::Readable for FIFO198_SPEC {}
#[doc = "`write(|w| ..)` method takes [`fifo198::W`](W) writer structure"]
impl crate::Writable for FIFO198_SPEC {
