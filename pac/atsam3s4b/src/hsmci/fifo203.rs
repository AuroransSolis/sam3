...
pub type R = crate::R<FIFO203_SPEC>;
#[doc = "Register `FIFO203` writer"]
pub type W = crate::W<FIFO203_SPEC>;
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        write!(f, "{}", self.bits())
    }
}
impl core::fmt::Debug for crate::generic::Reg<FIFO203_SPEC> {
...
pub struct FIFO203_SPEC;
impl crate::RegisterSpec for FIFO203_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`fifo203::R`](R) reader structure"]
impl crate::Readable for FIFO203_SPEC {}
#[doc = "`write(|w| ..)` method takes [`fifo203::W`](W) writer structure"]
impl crate::Writable for FIFO203_SPEC {
