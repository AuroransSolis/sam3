...
pub type R = crate::R<FIFO70_SPEC>;
#[doc = "Register `FIFO70` writer"]
pub type W = crate::W<FIFO70_SPEC>;
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        write!(f, "{}", self.bits())
    }
}
impl core::fmt::Debug for crate::generic::Reg<FIFO70_SPEC> {
...
pub struct FIFO70_SPEC;
impl crate::RegisterSpec for FIFO70_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`fifo70::R`](R) reader structure"]
impl crate::Readable for FIFO70_SPEC {}
#[doc = "`write(|w| ..)` method takes [`fifo70::W`](W) writer structure"]
impl crate::Writable for FIFO70_SPEC {
