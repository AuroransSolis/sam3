...
pub type R = crate::R<FIFO102_SPEC>;
#[doc = "Register `FIFO102` writer"]
pub type W = crate::W<FIFO102_SPEC>;
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        write!(f, "{}", self.bits())
    }
}
impl core::fmt::Debug for crate::generic::Reg<FIFO102_SPEC> {
...
pub struct FIFO102_SPEC;
impl crate::RegisterSpec for FIFO102_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`fifo102::R`](R) reader structure"]
impl crate::Readable for FIFO102_SPEC {}
#[doc = "`write(|w| ..)` method takes [`fifo102::W`](W) writer structure"]
impl crate::Writable for FIFO102_SPEC {
