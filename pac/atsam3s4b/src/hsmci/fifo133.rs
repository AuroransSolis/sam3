...
pub type R = crate::R<FIFO133_SPEC>;
#[doc = "Register `FIFO133` writer"]
pub type W = crate::W<FIFO133_SPEC>;
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        write!(f, "{}", self.bits())
    }
}
impl core::fmt::Debug for crate::generic::Reg<FIFO133_SPEC> {
...
pub struct FIFO133_SPEC;
impl crate::RegisterSpec for FIFO133_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`fifo133::R`](R) reader structure"]
impl crate::Readable for FIFO133_SPEC {}
#[doc = "`write(|w| ..)` method takes [`fifo133::W`](W) writer structure"]
impl crate::Writable for FIFO133_SPEC {
