...
pub type R = crate::R<FIFO247_SPEC>;
#[doc = "Register `FIFO247` writer"]
pub type W = crate::W<FIFO247_SPEC>;
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        write!(f, "{}", self.bits())
    }
}
impl core::fmt::Debug for crate::generic::Reg<FIFO247_SPEC> {
...
pub struct FIFO247_SPEC;
impl crate::RegisterSpec for FIFO247_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`fifo247::R`](R) reader structure"]
impl crate::Readable for FIFO247_SPEC {}
#[doc = "`write(|w| ..)` method takes [`fifo247::W`](W) writer structure"]
impl crate::Writable for FIFO247_SPEC {
