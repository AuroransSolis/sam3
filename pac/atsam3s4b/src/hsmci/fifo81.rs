...
pub type R = crate::R<FIFO81_SPEC>;
#[doc = "Register `FIFO81` writer"]
pub type W = crate::W<FIFO81_SPEC>;
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        write!(f, "{}", self.bits())
    }
}
impl core::fmt::Debug for crate::generic::Reg<FIFO81_SPEC> {
...
pub struct FIFO81_SPEC;
impl crate::RegisterSpec for FIFO81_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`fifo81::R`](R) reader structure"]
impl crate::Readable for FIFO81_SPEC {}
#[doc = "`write(|w| ..)` method takes [`fifo81::W`](W) writer structure"]
impl crate::Writable for FIFO81_SPEC {
