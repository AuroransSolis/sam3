...
pub type R = crate::R<FIFO194_SPEC>;
#[doc = "Register `FIFO194` writer"]
pub type W = crate::W<FIFO194_SPEC>;
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        write!(f, "{}", self.bits())
    }
}
impl core::fmt::Debug for crate::generic::Reg<FIFO194_SPEC> {
...
pub struct FIFO194_SPEC;
impl crate::RegisterSpec for FIFO194_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`fifo194::R`](R) reader structure"]
impl crate::Readable for FIFO194_SPEC {}
#[doc = "`write(|w| ..)` method takes [`fifo194::W`](W) writer structure"]
impl crate::Writable for FIFO194_SPEC {
