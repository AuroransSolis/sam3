...
pub type R = crate::R<FIFO49_SPEC>;
#[doc = "Register `FIFO49` writer"]
pub type W = crate::W<FIFO49_SPEC>;
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        write!(f, "{}", self.bits())
    }
}
impl core::fmt::Debug for crate::generic::Reg<FIFO49_SPEC> {
...
pub struct FIFO49_SPEC;
impl crate::RegisterSpec for FIFO49_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`fifo49::R`](R) reader structure"]
impl crate::Readable for FIFO49_SPEC {}
#[doc = "`write(|w| ..)` method takes [`fifo49::W`](W) writer structure"]
impl crate::Writable for FIFO49_SPEC {
