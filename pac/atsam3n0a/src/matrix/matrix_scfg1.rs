...
pub type R = crate::R<MatrixScfg1Spec>;
#[doc = "Register `MATRIX_SCFG1` writer"]
pub type W = crate::W<MatrixScfg1Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn slot_cycle(&mut self) -> SlotCycleW<MatrixScfg1Spec> {
        SlotCycleW::new(self, 0)
    }
    #[doc = "Bits 16:17 - Default Master Type"]
    #[inline(always)]
    #[must_use]
    pub fn defmstr_type(&mut self) -> DefmstrTypeW<MatrixScfg1Spec> {
        DefmstrTypeW::new(self, 16)
    }
    #[doc = "Bits 18:20 - Fixed Default Master"]
    #[inline(always)]
    #[must_use]
    pub fn fixed_defmstr(&mut self) -> FixedDefmstrW<MatrixScfg1Spec> {
        FixedDefmstrW::new(self, 18)
    }
    #[doc = "Bits 24:25 - Arbitration Type"]
    #[inline(always)]
    #[must_use]
    pub fn arbt(&mut self) -> ArbtW<MatrixScfg1Spec> {
        ArbtW::new(self, 24)
    }
}
...
pub struct MatrixScfg1Spec;
impl crate::RegisterSpec for MatrixScfg1Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`matrix_scfg1::R`](R) reader structure"]
impl crate::Readable for MatrixScfg1Spec {}
#[doc = "`write(|w| ..)` method takes [`matrix_scfg1::W`](W) writer structure"]
impl crate::Writable for MatrixScfg1Spec {
