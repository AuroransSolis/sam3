...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn pid2(&mut self) -> Pid2W<PmcPcer0Spec> {
        Pid2W::new(self, 2)
    }
    #[doc = "Bit 3 - Peripheral Clock 3 Enable"]
    #[inline(always)]
    #[must_use]
    pub fn pid3(&mut self) -> Pid3W<PmcPcer0Spec> {
        Pid3W::new(self, 3)
    }
    #[doc = "Bit 4 - Peripheral Clock 4 Enable"]
    #[inline(always)]
    #[must_use]
    pub fn pid4(&mut self) -> Pid4W<PmcPcer0Spec> {
        Pid4W::new(self, 4)
    }
    #[doc = "Bit 5 - Peripheral Clock 5 Enable"]
    #[inline(always)]
    #[must_use]
    pub fn pid5(&mut self) -> Pid5W<PmcPcer0Spec> {
        Pid5W::new(self, 5)
    }
    #[doc = "Bit 6 - Peripheral Clock 6 Enable"]
    #[inline(always)]
    #[must_use]
    pub fn pid6(&mut self) -> Pid6W<PmcPcer0Spec> {
        Pid6W::new(self, 6)
    }
    #[doc = "Bit 7 - Peripheral Clock 7 Enable"]
    #[inline(always)]
    #[must_use]
    pub fn pid7(&mut self) -> Pid7W<PmcPcer0Spec> {
        Pid7W::new(self, 7)
    }
