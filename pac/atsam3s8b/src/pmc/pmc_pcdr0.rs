...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn pid2(&mut self) -> PID2_W<PMC_PCDR0_SPEC> {
        PID2_W::new(self, 2)
    }
    #[doc = "Bit 3 - Peripheral Clock 3 Disable"]
    #[inline(always)]
    #[must_use]
    pub fn pid3(&mut self) -> PID3_W<PMC_PCDR0_SPEC> {
        PID3_W::new(self, 3)
    }
    #[doc = "Bit 4 - Peripheral Clock 4 Disable"]
    #[inline(always)]
    #[must_use]
    pub fn pid4(&mut self) -> PID4_W<PMC_PCDR0_SPEC> {
        PID4_W::new(self, 4)
    }
    #[doc = "Bit 5 - Peripheral Clock 5 Disable"]
    #[inline(always)]
    #[must_use]
    pub fn pid5(&mut self) -> PID5_W<PMC_PCDR0_SPEC> {
        PID5_W::new(self, 5)
    }
    #[doc = "Bit 6 - Peripheral Clock 6 Disable"]
    #[inline(always)]
    #[must_use]
    pub fn pid6(&mut self) -> PID6_W<PMC_PCDR0_SPEC> {
        PID6_W::new(self, 6)
    }
    #[doc = "Bit 7 - Peripheral Clock 7 Disable"]
    #[inline(always)]
    #[must_use]
    pub fn pid7(&mut self) -> PID7_W<PMC_PCDR0_SPEC> {
        PID7_W::new(self, 7)
    }
    ...
    #[inline(always)]
    #[must_use]
    pub fn pid16(&mut self) -> PID16_W<PMC_PCDR0_SPEC> {
        PID16_W::new(self, 16)
    }
