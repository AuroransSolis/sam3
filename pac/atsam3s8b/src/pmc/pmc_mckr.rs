...
pub type Pllbdiv2R = crate::BitReader;
#[doc = "Field `PLLBDIV2` writer - PLLB Divisor by 2"]
pub type Pllbdiv2W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    ...
    #[inline(always)]
    pub fn pllbdiv2(&self) -> Pllbdiv2R {
        Pllbdiv2R::new(((self.bits >> 13) & 1) != 0)
    }
}
impl W {
    #[doc = "Bits 0:1 - Master Clock Source Selection"]
    ...
    #[inline(always)]
    #[must_use]
    pub fn pllbdiv2(&mut self) -> Pllbdiv2W<PmcMckrSpec> {
        Pllbdiv2W::new(self, 13)
    }
}
#[doc = "Master Clock Register\n\nYou can [`read`](crate::Reg::read) this register and get [`pmc_mckr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`pmc_mckr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
