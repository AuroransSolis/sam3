...
pub type R = crate::R<FIFO250_SPEC>;
#[doc = "Register `FIFO250` writer"]
pub type W = crate::W<FIFO250_SPEC>;
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        write!(f, "{}", self.bits())
    }
}
impl core::fmt::Debug for crate::generic::Reg<FIFO250_SPEC> {
...
pub struct FIFO250_SPEC;
impl crate::RegisterSpec for FIFO250_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`fifo250::R`](R) reader structure"]
impl crate::Readable for FIFO250_SPEC {}
#[doc = "`write(|w| ..)` method takes [`fifo250::W`](W) writer structure"]
impl crate::Writable for FIFO250_SPEC {
