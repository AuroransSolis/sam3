...
pub type R = crate::R<FIFO41_SPEC>;
#[doc = "Register `FIFO41` writer"]
pub type W = crate::W<FIFO41_SPEC>;
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        write!(f, "{}", self.bits())
    }
}
impl core::fmt::Debug for crate::generic::Reg<FIFO41_SPEC> {
...
pub struct FIFO41_SPEC;
impl crate::RegisterSpec for FIFO41_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`fifo41::R`](R) reader structure"]
impl crate::Readable for FIFO41_SPEC {}
#[doc = "`write(|w| ..)` method takes [`fifo41::W`](W) writer structure"]
impl crate::Writable for FIFO41_SPEC {
