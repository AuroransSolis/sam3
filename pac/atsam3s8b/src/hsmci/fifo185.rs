...
pub type R = crate::R<FIFO185_SPEC>;
#[doc = "Register `FIFO185` writer"]
pub type W = crate::W<FIFO185_SPEC>;
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        write!(f, "{}", self.bits())
    }
}
impl core::fmt::Debug for crate::generic::Reg<FIFO185_SPEC> {
...
pub struct FIFO185_SPEC;
impl crate::RegisterSpec for FIFO185_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`fifo185::R`](R) reader structure"]
impl crate::Readable for FIFO185_SPEC {}
#[doc = "`write(|w| ..)` method takes [`fifo185::W`](W) writer structure"]
impl crate::Writable for FIFO185_SPEC {
