...
pub type R = crate::R<FIFO173_SPEC>;
#[doc = "Register `FIFO173` writer"]
pub type W = crate::W<FIFO173_SPEC>;
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        write!(f, "{}", self.bits())
    }
}
impl core::fmt::Debug for crate::generic::Reg<FIFO173_SPEC> {
...
pub struct FIFO173_SPEC;
impl crate::RegisterSpec for FIFO173_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`fifo173::R`](R) reader structure"]
impl crate::Readable for FIFO173_SPEC {}
#[doc = "`write(|w| ..)` method takes [`fifo173::W`](W) writer structure"]
impl crate::Writable for FIFO173_SPEC {
