...
pub type BCNT_R = crate::FieldReader<BCNT_A>;
...
impl crate::FieldSpec for BCNT_A {
    type Ux = u16;
}
impl BCNT_R {
...
pub type BCNT_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 16, O, BCNT_A>;
impl<'a, REG, const O: u8> BCNT_W<'a, REG, O>
where
