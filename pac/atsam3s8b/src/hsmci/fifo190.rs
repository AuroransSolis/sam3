...
pub type R = crate::R<FIFO190_SPEC>;
#[doc = "Register `FIFO190` writer"]
pub type W = crate::W<FIFO190_SPEC>;
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        write!(f, "{}", self.bits())
    }
}
impl core::fmt::Debug for crate::generic::Reg<FIFO190_SPEC> {
...
pub struct FIFO190_SPEC;
impl crate::RegisterSpec for FIFO190_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`fifo190::R`](R) reader structure"]
impl crate::Readable for FIFO190_SPEC {}
#[doc = "`write(|w| ..)` method takes [`fifo190::W`](W) writer structure"]
impl crate::Writable for FIFO190_SPEC {
