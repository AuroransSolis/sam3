...
pub type R = crate::R<FIFO19_SPEC>;
#[doc = "Register `FIFO19` writer"]
pub type W = crate::W<FIFO19_SPEC>;
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        write!(f, "{}", self.bits())
    }
}
impl core::fmt::Debug for crate::generic::Reg<FIFO19_SPEC> {
...
pub struct FIFO19_SPEC;
impl crate::RegisterSpec for FIFO19_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`fifo19::R`](R) reader structure"]
impl crate::Readable for FIFO19_SPEC {}
#[doc = "`write(|w| ..)` method takes [`fifo19::W`](W) writer structure"]
impl crate::Writable for FIFO19_SPEC {
