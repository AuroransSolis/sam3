...
pub type R = crate::R<FIFO224_SPEC>;
#[doc = "Register `FIFO224` writer"]
pub type W = crate::W<FIFO224_SPEC>;
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        write!(f, "{}", self.bits())
    }
}
impl core::fmt::Debug for crate::generic::Reg<FIFO224_SPEC> {
...
pub struct FIFO224_SPEC;
impl crate::RegisterSpec for FIFO224_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`fifo224::R`](R) reader structure"]
impl crate::Readable for FIFO224_SPEC {}
#[doc = "`write(|w| ..)` method takes [`fifo224::W`](W) writer structure"]
impl crate::Writable for FIFO224_SPEC {
