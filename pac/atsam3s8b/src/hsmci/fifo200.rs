...
pub type R = crate::R<FIFO200_SPEC>;
#[doc = "Register `FIFO200` writer"]
pub type W = crate::W<FIFO200_SPEC>;
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        write!(f, "{}", self.bits())
    }
}
impl core::fmt::Debug for crate::generic::Reg<FIFO200_SPEC> {
...
pub struct FIFO200_SPEC;
impl crate::RegisterSpec for FIFO200_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`fifo200::R`](R) reader structure"]
impl crate::Readable for FIFO200_SPEC {}
#[doc = "`write(|w| ..)` method takes [`fifo200::W`](W) writer structure"]
impl crate::Writable for FIFO200_SPEC {
