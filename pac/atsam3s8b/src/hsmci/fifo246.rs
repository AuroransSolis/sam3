...
pub type R = crate::R<FIFO246_SPEC>;
#[doc = "Register `FIFO246` writer"]
pub type W = crate::W<FIFO246_SPEC>;
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        write!(f, "{}", self.bits())
    }
}
impl core::fmt::Debug for crate::generic::Reg<FIFO246_SPEC> {
...
pub struct FIFO246_SPEC;
impl crate::RegisterSpec for FIFO246_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`fifo246::R`](R) reader structure"]
impl crate::Readable for FIFO246_SPEC {}
#[doc = "`write(|w| ..)` method takes [`fifo246::W`](W) writer structure"]
impl crate::Writable for FIFO246_SPEC {
