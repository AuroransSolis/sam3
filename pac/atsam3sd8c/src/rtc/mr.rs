...
impl OUT0_R {
    ...
    #[doc = "Checks if the value of the field is `NoWave`"]
    #[inline(always)]
    ...
    #[doc = "Checks if the value of the field is `AlarmToggle`"]
    #[inline(always)]
    pub fn is_alarm_toggle(&self) -> bool {
        *self == OUT0_A::AlarmToggle
    }
    #[doc = "Checks if the value of the field is `AlarmFlag`"]
    #[inline(always)]
    pub fn is_alarm_flag(&self) -> bool {
        *self == OUT0_A::AlarmFlag
    }
    #[doc = "Checks if the value of the field is `ProgPulse`"]
    #[inline(always)]
...
impl THIGH_R {
    ...
    #[doc = "Checks if the value of the field is `H31ms`"]
    #[inline(always)]
    pub fn is_h_31ms(&self) -> bool {
        *self == THIGH_A::H31ms
    }
    #[doc = "Checks if the value of the field is `H16ms`"]
    #[inline(always)]
    pub fn is_h_16ms(&self) -> bool {
        *self == THIGH_A::H16ms
    }
    #[doc = "Checks if the value of the field is `H4ms`"]
    #[inline(always)]
    pub fn is_h_4ms(&self) -> bool {
        *self == THIGH_A::H4ms
    }
    #[doc = "Checks if the value of the field is `H976us`"]
    #[inline(always)]
    pub fn is_h_976us(&self) -> bool {
        *self == THIGH_A::H976us
    }
    #[doc = "Checks if the value of the field is `H488us`"]
    #[inline(always)]
    pub fn is_h_488us(&self) -> bool {
        *self == THIGH_A::H488us
    }
    #[doc = "Checks if the value of the field is `H122us`"]
    #[inline(always)]
    pub fn is_h_122us(&self) -> bool {
        *self == THIGH_A::H122us
    }
    #[doc = "Checks if the value of the field is `H30us`"]
    #[inline(always)]
    pub fn is_h_30us(&self) -> bool {
        *self == THIGH_A::H30us
    }
    #[doc = "Checks if the value of the field is `H15us`"]
    #[inline(always)]
...
impl TPERIOD_R {
    ...
    #[doc = "Checks if the value of the field is `P1s`"]
    #[inline(always)]
    pub fn is_p_1s(&self) -> bool {
        *self == TPERIOD_A::P1s
    }
    #[doc = "Checks if the value of the field is `P500ms`"]
    #[inline(always)]
    pub fn is_p_500ms(&self) -> bool {
        *self == TPERIOD_A::P500ms
    }
    #[doc = "Checks if the value of the field is `P250ms`"]
    #[inline(always)]
    pub fn is_p_250ms(&self) -> bool {
        *self == TPERIOD_A::P250ms
    }
    #[doc = "Checks if the value of the field is `P125ms`"]
    #[inline(always)]
