...
pub type R = crate::R<FIFO222_SPEC>;
#[doc = "Register `FIFO222` writer"]
pub type W = crate::W<FIFO222_SPEC>;
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        write!(f, "{}", self.bits())
    }
}
impl core::fmt::Debug for crate::generic::Reg<FIFO222_SPEC> {
...
pub struct FIFO222_SPEC;
impl crate::RegisterSpec for FIFO222_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`fifo222::R`](R) reader structure"]
impl crate::Readable for FIFO222_SPEC {}
#[doc = "`write(|w| ..)` method takes [`fifo222::W`](W) writer structure"]
impl crate::Writable for FIFO222_SPEC {
