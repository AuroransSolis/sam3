...
pub type R = crate::R<FIFO205_SPEC>;
#[doc = "Register `FIFO205` writer"]
pub type W = crate::W<FIFO205_SPEC>;
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        write!(f, "{}", self.bits())
    }
}
impl core::fmt::Debug for crate::generic::Reg<FIFO205_SPEC> {
...
pub struct FIFO205_SPEC;
impl crate::RegisterSpec for FIFO205_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`fifo205::R`](R) reader structure"]
impl crate::Readable for FIFO205_SPEC {}
#[doc = "`write(|w| ..)` method takes [`fifo205::W`](W) writer structure"]
impl crate::Writable for FIFO205_SPEC {
