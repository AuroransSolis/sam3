...
pub type R = crate::R<FIFO118_SPEC>;
#[doc = "Register `FIFO118` writer"]
pub type W = crate::W<FIFO118_SPEC>;
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        write!(f, "{}", self.bits())
    }
}
impl core::fmt::Debug for crate::generic::Reg<FIFO118_SPEC> {
...
pub struct FIFO118_SPEC;
impl crate::RegisterSpec for FIFO118_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`fifo118::R`](R) reader structure"]
impl crate::Readable for FIFO118_SPEC {}
#[doc = "`write(|w| ..)` method takes [`fifo118::W`](W) writer structure"]
impl crate::Writable for FIFO118_SPEC {
