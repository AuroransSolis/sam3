...
pub type R = crate::R<FIFO119_SPEC>;
#[doc = "Register `FIFO119` writer"]
pub type W = crate::W<FIFO119_SPEC>;
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        write!(f, "{}", self.bits())
    }
}
impl core::fmt::Debug for crate::generic::Reg<FIFO119_SPEC> {
...
pub struct FIFO119_SPEC;
impl crate::RegisterSpec for FIFO119_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`fifo119::R`](R) reader structure"]
impl crate::Readable for FIFO119_SPEC {}
#[doc = "`write(|w| ..)` method takes [`fifo119::W`](W) writer structure"]
impl crate::Writable for FIFO119_SPEC {
