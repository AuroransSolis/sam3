...
pub type R = crate::R<FIFO33_SPEC>;
#[doc = "Register `FIFO33` writer"]
pub type W = crate::W<FIFO33_SPEC>;
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        write!(f, "{}", self.bits())
    }
}
impl core::fmt::Debug for crate::generic::Reg<FIFO33_SPEC> {
...
pub struct FIFO33_SPEC;
impl crate::RegisterSpec for FIFO33_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`fifo33::R`](R) reader structure"]
impl crate::Readable for FIFO33_SPEC {}
#[doc = "`write(|w| ..)` method takes [`fifo33::W`](W) writer structure"]
impl crate::Writable for FIFO33_SPEC {
