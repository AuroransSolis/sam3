...
pub type R = crate::R<FIFO215_SPEC>;
#[doc = "Register `FIFO215` writer"]
pub type W = crate::W<FIFO215_SPEC>;
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        write!(f, "{}", self.bits())
    }
}
impl core::fmt::Debug for crate::generic::Reg<FIFO215_SPEC> {
...
pub struct FIFO215_SPEC;
impl crate::RegisterSpec for FIFO215_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`fifo215::R`](R) reader structure"]
impl crate::Readable for FIFO215_SPEC {}
#[doc = "`write(|w| ..)` method takes [`fifo215::W`](W) writer structure"]
impl crate::Writable for FIFO215_SPEC {
