...
pub type R = crate::R<FIFO181_SPEC>;
#[doc = "Register `FIFO181` writer"]
pub type W = crate::W<FIFO181_SPEC>;
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        write!(f, "{}", self.bits())
    }
}
impl core::fmt::Debug for crate::generic::Reg<FIFO181_SPEC> {
...
pub struct FIFO181_SPEC;
impl crate::RegisterSpec for FIFO181_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`fifo181::R`](R) reader structure"]
impl crate::Readable for FIFO181_SPEC {}
#[doc = "`write(|w| ..)` method takes [`fifo181::W`](W) writer structure"]
impl crate::Writable for FIFO181_SPEC {
