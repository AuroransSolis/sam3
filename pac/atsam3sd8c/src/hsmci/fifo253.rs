...
pub type R = crate::R<FIFO253_SPEC>;
#[doc = "Register `FIFO253` writer"]
pub type W = crate::W<FIFO253_SPEC>;
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        write!(f, "{}", self.bits())
    }
}
impl core::fmt::Debug for crate::generic::Reg<FIFO253_SPEC> {
...
pub struct FIFO253_SPEC;
impl crate::RegisterSpec for FIFO253_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`fifo253::R`](R) reader structure"]
impl crate::Readable for FIFO253_SPEC {}
#[doc = "`write(|w| ..)` method takes [`fifo253::W`](W) writer structure"]
impl crate::Writable for FIFO253_SPEC {
