...
pub type R = crate::R<FIFO83_SPEC>;
#[doc = "Register `FIFO83` writer"]
pub type W = crate::W<FIFO83_SPEC>;
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        write!(f, "{}", self.bits())
    }
}
impl core::fmt::Debug for crate::generic::Reg<FIFO83_SPEC> {
...
pub struct FIFO83_SPEC;
impl crate::RegisterSpec for FIFO83_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`fifo83::R`](R) reader structure"]
impl crate::Readable for FIFO83_SPEC {}
#[doc = "`write(|w| ..)` method takes [`fifo83::W`](W) writer structure"]
impl crate::Writable for FIFO83_SPEC {
