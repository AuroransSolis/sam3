...
pub type Pid2W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `PID3` writer - Peripheral Clock 3 Disable"]
pub type Pid3W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `PID4` writer - Peripheral Clock 4 Disable"]
pub type Pid4W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `PID5` writer - Peripheral Clock 5 Disable"]
pub type Pid5W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `PID6` writer - Peripheral Clock 6 Disable"]
pub type Pid6W<'a, REG> = crate::BitWriter<'a, REG>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn pid2(&mut self) -> Pid2W<PmcPcdr0Spec> {
        Pid2W::new(self, 2)
    }
    #[doc = "Bit 3 - Peripheral Clock 3 Disable"]
    #[inline(always)]
    #[must_use]
    pub fn pid3(&mut self) -> Pid3W<PmcPcdr0Spec> {
        Pid3W::new(self, 3)
    }
    #[doc = "Bit 4 - Peripheral Clock 4 Disable"]
    #[inline(always)]
    #[must_use]
    pub fn pid4(&mut self) -> Pid4W<PmcPcdr0Spec> {
        Pid4W::new(self, 4)
    }
    #[doc = "Bit 5 - Peripheral Clock 5 Disable"]
    #[inline(always)]
    #[must_use]
    pub fn pid5(&mut self) -> Pid5W<PmcPcdr0Spec> {
        Pid5W::new(self, 5)
    }
    #[doc = "Bit 6 - Peripheral Clock 6 Disable"]
    #[inline(always)]
    #[must_use]
    pub fn pid6(&mut self) -> Pid6W<PmcPcdr0Spec> {
        Pid6W::new(self, 6)
    }
    #[doc = "Bit 7 - Peripheral Clock 7 Disable"]
    #[inline(always)]
    #[must_use]
    pub fn pid7(&mut self) -> Pid7W<PmcPcdr0Spec> {
        Pid7W::new(self, 7)
    }
    ...
    #[inline(always)]
    #[must_use]
    pub fn pid16(&mut self) -> Pid16W<PmcPcdr0Spec> {
        Pid16W::new(self, 16)
    }
