...
#[doc = "Endpoint Control and Status Register 3\n\nYou can [`read`](crate::Reg::read) this register and get [`csr3::R`](R). You can [`write_with_zero`](crate::Reg::write_with_zero) this register using [`csr3::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Csr3Spec;
