...
pub type W = crate::W<CDTYUPD2_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn cdtyupd(&mut self) -> CDTYUPD_W<CDTYUPD2_SPEC, 0> {
        CDTYUPD_W::new(self)
    }
...
#[doc = "PWM Channel Duty Cycle Update Register (ch_num = 2)\n\nYou can [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`cdtyupd2::W`](W). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
