...
pub type R = crate::R<Eptsta1Spec>;
...
#[doc = "UDPHS Endpoint Status Register (endpoint = 1)\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`eptsta1::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Eptsta1Spec;
impl crate::RegisterSpec for Eptsta1Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`eptsta1::R`](R) reader structure"]
impl crate::Readable for Eptsta1Spec {}
#[doc = "`reset()` method sets EPTSTA1 to value 0x40"]
impl crate::Resettable for Eptsta1Spec {
