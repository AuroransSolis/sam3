...
pub struct R(crate::R<DMASTATUS3_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<DMASTATUS3_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<DMASTATUS3_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<DMASTATUS3_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `DMASTATUS3` writer"]
pub struct W(crate::W<DMASTATUS3_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<DMASTATUS3_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<DMASTATUS3_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<DMASTATUS3_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type CHANN_ENB_W<'a, const O: u8> = crate::BitWriter<'a, u32, DMASTATUS3_SPEC, bool, O>;
...
pub type CHANN_ACT_W<'a, const O: u8> = crate::BitWriter<'a, u32, DMASTATUS3_SPEC, bool, O>;
...
pub type END_TR_ST_W<'a, const O: u8> = crate::BitWriter<'a, u32, DMASTATUS3_SPEC, bool, O>;
...
pub type END_BF_ST_W<'a, const O: u8> = crate::BitWriter<'a, u32, DMASTATUS3_SPEC, bool, O>;
...
pub type DESC_LDST_W<'a, const O: u8> = crate::BitWriter<'a, u32, DMASTATUS3_SPEC, bool, O>;
...
pub type BUFF_COUNT_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, DMASTATUS3_SPEC, u16, u16, 16, O>;
impl R {
