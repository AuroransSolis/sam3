...
pub type R = crate::R<Eptsta5Spec>;
...
pub struct Eptsta5Spec;
impl crate::RegisterSpec for Eptsta5Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`eptsta5::R`](R) reader structure"]
impl crate::Readable for Eptsta5Spec {}
#[doc = "`reset()` method sets EPTSTA5 to value 0x40"]
impl crate::Resettable for Eptsta5Spec {
