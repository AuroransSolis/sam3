...
pub type R = crate::R<DMANXTDSC3_SPEC>;
#[doc = "Register `DMANXTDSC3` writer"]
pub type W = crate::W<DMANXTDSC3_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn nxt_dsc_add(&mut self) -> NXT_DSC_ADD_W<DMANXTDSC3_SPEC, 0> {
