...
pub type R = crate::R<IsoendptEptctl2IsoendptSpec>;
...
pub struct IsoendptEptctl2IsoendptSpec;
impl crate::RegisterSpec for IsoendptEptctl2IsoendptSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`isoendpt_eptctl2_isoendpt::R`](R) reader structure"]
impl crate::Readable for IsoendptEptctl2IsoendptSpec {}
#[doc = "`reset()` method sets EPTCTL2_ISOENDPT to value 0"]
impl crate::Resettable for IsoendptEptctl2IsoendptSpec {
