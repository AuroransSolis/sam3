...
pub struct W(crate::W<EPTCTLDIS0_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<EPTCTLDIS0_SPEC>;
    #[inline(always)]
...
impl From<crate::W<EPTCTLDIS0_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<EPTCTLDIS0_SPEC>) -> Self {
        W(writer)
    }
}
#[doc = "Field `EPT_DISABL` writer - Endpoint Disable"]
pub type EPT_DISABL_W<'a, const O: u8> = crate::BitWriter<'a, u32, EPTCTLDIS0_SPEC, bool, O>;
#[doc = "Field `AUTO_VALID` writer - Packet Auto-Valid Disable"]
pub type AUTO_VALID_W<'a, const O: u8> = crate::BitWriter<'a, u32, EPTCTLDIS0_SPEC, bool, O>;
#[doc = "Field `INTDIS_DMA` writer - Interrupts Disable DMA"]
pub type INTDIS_DMA_W<'a, const O: u8> = crate::BitWriter<'a, u32, EPTCTLDIS0_SPEC, bool, O>;
#[doc = "Field `NYET_DIS` writer - NYET Enable (Only for High Speed Bulk OUT endpoints)"]
pub type NYET_DIS_W<'a, const O: u8> = crate::BitWriter<'a, u32, EPTCTLDIS0_SPEC, bool, O>;
#[doc = "Field `ERR_OVFLW` writer - Overflow Error Interrupt Disable"]
pub type ERR_OVFLW_W<'a, const O: u8> = crate::BitWriter<'a, u32, EPTCTLDIS0_SPEC, bool, O>;
#[doc = "Field `RXRDY_TXKL` writer - Received OUT Data Interrupt Disable"]
pub type RXRDY_TXKL_W<'a, const O: u8> = crate::BitWriter<'a, u32, EPTCTLDIS0_SPEC, bool, O>;
#[doc = "Field `TX_COMPLT` writer - Transmitted IN Data Complete Interrupt Disable"]
pub type TX_COMPLT_W<'a, const O: u8> = crate::BitWriter<'a, u32, EPTCTLDIS0_SPEC, bool, O>;
#[doc = "Field `TXRDY` writer - TX Packet Ready Interrupt Disable"]
pub type TXRDY_W<'a, const O: u8> = crate::BitWriter<'a, u32, EPTCTLDIS0_SPEC, bool, O>;
#[doc = "Field `RX_SETUP` writer - Received SETUP Interrupt Disable"]
pub type RX_SETUP_W<'a, const O: u8> = crate::BitWriter<'a, u32, EPTCTLDIS0_SPEC, bool, O>;
#[doc = "Field `STALL_SNT` writer - Stall Sent Interrupt Disable"]
pub type STALL_SNT_W<'a, const O: u8> = crate::BitWriter<'a, u32, EPTCTLDIS0_SPEC, bool, O>;
#[doc = "Field `NAK_IN` writer - NAKIN Interrupt Disable"]
pub type NAK_IN_W<'a, const O: u8> = crate::BitWriter<'a, u32, EPTCTLDIS0_SPEC, bool, O>;
#[doc = "Field `NAK_OUT` writer - NAKOUT Interrupt Disable"]
pub type NAK_OUT_W<'a, const O: u8> = crate::BitWriter<'a, u32, EPTCTLDIS0_SPEC, bool, O>;
#[doc = "Field `BUSY_BANK` writer - Busy Bank Interrupt Disable"]
pub type BUSY_BANK_W<'a, const O: u8> = crate::BitWriter<'a, u32, EPTCTLDIS0_SPEC, bool, O>;
#[doc = "Field `SHRT_PCKT` writer - Short Packet Interrupt Disable"]
pub type SHRT_PCKT_W<'a, const O: u8> = crate::BitWriter<'a, u32, EPTCTLDIS0_SPEC, bool, O>;
impl W {
