...
pub struct R(crate::R<DMANXTDSC5_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<DMANXTDSC5_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<DMANXTDSC5_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<DMANXTDSC5_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `DMANXTDSC5` writer"]
pub struct W(crate::W<DMANXTDSC5_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<DMANXTDSC5_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<DMANXTDSC5_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<DMANXTDSC5_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type NXT_DSC_ADD_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, DMANXTDSC5_SPEC, u32, u32, 32, O>;
impl R {
