...
pub struct W(crate::W<ISOENDPT_EPTSETSTA3_ISOENDPT_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<ISOENDPT_EPTSETSTA3_ISOENDPT_SPEC>;
    #[inline(always)]
...
impl From<crate::W<ISOENDPT_EPTSETSTA3_ISOENDPT_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<ISOENDPT_EPTSETSTA3_ISOENDPT_SPEC>) -> Self {
        W(writer)
    }
}
#[doc = "Field `RXRDY_TXKL` writer - KILL Bank Set (for IN Endpoint)"]
pub type RXRDY_TXKL_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, ISOENDPT_EPTSETSTA3_ISOENDPT_SPEC, bool, O>;
...
#[doc = "UDPHS Endpoint Set Status Register (endpoint = 3)\n\nThis register you can [`write_with_zero`](crate::generic::Reg::write_with_zero). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [isoendpt_eptsetsta3_isoendpt](index.html) module"]
