...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn src_per(&mut self) -> SrcPerW<Cfg2Spec> {
        SrcPerW::new(self, 0)
    }
    #[doc = "Bits 4:7 - Destination with Peripheral identifier"]
    #[inline(always)]
    #[must_use]
    pub fn dst_per(&mut self) -> DstPerW<Cfg2Spec> {
        DstPerW::new(self, 4)
    }
    #[doc = "Bit 9 - Software or Hardware Selection for the Source"]
    #[inline(always)]
    #[must_use]
    pub fn src_h2sel(&mut self) -> SrcH2selW<Cfg2Spec> {
        SrcH2selW::new(self, 9)
    }
    #[doc = "Bit 13 - Software or Hardware Selection for the Destination"]
    #[inline(always)]
    #[must_use]
    pub fn dst_h2sel(&mut self) -> DstH2selW<Cfg2Spec> {
        DstH2selW::new(self, 13)
    }
    #[doc = "Bit 16 - Stop On Done"]
    #[inline(always)]
    #[must_use]
    pub fn sod(&mut self) -> SodW<Cfg2Spec> {
        SodW::new(self, 16)
    }
    #[doc = "Bit 20 - Interface Lock"]
    #[inline(always)]
    #[must_use]
    pub fn lock_if(&mut self) -> LockIfW<Cfg2Spec> {
        LockIfW::new(self, 20)
    }
    #[doc = "Bit 21 - Bus Lock"]
    #[inline(always)]
    #[must_use]
    pub fn lock_b(&mut self) -> LockBW<Cfg2Spec> {
        LockBW::new(self, 21)
    }
    #[doc = "Bit 22 - Master Interface Arbiter Lock"]
    #[inline(always)]
    #[must_use]
    pub fn lock_if_l(&mut self) -> LockIfLW<Cfg2Spec> {
        LockIfLW::new(self, 22)
    }
    #[doc = "Bits 24:26 - AHB Protection"]
    #[inline(always)]
    #[must_use]
    pub fn ahb_prot(&mut self) -> AhbProtW<Cfg2Spec> {
        AhbProtW::new(self, 24)
    }
    #[doc = "Bits 28:29 - FIFO Configuration"]
    #[inline(always)]
    #[must_use]
    pub fn fifocfg(&mut self) -> FifocfgW<Cfg2Spec> {
