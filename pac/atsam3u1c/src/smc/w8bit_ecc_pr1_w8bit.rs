...
pub type R = crate::R<W8bitEccPr1W8bitSpec>;
...
pub struct W8bitEccPr1W8bitSpec;
impl crate::RegisterSpec for W8bitEccPr1W8bitSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`w8bit_ecc_pr1_w8bit::R`](R) reader structure"]
impl crate::Readable for W8bitEccPr1W8bitSpec {}
#[doc = "`reset()` method sets ECC_PR1_W8BIT to value 0"]
impl crate::Resettable for W8bitEccPr1W8bitSpec {
