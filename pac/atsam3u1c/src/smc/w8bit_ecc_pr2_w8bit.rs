...
pub type R = crate::R<W8bitEccPr2W8bitSpec>;
...
pub struct W8bitEccPr2W8bitSpec;
impl crate::RegisterSpec for W8bitEccPr2W8bitSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`w8bit_ecc_pr2_w8bit::R`](R) reader structure"]
impl crate::Readable for W8bitEccPr2W8bitSpec {}
#[doc = "`reset()` method sets ECC_PR2_W8BIT to value 0"]
impl crate::Resettable for W8bitEccPr2W8bitSpec {
