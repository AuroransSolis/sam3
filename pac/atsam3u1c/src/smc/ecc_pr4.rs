...
pub struct R(crate::R<ECC_PR4_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<ECC_PR4_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<ECC_PR4_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<ECC_PR4_SPEC>) -> Self {
        R(reader)
    }
}
...
#[doc = "SMC ECC parity 4 Register\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [ecc_pr4](index.html) module"]
