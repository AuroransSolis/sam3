...
pub type R = crate::R<W8bitEccPr6W8bitSpec>;
...
pub struct W8bitEccPr6W8bitSpec;
impl crate::RegisterSpec for W8bitEccPr6W8bitSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`w8bit_ecc_pr6_w8bit::R`](R) reader structure"]
impl crate::Readable for W8bitEccPr6W8bitSpec {}
#[doc = "`reset()` method sets ECC_PR6_W8BIT to value 0"]
impl crate::Resettable for W8bitEccPr6W8bitSpec {
