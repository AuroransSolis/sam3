...
pub struct EccPr3Spec;
impl crate::RegisterSpec for EccPr3Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ecc_pr3::R`](R) reader structure"]
impl crate::Readable for EccPr3Spec {}
#[doc = "`reset()` method sets ECC_PR3 to value 0"]
impl crate::Resettable for EccPr3Spec {
