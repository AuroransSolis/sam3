...
pub type R = crate::R<ECC_PR8_SPEC>;
...
#[doc = "SMC ECC parity 8 Register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`ecc_pr8::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
