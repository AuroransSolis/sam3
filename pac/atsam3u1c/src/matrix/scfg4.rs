...
pub type R = crate::R<SCFG4_SPEC>;
#[doc = "Register `SCFG4` writer"]
pub type W = crate::W<SCFG4_SPEC>;
...
pub struct SCFG4_SPEC;
impl crate::RegisterSpec for SCFG4_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`scfg4::R`](R) reader structure"]
impl crate::Readable for SCFG4_SPEC {}
#[doc = "`write(|w| ..)` method takes [`scfg4::W`](W) writer structure"]
impl crate::Writable for SCFG4_SPEC {
