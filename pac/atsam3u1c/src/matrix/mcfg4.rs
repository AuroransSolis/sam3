...
pub type R = crate::R<MCFG4_SPEC>;
#[doc = "Register `MCFG4` writer"]
pub type W = crate::W<MCFG4_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn ulbt(&mut self) -> ULBT_W<MCFG4_SPEC, 0> {
        ULBT_W::new(self)
    }
...
pub struct MCFG4_SPEC;
impl crate::RegisterSpec for MCFG4_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`mcfg4::R`](R) reader structure"]
impl crate::Readable for MCFG4_SPEC {}
#[doc = "`write(|w| ..)` method takes [`mcfg4::W`](W) writer structure"]
impl crate::Writable for MCFG4_SPEC {
