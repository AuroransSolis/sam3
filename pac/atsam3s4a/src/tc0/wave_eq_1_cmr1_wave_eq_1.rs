...
pub type R = crate::R<WAVE_EQ_1_CMR1_WAVE_EQ_1_SPEC>;
#[doc = "Register `CMR1_WAVE_EQ_1` writer"]
pub type W = crate::W<WAVE_EQ_1_CMR1_WAVE_EQ_1_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn tcclks(&mut self) -> TCCLKS_W<WAVE_EQ_1_CMR1_WAVE_EQ_1_SPEC, 0> {
        TCCLKS_W::new(self)
    }
    #[doc = "Bit 3 - Clock Invert"]
    #[inline(always)]
    #[must_use]
    pub fn clki(&mut self) -> CLKI_W<WAVE_EQ_1_CMR1_WAVE_EQ_1_SPEC, 3> {
        CLKI_W::new(self)
    }
    #[doc = "Bits 4:5 - Burst Signal Selection"]
    #[inline(always)]
    #[must_use]
    pub fn burst(&mut self) -> BURST_W<WAVE_EQ_1_CMR1_WAVE_EQ_1_SPEC, 4> {
        BURST_W::new(self)
    }
    #[doc = "Bit 6 - Counter Clock Stopped with RC Compare"]
    #[inline(always)]
    #[must_use]
    pub fn cpcstop(&mut self) -> CPCSTOP_W<WAVE_EQ_1_CMR1_WAVE_EQ_1_SPEC, 6> {
        CPCSTOP_W::new(self)
    }
    #[doc = "Bit 7 - Counter Clock Disable with RC Compare"]
    #[inline(always)]
    #[must_use]
    pub fn cpcdis(&mut self) -> CPCDIS_W<WAVE_EQ_1_CMR1_WAVE_EQ_1_SPEC, 7> {
        CPCDIS_W::new(self)
    }
    #[doc = "Bits 8:9 - External Event Edge Selection"]
    #[inline(always)]
    #[must_use]
    pub fn eevtedg(&mut self) -> EEVTEDG_W<WAVE_EQ_1_CMR1_WAVE_EQ_1_SPEC, 8> {
        EEVTEDG_W::new(self)
    }
    #[doc = "Bits 10:11 - External Event Selection"]
    #[inline(always)]
    #[must_use]
    pub fn eevt(&mut self) -> EEVT_W<WAVE_EQ_1_CMR1_WAVE_EQ_1_SPEC, 10> {
        EEVT_W::new(self)
    }
    #[doc = "Bit 12 - External Event Trigger Enable"]
    #[inline(always)]
    #[must_use]
    pub fn enetrg(&mut self) -> ENETRG_W<WAVE_EQ_1_CMR1_WAVE_EQ_1_SPEC, 12> {
        ENETRG_W::new(self)
    }
    #[doc = "Bits 13:14 - Waveform Selection"]
    #[inline(always)]
    #[must_use]
    pub fn wavsel(&mut self) -> WAVSEL_W<WAVE_EQ_1_CMR1_WAVE_EQ_1_SPEC, 13> {
        WAVSEL_W::new(self)
    }
    #[doc = "Bit 15 - Waveform Mode"]
    #[inline(always)]
    #[must_use]
    pub fn wave(&mut self) -> WAVE_W<WAVE_EQ_1_CMR1_WAVE_EQ_1_SPEC, 15> {
        WAVE_W::new(self)
    }
    #[doc = "Bits 16:17 - RA Compare Effect on TIOA"]
    #[inline(always)]
    #[must_use]
    pub fn acpa(&mut self) -> ACPA_W<WAVE_EQ_1_CMR1_WAVE_EQ_1_SPEC, 16> {
        ACPA_W::new(self)
    }
    #[doc = "Bits 18:19 - RC Compare Effect on TIOA"]
    #[inline(always)]
    #[must_use]
    pub fn acpc(&mut self) -> ACPC_W<WAVE_EQ_1_CMR1_WAVE_EQ_1_SPEC, 18> {
        ACPC_W::new(self)
    }
    #[doc = "Bits 20:21 - External Event Effect on TIOA"]
    #[inline(always)]
    #[must_use]
    pub fn aeevt(&mut self) -> AEEVT_W<WAVE_EQ_1_CMR1_WAVE_EQ_1_SPEC, 20> {
        AEEVT_W::new(self)
    }
    #[doc = "Bits 22:23 - Software Trigger Effect on TIOA"]
    #[inline(always)]
    #[must_use]
    pub fn aswtrg(&mut self) -> ASWTRG_W<WAVE_EQ_1_CMR1_WAVE_EQ_1_SPEC, 22> {
        ASWTRG_W::new(self)
    }
    #[doc = "Bits 24:25 - RB Compare Effect on TIOB"]
    #[inline(always)]
    #[must_use]
    pub fn bcpb(&mut self) -> BCPB_W<WAVE_EQ_1_CMR1_WAVE_EQ_1_SPEC, 24> {
        BCPB_W::new(self)
    }
    #[doc = "Bits 26:27 - RC Compare Effect on TIOB"]
    #[inline(always)]
    #[must_use]
    pub fn bcpc(&mut self) -> BCPC_W<WAVE_EQ_1_CMR1_WAVE_EQ_1_SPEC, 26> {
        BCPC_W::new(self)
    }
    #[doc = "Bits 28:29 - External Event Effect on TIOB"]
    #[inline(always)]
    #[must_use]
    pub fn beevt(&mut self) -> BEEVT_W<WAVE_EQ_1_CMR1_WAVE_EQ_1_SPEC, 28> {
        BEEVT_W::new(self)
    }
    #[doc = "Bits 30:31 - Software Trigger Effect on TIOB"]
    #[inline(always)]
    #[must_use]
    pub fn bswtrg(&mut self) -> BSWTRG_W<WAVE_EQ_1_CMR1_WAVE_EQ_1_SPEC, 30> {
        BSWTRG_W::new(self)
    }
