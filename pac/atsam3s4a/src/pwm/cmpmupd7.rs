...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn cenupd(&mut self) -> CENUPD_W<CMPMUPD7_SPEC> {
        CENUPD_W::new(self, 0)
    }
    #[doc = "Bits 4:7 - Comparison x Trigger Update"]
    #[inline(always)]
    #[must_use]
    pub fn ctrupd(&mut self) -> CTRUPD_W<CMPMUPD7_SPEC> {
        CTRUPD_W::new(self, 4)
    }
    #[doc = "Bits 8:11 - Comparison x Period Update"]
    #[inline(always)]
    #[must_use]
    pub fn cprupd(&mut self) -> CPRUPD_W<CMPMUPD7_SPEC> {
        CPRUPD_W::new(self, 8)
    }
    #[doc = "Bits 16:19 - Comparison x Update Period Update"]
    #[inline(always)]
    #[must_use]
    pub fn cuprupd(&mut self) -> CUPRUPD_W<CMPMUPD7_SPEC> {
