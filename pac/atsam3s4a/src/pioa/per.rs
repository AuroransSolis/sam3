...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn p0(&mut self) -> P0_W<PER_SPEC, 0> {
        P0_W::new(self)
    }
    #[doc = "Bit 1 - PIO Enable"]
    #[inline(always)]
    #[must_use]
    pub fn p1(&mut self) -> P1_W<PER_SPEC, 1> {
        P1_W::new(self)
    }
    #[doc = "Bit 2 - PIO Enable"]
    #[inline(always)]
    #[must_use]
    pub fn p2(&mut self) -> P2_W<PER_SPEC, 2> {
        P2_W::new(self)
    }
    #[doc = "Bit 3 - PIO Enable"]
    #[inline(always)]
    #[must_use]
    pub fn p3(&mut self) -> P3_W<PER_SPEC, 3> {
        P3_W::new(self)
    }
    #[doc = "Bit 4 - PIO Enable"]
    #[inline(always)]
    #[must_use]
    pub fn p4(&mut self) -> P4_W<PER_SPEC, 4> {
        P4_W::new(self)
    }
    #[doc = "Bit 5 - PIO Enable"]
    #[inline(always)]
    #[must_use]
    pub fn p5(&mut self) -> P5_W<PER_SPEC, 5> {
        P5_W::new(self)
    }
    #[doc = "Bit 6 - PIO Enable"]
    #[inline(always)]
    #[must_use]
    pub fn p6(&mut self) -> P6_W<PER_SPEC, 6> {
        P6_W::new(self)
    }
    #[doc = "Bit 7 - PIO Enable"]
    #[inline(always)]
    #[must_use]
    pub fn p7(&mut self) -> P7_W<PER_SPEC, 7> {
        P7_W::new(self)
    }
    #[doc = "Bit 8 - PIO Enable"]
    #[inline(always)]
    #[must_use]
    pub fn p8(&mut self) -> P8_W<PER_SPEC, 8> {
        P8_W::new(self)
    }
    #[doc = "Bit 9 - PIO Enable"]
    #[inline(always)]
    #[must_use]
    pub fn p9(&mut self) -> P9_W<PER_SPEC, 9> {
        P9_W::new(self)
    }
    #[doc = "Bit 10 - PIO Enable"]
    #[inline(always)]
    #[must_use]
    pub fn p10(&mut self) -> P10_W<PER_SPEC, 10> {
        P10_W::new(self)
    }
    #[doc = "Bit 11 - PIO Enable"]
    #[inline(always)]
    #[must_use]
    pub fn p11(&mut self) -> P11_W<PER_SPEC, 11> {
        P11_W::new(self)
    }
    #[doc = "Bit 12 - PIO Enable"]
    #[inline(always)]
    #[must_use]
    pub fn p12(&mut self) -> P12_W<PER_SPEC, 12> {
        P12_W::new(self)
    }
    #[doc = "Bit 13 - PIO Enable"]
    #[inline(always)]
    #[must_use]
    pub fn p13(&mut self) -> P13_W<PER_SPEC, 13> {
        P13_W::new(self)
    }
    #[doc = "Bit 14 - PIO Enable"]
    #[inline(always)]
    #[must_use]
    pub fn p14(&mut self) -> P14_W<PER_SPEC, 14> {
        P14_W::new(self)
    }
    #[doc = "Bit 15 - PIO Enable"]
    #[inline(always)]
    #[must_use]
    pub fn p15(&mut self) -> P15_W<PER_SPEC, 15> {
        P15_W::new(self)
    }
    #[doc = "Bit 16 - PIO Enable"]
    #[inline(always)]
    #[must_use]
    pub fn p16(&mut self) -> P16_W<PER_SPEC, 16> {
        P16_W::new(self)
    }
    #[doc = "Bit 17 - PIO Enable"]
    #[inline(always)]
    #[must_use]
    pub fn p17(&mut self) -> P17_W<PER_SPEC, 17> {
        P17_W::new(self)
    }
    #[doc = "Bit 18 - PIO Enable"]
    #[inline(always)]
    #[must_use]
    pub fn p18(&mut self) -> P18_W<PER_SPEC, 18> {
        P18_W::new(self)
    }
    #[doc = "Bit 19 - PIO Enable"]
    #[inline(always)]
    #[must_use]
    pub fn p19(&mut self) -> P19_W<PER_SPEC, 19> {
        P19_W::new(self)
    }
    #[doc = "Bit 20 - PIO Enable"]
    #[inline(always)]
    #[must_use]
    pub fn p20(&mut self) -> P20_W<PER_SPEC, 20> {
        P20_W::new(self)
    }
    #[doc = "Bit 21 - PIO Enable"]
    #[inline(always)]
    #[must_use]
    pub fn p21(&mut self) -> P21_W<PER_SPEC, 21> {
        P21_W::new(self)
    }
    #[doc = "Bit 22 - PIO Enable"]
    #[inline(always)]
    #[must_use]
    pub fn p22(&mut self) -> P22_W<PER_SPEC, 22> {
        P22_W::new(self)
    }
    #[doc = "Bit 23 - PIO Enable"]
    #[inline(always)]
    #[must_use]
    pub fn p23(&mut self) -> P23_W<PER_SPEC, 23> {
        P23_W::new(self)
    }
    #[doc = "Bit 24 - PIO Enable"]
    #[inline(always)]
    #[must_use]
    pub fn p24(&mut self) -> P24_W<PER_SPEC, 24> {
        P24_W::new(self)
    }
    #[doc = "Bit 25 - PIO Enable"]
    #[inline(always)]
    #[must_use]
    pub fn p25(&mut self) -> P25_W<PER_SPEC, 25> {
        P25_W::new(self)
    }
    #[doc = "Bit 26 - PIO Enable"]
    #[inline(always)]
    #[must_use]
    pub fn p26(&mut self) -> P26_W<PER_SPEC, 26> {
        P26_W::new(self)
    }
    #[doc = "Bit 27 - PIO Enable"]
    #[inline(always)]
    #[must_use]
    pub fn p27(&mut self) -> P27_W<PER_SPEC, 27> {
        P27_W::new(self)
    }
    #[doc = "Bit 28 - PIO Enable"]
    #[inline(always)]
    #[must_use]
    pub fn p28(&mut self) -> P28_W<PER_SPEC, 28> {
        P28_W::new(self)
    }
    #[doc = "Bit 29 - PIO Enable"]
    #[inline(always)]
    #[must_use]
    pub fn p29(&mut self) -> P29_W<PER_SPEC, 29> {
        P29_W::new(self)
    }
    #[doc = "Bit 30 - PIO Enable"]
    #[inline(always)]
    #[must_use]
    pub fn p30(&mut self) -> P30_W<PER_SPEC, 30> {
        P30_W::new(self)
    }
    #[doc = "Bit 31 - PIO Enable"]
    #[inline(always)]
    #[must_use]
    pub fn p31(&mut self) -> P31_W<PER_SPEC, 31> {
        P31_W::new(self)
    }
