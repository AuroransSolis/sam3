#[doc = "Register `MATRIX_SCFG3` reader"]
pub type R = crate::R<MatrixScfg3Spec>;
#[doc = "Register `MATRIX_SCFG3` writer"]
pub type W = crate::W<MatrixScfg3Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn slot_cycle(&mut self) -> SlotCycleW<MatrixScfg3Spec> {
        SlotCycleW::new(self, 0)
    }
    #[doc = "Bits 16:17 - Default Master Type"]
    #[inline(always)]
    #[must_use]
    pub fn defmstr_type(&mut self) -> DefmstrTypeW<MatrixScfg3Spec> {
        DefmstrTypeW::new(self, 16)
    }
    #[doc = "Bits 18:20 - Fixed Default Master"]
    #[inline(always)]
    #[must_use]
    pub fn fixed_defmstr(&mut self) -> FixedDefmstrW<MatrixScfg3Spec> {
        FixedDefmstrW::new(self, 18)
    }
    #[doc = "Bits 24:25 - Arbitration Type"]
    #[inline(always)]
    #[must_use]
    pub fn arbt(&mut self) -> ArbtW<MatrixScfg3Spec> {
        ArbtW::new(self, 24)
    }
}
#[doc = "Slave Configuration Register 3\n\nYou can [`read`](crate::Reg::read) this register and get [`matrix_scfg3::R`](R). You can [`write_with_zero`](crate::Reg::write_with_zero) this register using [`matrix_scfg3::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct MatrixScfg3Spec;
impl crate::RegisterSpec for MatrixScfg3Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`matrix_scfg3::R`](R) reader structure"]
impl crate::Readable for MatrixScfg3Spec {}
#[doc = "`write(|w| ..)` method takes [`matrix_scfg3::W`](W) writer structure"]
impl crate::Writable for MatrixScfg3Spec {
