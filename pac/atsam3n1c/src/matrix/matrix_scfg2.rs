#[doc = "Register `MATRIX_SCFG2` reader"]
pub type R = crate::R<MATRIX_SCFG2_SPEC>;
#[doc = "Register `MATRIX_SCFG2` writer"]
pub type W = crate::W<MATRIX_SCFG2_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn slot_cycle(&mut self) -> SLOT_CYCLE_W<MATRIX_SCFG2_SPEC, 0> {
        SLOT_CYCLE_W::new(self)
    }
    #[doc = "Bits 16:17 - Default Master Type"]
    #[inline(always)]
    #[must_use]
    pub fn defmstr_type(&mut self) -> DEFMSTR_TYPE_W<MATRIX_SCFG2_SPEC, 16> {
        DEFMSTR_TYPE_W::new(self)
    }
    #[doc = "Bits 18:20 - Fixed Default Master"]
    #[inline(always)]
    #[must_use]
    pub fn fixed_defmstr(&mut self) -> FIXED_DEFMSTR_W<MATRIX_SCFG2_SPEC, 18> {
        FIXED_DEFMSTR_W::new(self)
    }
    #[doc = "Bits 24:25 - Arbitration Type"]
    #[inline(always)]
    #[must_use]
    pub fn arbt(&mut self) -> ARBT_W<MATRIX_SCFG2_SPEC, 24> {
        ARBT_W::new(self)
    }
...
pub struct MATRIX_SCFG2_SPEC;
impl crate::RegisterSpec for MATRIX_SCFG2_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`matrix_scfg2::R`](R) reader structure"]
impl crate::Readable for MATRIX_SCFG2_SPEC {}
#[doc = "`write(|w| ..)` method takes [`matrix_scfg2::W`](W) writer structure"]
impl crate::Writable for MATRIX_SCFG2_SPEC {
