...
pub type R = crate::R<Abcdsr1Spec>;
#[doc = "Register `ABCDSR1` writer"]
pub type W = crate::W<Abcdsr1Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn p0(&mut self) -> P0W<Abcdsr1Spec> {
        P0W::new(self, 0)
    }
    #[doc = "Bit 1 - Peripheral Select."]
    #[inline(always)]
    #[must_use]
    pub fn p1(&mut self) -> P1W<Abcdsr1Spec> {
        P1W::new(self, 1)
    }
    #[doc = "Bit 2 - Peripheral Select."]
    #[inline(always)]
    #[must_use]
    pub fn p2(&mut self) -> P2W<Abcdsr1Spec> {
        P2W::new(self, 2)
    }
    #[doc = "Bit 3 - Peripheral Select."]
    #[inline(always)]
    #[must_use]
    pub fn p3(&mut self) -> P3W<Abcdsr1Spec> {
        P3W::new(self, 3)
    }
    #[doc = "Bit 4 - Peripheral Select."]
    #[inline(always)]
    #[must_use]
    pub fn p4(&mut self) -> P4W<Abcdsr1Spec> {
        P4W::new(self, 4)
    }
    #[doc = "Bit 5 - Peripheral Select."]
    #[inline(always)]
    #[must_use]
    pub fn p5(&mut self) -> P5W<Abcdsr1Spec> {
        P5W::new(self, 5)
    }
    #[doc = "Bit 6 - Peripheral Select."]
    #[inline(always)]
    #[must_use]
    pub fn p6(&mut self) -> P6W<Abcdsr1Spec> {
        P6W::new(self, 6)
    }
    #[doc = "Bit 7 - Peripheral Select."]
    #[inline(always)]
    #[must_use]
    pub fn p7(&mut self) -> P7W<Abcdsr1Spec> {
        P7W::new(self, 7)
    }
    #[doc = "Bit 8 - Peripheral Select."]
    #[inline(always)]
    #[must_use]
    pub fn p8(&mut self) -> P8W<Abcdsr1Spec> {
        P8W::new(self, 8)
    }
    #[doc = "Bit 9 - Peripheral Select."]
    #[inline(always)]
    #[must_use]
    pub fn p9(&mut self) -> P9W<Abcdsr1Spec> {
        P9W::new(self, 9)
    }
    #[doc = "Bit 10 - Peripheral Select."]
    #[inline(always)]
    #[must_use]
    pub fn p10(&mut self) -> P10W<Abcdsr1Spec> {
        P10W::new(self, 10)
    }
    #[doc = "Bit 11 - Peripheral Select."]
    #[inline(always)]
    #[must_use]
    pub fn p11(&mut self) -> P11W<Abcdsr1Spec> {
        P11W::new(self, 11)
    }
    #[doc = "Bit 12 - Peripheral Select."]
    #[inline(always)]
    #[must_use]
    pub fn p12(&mut self) -> P12W<Abcdsr1Spec> {
        P12W::new(self, 12)
    }
    #[doc = "Bit 13 - Peripheral Select."]
    #[inline(always)]
    #[must_use]
    pub fn p13(&mut self) -> P13W<Abcdsr1Spec> {
        P13W::new(self, 13)
    }
    #[doc = "Bit 14 - Peripheral Select."]
    #[inline(always)]
    #[must_use]
    pub fn p14(&mut self) -> P14W<Abcdsr1Spec> {
        P14W::new(self, 14)
    }
    #[doc = "Bit 15 - Peripheral Select."]
    #[inline(always)]
    #[must_use]
    pub fn p15(&mut self) -> P15W<Abcdsr1Spec> {
        P15W::new(self, 15)
    }
    #[doc = "Bit 16 - Peripheral Select."]
    #[inline(always)]
    #[must_use]
    pub fn p16(&mut self) -> P16W<Abcdsr1Spec> {
        P16W::new(self, 16)
    }
    #[doc = "Bit 17 - Peripheral Select."]
    #[inline(always)]
    #[must_use]
    pub fn p17(&mut self) -> P17W<Abcdsr1Spec> {
        P17W::new(self, 17)
    }
    #[doc = "Bit 18 - Peripheral Select."]
    #[inline(always)]
    #[must_use]
    pub fn p18(&mut self) -> P18W<Abcdsr1Spec> {
        P18W::new(self, 18)
    }
    #[doc = "Bit 19 - Peripheral Select."]
    #[inline(always)]
    #[must_use]
    pub fn p19(&mut self) -> P19W<Abcdsr1Spec> {
        P19W::new(self, 19)
    }
    #[doc = "Bit 20 - Peripheral Select."]
    #[inline(always)]
    #[must_use]
    pub fn p20(&mut self) -> P20W<Abcdsr1Spec> {
        P20W::new(self, 20)
    }
    #[doc = "Bit 21 - Peripheral Select."]
    #[inline(always)]
    #[must_use]
    pub fn p21(&mut self) -> P21W<Abcdsr1Spec> {
        P21W::new(self, 21)
    }
    #[doc = "Bit 22 - Peripheral Select."]
    #[inline(always)]
    #[must_use]
    pub fn p22(&mut self) -> P22W<Abcdsr1Spec> {
        P22W::new(self, 22)
    }
    #[doc = "Bit 23 - Peripheral Select."]
    #[inline(always)]
    #[must_use]
    pub fn p23(&mut self) -> P23W<Abcdsr1Spec> {
        P23W::new(self, 23)
    }
    #[doc = "Bit 24 - Peripheral Select."]
    #[inline(always)]
    #[must_use]
    pub fn p24(&mut self) -> P24W<Abcdsr1Spec> {
        P24W::new(self, 24)
    }
    #[doc = "Bit 25 - Peripheral Select."]
    #[inline(always)]
    #[must_use]
    pub fn p25(&mut self) -> P25W<Abcdsr1Spec> {
        P25W::new(self, 25)
    }
    #[doc = "Bit 26 - Peripheral Select."]
    #[inline(always)]
    #[must_use]
    pub fn p26(&mut self) -> P26W<Abcdsr1Spec> {
        P26W::new(self, 26)
    }
    #[doc = "Bit 27 - Peripheral Select."]
    #[inline(always)]
    #[must_use]
    pub fn p27(&mut self) -> P27W<Abcdsr1Spec> {
        P27W::new(self, 27)
    }
    #[doc = "Bit 28 - Peripheral Select."]
    #[inline(always)]
    #[must_use]
    pub fn p28(&mut self) -> P28W<Abcdsr1Spec> {
        P28W::new(self, 28)
    }
    #[doc = "Bit 29 - Peripheral Select."]
    #[inline(always)]
    #[must_use]
    pub fn p29(&mut self) -> P29W<Abcdsr1Spec> {
        P29W::new(self, 29)
    }
    #[doc = "Bit 30 - Peripheral Select."]
    #[inline(always)]
    #[must_use]
    pub fn p30(&mut self) -> P30W<Abcdsr1Spec> {
        P30W::new(self, 30)
    }
    #[doc = "Bit 31 - Peripheral Select."]
    #[inline(always)]
    #[must_use]
    pub fn p31(&mut self) -> P31W<Abcdsr1Spec> {
        P31W::new(self, 31)
    }
}
...
impl crate::RegisterSpec for Abcdsr1Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`abcdsr1::R`](R) reader structure"]
impl crate::Readable for Abcdsr1Spec {}
#[doc = "`write(|w| ..)` method takes [`abcdsr1::W`](W) writer structure"]
impl crate::Writable for Abcdsr1Spec {
