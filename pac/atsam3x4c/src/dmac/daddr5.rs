...
impl core::ops::Deref for R {
    type Target = crate::R<DADDR5_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<DADDR5_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<DADDR5_SPEC>) -> Self {
        R(reader)
    }
}
...
impl core::ops::Deref for W {
    type Target = crate::W<DADDR5_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<DADDR5_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<DADDR5_SPEC>) -> Self {
        W(writer)
    }
}
