...
pub type R = crate::R<Ctrla5Spec>;
#[doc = "Register `CTRLA5` writer"]
pub type W = crate::W<Ctrla5Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn btsize(&mut self) -> BtsizeW<Ctrla5Spec> {
        BtsizeW::new(self, 0)
    }
    #[doc = "Bits 16:18 - Source Chunk Transfer Size."]
    #[inline(always)]
    #[must_use]
    pub fn scsize(&mut self) -> ScsizeW<Ctrla5Spec> {
        ScsizeW::new(self, 16)
    }
    #[doc = "Bits 20:22 - Destination Chunk Transfer Size"]
    #[inline(always)]
    #[must_use]
    pub fn dcsize(&mut self) -> DcsizeW<Ctrla5Spec> {
        DcsizeW::new(self, 20)
    }
    #[doc = "Bits 24:25 - Transfer Width for the Source"]
    #[inline(always)]
    #[must_use]
    pub fn src_width(&mut self) -> SrcWidthW<Ctrla5Spec> {
        SrcWidthW::new(self, 24)
    }
    #[doc = "Bits 28:29 - Transfer Width for the Destination"]
    #[inline(always)]
    #[must_use]
    pub fn dst_width(&mut self) -> DstWidthW<Ctrla5Spec> {
        DstWidthW::new(self, 28)
    }
    #[doc = "Bit 31 - Current Descriptor Stop Command and Transfer Completed Memory Indicator"]
    #[inline(always)]
    #[must_use]
    pub fn done(&mut self) -> DoneW<Ctrla5Spec> {
        DoneW::new(self, 31)
    }
}
#[doc = "DMAC Channel Control A Register (ch_num = 5)\n\nYou can [`read`](crate::Reg::read) this register and get [`ctrla5::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`ctrla5::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Ctrla5Spec;
impl crate::RegisterSpec for Ctrla5Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ctrla5::R`](R) reader structure"]
impl crate::Readable for Ctrla5Spec {}
#[doc = "`write(|w| ..)` method takes [`ctrla5::W`](W) writer structure"]
impl crate::Writable for Ctrla5Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets CTRLA5 to value 0"]
impl crate::Resettable for Ctrla5Spec {
