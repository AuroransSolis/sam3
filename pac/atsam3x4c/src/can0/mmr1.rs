...
pub type R = crate::R<Mmr1Spec>;
#[doc = "Register `MMR1` writer"]
pub type W = crate::W<Mmr1Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn mtimemark(&mut self) -> MtimemarkW<Mmr1Spec> {
        MtimemarkW::new(self, 0)
    }
    #[doc = "Bits 16:19 - Mailbox Priority"]
    #[inline(always)]
    #[must_use]
    pub fn prior(&mut self) -> PriorW<Mmr1Spec> {
        PriorW::new(self, 16)
    }
    #[doc = "Bits 24:26 - Mailbox Object Type"]
    #[inline(always)]
    #[must_use]
    pub fn mot(&mut self) -> MotW<Mmr1Spec> {
        MotW::new(self, 24)
    }
}
#[doc = "Mailbox Mode Register (MB = 1)\n\nYou can [`read`](crate::Reg::read) this register and get [`mmr1::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`mmr1::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Mmr1Spec;
impl crate::RegisterSpec for Mmr1Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`mmr1::R`](R) reader structure"]
impl crate::Readable for Mmr1Spec {}
#[doc = "`write(|w| ..)` method takes [`mmr1::W`](W) writer structure"]
impl crate::Writable for Mmr1Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets MMR1 to value 0"]
impl crate::Resettable for Mmr1Spec {
