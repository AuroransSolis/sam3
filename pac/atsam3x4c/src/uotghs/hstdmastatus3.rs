...
pub type R = crate::R<Hstdmastatus3Spec>;
#[doc = "Register `HSTDMASTATUS3` writer"]
pub type W = crate::W<Hstdmastatus3Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn chann_enb(&mut self) -> ChannEnbW<Hstdmastatus3Spec> {
        ChannEnbW::new(self, 0)
    }
    #[doc = "Bit 1 - Channel Active Status"]
    #[inline(always)]
    #[must_use]
    pub fn chann_act(&mut self) -> ChannActW<Hstdmastatus3Spec> {
        ChannActW::new(self, 1)
    }
    #[doc = "Bit 4 - End of Channel Transfer Status"]
    #[inline(always)]
    #[must_use]
    pub fn end_tr_st(&mut self) -> EndTrStW<Hstdmastatus3Spec> {
        EndTrStW::new(self, 4)
    }
    #[doc = "Bit 5 - End of Channel Buffer Status"]
    #[inline(always)]
    #[must_use]
    pub fn end_bf_st(&mut self) -> EndBfStW<Hstdmastatus3Spec> {
        EndBfStW::new(self, 5)
    }
    #[doc = "Bit 6 - Descriptor Loaded Status"]
    #[inline(always)]
    #[must_use]
    pub fn desc_ldst(&mut self) -> DescLdstW<Hstdmastatus3Spec> {
        DescLdstW::new(self, 6)
    }
    #[doc = "Bits 16:31 - Buffer Byte Count"]
    #[inline(always)]
    #[must_use]
    pub fn buff_count(&mut self) -> BuffCountW<Hstdmastatus3Spec> {
...
pub struct Hstdmastatus3Spec;
impl crate::RegisterSpec for Hstdmastatus3Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`hstdmastatus3::R`](R) reader structure"]
impl crate::Readable for Hstdmastatus3Spec {}
#[doc = "`write(|w| ..)` method takes [`hstdmastatus3::W`](W) writer structure"]
impl crate::Writable for Hstdmastatus3Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets HSTDMASTATUS3 to value 0"]
impl crate::Resettable for Hstdmastatus3Spec {
