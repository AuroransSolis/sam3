#[doc = "Register `HSTDMASTATUS3` reader"]
pub struct R(crate::R<HSTDMASTATUS3_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<HSTDMASTATUS3_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<HSTDMASTATUS3_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<HSTDMASTATUS3_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `HSTDMASTATUS3` writer"]
pub struct W(crate::W<HSTDMASTATUS3_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<HSTDMASTATUS3_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<HSTDMASTATUS3_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<HSTDMASTATUS3_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type CHANN_ENB_W<'a, const O: u8> = crate::BitWriter<'a, u32, HSTDMASTATUS3_SPEC, bool, O>;
...
pub type CHANN_ACT_W<'a, const O: u8> = crate::BitWriter<'a, u32, HSTDMASTATUS3_SPEC, bool, O>;
...
pub type END_TR_ST_W<'a, const O: u8> = crate::BitWriter<'a, u32, HSTDMASTATUS3_SPEC, bool, O>;
...
pub type END_BF_ST_W<'a, const O: u8> = crate::BitWriter<'a, u32, HSTDMASTATUS3_SPEC, bool, O>;
...
pub type DESC_LDST_W<'a, const O: u8> = crate::BitWriter<'a, u32, HSTDMASTATUS3_SPEC, bool, O>;
...
pub type BUFF_COUNT_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, HSTDMASTATUS3_SPEC, u16, u16, 16, O>;
impl R {
...
#[doc = "Host DMA Channel Status Register (n = 3)\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [hstdmastatus3](index.html) module"]
pub struct HSTDMASTATUS3_SPEC;
impl crate::RegisterSpec for HSTDMASTATUS3_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [hstdmastatus3::R](R) reader structure"]
impl crate::Readable for HSTDMASTATUS3_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [hstdmastatus3::W](W) writer structure"]
impl crate::Writable for HSTDMASTATUS3_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets HSTDMASTATUS3 to value 0"]
impl crate::Resettable for HSTDMASTATUS3_SPEC {
    #[inline(always)]
