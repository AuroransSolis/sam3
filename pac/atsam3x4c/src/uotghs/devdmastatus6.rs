...
pub type R = crate::R<Devdmastatus6Spec>;
#[doc = "Register `DEVDMASTATUS6` writer"]
pub type W = crate::W<Devdmastatus6Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn chann_enb(&mut self) -> ChannEnbW<Devdmastatus6Spec> {
        ChannEnbW::new(self, 0)
    }
    #[doc = "Bit 1 - Channel Active Status"]
    #[inline(always)]
    #[must_use]
    pub fn chann_act(&mut self) -> ChannActW<Devdmastatus6Spec> {
        ChannActW::new(self, 1)
    }
    #[doc = "Bit 4 - End of Channel Transfer Status"]
    #[inline(always)]
    #[must_use]
    pub fn end_tr_st(&mut self) -> EndTrStW<Devdmastatus6Spec> {
        EndTrStW::new(self, 4)
    }
    #[doc = "Bit 5 - End of Channel Buffer Status"]
    #[inline(always)]
    #[must_use]
    pub fn end_bf_st(&mut self) -> EndBfStW<Devdmastatus6Spec> {
        EndBfStW::new(self, 5)
    }
    #[doc = "Bit 6 - Descriptor Loaded Status"]
    #[inline(always)]
    #[must_use]
    pub fn desc_ldst(&mut self) -> DescLdstW<Devdmastatus6Spec> {
        DescLdstW::new(self, 6)
    }
    #[doc = "Bits 16:31 - Buffer Byte Count"]
    #[inline(always)]
    #[must_use]
    pub fn buff_count(&mut self) -> BuffCountW<Devdmastatus6Spec> {
        BuffCountW::new(self, 16)
    }
}
#[doc = "Device DMA Channel Status Register (n = 6)\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`devdmastatus6::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`devdmastatus6::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Devdmastatus6Spec;
impl crate::RegisterSpec for Devdmastatus6Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`devdmastatus6::R`](R) reader structure"]
impl crate::Readable for Devdmastatus6Spec {}
#[doc = "`write(|w| ..)` method takes [`devdmastatus6::W`](W) writer structure"]
impl crate::Writable for Devdmastatus6Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DEVDMASTATUS6 to value 0"]
impl crate::Resettable for Devdmastatus6Spec {
