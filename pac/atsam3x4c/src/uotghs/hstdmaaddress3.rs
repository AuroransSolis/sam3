...
pub struct R(crate::R<HSTDMAADDRESS3_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<HSTDMAADDRESS3_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<HSTDMAADDRESS3_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<HSTDMAADDRESS3_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `HSTDMAADDRESS3` writer"]
pub struct W(crate::W<HSTDMAADDRESS3_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<HSTDMAADDRESS3_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<HSTDMAADDRESS3_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<HSTDMAADDRESS3_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type BUFF_ADD_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, HSTDMAADDRESS3_SPEC, u32, u32, 32, O>;
impl R {
