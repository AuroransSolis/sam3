#[doc = "Register `DEVEPTIMR9` reader"]
pub type R = crate::R<DEVEPTIMR9_SPEC>;
...
#[doc = "Device Endpoint Mask Register (n = 0) 9\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`deveptimr9::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DEVEPTIMR9_SPEC;
impl crate::RegisterSpec for DEVEPTIMR9_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`deveptimr9::R`](R) reader structure"]
impl crate::Readable for DEVEPTIMR9_SPEC {}
