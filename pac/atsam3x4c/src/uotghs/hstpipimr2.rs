#[doc = "Register `HSTPIPIMR2` reader"]
pub type R = crate::R<HSTPIPIMR2_SPEC>;
...
#[doc = "Host Pipe Mask Register (n = 0) 2\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`hstpipimr2::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct HSTPIPIMR2_SPEC;
impl crate::RegisterSpec for HSTPIPIMR2_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`hstpipimr2::R`](R) reader structure"]
impl crate::Readable for HSTPIPIMR2_SPEC {}
