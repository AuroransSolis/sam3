#[doc = "Register `DEVEPTISR7` reader"]
pub type R = crate::R<DEVEPTISR7_SPEC>;
...
#[doc = "Device Endpoint Status Register (n = 0) 7\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`deveptisr7::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DEVEPTISR7_SPEC;
impl crate::RegisterSpec for DEVEPTISR7_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`deveptisr7::R`](R) reader structure"]
impl crate::Readable for DEVEPTISR7_SPEC {}
