...
pub struct R(crate::R<DEVDMAADDRESS7_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<DEVDMAADDRESS7_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<DEVDMAADDRESS7_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<DEVDMAADDRESS7_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `DEVDMAADDRESS7` writer"]
pub struct W(crate::W<DEVDMAADDRESS7_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<DEVDMAADDRESS7_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<DEVDMAADDRESS7_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<DEVDMAADDRESS7_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type BUFF_ADD_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, DEVDMAADDRESS7_SPEC, u32, u32, 32, O>;
impl R {
