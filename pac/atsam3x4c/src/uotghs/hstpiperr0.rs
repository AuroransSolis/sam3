...
pub type R = crate::R<HSTPIPERR0_SPEC>;
#[doc = "Register `HSTPIPERR0` writer"]
pub type W = crate::W<HSTPIPERR0_SPEC>;
...
pub struct HSTPIPERR0_SPEC;
impl crate::RegisterSpec for HSTPIPERR0_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`hstpiperr0::R`](R) reader structure"]
impl crate::Readable for HSTPIPERR0_SPEC {}
#[doc = "`write(|w| ..)` method takes [`hstpiperr0::W`](W) writer structure"]
impl crate::Writable for HSTPIPERR0_SPEC {
