...
pub struct R(crate::R<HSTDMANXTDSC7_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<HSTDMANXTDSC7_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<HSTDMANXTDSC7_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<HSTDMANXTDSC7_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `HSTDMANXTDSC7` writer"]
pub struct W(crate::W<HSTDMANXTDSC7_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<HSTDMANXTDSC7_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<HSTDMANXTDSC7_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<HSTDMANXTDSC7_SPEC>) -> Self {
        W(writer)
    }
}
