...
pub type R = crate::R<Devdmastatus5Spec>;
#[doc = "Register `DEVDMASTATUS5` writer"]
pub type W = crate::W<Devdmastatus5Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn chann_enb(&mut self) -> ChannEnbW<Devdmastatus5Spec> {
        ChannEnbW::new(self, 0)
    }
    #[doc = "Bit 1 - Channel Active Status"]
    #[inline(always)]
    #[must_use]
    pub fn chann_act(&mut self) -> ChannActW<Devdmastatus5Spec> {
        ChannActW::new(self, 1)
    }
    #[doc = "Bit 4 - End of Channel Transfer Status"]
    #[inline(always)]
    #[must_use]
    pub fn end_tr_st(&mut self) -> EndTrStW<Devdmastatus5Spec> {
        EndTrStW::new(self, 4)
    }
    #[doc = "Bit 5 - End of Channel Buffer Status"]
    #[inline(always)]
    #[must_use]
    pub fn end_bf_st(&mut self) -> EndBfStW<Devdmastatus5Spec> {
        EndBfStW::new(self, 5)
    }
    #[doc = "Bit 6 - Descriptor Loaded Status"]
    #[inline(always)]
    #[must_use]
    pub fn desc_ldst(&mut self) -> DescLdstW<Devdmastatus5Spec> {
        DescLdstW::new(self, 6)
    }
    #[doc = "Bits 16:31 - Buffer Byte Count"]
    #[inline(always)]
    #[must_use]
    pub fn buff_count(&mut self) -> BuffCountW<Devdmastatus5Spec> {
...
pub struct Devdmastatus5Spec;
impl crate::RegisterSpec for Devdmastatus5Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`devdmastatus5::R`](R) reader structure"]
impl crate::Readable for Devdmastatus5Spec {}
#[doc = "`write(|w| ..)` method takes [`devdmastatus5::W`](W) writer structure"]
impl crate::Writable for Devdmastatus5Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DEVDMASTATUS5 to value 0"]
impl crate::Resettable for Devdmastatus5Spec {
