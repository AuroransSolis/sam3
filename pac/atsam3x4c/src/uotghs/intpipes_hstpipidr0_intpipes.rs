...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn rxinec(&mut self) -> RXINEC_W<INTPIPES_HSTPIPIDR0_INTPIPES_SPEC> {
        RXINEC_W::new(self, 0)
    }
    #[doc = "Bit 1 - Transmitted OUT Data Interrupt Disable"]
    #[inline(always)]
    #[must_use]
    pub fn txoutec(&mut self) -> TXOUTEC_W<INTPIPES_HSTPIPIDR0_INTPIPES_SPEC> {
        TXOUTEC_W::new(self, 1)
    }
    #[doc = "Bit 2 - Underflow Interrupt Disable"]
    #[inline(always)]
    #[must_use]
    pub fn underfiec(&mut self) -> UNDERFIEC_W<INTPIPES_HSTPIPIDR0_INTPIPES_SPEC> {
        UNDERFIEC_W::new(self, 2)
    }
    #[doc = "Bit 3 - Pipe Error Interrupt Disable"]
    #[inline(always)]
    #[must_use]
    pub fn perrec(&mut self) -> PERREC_W<INTPIPES_HSTPIPIDR0_INTPIPES_SPEC> {
        PERREC_W::new(self, 3)
    }
    #[doc = "Bit 4 - NAKed Interrupt Disable"]
    #[inline(always)]
    #[must_use]
    pub fn nakedec(&mut self) -> NAKEDEC_W<INTPIPES_HSTPIPIDR0_INTPIPES_SPEC> {
        NAKEDEC_W::new(self, 4)
    }
    #[doc = "Bit 5 - Overflow Interrupt Disable"]
    #[inline(always)]
    #[must_use]
    pub fn overfiec(&mut self) -> OVERFIEC_W<INTPIPES_HSTPIPIDR0_INTPIPES_SPEC> {
        OVERFIEC_W::new(self, 5)
    }
    #[doc = "Bit 6 - Received STALLed Interrupt Disable"]
    #[inline(always)]
    #[must_use]
    pub fn rxstalldec(&mut self) -> RXSTALLDEC_W<INTPIPES_HSTPIPIDR0_INTPIPES_SPEC> {
        RXSTALLDEC_W::new(self, 6)
    }
    #[doc = "Bit 7 - Short Packet Interrupt Disable"]
    #[inline(always)]
    #[must_use]
    pub fn shortpacketiec(&mut self) -> SHORTPACKETIEC_W<INTPIPES_HSTPIPIDR0_INTPIPES_SPEC> {
        SHORTPACKETIEC_W::new(self, 7)
    }
    #[doc = "Bit 12 - Number of Busy Banks Disable"]
    #[inline(always)]
    #[must_use]
    pub fn nbusybkec(&mut self) -> NBUSYBKEC_W<INTPIPES_HSTPIPIDR0_INTPIPES_SPEC> {
        NBUSYBKEC_W::new(self, 12)
    }
    #[doc = "Bit 14 - FIFO Control Disable"]
    #[inline(always)]
    #[must_use]
    pub fn fifoconc(&mut self) -> FIFOCONC_W<INTPIPES_HSTPIPIDR0_INTPIPES_SPEC> {
        FIFOCONC_W::new(self, 14)
    }
    #[doc = "Bit 16 - Pipe Interrupts Disable HDMA Request Disable"]
    #[inline(always)]
    #[must_use]
    pub fn pdishdmac(&mut self) -> PDISHDMAC_W<INTPIPES_HSTPIPIDR0_INTPIPES_SPEC> {
        PDISHDMAC_W::new(self, 16)
    }
    #[doc = "Bit 17 - Pipe Freeze Disable"]
    #[inline(always)]
    #[must_use]
    pub fn pfreezec(&mut self) -> PFREEZEC_W<INTPIPES_HSTPIPIDR0_INTPIPES_SPEC> {
