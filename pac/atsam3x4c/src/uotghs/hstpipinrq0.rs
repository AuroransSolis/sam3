...
pub type R = crate::R<Hstpipinrq0Spec>;
#[doc = "Register `HSTPIPINRQ0` writer"]
pub type W = crate::W<Hstpipinrq0Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn inrq(&mut self) -> InrqW<Hstpipinrq0Spec> {
        InrqW::new(self, 0)
    }
    #[doc = "Bit 8 - IN Request Mode"]
    #[inline(always)]
    #[must_use]
    pub fn inmode(&mut self) -> InmodeW<Hstpipinrq0Spec> {
        InmodeW::new(self, 8)
    }
}
#[doc = "Host Pipe IN Request Register (n = 0) 0\n\nYou can [`read`](crate::Reg::read) this register and get [`hstpipinrq0::R`](R). You can [`write_with_zero`](crate::Reg::write_with_zero) this register using [`hstpipinrq0::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Hstpipinrq0Spec;
impl crate::RegisterSpec for Hstpipinrq0Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`hstpipinrq0::R`](R) reader structure"]
impl crate::Readable for Hstpipinrq0Spec {}
#[doc = "`write(|w| ..)` method takes [`hstpipinrq0::W`](W) writer structure"]
impl crate::Writable for Hstpipinrq0Spec {
