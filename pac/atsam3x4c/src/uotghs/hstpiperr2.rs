...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn datatgl(&mut self) -> DATATGL_W<HSTPIPERR2_SPEC> {
        DATATGL_W::new(self, 0)
    }
    #[doc = "Bit 1 - Data PID Error"]
    #[inline(always)]
    #[must_use]
    pub fn datapid(&mut self) -> DATAPID_W<HSTPIPERR2_SPEC> {
        DATAPID_W::new(self, 1)
    }
    #[doc = "Bit 2 - PID Error"]
    #[inline(always)]
    #[must_use]
    pub fn pid(&mut self) -> PID_W<HSTPIPERR2_SPEC> {
        PID_W::new(self, 2)
    }
    #[doc = "Bit 3 - Time-Out Error"]
    #[inline(always)]
    #[must_use]
    pub fn timeout(&mut self) -> TIMEOUT_W<HSTPIPERR2_SPEC> {
        TIMEOUT_W::new(self, 3)
    }
    #[doc = "Bit 4 - CRC16 Error"]
    #[inline(always)]
    #[must_use]
    pub fn crc16(&mut self) -> CRC16_W<HSTPIPERR2_SPEC> {
        CRC16_W::new(self, 4)
    }
    #[doc = "Bits 5:6 - Error Counter"]
    #[inline(always)]
    #[must_use]
    pub fn counter(&mut self) -> COUNTER_W<HSTPIPERR2_SPEC> {
