...
pub type R = crate::R<Hstdmanxtdsc5Spec>;
#[doc = "Register `HSTDMANXTDSC5` writer"]
pub type W = crate::W<Hstdmanxtdsc5Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn nxt_dsc_add(&mut self) -> NxtDscAddW<Hstdmanxtdsc5Spec> {
        NxtDscAddW::new(self, 0)
    }
}
#[doc = "Host DMA Channel Next Descriptor Address Register (n = 5)\n\nYou can [`read`](crate::Reg::read) this register and get [`hstdmanxtdsc5::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`hstdmanxtdsc5::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Hstdmanxtdsc5Spec;
impl crate::RegisterSpec for Hstdmanxtdsc5Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`hstdmanxtdsc5::R`](R) reader structure"]
impl crate::Readable for Hstdmanxtdsc5Spec {}
#[doc = "`write(|w| ..)` method takes [`hstdmanxtdsc5::W`](W) writer structure"]
impl crate::Writable for Hstdmanxtdsc5Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets HSTDMANXTDSC5 to value 0"]
impl crate::Resettable for Hstdmanxtdsc5Spec {
