...
pub type R = crate::R<MID5_SPEC>;
#[doc = "Register `MID5` writer"]
pub type W = crate::W<MID5_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn midv_b(&mut self) -> MIDV_B_W<MID5_SPEC, 0> {
        MIDV_B_W::new(self)
    }
    #[doc = "Bits 18:28 - Identifier for standard frame mode"]
    #[inline(always)]
    #[must_use]
    pub fn midv_a(&mut self) -> MIDV_A_W<MID5_SPEC, 18> {
        MIDV_A_W::new(self)
    }
    #[doc = "Bit 29 - Identifier Version"]
    #[inline(always)]
    #[must_use]
    pub fn mide(&mut self) -> MIDE_W<MID5_SPEC, 29> {
        MIDE_W::new(self)
    }
