...
pub type R = crate::R<Mmr4Spec>;
#[doc = "Register `MMR4` writer"]
pub type W = crate::W<Mmr4Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn mtimemark(&mut self) -> MtimemarkW<Mmr4Spec> {
        MtimemarkW::new(self, 0)
    }
    #[doc = "Bits 16:19 - Mailbox Priority"]
    #[inline(always)]
    #[must_use]
    pub fn prior(&mut self) -> PriorW<Mmr4Spec> {
        PriorW::new(self, 16)
    }
    #[doc = "Bits 24:26 - Mailbox Object Type"]
    #[inline(always)]
    #[must_use]
    pub fn mot(&mut self) -> MotW<Mmr4Spec> {
        MotW::new(self, 24)
    }
}
#[doc = "Mailbox Mode Register (MB = 4)\n\nYou can [`read`](crate::Reg::read) this register and get [`mmr4::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`mmr4::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Mmr4Spec;
impl crate::RegisterSpec for Mmr4Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`mmr4::R`](R) reader structure"]
impl crate::Readable for Mmr4Spec {}
#[doc = "`write(|w| ..)` method takes [`mmr4::W`](W) writer structure"]
impl crate::Writable for Mmr4Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets MMR4 to value 0"]
impl crate::Resettable for Mmr4Spec {
