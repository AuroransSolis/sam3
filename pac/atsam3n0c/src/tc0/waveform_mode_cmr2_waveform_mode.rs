...
impl core::ops::Deref for R {
    type Target = crate::R<WAVEFORM_MODE_CMR2_WAVEFORM_MODE_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<WAVEFORM_MODE_CMR2_WAVEFORM_MODE_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<WAVEFORM_MODE_CMR2_WAVEFORM_MODE_SPEC>) -> Self {
        R(reader)
    }
}
...
impl core::ops::Deref for W {
    type Target = crate::W<WAVEFORM_MODE_CMR2_WAVEFORM_MODE_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<WAVEFORM_MODE_CMR2_WAVEFORM_MODE_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<WAVEFORM_MODE_CMR2_WAVEFORM_MODE_SPEC>) -> Self {
        W(writer)
    }
}
#[doc = "Clock Selection\n\nValue on reset: 0"]
