...
pub type R = crate::R<Cmr0Spec>;
#[doc = "Register `CMR0` writer"]
pub type W = crate::W<Cmr0Spec>;
#[doc = "Clock Selection\n\nValue on reset: 0"]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn tcclks(&mut self) -> TcclksW<Cmr0Spec> {
        TcclksW::new(self, 0)
    }
    #[doc = "Bit 3 - Clock Invert"]
    #[inline(always)]
    #[must_use]
    pub fn clki(&mut self) -> ClkiW<Cmr0Spec> {
        ClkiW::new(self, 3)
    }
    #[doc = "Bits 4:5 - Burst Signal Selection"]
    #[inline(always)]
    #[must_use]
    pub fn burst(&mut self) -> BurstW<Cmr0Spec> {
        BurstW::new(self, 4)
    }
    #[doc = "Bit 6 - Counter Clock Stopped with RB Loading"]
    #[inline(always)]
    #[must_use]
    pub fn ldbstop(&mut self) -> LdbstopW<Cmr0Spec> {
        LdbstopW::new(self, 6)
    }
    #[doc = "Bit 7 - Counter Clock Disable with RB Loading"]
    #[inline(always)]
    #[must_use]
    pub fn ldbdis(&mut self) -> LdbdisW<Cmr0Spec> {
        LdbdisW::new(self, 7)
    }
    #[doc = "Bits 8:9 - External Trigger Edge Selection"]
    #[inline(always)]
    #[must_use]
    pub fn etrgedg(&mut self) -> EtrgedgW<Cmr0Spec> {
        EtrgedgW::new(self, 8)
    }
    #[doc = "Bit 10 - TIOA or TIOB External Trigger Selection"]
    #[inline(always)]
    #[must_use]
    pub fn abetrg(&mut self) -> AbetrgW<Cmr0Spec> {
        AbetrgW::new(self, 10)
    }
    #[doc = "Bit 14 - RC Compare Trigger Enable"]
    #[inline(always)]
    #[must_use]
    pub fn cpctrg(&mut self) -> CpctrgW<Cmr0Spec> {
        CpctrgW::new(self, 14)
    }
    #[doc = "Bit 15 - Waveform Mode"]
    #[inline(always)]
    #[must_use]
    pub fn wave(&mut self) -> WaveW<Cmr0Spec> {
        WaveW::new(self, 15)
    }
    #[doc = "Bits 16:17 - RA Loading Edge Selection"]
    #[inline(always)]
    #[must_use]
    pub fn ldra(&mut self) -> LdraW<Cmr0Spec> {
        LdraW::new(self, 16)
    }
    #[doc = "Bits 18:19 - RB Loading Edge Selection"]
    #[inline(always)]
    #[must_use]
    pub fn ldrb(&mut self) -> LdrbW<Cmr0Spec> {
        LdrbW::new(self, 18)
    }
}
#[doc = "Channel Mode Register (channel = 0)\n\nYou can [`read`](crate::Reg::read) this register and get [`cmr0::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`cmr0::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Cmr0Spec;
impl crate::RegisterSpec for Cmr0Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`cmr0::R`](R) reader structure"]
impl crate::Readable for Cmr0Spec {}
#[doc = "`write(|w| ..)` method takes [`cmr0::W`](W) writer structure"]
impl crate::Writable for Cmr0Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets CMR0 to value 0"]
impl crate::Resettable for Cmr0Spec {
