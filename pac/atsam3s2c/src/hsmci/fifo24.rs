...
pub type R = crate::R<FIFO24_SPEC>;
#[doc = "Register `FIFO24` writer"]
pub type W = crate::W<FIFO24_SPEC>;
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        write!(f, "{}", self.bits())
    }
}
impl core::fmt::Debug for crate::generic::Reg<FIFO24_SPEC> {
...
pub struct FIFO24_SPEC;
impl crate::RegisterSpec for FIFO24_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`fifo24::R`](R) reader structure"]
impl crate::Readable for FIFO24_SPEC {}
#[doc = "`write(|w| ..)` method takes [`fifo24::W`](W) writer structure"]
impl crate::Writable for FIFO24_SPEC {
