...
pub type R = crate::R<FIFO86_SPEC>;
#[doc = "Register `FIFO86` writer"]
pub type W = crate::W<FIFO86_SPEC>;
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        write!(f, "{}", self.bits())
    }
}
impl core::fmt::Debug for crate::generic::Reg<FIFO86_SPEC> {
...
pub struct FIFO86_SPEC;
impl crate::RegisterSpec for FIFO86_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`fifo86::R`](R) reader structure"]
impl crate::Readable for FIFO86_SPEC {}
#[doc = "`write(|w| ..)` method takes [`fifo86::W`](W) writer structure"]
impl crate::Writable for FIFO86_SPEC {
