...
pub type R = crate::R<FIFO26_SPEC>;
#[doc = "Register `FIFO26` writer"]
pub type W = crate::W<FIFO26_SPEC>;
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        write!(f, "{}", self.bits())
    }
}
impl core::fmt::Debug for crate::generic::Reg<FIFO26_SPEC> {
...
pub struct FIFO26_SPEC;
impl crate::RegisterSpec for FIFO26_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`fifo26::R`](R) reader structure"]
impl crate::Readable for FIFO26_SPEC {}
#[doc = "`write(|w| ..)` method takes [`fifo26::W`](W) writer structure"]
impl crate::Writable for FIFO26_SPEC {
