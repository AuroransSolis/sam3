...
pub type R = crate::R<FIFO97_SPEC>;
#[doc = "Register `FIFO97` writer"]
pub type W = crate::W<FIFO97_SPEC>;
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        write!(f, "{}", self.bits())
    }
}
impl core::fmt::Debug for crate::generic::Reg<FIFO97_SPEC> {
...
pub struct FIFO97_SPEC;
impl crate::RegisterSpec for FIFO97_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`fifo97::R`](R) reader structure"]
impl crate::Readable for FIFO97_SPEC {}
#[doc = "`write(|w| ..)` method takes [`fifo97::W`](W) writer structure"]
impl crate::Writable for FIFO97_SPEC {
