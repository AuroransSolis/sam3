...
pub type R = crate::R<FIFO141_SPEC>;
#[doc = "Register `FIFO141` writer"]
pub type W = crate::W<FIFO141_SPEC>;
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        write!(f, "{}", self.bits())
    }
}
impl core::fmt::Debug for crate::generic::Reg<FIFO141_SPEC> {
...
pub struct FIFO141_SPEC;
impl crate::RegisterSpec for FIFO141_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`fifo141::R`](R) reader structure"]
impl crate::Readable for FIFO141_SPEC {}
#[doc = "`write(|w| ..)` method takes [`fifo141::W`](W) writer structure"]
impl crate::Writable for FIFO141_SPEC {
