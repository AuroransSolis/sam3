...
pub type R = crate::R<FIFO130_SPEC>;
#[doc = "Register `FIFO130` writer"]
pub type W = crate::W<FIFO130_SPEC>;
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        write!(f, "{}", self.bits())
    }
}
impl core::fmt::Debug for crate::generic::Reg<FIFO130_SPEC> {
...
pub struct FIFO130_SPEC;
impl crate::RegisterSpec for FIFO130_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`fifo130::R`](R) reader structure"]
impl crate::Readable for FIFO130_SPEC {}
#[doc = "`write(|w| ..)` method takes [`fifo130::W`](W) writer structure"]
impl crate::Writable for FIFO130_SPEC {
