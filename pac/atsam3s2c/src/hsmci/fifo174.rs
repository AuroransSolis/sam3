...
pub type R = crate::R<FIFO174_SPEC>;
#[doc = "Register `FIFO174` writer"]
pub type W = crate::W<FIFO174_SPEC>;
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        write!(f, "{}", self.bits())
    }
}
impl core::fmt::Debug for crate::generic::Reg<FIFO174_SPEC> {
...
pub struct FIFO174_SPEC;
impl crate::RegisterSpec for FIFO174_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`fifo174::R`](R) reader structure"]
impl crate::Readable for FIFO174_SPEC {}
#[doc = "`write(|w| ..)` method takes [`fifo174::W`](W) writer structure"]
impl crate::Writable for FIFO174_SPEC {
