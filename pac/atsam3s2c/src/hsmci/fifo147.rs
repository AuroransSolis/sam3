...
pub type R = crate::R<FIFO147_SPEC>;
#[doc = "Register `FIFO147` writer"]
pub type W = crate::W<FIFO147_SPEC>;
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        write!(f, "{}", self.bits())
    }
}
impl core::fmt::Debug for crate::generic::Reg<FIFO147_SPEC> {
...
pub struct FIFO147_SPEC;
impl crate::RegisterSpec for FIFO147_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`fifo147::R`](R) reader structure"]
impl crate::Readable for FIFO147_SPEC {}
#[doc = "`write(|w| ..)` method takes [`fifo147::W`](W) writer structure"]
impl crate::Writable for FIFO147_SPEC {
