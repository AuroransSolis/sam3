...
pub type R = crate::R<FIFO89_SPEC>;
#[doc = "Register `FIFO89` writer"]
pub type W = crate::W<FIFO89_SPEC>;
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        write!(f, "{}", self.bits())
    }
}
impl core::fmt::Debug for crate::generic::Reg<FIFO89_SPEC> {
...
pub struct FIFO89_SPEC;
impl crate::RegisterSpec for FIFO89_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`fifo89::R`](R) reader structure"]
impl crate::Readable for FIFO89_SPEC {}
#[doc = "`write(|w| ..)` method takes [`fifo89::W`](W) writer structure"]
impl crate::Writable for FIFO89_SPEC {
