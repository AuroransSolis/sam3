...
pub type R = crate::R<FIFO22_SPEC>;
#[doc = "Register `FIFO22` writer"]
pub type W = crate::W<FIFO22_SPEC>;
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        write!(f, "{}", self.bits())
    }
}
impl core::fmt::Debug for crate::generic::Reg<FIFO22_SPEC> {
...
pub struct FIFO22_SPEC;
impl crate::RegisterSpec for FIFO22_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`fifo22::R`](R) reader structure"]
impl crate::Readable for FIFO22_SPEC {}
#[doc = "`write(|w| ..)` method takes [`fifo22::W`](W) writer structure"]
impl crate::Writable for FIFO22_SPEC {
