...
pub type R = crate::R<FIFO238_SPEC>;
#[doc = "Register `FIFO238` writer"]
pub type W = crate::W<FIFO238_SPEC>;
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        write!(f, "{}", self.bits())
    }
}
impl core::fmt::Debug for crate::generic::Reg<FIFO238_SPEC> {
...
pub struct FIFO238_SPEC;
impl crate::RegisterSpec for FIFO238_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`fifo238::R`](R) reader structure"]
impl crate::Readable for FIFO238_SPEC {}
#[doc = "`write(|w| ..)` method takes [`fifo238::W`](W) writer structure"]
impl crate::Writable for FIFO238_SPEC {
