...
pub type R = crate::R<CYCLE2_SPEC>;
#[doc = "Register `CYCLE2` writer"]
pub type W = crate::W<CYCLE2_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn nwe_cycle(&mut self) -> NWE_CYCLE_W<CYCLE2_SPEC, 0> {
        NWE_CYCLE_W::new(self)
    }
    #[doc = "Bits 16:24 - Total Read Cycle Length"]
    #[inline(always)]
    #[must_use]
    pub fn nrd_cycle(&mut self) -> NRD_CYCLE_W<CYCLE2_SPEC, 16> {
