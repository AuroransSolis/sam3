...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn txcomp(&mut self) -> TxcompW<Csr1Spec> {
        TxcompW::new(self, 0)
    }
    #[doc = "Bit 1 - Receive Data Bank 0"]
    #[inline(always)]
    #[must_use]
    pub fn rx_data_bk0(&mut self) -> RxDataBk0W<Csr1Spec> {
        RxDataBk0W::new(self, 1)
    }
    #[doc = "Bit 2 - Received Setup"]
    #[inline(always)]
    #[must_use]
    pub fn rxsetup(&mut self) -> RxsetupW<Csr1Spec> {
        RxsetupW::new(self, 2)
    }
    #[doc = "Bit 3 - Stall Sent"]
    #[inline(always)]
    #[must_use]
    pub fn stallsent(&mut self) -> StallsentW<Csr1Spec> {
        StallsentW::new(self, 3)
    }
    #[doc = "Bit 4 - Transmit Packet Ready"]
    #[inline(always)]
    #[must_use]
    pub fn txpktrdy(&mut self) -> TxpktrdyW<Csr1Spec> {
        TxpktrdyW::new(self, 4)
    }
    #[doc = "Bit 5 - Force Stall (used by Control, Bulk and Isochronous Endpoints)"]
    #[inline(always)]
    #[must_use]
    pub fn forcestall(&mut self) -> ForcestallW<Csr1Spec> {
        ForcestallW::new(self, 5)
    }
    #[doc = "Bit 6 - Receive Data Bank 1 (only used by endpoints with ping-pong attributes)"]
    #[inline(always)]
    #[must_use]
    pub fn rx_data_bk1(&mut self) -> RxDataBk1W<Csr1Spec> {
        RxDataBk1W::new(self, 6)
    }
    #[doc = "Bit 7 - Transfer Direction (only available for control endpoints)"]
    #[inline(always)]
    #[must_use]
    pub fn dir(&mut self) -> DirW<Csr1Spec> {
        DirW::new(self, 7)
    }
    #[doc = "Bits 8:10 - Endpoint Type"]
    #[inline(always)]
    #[must_use]
    pub fn eptype(&mut self) -> EptypeW<Csr1Spec> {
        EptypeW::new(self, 8)
    }
    #[doc = "Bit 11 - Data Toggle"]
    #[inline(always)]
    #[must_use]
    pub fn dtgle(&mut self) -> DtgleW<Csr1Spec> {
        DtgleW::new(self, 11)
    }
    #[doc = "Bit 15 - Endpoint Enable Disable"]
    #[inline(always)]
    #[must_use]
    pub fn epeds(&mut self) -> EpedsW<Csr1Spec> {
        EpedsW::new(self, 15)
    }
    #[doc = "Bits 16:26 - Number of Bytes Available in the FIFO"]
    #[inline(always)]
    #[must_use]
    pub fn rxbytecnt(&mut self) -> RxbytecntW<Csr1Spec> {
