...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn clken(&mut self) -> ClkenW<Ccr1Spec> {
        ClkenW::new(self, 0)
    }
    #[doc = "Bit 1 - Counter Clock Disable Command"]
    #[inline(always)]
    #[must_use]
    pub fn clkdis(&mut self) -> ClkdisW<Ccr1Spec> {
        ClkdisW::new(self, 1)
    }
    #[doc = "Bit 2 - Software Trigger Command"]
    #[inline(always)]
    #[must_use]
    pub fn swtrg(&mut self) -> SwtrgW<Ccr1Spec> {
        SwtrgW::new(self, 2)
    }
}
#[doc = "Channel Control Register (channel = 1)\n\nYou can [`write_with_zero`](crate::Reg::write_with_zero) this register using [`ccr1::W`](W). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Ccr1Spec;
