...
pub type DIFF0_W<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type DIFF1_W<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type DIFF2_W<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type DIFF3_W<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type DIFF4_W<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type DIFF5_W<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type DIFF6_W<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type DIFF7_W<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type DIFF8_W<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type DIFF9_W<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type DIFF10_W<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type DIFF11_W<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type DIFF12_W<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type DIFF13_W<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type DIFF14_W<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type DIFF15_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn off0(&mut self) -> OFF0_W<COR_SPEC> {
        OFF0_W::new(self, 0)
    }
    #[doc = "Bit 1 - Offset for channel 1"]
    #[inline(always)]
    #[must_use]
    pub fn off1(&mut self) -> OFF1_W<COR_SPEC> {
        OFF1_W::new(self, 1)
    }
    #[doc = "Bit 2 - Offset for channel 2"]
    #[inline(always)]
    #[must_use]
    pub fn off2(&mut self) -> OFF2_W<COR_SPEC> {
        OFF2_W::new(self, 2)
    }
    #[doc = "Bit 3 - Offset for channel 3"]
    #[inline(always)]
    #[must_use]
    pub fn off3(&mut self) -> OFF3_W<COR_SPEC> {
        OFF3_W::new(self, 3)
    }
    #[doc = "Bit 4 - Offset for channel 4"]
    #[inline(always)]
    #[must_use]
    pub fn off4(&mut self) -> OFF4_W<COR_SPEC> {
        OFF4_W::new(self, 4)
    }
    #[doc = "Bit 5 - Offset for channel 5"]
    #[inline(always)]
    #[must_use]
    pub fn off5(&mut self) -> OFF5_W<COR_SPEC> {
        OFF5_W::new(self, 5)
    }
    #[doc = "Bit 6 - Offset for channel 6"]
    #[inline(always)]
    #[must_use]
    pub fn off6(&mut self) -> OFF6_W<COR_SPEC> {
        OFF6_W::new(self, 6)
    }
    #[doc = "Bit 7 - Offset for channel 7"]
    #[inline(always)]
    #[must_use]
    pub fn off7(&mut self) -> OFF7_W<COR_SPEC> {
        OFF7_W::new(self, 7)
    }
    #[doc = "Bit 8 - Offset for channel 8"]
    #[inline(always)]
    #[must_use]
    pub fn off8(&mut self) -> OFF8_W<COR_SPEC> {
        OFF8_W::new(self, 8)
    }
    #[doc = "Bit 9 - Offset for channel 9"]
    #[inline(always)]
    #[must_use]
    pub fn off9(&mut self) -> OFF9_W<COR_SPEC> {
        OFF9_W::new(self, 9)
    }
    #[doc = "Bit 10 - Offset for channel 10"]
    #[inline(always)]
    #[must_use]
    pub fn off10(&mut self) -> OFF10_W<COR_SPEC> {
        OFF10_W::new(self, 10)
    }
    #[doc = "Bit 11 - Offset for channel 11"]
    #[inline(always)]
    #[must_use]
    pub fn off11(&mut self) -> OFF11_W<COR_SPEC> {
        OFF11_W::new(self, 11)
    }
    #[doc = "Bit 12 - Offset for channel 12"]
    #[inline(always)]
    #[must_use]
    pub fn off12(&mut self) -> OFF12_W<COR_SPEC> {
        OFF12_W::new(self, 12)
    }
    #[doc = "Bit 13 - Offset for channel 13"]
    #[inline(always)]
    #[must_use]
    pub fn off13(&mut self) -> OFF13_W<COR_SPEC> {
        OFF13_W::new(self, 13)
    }
    #[doc = "Bit 14 - Offset for channel 14"]
    #[inline(always)]
    #[must_use]
    pub fn off14(&mut self) -> OFF14_W<COR_SPEC> {
        OFF14_W::new(self, 14)
    }
    #[doc = "Bit 15 - Offset for channel 15"]
    #[inline(always)]
    #[must_use]
    pub fn off15(&mut self) -> OFF15_W<COR_SPEC> {
        OFF15_W::new(self, 15)
    }
    #[doc = "Bit 16 - Differential inputs for channel 0"]
    #[inline(always)]
    #[must_use]
    pub fn diff0(&mut self) -> DIFF0_W<COR_SPEC> {
        DIFF0_W::new(self, 16)
    }
    #[doc = "Bit 17 - Differential inputs for channel 1"]
    #[inline(always)]
    #[must_use]
    pub fn diff1(&mut self) -> DIFF1_W<COR_SPEC> {
        DIFF1_W::new(self, 17)
    }
    #[doc = "Bit 18 - Differential inputs for channel 2"]
    #[inline(always)]
    #[must_use]
    pub fn diff2(&mut self) -> DIFF2_W<COR_SPEC> {
        DIFF2_W::new(self, 18)
    }
    #[doc = "Bit 19 - Differential inputs for channel 3"]
    #[inline(always)]
    #[must_use]
    pub fn diff3(&mut self) -> DIFF3_W<COR_SPEC> {
        DIFF3_W::new(self, 19)
    }
    #[doc = "Bit 20 - Differential inputs for channel 4"]
    #[inline(always)]
    #[must_use]
    pub fn diff4(&mut self) -> DIFF4_W<COR_SPEC> {
        DIFF4_W::new(self, 20)
    }
    #[doc = "Bit 21 - Differential inputs for channel 5"]
    #[inline(always)]
    #[must_use]
    pub fn diff5(&mut self) -> DIFF5_W<COR_SPEC> {
        DIFF5_W::new(self, 21)
    }
    #[doc = "Bit 22 - Differential inputs for channel 6"]
    #[inline(always)]
    #[must_use]
    pub fn diff6(&mut self) -> DIFF6_W<COR_SPEC> {
        DIFF6_W::new(self, 22)
    }
    #[doc = "Bit 23 - Differential inputs for channel 7"]
    #[inline(always)]
    #[must_use]
    pub fn diff7(&mut self) -> DIFF7_W<COR_SPEC> {
        DIFF7_W::new(self, 23)
    }
    #[doc = "Bit 24 - Differential inputs for channel 8"]
    #[inline(always)]
    #[must_use]
    pub fn diff8(&mut self) -> DIFF8_W<COR_SPEC> {
        DIFF8_W::new(self, 24)
    }
    #[doc = "Bit 25 - Differential inputs for channel 9"]
    #[inline(always)]
    #[must_use]
    pub fn diff9(&mut self) -> DIFF9_W<COR_SPEC> {
        DIFF9_W::new(self, 25)
    }
    #[doc = "Bit 26 - Differential inputs for channel 10"]
    #[inline(always)]
    #[must_use]
    pub fn diff10(&mut self) -> DIFF10_W<COR_SPEC> {
        DIFF10_W::new(self, 26)
    }
    #[doc = "Bit 27 - Differential inputs for channel 11"]
    #[inline(always)]
    #[must_use]
    pub fn diff11(&mut self) -> DIFF11_W<COR_SPEC> {
        DIFF11_W::new(self, 27)
    }
    #[doc = "Bit 28 - Differential inputs for channel 12"]
    #[inline(always)]
    #[must_use]
    pub fn diff12(&mut self) -> DIFF12_W<COR_SPEC> {
        DIFF12_W::new(self, 28)
    }
    #[doc = "Bit 29 - Differential inputs for channel 13"]
    #[inline(always)]
    #[must_use]
    pub fn diff13(&mut self) -> DIFF13_W<COR_SPEC> {
        DIFF13_W::new(self, 29)
    }
    #[doc = "Bit 30 - Differential inputs for channel 14"]
    #[inline(always)]
    #[must_use]
    pub fn diff14(&mut self) -> DIFF14_W<COR_SPEC> {
        DIFF14_W::new(self, 30)
    }
    #[doc = "Bit 31 - Differential inputs for channel 15"]
    #[inline(always)]
    #[must_use]
    pub fn diff15(&mut self) -> DIFF15_W<COR_SPEC> {
        DIFF15_W::new(self, 31)
    }
