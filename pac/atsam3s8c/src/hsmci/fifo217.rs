...
pub type R = crate::R<FIFO217_SPEC>;
#[doc = "Register `FIFO217` writer"]
pub type W = crate::W<FIFO217_SPEC>;
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        write!(f, "{}", self.bits())
    }
}
impl core::fmt::Debug for crate::generic::Reg<FIFO217_SPEC> {
...
pub struct FIFO217_SPEC;
impl crate::RegisterSpec for FIFO217_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`fifo217::R`](R) reader structure"]
impl crate::Readable for FIFO217_SPEC {}
#[doc = "`write(|w| ..)` method takes [`fifo217::W`](W) writer structure"]
impl crate::Writable for FIFO217_SPEC {
