...
pub type R = crate::R<FIFO87_SPEC>;
#[doc = "Register `FIFO87` writer"]
pub type W = crate::W<FIFO87_SPEC>;
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        write!(f, "{}", self.bits())
    }
}
impl core::fmt::Debug for crate::generic::Reg<FIFO87_SPEC> {
...
pub struct FIFO87_SPEC;
impl crate::RegisterSpec for FIFO87_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`fifo87::R`](R) reader structure"]
impl crate::Readable for FIFO87_SPEC {}
#[doc = "`write(|w| ..)` method takes [`fifo87::W`](W) writer structure"]
impl crate::Writable for FIFO87_SPEC {
