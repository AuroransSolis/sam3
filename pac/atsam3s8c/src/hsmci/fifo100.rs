...
pub type R = crate::R<FIFO100_SPEC>;
#[doc = "Register `FIFO100` writer"]
pub type W = crate::W<FIFO100_SPEC>;
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        write!(f, "{}", self.bits())
    }
}
impl core::fmt::Debug for crate::generic::Reg<FIFO100_SPEC> {
...
pub struct FIFO100_SPEC;
impl crate::RegisterSpec for FIFO100_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`fifo100::R`](R) reader structure"]
impl crate::Readable for FIFO100_SPEC {}
#[doc = "`write(|w| ..)` method takes [`fifo100::W`](W) writer structure"]
impl crate::Writable for FIFO100_SPEC {
