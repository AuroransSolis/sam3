...
pub type R = crate::R<FIFO187_SPEC>;
#[doc = "Register `FIFO187` writer"]
pub type W = crate::W<FIFO187_SPEC>;
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        write!(f, "{}", self.bits())
    }
}
impl core::fmt::Debug for crate::generic::Reg<FIFO187_SPEC> {
...
pub struct FIFO187_SPEC;
impl crate::RegisterSpec for FIFO187_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`fifo187::R`](R) reader structure"]
impl crate::Readable for FIFO187_SPEC {}
#[doc = "`write(|w| ..)` method takes [`fifo187::W`](W) writer structure"]
impl crate::Writable for FIFO187_SPEC {
