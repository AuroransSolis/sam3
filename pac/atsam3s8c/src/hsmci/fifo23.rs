...
pub type R = crate::R<FIFO23_SPEC>;
#[doc = "Register `FIFO23` writer"]
pub type W = crate::W<FIFO23_SPEC>;
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        write!(f, "{}", self.bits())
    }
}
impl core::fmt::Debug for crate::generic::Reg<FIFO23_SPEC> {
...
pub struct FIFO23_SPEC;
impl crate::RegisterSpec for FIFO23_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`fifo23::R`](R) reader structure"]
impl crate::Readable for FIFO23_SPEC {}
#[doc = "`write(|w| ..)` method takes [`fifo23::W`](W) writer structure"]
impl crate::Writable for FIFO23_SPEC {
