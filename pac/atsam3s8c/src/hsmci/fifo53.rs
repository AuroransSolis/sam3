...
pub type R = crate::R<FIFO53_SPEC>;
#[doc = "Register `FIFO53` writer"]
pub type W = crate::W<FIFO53_SPEC>;
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        write!(f, "{}", self.bits())
    }
}
impl core::fmt::Debug for crate::generic::Reg<FIFO53_SPEC> {
...
pub struct FIFO53_SPEC;
impl crate::RegisterSpec for FIFO53_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`fifo53::R`](R) reader structure"]
impl crate::Readable for FIFO53_SPEC {}
#[doc = "`write(|w| ..)` method takes [`fifo53::W`](W) writer structure"]
impl crate::Writable for FIFO53_SPEC {
