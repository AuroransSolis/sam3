...
pub type R = crate::R<FIFO120_SPEC>;
#[doc = "Register `FIFO120` writer"]
pub type W = crate::W<FIFO120_SPEC>;
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        write!(f, "{}", self.bits())
    }
}
impl core::fmt::Debug for crate::generic::Reg<FIFO120_SPEC> {
...
pub struct FIFO120_SPEC;
impl crate::RegisterSpec for FIFO120_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`fifo120::R`](R) reader structure"]
impl crate::Readable for FIFO120_SPEC {}
#[doc = "`write(|w| ..)` method takes [`fifo120::W`](W) writer structure"]
impl crate::Writable for FIFO120_SPEC {
