...
pub type R = crate::R<FIFO243_SPEC>;
#[doc = "Register `FIFO243` writer"]
pub type W = crate::W<FIFO243_SPEC>;
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        write!(f, "{}", self.bits())
    }
}
impl core::fmt::Debug for crate::generic::Reg<FIFO243_SPEC> {
...
pub struct FIFO243_SPEC;
impl crate::RegisterSpec for FIFO243_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`fifo243::R`](R) reader structure"]
impl crate::Readable for FIFO243_SPEC {}
#[doc = "`write(|w| ..)` method takes [`fifo243::W`](W) writer structure"]
impl crate::Writable for FIFO243_SPEC {
