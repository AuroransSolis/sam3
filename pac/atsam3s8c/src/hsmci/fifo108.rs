...
impl W {}
#[doc = "FIFO Memory Aperture0 108\n\nYou can [`read`](crate::Reg::read) this register and get [`fifo108::R`](R). You can [`write_with_zero`](crate::Reg::write_with_zero) this register using [`fifo108::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
