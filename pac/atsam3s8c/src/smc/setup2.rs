...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn nwe_setup(&mut self) -> NweSetupW<Setup2Spec> {
        NweSetupW::new(self, 0)
    }
    #[doc = "Bits 8:13 - NCS Setup Length in WRITE Access"]
    #[inline(always)]
    #[must_use]
    pub fn ncs_wr_setup(&mut self) -> NcsWrSetupW<Setup2Spec> {
        NcsWrSetupW::new(self, 8)
    }
    #[doc = "Bits 16:21 - NRD Setup Length"]
    #[inline(always)]
    #[must_use]
    pub fn nrd_setup(&mut self) -> NrdSetupW<Setup2Spec> {
        NrdSetupW::new(self, 16)
    }
    #[doc = "Bits 24:29 - NCS Setup Length in READ Access"]
    #[inline(always)]
    #[must_use]
    pub fn ncs_rd_setup(&mut self) -> NcsRdSetupW<Setup2Spec> {
        NcsRdSetupW::new(self, 24)
    }
}
#[doc = "SMC Setup Register (CS_number = 2)\n\nYou can [`read`](crate::Reg::read) this register and get [`setup2::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`setup2::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
...
impl crate::Writable for Setup2Spec {
