...
pub type R = crate::R<FDR3_SPEC>;
#[doc = "Register `FDR3` writer"]
pub type W = crate::W<FDR3_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn fifo_data(&mut self) -> FIFO_DATA_W<FDR3_SPEC, 0> {
...
pub struct FDR3_SPEC;
impl crate::RegisterSpec for FDR3_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`fdr3::R`](R) reader structure"]
impl crate::Readable for FDR3_SPEC {}
#[doc = "`write(|w| ..)` method takes [`fdr3::W`](W) writer structure"]
impl crate::Writable for FDR3_SPEC {
