#[doc = "Register `DEVEPTCFG3` reader"]
pub type R = crate::R<Deveptcfg3Spec>;
#[doc = "Register `DEVEPTCFG3` writer"]
pub type W = crate::W<Deveptcfg3Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn alloc(&mut self) -> AllocW<Deveptcfg3Spec> {
        AllocW::new(self, 1)
    }
    #[doc = "Bits 2:3 - Endpoint Banks"]
    #[inline(always)]
    #[must_use]
    pub fn epbk(&mut self) -> EpbkW<Deveptcfg3Spec> {
        EpbkW::new(self, 2)
    }
    #[doc = "Bits 4:6 - Endpoint Size"]
    #[inline(always)]
    #[must_use]
    pub fn epsize(&mut self) -> EpsizeW<Deveptcfg3Spec> {
        EpsizeW::new(self, 4)
    }
    #[doc = "Bit 8 - Endpoint Direction"]
    #[inline(always)]
    #[must_use]
    pub fn epdir(&mut self) -> EpdirW<Deveptcfg3Spec> {
        EpdirW::new(self, 8)
    }
    #[doc = "Bit 9 - Automatic Switch"]
    #[inline(always)]
    #[must_use]
    pub fn autosw(&mut self) -> AutoswW<Deveptcfg3Spec> {
        AutoswW::new(self, 9)
    }
    #[doc = "Bits 11:12 - Endpoint Type"]
    #[inline(always)]
    #[must_use]
    pub fn eptype(&mut self) -> EptypeW<Deveptcfg3Spec> {
        EptypeW::new(self, 11)
    }
    #[doc = "Bits 13:14 - Number of transaction per microframe for isochronous endpoint"]
    #[inline(always)]
    #[must_use]
    pub fn nbtrans(&mut self) -> NbtransW<Deveptcfg3Spec> {
        NbtransW::new(self, 13)
    }
}
#[doc = "Device Endpoint Configuration Register (n = 0) 3\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`deveptcfg3::R`](R).  You can [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`deveptcfg3::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Deveptcfg3Spec;
impl crate::RegisterSpec for Deveptcfg3Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`deveptcfg3::R`](R) reader structure"]
impl crate::Readable for Deveptcfg3Spec {}
#[doc = "`write(|w| ..)` method takes [`deveptcfg3::W`](W) writer structure"]
impl crate::Writable for Deveptcfg3Spec {
