...
pub type R = crate::R<HSTPIPISR7_SPEC>;
...
#[doc = "Host Pipe Status Register (n = 0) 7\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`hstpipisr7::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct HSTPIPISR7_SPEC;
impl crate::RegisterSpec for HSTPIPISR7_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`hstpipisr7::R`](R) reader structure"]
impl crate::Readable for HSTPIPISR7_SPEC {}
