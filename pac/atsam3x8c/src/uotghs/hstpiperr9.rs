...
pub type R = crate::R<Hstpiperr9Spec>;
#[doc = "Register `HSTPIPERR9` writer"]
pub type W = crate::W<Hstpiperr9Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn datatgl(&mut self) -> DatatglW<Hstpiperr9Spec> {
        DatatglW::new(self, 0)
    }
    #[doc = "Bit 1 - Data PID Error"]
    #[inline(always)]
    #[must_use]
    pub fn datapid(&mut self) -> DatapidW<Hstpiperr9Spec> {
        DatapidW::new(self, 1)
    }
    #[doc = "Bit 2 - PID Error"]
    #[inline(always)]
    #[must_use]
    pub fn pid(&mut self) -> PidW<Hstpiperr9Spec> {
        PidW::new(self, 2)
    }
    #[doc = "Bit 3 - Time-Out Error"]
    #[inline(always)]
    #[must_use]
    pub fn timeout(&mut self) -> TimeoutW<Hstpiperr9Spec> {
        TimeoutW::new(self, 3)
    }
    #[doc = "Bit 4 - CRC16 Error"]
    #[inline(always)]
    #[must_use]
    pub fn crc16(&mut self) -> Crc16W<Hstpiperr9Spec> {
        Crc16W::new(self, 4)
    }
    #[doc = "Bits 5:6 - Error Counter"]
    #[inline(always)]
    #[must_use]
    pub fn counter(&mut self) -> CounterW<Hstpiperr9Spec> {
        CounterW::new(self, 5)
    }
}
...
pub struct Hstpiperr9Spec;
impl crate::RegisterSpec for Hstpiperr9Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`hstpiperr9::R`](R) reader structure"]
impl crate::Readable for Hstpiperr9Spec {}
#[doc = "`write(|w| ..)` method takes [`hstpiperr9::W`](W) writer structure"]
impl crate::Writable for Hstpiperr9Spec {
