...
pub type R = crate::R<DEVEPTISR1_SPEC>;
...
#[doc = "Device Endpoint Status Register (n = 0) 1\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`deveptisr1::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DEVEPTISR1_SPEC;
impl crate::RegisterSpec for DEVEPTISR1_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`deveptisr1::R`](R) reader structure"]
impl crate::Readable for DEVEPTISR1_SPEC {}
