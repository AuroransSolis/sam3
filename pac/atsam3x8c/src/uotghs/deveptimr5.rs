#[doc = "Register `DEVEPTIMR5` reader"]
pub type R = crate::R<DEVEPTIMR5_SPEC>;
...
#[doc = "Device Endpoint Mask Register (n = 0) 5\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`deveptimr5::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DEVEPTIMR5_SPEC;
impl crate::RegisterSpec for DEVEPTIMR5_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`deveptimr5::R`](R) reader structure"]
impl crate::Readable for DEVEPTIMR5_SPEC {}
