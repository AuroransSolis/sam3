...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn rxinec(&mut self) -> RXINEC_W<ISOPIPES_HSTPIPIDR0_ISOPIPES_SPEC, 0> {
        RXINEC_W::new(self)
    }
    #[doc = "Bit 1 - Transmitted OUT Data Interrupt Disable"]
    #[inline(always)]
    #[must_use]
    pub fn txoutec(&mut self) -> TXOUTEC_W<ISOPIPES_HSTPIPIDR0_ISOPIPES_SPEC, 1> {
        TXOUTEC_W::new(self)
    }
    #[doc = "Bit 2 - Underflow Interrupt Disable"]
    #[inline(always)]
    #[must_use]
    pub fn underfiec(&mut self) -> UNDERFIEC_W<ISOPIPES_HSTPIPIDR0_ISOPIPES_SPEC, 2> {
        UNDERFIEC_W::new(self)
    }
    #[doc = "Bit 3 - Pipe Error Interrupt Disable"]
    #[inline(always)]
    #[must_use]
    pub fn perrec(&mut self) -> PERREC_W<ISOPIPES_HSTPIPIDR0_ISOPIPES_SPEC, 3> {
        PERREC_W::new(self)
    }
    #[doc = "Bit 4 - NAKed Interrupt Disable"]
    #[inline(always)]
    #[must_use]
    pub fn nakedec(&mut self) -> NAKEDEC_W<ISOPIPES_HSTPIPIDR0_ISOPIPES_SPEC, 4> {
        NAKEDEC_W::new(self)
    }
    #[doc = "Bit 5 - Overflow Interrupt Disable"]
    #[inline(always)]
    #[must_use]
    pub fn overfiec(&mut self) -> OVERFIEC_W<ISOPIPES_HSTPIPIDR0_ISOPIPES_SPEC, 5> {
        OVERFIEC_W::new(self)
    }
    #[doc = "Bit 6 - CRC Error Interrupt Disable"]
    #[inline(always)]
    #[must_use]
    pub fn crcerrec(&mut self) -> CRCERREC_W<ISOPIPES_HSTPIPIDR0_ISOPIPES_SPEC, 6> {
        CRCERREC_W::new(self)
    }
    #[doc = "Bit 7 - Short Packet Interrupt Disable"]
    #[inline(always)]
    #[must_use]
    pub fn shortpacketiec(&mut self) -> SHORTPACKETIEC_W<ISOPIPES_HSTPIPIDR0_ISOPIPES_SPEC, 7> {
        SHORTPACKETIEC_W::new(self)
    }
    #[doc = "Bit 12 - Number of Busy Banks Disable"]
    #[inline(always)]
    #[must_use]
    pub fn nbusybkec(&mut self) -> NBUSYBKEC_W<ISOPIPES_HSTPIPIDR0_ISOPIPES_SPEC, 12> {
        NBUSYBKEC_W::new(self)
    }
    #[doc = "Bit 14 - FIFO Control Disable"]
    #[inline(always)]
    #[must_use]
    pub fn fifoconc(&mut self) -> FIFOCONC_W<ISOPIPES_HSTPIPIDR0_ISOPIPES_SPEC, 14> {
        FIFOCONC_W::new(self)
    }
    #[doc = "Bit 16 - Pipe Interrupts Disable HDMA Request Disable"]
    #[inline(always)]
    #[must_use]
    pub fn pdishdmac(&mut self) -> PDISHDMAC_W<ISOPIPES_HSTPIPIDR0_ISOPIPES_SPEC, 16> {
        PDISHDMAC_W::new(self)
    }
    #[doc = "Bit 17 - Pipe Freeze Disable"]
    #[inline(always)]
    #[must_use]
    pub fn pfreezec(&mut self) -> PFREEZEC_W<ISOPIPES_HSTPIPIDR0_ISOPIPES_SPEC, 17> {
        PFREEZEC_W::new(self)
    }
