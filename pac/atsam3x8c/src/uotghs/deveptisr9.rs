#[doc = "Register `DEVEPTISR9` reader"]
pub type R = crate::R<DEVEPTISR9_SPEC>;
...
#[doc = "Device Endpoint Status Register (n = 0) 9\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`deveptisr9::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DEVEPTISR9_SPEC;
impl crate::RegisterSpec for DEVEPTISR9_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`deveptisr9::R`](R) reader structure"]
impl crate::Readable for DEVEPTISR9_SPEC {}
