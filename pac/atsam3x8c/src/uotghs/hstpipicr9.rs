...
pub type W = crate::W<Hstpipicr9Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn rxinic(&mut self) -> RxinicW<Hstpipicr9Spec> {
        RxinicW::new(self, 0)
    }
    #[doc = "Bit 1 - Transmitted OUT Data Interrupt Clear"]
    #[inline(always)]
    #[must_use]
    pub fn txoutic(&mut self) -> TxouticW<Hstpipicr9Spec> {
        TxouticW::new(self, 1)
    }
    #[doc = "Bit 2 - Transmitted SETUP Interrupt Clear"]
    #[inline(always)]
    #[must_use]
    pub fn txstpic(&mut self) -> TxstpicW<Hstpipicr9Spec> {
        TxstpicW::new(self, 2)
    }
    #[doc = "Bit 4 - NAKed Interrupt Clear"]
    #[inline(always)]
    #[must_use]
    pub fn nakedic(&mut self) -> NakedicW<Hstpipicr9Spec> {
        NakedicW::new(self, 4)
    }
    #[doc = "Bit 5 - Overflow Interrupt Clear"]
    #[inline(always)]
    #[must_use]
    pub fn overfic(&mut self) -> OverficW<Hstpipicr9Spec> {
        OverficW::new(self, 5)
    }
    #[doc = "Bit 6 - Received STALLed Interrupt Clear"]
    #[inline(always)]
    #[must_use]
    pub fn rxstalldic(&mut self) -> RxstalldicW<Hstpipicr9Spec> {
        RxstalldicW::new(self, 6)
    }
    #[doc = "Bit 7 - Short Packet Interrupt Clear"]
    #[inline(always)]
    #[must_use]
    pub fn shortpacketic(&mut self) -> ShortpacketicW<Hstpipicr9Spec> {
...
pub struct Hstpipicr9Spec;
impl crate::RegisterSpec for Hstpipicr9Spec {
    type Ux = u32;
}
#[doc = "`write(|w| ..)` method takes [`hstpipicr9::W`](W) writer structure"]
impl crate::Writable for Hstpipicr9Spec {
