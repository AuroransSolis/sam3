...
pub type R = crate::R<IntpipesHstpipisr0IntpipesSpec>;
...
pub struct IntpipesHstpipisr0IntpipesSpec;
impl crate::RegisterSpec for IntpipesHstpipisr0IntpipesSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`intpipes_hstpipisr0_intpipes::R`](R) reader structure"]
impl crate::Readable for IntpipesHstpipisr0IntpipesSpec {}
