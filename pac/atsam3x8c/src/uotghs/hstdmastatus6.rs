...
pub type R = crate::R<Hstdmastatus6Spec>;
#[doc = "Register `HSTDMASTATUS6` writer"]
pub type W = crate::W<Hstdmastatus6Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn chann_enb(&mut self) -> ChannEnbW<Hstdmastatus6Spec> {
        ChannEnbW::new(self, 0)
    }
    #[doc = "Bit 1 - Channel Active Status"]
    #[inline(always)]
    #[must_use]
    pub fn chann_act(&mut self) -> ChannActW<Hstdmastatus6Spec> {
        ChannActW::new(self, 1)
    }
    #[doc = "Bit 4 - End of Channel Transfer Status"]
    #[inline(always)]
    #[must_use]
    pub fn end_tr_st(&mut self) -> EndTrStW<Hstdmastatus6Spec> {
        EndTrStW::new(self, 4)
    }
    #[doc = "Bit 5 - End of Channel Buffer Status"]
    #[inline(always)]
    #[must_use]
    pub fn end_bf_st(&mut self) -> EndBfStW<Hstdmastatus6Spec> {
        EndBfStW::new(self, 5)
    }
    #[doc = "Bit 6 - Descriptor Loaded Status"]
    #[inline(always)]
    #[must_use]
    pub fn desc_ldst(&mut self) -> DescLdstW<Hstdmastatus6Spec> {
        DescLdstW::new(self, 6)
    }
    #[doc = "Bits 16:31 - Buffer Byte Count"]
    #[inline(always)]
    #[must_use]
    pub fn buff_count(&mut self) -> BuffCountW<Hstdmastatus6Spec> {
        BuffCountW::new(self, 16)
    }
}
#[doc = "Host DMA Channel Status Register (n = 6)\n\nYou can [`read`](crate::Reg::read) this register and get [`hstdmastatus6::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`hstdmastatus6::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Hstdmastatus6Spec;
impl crate::RegisterSpec for Hstdmastatus6Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`hstdmastatus6::R`](R) reader structure"]
impl crate::Readable for Hstdmastatus6Spec {}
#[doc = "`write(|w| ..)` method takes [`hstdmastatus6::W`](W) writer structure"]
impl crate::Writable for Hstdmastatus6Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets HSTDMASTATUS6 to value 0"]
impl crate::Resettable for Hstdmastatus6Spec {
