...
pub type R = crate::R<Devdmastatus1Spec>;
#[doc = "Register `DEVDMASTATUS1` writer"]
pub type W = crate::W<Devdmastatus1Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn chann_enb(&mut self) -> ChannEnbW<Devdmastatus1Spec> {
        ChannEnbW::new(self, 0)
    }
    #[doc = "Bit 1 - Channel Active Status"]
    #[inline(always)]
    #[must_use]
    pub fn chann_act(&mut self) -> ChannActW<Devdmastatus1Spec> {
        ChannActW::new(self, 1)
    }
    #[doc = "Bit 4 - End of Channel Transfer Status"]
    #[inline(always)]
    #[must_use]
    pub fn end_tr_st(&mut self) -> EndTrStW<Devdmastatus1Spec> {
        EndTrStW::new(self, 4)
    }
    #[doc = "Bit 5 - End of Channel Buffer Status"]
    #[inline(always)]
    #[must_use]
    pub fn end_bf_st(&mut self) -> EndBfStW<Devdmastatus1Spec> {
        EndBfStW::new(self, 5)
    }
    #[doc = "Bit 6 - Descriptor Loaded Status"]
    #[inline(always)]
    #[must_use]
    pub fn desc_ldst(&mut self) -> DescLdstW<Devdmastatus1Spec> {
        DescLdstW::new(self, 6)
    }
    #[doc = "Bits 16:31 - Buffer Byte Count"]
    #[inline(always)]
    #[must_use]
    pub fn buff_count(&mut self) -> BuffCountW<Devdmastatus1Spec> {
...
pub struct Devdmastatus1Spec;
impl crate::RegisterSpec for Devdmastatus1Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`devdmastatus1::R`](R) reader structure"]
impl crate::Readable for Devdmastatus1Spec {}
#[doc = "`write(|w| ..)` method takes [`devdmastatus1::W`](W) writer structure"]
impl crate::Writable for Devdmastatus1Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DEVDMASTATUS1 to value 0"]
impl crate::Resettable for Devdmastatus1Spec {
