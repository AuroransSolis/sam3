#[doc = "Register `DEVEPTIMR7` reader"]
pub type R = crate::R<DEVEPTIMR7_SPEC>;
...
#[doc = "Device Endpoint Mask Register (n = 0) 7\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`deveptimr7::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DEVEPTIMR7_SPEC;
impl crate::RegisterSpec for DEVEPTIMR7_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`deveptimr7::R`](R) reader structure"]
impl crate::Readable for DEVEPTIMR7_SPEC {}
