#[doc = "Register `HSTPIPIMR5` reader"]
pub type R = crate::R<HSTPIPIMR5_SPEC>;
...
#[doc = "Host Pipe Mask Register (n = 0) 5\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`hstpipimr5::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct HSTPIPIMR5_SPEC;
impl crate::RegisterSpec for HSTPIPIMR5_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`hstpipimr5::R`](R) reader structure"]
impl crate::Readable for HSTPIPIMR5_SPEC {}
