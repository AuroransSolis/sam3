#[doc = "Register `HSTPIPIMR8` reader"]
pub type R = crate::R<HSTPIPIMR8_SPEC>;
...
#[doc = "Host Pipe Mask Register (n = 0) 8\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`hstpipimr8::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct HSTPIPIMR8_SPEC;
impl crate::RegisterSpec for HSTPIPIMR8_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`hstpipimr8::R`](R) reader structure"]
impl crate::Readable for HSTPIPIMR8_SPEC {}
