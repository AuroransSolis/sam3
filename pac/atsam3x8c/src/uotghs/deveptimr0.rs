#[doc = "Register `DEVEPTIMR0` reader"]
pub type R = crate::R<DEVEPTIMR0_SPEC>;
...
pub struct DEVEPTIMR0_SPEC;
impl crate::RegisterSpec for DEVEPTIMR0_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`deveptimr0::R`](R) reader structure"]
impl crate::Readable for DEVEPTIMR0_SPEC {}
