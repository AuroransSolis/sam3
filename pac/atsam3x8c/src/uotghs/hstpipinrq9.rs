...
pub type R = crate::R<Hstpipinrq9Spec>;
#[doc = "Register `HSTPIPINRQ9` writer"]
pub type W = crate::W<Hstpipinrq9Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn inrq(&mut self) -> InrqW<Hstpipinrq9Spec> {
        InrqW::new(self, 0)
    }
    #[doc = "Bit 8 - IN Request Mode"]
    #[inline(always)]
    #[must_use]
    pub fn inmode(&mut self) -> InmodeW<Hstpipinrq9Spec> {
        InmodeW::new(self, 8)
    }
}
...
impl crate::Readable for Hstpipinrq9Spec {}
#[doc = "`write(|w| ..)` method takes [`hstpipinrq9::W`](W) writer structure"]
impl crate::Writable for Hstpipinrq9Spec {
