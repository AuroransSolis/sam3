#[doc = "Register `DEVEPTIMR1` reader"]
pub type R = crate::R<DEVEPTIMR1_SPEC>;
...
#[doc = "Device Endpoint Mask Register (n = 0) 1\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`deveptimr1::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DEVEPTIMR1_SPEC;
impl crate::RegisterSpec for DEVEPTIMR1_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`deveptimr1::R`](R) reader structure"]
impl crate::Readable for DEVEPTIMR1_SPEC {}
