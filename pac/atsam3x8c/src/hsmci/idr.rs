...
pub type SDIOIRQFOR_SLOT_A_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `SDIOIRQforSlotB` writer - "]
pub type SDIOIRQFOR_SLOT_B_W<'a, REG> = crate::BitWriter<'a, REG>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn sdioirqfor_slot_a(&mut self) -> SDIOIRQFOR_SLOT_A_W<IDR_SPEC> {
        SDIOIRQFOR_SLOT_A_W::new(self, 8)
    }
    #[doc = "Bit 9"]
    #[inline(always)]
    #[must_use]
    pub fn sdioirqfor_slot_b(&mut self) -> SDIOIRQFOR_SLOT_B_W<IDR_SPEC> {
        SDIOIRQFOR_SLOT_B_W::new(self, 9)
    }
    ...
    #[inline(always)]
    #[must_use]
    pub fn blkovre(&mut self) -> BLKOVRE_W<IDR_SPEC> {
        BLKOVRE_W::new(self, 24)
    }
    #[doc = "Bit 25 - DMA Transfer completed Interrupt Disable"]
    #[inline(always)]
    #[must_use]
    pub fn dmadone(&mut self) -> DMADONE_W<IDR_SPEC> {
