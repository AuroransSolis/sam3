...
pub type R = crate::R<MATRIX_MCFG5_SPEC>;
#[doc = "Register `MATRIX_MCFG5` writer"]
pub type W = crate::W<MATRIX_MCFG5_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn ulbt(&mut self) -> ULBT_W<MATRIX_MCFG5_SPEC, 0> {
        ULBT_W::new(self)
    }
...
pub struct MATRIX_MCFG5_SPEC;
impl crate::RegisterSpec for MATRIX_MCFG5_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`matrix_mcfg5::R`](R) reader structure"]
impl crate::Readable for MATRIX_MCFG5_SPEC {}
#[doc = "`write(|w| ..)` method takes [`matrix_mcfg5::W`](W) writer structure"]
impl crate::Writable for MATRIX_MCFG5_SPEC {
