...
pub type R = crate::R<CPRD4_SPEC>;
#[doc = "Register `CPRD4` writer"]
pub type W = crate::W<CPRD4_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn cprd(&mut self) -> CPRD_W<CPRD4_SPEC, 0> {
        CPRD_W::new(self)
    }
...
#[doc = "PWM Channel Period Register (ch_num = 4)\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`cprd4::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`cprd4::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
