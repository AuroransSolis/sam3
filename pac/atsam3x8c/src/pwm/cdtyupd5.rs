...
pub struct W(crate::W<CDTYUPD5_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<CDTYUPD5_SPEC>;
    #[inline(always)]
...
impl From<crate::W<CDTYUPD5_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<CDTYUPD5_SPEC>) -> Self {
        W(writer)
    }
}
#[doc = "Field `CDTYUPD` writer - Channel Duty-Cycle Update"]
pub type CDTYUPD_W<'a, const O: u8> = crate::FieldWriter<'a, u32, CDTYUPD5_SPEC, u32, u32, 24, O>;
impl W {
