#[doc = "Register `PMC_PCK0` reader"]
pub type R = crate::R<PmcPck0Spec>;
#[doc = "Register `PMC_PCK0` writer"]
pub type W = crate::W<PmcPck0Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn css(&mut self) -> CssW<PmcPck0Spec> {
        CssW::new(self, 0)
    }
    #[doc = "Bits 4:6 - Programmable Clock Prescaler"]
    #[inline(always)]
    #[must_use]
    pub fn pres(&mut self) -> PresW<PmcPck0Spec> {
        PresW::new(self, 4)
    }
}
#[doc = "Programmable Clock 0 Register 0\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`pmc_pck0::R`](R).  You can [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`pmc_pck0::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct PmcPck0Spec;
impl crate::RegisterSpec for PmcPck0Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`pmc_pck0::R`](R) reader structure"]
impl crate::Readable for PmcPck0Spec {}
#[doc = "`write(|w| ..)` method takes [`pmc_pck0::W`](W) writer structure"]
impl crate::Writable for PmcPck0Spec {
