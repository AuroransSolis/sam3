#[doc = "Register `PMC_PCK1` reader"]
pub type R = crate::R<PMC_PCK1_SPEC>;
#[doc = "Register `PMC_PCK1` writer"]
pub type W = crate::W<PMC_PCK1_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn css(&mut self) -> CSS_W<PMC_PCK1_SPEC, 0> {
        CSS_W::new(self)
    }
    #[doc = "Bits 4:6 - Programmable Clock Prescaler"]
    #[inline(always)]
    #[must_use]
    pub fn pres(&mut self) -> PRES_W<PMC_PCK1_SPEC, 4> {
        PRES_W::new(self)
    }
...
pub struct PMC_PCK1_SPEC;
impl crate::RegisterSpec for PMC_PCK1_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`pmc_pck1::R`](R) reader structure"]
impl crate::Readable for PMC_PCK1_SPEC {}
#[doc = "`write(|w| ..)` method takes [`pmc_pck1::W`](W) writer structure"]
impl crate::Writable for PMC_PCK1_SPEC {
