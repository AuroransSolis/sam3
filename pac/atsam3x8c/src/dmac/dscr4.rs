...
pub type R = crate::R<DSCR4_SPEC>;
#[doc = "Register `DSCR4` writer"]
pub type W = crate::W<DSCR4_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn dscr(&mut self) -> DSCR_W<DSCR4_SPEC, 2> {
        DSCR_W::new(self)
    }
...
#[doc = "DMAC Channel Descriptor Address Register (ch_num = 4)\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`dscr4::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`dscr4::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
