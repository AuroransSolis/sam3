...
pub type SCSIZE_W<'a, const O: u8> = crate::FieldWriter<'a, u32, CTRLA2_SPEC, u8, SCSIZE_A, 3, O>;
...
pub type DCSIZE_W<'a, const O: u8> = crate::FieldWriter<'a, u32, CTRLA2_SPEC, u8, DCSIZE_A, 3, O>;
