...
pub type LINABT_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `LINWKUP` writer - Send LIN Wakeup Signal"]
pub type LINWKUP_W<'a, REG> = crate::BitWriter<'a, REG>;
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn linabt(&mut self) -> LINABT_W<CR_SPEC> {
        LINABT_W::new(self, 20)
    }
    #[doc = "Bit 21 - Send LIN Wakeup Signal"]
    #[inline(always)]
    #[must_use]
    pub fn linwkup(&mut self) -> LINWKUP_W<CR_SPEC> {
        LINWKUP_W::new(self, 21)
    }
