...
pub type R = crate::R<MAM3_SPEC>;
#[doc = "Register `MAM3` writer"]
pub type W = crate::W<MAM3_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn midv_b(&mut self) -> MIDV_B_W<MAM3_SPEC, 0> {
        MIDV_B_W::new(self)
    }
    #[doc = "Bits 18:28 - Identifier for standard frame mode"]
    #[inline(always)]
    #[must_use]
    pub fn midv_a(&mut self) -> MIDV_A_W<MAM3_SPEC, 18> {
        MIDV_A_W::new(self)
    }
    #[doc = "Bit 29 - Identifier Version"]
    #[inline(always)]
    #[must_use]
    pub fn mide(&mut self) -> MIDE_W<MAM3_SPEC, 29> {
        MIDE_W::new(self)
    }
