...
impl core::ops::Deref for R {
    type Target = crate::R<SA1T_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<SA1T_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<SA1T_SPEC>) -> Self {
        R(reader)
    }
}
...
impl From<crate::W<SA1T_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<SA1T_SPEC>) -> Self {
        W(writer)
    }
}
