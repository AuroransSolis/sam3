...
#[doc = "Mailbox Status Register (MB = 2)\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`msr2::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Msr2Spec;
impl crate::RegisterSpec for Msr2Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`msr2::R`](R) reader structure"]
impl crate::Readable for Msr2Spec {}
#[doc = "`reset()` method sets MSR2 to value 0"]
impl crate::Resettable for Msr2Spec {
