...
pub type R = crate::R<Mam3Spec>;
#[doc = "Register `MAM3` writer"]
pub type W = crate::W<Mam3Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn midv_b(&mut self) -> MidvBW<Mam3Spec> {
        MidvBW::new(self, 0)
    }
    #[doc = "Bits 18:28 - Identifier for standard frame mode"]
    #[inline(always)]
    #[must_use]
    pub fn midv_a(&mut self) -> MidvAW<Mam3Spec> {
        MidvAW::new(self, 18)
    }
    #[doc = "Bit 29 - Identifier Version"]
    #[inline(always)]
    #[must_use]
    pub fn mide(&mut self) -> MideW<Mam3Spec> {
        MideW::new(self, 29)
    }
}
#[doc = "Mailbox Acceptance Mask Register (MB = 3)\n\nYou can [`read`](crate::Reg::read) this register and get [`mam3::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`mam3::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Mam3Spec;
impl crate::RegisterSpec for Mam3Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`mam3::R`](R) reader structure"]
impl crate::Readable for Mam3Spec {}
#[doc = "`write(|w| ..)` method takes [`mam3::W`](W) writer structure"]
impl crate::Writable for Mam3Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets MAM3 to value 0"]
impl crate::Resettable for Mam3Spec {
