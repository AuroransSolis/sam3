...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn p0(&mut self) -> P0_W<PPDDR_SPEC> {
        P0_W::new(self, 0)
    }
    #[doc = "Bit 1 - Pull Down Disable."]
    #[inline(always)]
    #[must_use]
    pub fn p1(&mut self) -> P1_W<PPDDR_SPEC> {
        P1_W::new(self, 1)
    }
    #[doc = "Bit 2 - Pull Down Disable."]
    #[inline(always)]
    #[must_use]
    pub fn p2(&mut self) -> P2_W<PPDDR_SPEC> {
        P2_W::new(self, 2)
    }
    #[doc = "Bit 3 - Pull Down Disable."]
    #[inline(always)]
    #[must_use]
    pub fn p3(&mut self) -> P3_W<PPDDR_SPEC> {
        P3_W::new(self, 3)
    }
    #[doc = "Bit 4 - Pull Down Disable."]
    #[inline(always)]
    #[must_use]
    pub fn p4(&mut self) -> P4_W<PPDDR_SPEC> {
        P4_W::new(self, 4)
    }
    #[doc = "Bit 5 - Pull Down Disable."]
    #[inline(always)]
    #[must_use]
    pub fn p5(&mut self) -> P5_W<PPDDR_SPEC> {
        P5_W::new(self, 5)
    }
    #[doc = "Bit 6 - Pull Down Disable."]
    #[inline(always)]
    #[must_use]
    pub fn p6(&mut self) -> P6_W<PPDDR_SPEC> {
        P6_W::new(self, 6)
    }
    #[doc = "Bit 7 - Pull Down Disable."]
    #[inline(always)]
    #[must_use]
    pub fn p7(&mut self) -> P7_W<PPDDR_SPEC> {
        P7_W::new(self, 7)
    }
    #[doc = "Bit 8 - Pull Down Disable."]
    #[inline(always)]
    #[must_use]
    pub fn p8(&mut self) -> P8_W<PPDDR_SPEC> {
        P8_W::new(self, 8)
    }
    #[doc = "Bit 9 - Pull Down Disable."]
    #[inline(always)]
    #[must_use]
    pub fn p9(&mut self) -> P9_W<PPDDR_SPEC> {
        P9_W::new(self, 9)
    }
    #[doc = "Bit 10 - Pull Down Disable."]
    #[inline(always)]
    #[must_use]
    pub fn p10(&mut self) -> P10_W<PPDDR_SPEC> {
        P10_W::new(self, 10)
    }
    #[doc = "Bit 11 - Pull Down Disable."]
    #[inline(always)]
    #[must_use]
    pub fn p11(&mut self) -> P11_W<PPDDR_SPEC> {
        P11_W::new(self, 11)
    }
    #[doc = "Bit 12 - Pull Down Disable."]
    #[inline(always)]
    #[must_use]
    pub fn p12(&mut self) -> P12_W<PPDDR_SPEC> {
        P12_W::new(self, 12)
    }
    #[doc = "Bit 13 - Pull Down Disable."]
    #[inline(always)]
    #[must_use]
    pub fn p13(&mut self) -> P13_W<PPDDR_SPEC> {
        P13_W::new(self, 13)
    }
    #[doc = "Bit 14 - Pull Down Disable."]
    #[inline(always)]
    #[must_use]
    pub fn p14(&mut self) -> P14_W<PPDDR_SPEC> {
        P14_W::new(self, 14)
    }
    #[doc = "Bit 15 - Pull Down Disable."]
    #[inline(always)]
    #[must_use]
    pub fn p15(&mut self) -> P15_W<PPDDR_SPEC> {
        P15_W::new(self, 15)
    }
    #[doc = "Bit 16 - Pull Down Disable."]
    #[inline(always)]
    #[must_use]
    pub fn p16(&mut self) -> P16_W<PPDDR_SPEC> {
        P16_W::new(self, 16)
    }
    #[doc = "Bit 17 - Pull Down Disable."]
    #[inline(always)]
    #[must_use]
    pub fn p17(&mut self) -> P17_W<PPDDR_SPEC> {
        P17_W::new(self, 17)
    }
    #[doc = "Bit 18 - Pull Down Disable."]
    #[inline(always)]
    #[must_use]
    pub fn p18(&mut self) -> P18_W<PPDDR_SPEC> {
        P18_W::new(self, 18)
    }
    #[doc = "Bit 19 - Pull Down Disable."]
    #[inline(always)]
    #[must_use]
    pub fn p19(&mut self) -> P19_W<PPDDR_SPEC> {
        P19_W::new(self, 19)
    }
    #[doc = "Bit 20 - Pull Down Disable."]
    #[inline(always)]
    #[must_use]
    pub fn p20(&mut self) -> P20_W<PPDDR_SPEC> {
        P20_W::new(self, 20)
    }
    #[doc = "Bit 21 - Pull Down Disable."]
    #[inline(always)]
    #[must_use]
    pub fn p21(&mut self) -> P21_W<PPDDR_SPEC> {
        P21_W::new(self, 21)
    }
    #[doc = "Bit 22 - Pull Down Disable."]
    #[inline(always)]
    #[must_use]
    pub fn p22(&mut self) -> P22_W<PPDDR_SPEC> {
        P22_W::new(self, 22)
    }
    #[doc = "Bit 23 - Pull Down Disable."]
    #[inline(always)]
    #[must_use]
    pub fn p23(&mut self) -> P23_W<PPDDR_SPEC> {
        P23_W::new(self, 23)
    }
    #[doc = "Bit 24 - Pull Down Disable."]
    #[inline(always)]
    #[must_use]
    pub fn p24(&mut self) -> P24_W<PPDDR_SPEC> {
        P24_W::new(self, 24)
    }
    #[doc = "Bit 25 - Pull Down Disable."]
    #[inline(always)]
    #[must_use]
    pub fn p25(&mut self) -> P25_W<PPDDR_SPEC> {
        P25_W::new(self, 25)
    }
    #[doc = "Bit 26 - Pull Down Disable."]
    #[inline(always)]
    #[must_use]
    pub fn p26(&mut self) -> P26_W<PPDDR_SPEC> {
        P26_W::new(self, 26)
    }
    #[doc = "Bit 27 - Pull Down Disable."]
    #[inline(always)]
    #[must_use]
    pub fn p27(&mut self) -> P27_W<PPDDR_SPEC> {
        P27_W::new(self, 27)
    }
    #[doc = "Bit 28 - Pull Down Disable."]
    #[inline(always)]
    #[must_use]
    pub fn p28(&mut self) -> P28_W<PPDDR_SPEC> {
        P28_W::new(self, 28)
    }
    #[doc = "Bit 29 - Pull Down Disable."]
    #[inline(always)]
    #[must_use]
    pub fn p29(&mut self) -> P29_W<PPDDR_SPEC> {
        P29_W::new(self, 29)
    }
    #[doc = "Bit 30 - Pull Down Disable."]
    #[inline(always)]
    #[must_use]
    pub fn p30(&mut self) -> P30_W<PPDDR_SPEC> {
        P30_W::new(self, 30)
    }
    #[doc = "Bit 31 - Pull Down Disable."]
    #[inline(always)]
    #[must_use]
    pub fn p31(&mut self) -> P31_W<PPDDR_SPEC> {
        P31_W::new(self, 31)
    }
