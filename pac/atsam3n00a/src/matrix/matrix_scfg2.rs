...
pub type R = crate::R<MatrixScfg2Spec>;
#[doc = "Register `MATRIX_SCFG2` writer"]
pub type W = crate::W<MatrixScfg2Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn slot_cycle(&mut self) -> SlotCycleW<MatrixScfg2Spec> {
        SlotCycleW::new(self, 0)
    }
    #[doc = "Bits 16:17 - Default Master Type"]
    #[inline(always)]
    #[must_use]
    pub fn defmstr_type(&mut self) -> DefmstrTypeW<MatrixScfg2Spec> {
        DefmstrTypeW::new(self, 16)
    }
    #[doc = "Bits 18:20 - Fixed Default Master"]
    #[inline(always)]
    #[must_use]
    pub fn fixed_defmstr(&mut self) -> FixedDefmstrW<MatrixScfg2Spec> {
        FixedDefmstrW::new(self, 18)
    }
    #[doc = "Bits 24:25 - Arbitration Type"]
    #[inline(always)]
    #[must_use]
    pub fn arbt(&mut self) -> ArbtW<MatrixScfg2Spec> {
        ArbtW::new(self, 24)
    }
}
...
impl crate::Readable for MatrixScfg2Spec {}
#[doc = "`write(|w| ..)` method takes [`matrix_scfg2::W`](W) writer structure"]
impl crate::Writable for MatrixScfg2Spec {
