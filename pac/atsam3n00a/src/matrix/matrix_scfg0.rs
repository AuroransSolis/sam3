...
pub type R = crate::R<MatrixScfg0Spec>;
#[doc = "Register `MATRIX_SCFG0` writer"]
pub type W = crate::W<MatrixScfg0Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn slot_cycle(&mut self) -> SlotCycleW<MatrixScfg0Spec> {
        SlotCycleW::new(self, 0)
    }
    #[doc = "Bits 16:17 - Default Master Type"]
    #[inline(always)]
    #[must_use]
    pub fn defmstr_type(&mut self) -> DefmstrTypeW<MatrixScfg0Spec> {
        DefmstrTypeW::new(self, 16)
    }
    #[doc = "Bits 18:20 - Fixed Default Master"]
    #[inline(always)]
    #[must_use]
    pub fn fixed_defmstr(&mut self) -> FixedDefmstrW<MatrixScfg0Spec> {
        FixedDefmstrW::new(self, 18)
    }
    #[doc = "Bits 24:25 - Arbitration Type"]
    #[inline(always)]
    #[must_use]
    pub fn arbt(&mut self) -> ArbtW<MatrixScfg0Spec> {
        ArbtW::new(self, 24)
    }
}
...
pub struct MatrixScfg0Spec;
impl crate::RegisterSpec for MatrixScfg0Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`matrix_scfg0::R`](R) reader structure"]
impl crate::Readable for MatrixScfg0Spec {}
#[doc = "`write(|w| ..)` method takes [`matrix_scfg0::W`](W) writer structure"]
impl crate::Writable for MatrixScfg0Spec {
