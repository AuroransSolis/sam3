...
pub type R = crate::R<FIFO165_SPEC>;
#[doc = "Register `FIFO165` writer"]
pub type W = crate::W<FIFO165_SPEC>;
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        write!(f, "{}", self.bits())
    }
}
impl core::fmt::Debug for crate::generic::Reg<FIFO165_SPEC> {
...
pub struct FIFO165_SPEC;
impl crate::RegisterSpec for FIFO165_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`fifo165::R`](R) reader structure"]
impl crate::Readable for FIFO165_SPEC {}
#[doc = "`write(|w| ..)` method takes [`fifo165::W`](W) writer structure"]
impl crate::Writable for FIFO165_SPEC {
