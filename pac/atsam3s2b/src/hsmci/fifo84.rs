...
pub type R = crate::R<FIFO84_SPEC>;
#[doc = "Register `FIFO84` writer"]
pub type W = crate::W<FIFO84_SPEC>;
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        write!(f, "{}", self.bits())
    }
}
impl core::fmt::Debug for crate::generic::Reg<FIFO84_SPEC> {
...
pub struct FIFO84_SPEC;
impl crate::RegisterSpec for FIFO84_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`fifo84::R`](R) reader structure"]
impl crate::Readable for FIFO84_SPEC {}
#[doc = "`write(|w| ..)` method takes [`fifo84::W`](W) writer structure"]
impl crate::Writable for FIFO84_SPEC {
