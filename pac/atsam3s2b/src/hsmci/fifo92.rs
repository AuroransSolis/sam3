...
pub type R = crate::R<FIFO92_SPEC>;
#[doc = "Register `FIFO92` writer"]
pub type W = crate::W<FIFO92_SPEC>;
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        write!(f, "{}", self.bits())
    }
}
impl core::fmt::Debug for crate::generic::Reg<FIFO92_SPEC> {
...
pub struct FIFO92_SPEC;
impl crate::RegisterSpec for FIFO92_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`fifo92::R`](R) reader structure"]
impl crate::Readable for FIFO92_SPEC {}
#[doc = "`write(|w| ..)` method takes [`fifo92::W`](W) writer structure"]
impl crate::Writable for FIFO92_SPEC {
