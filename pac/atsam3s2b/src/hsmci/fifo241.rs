...
pub type R = crate::R<FIFO241_SPEC>;
#[doc = "Register `FIFO241` writer"]
pub type W = crate::W<FIFO241_SPEC>;
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        write!(f, "{}", self.bits())
    }
}
impl core::fmt::Debug for crate::generic::Reg<FIFO241_SPEC> {
...
pub struct FIFO241_SPEC;
impl crate::RegisterSpec for FIFO241_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`fifo241::R`](R) reader structure"]
impl crate::Readable for FIFO241_SPEC {}
#[doc = "`write(|w| ..)` method takes [`fifo241::W`](W) writer structure"]
impl crate::Writable for FIFO241_SPEC {
