...
pub type R = crate::R<FIFO161_SPEC>;
#[doc = "Register `FIFO161` writer"]
pub type W = crate::W<FIFO161_SPEC>;
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        write!(f, "{}", self.bits())
    }
}
impl core::fmt::Debug for crate::generic::Reg<FIFO161_SPEC> {
...
pub struct FIFO161_SPEC;
impl crate::RegisterSpec for FIFO161_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`fifo161::R`](R) reader structure"]
impl crate::Readable for FIFO161_SPEC {}
#[doc = "`write(|w| ..)` method takes [`fifo161::W`](W) writer structure"]
impl crate::Writable for FIFO161_SPEC {
