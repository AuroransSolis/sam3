...
pub type R = crate::R<FIFO245_SPEC>;
#[doc = "Register `FIFO245` writer"]
pub type W = crate::W<FIFO245_SPEC>;
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        write!(f, "{}", self.bits())
    }
}
impl core::fmt::Debug for crate::generic::Reg<FIFO245_SPEC> {
...
pub struct FIFO245_SPEC;
impl crate::RegisterSpec for FIFO245_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`fifo245::R`](R) reader structure"]
impl crate::Readable for FIFO245_SPEC {}
#[doc = "`write(|w| ..)` method takes [`fifo245::W`](W) writer structure"]
impl crate::Writable for FIFO245_SPEC {
