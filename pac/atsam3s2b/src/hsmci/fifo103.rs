...
pub type R = crate::R<FIFO103_SPEC>;
#[doc = "Register `FIFO103` writer"]
pub type W = crate::W<FIFO103_SPEC>;
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        write!(f, "{}", self.bits())
    }
}
impl core::fmt::Debug for crate::generic::Reg<FIFO103_SPEC> {
...
pub struct FIFO103_SPEC;
impl crate::RegisterSpec for FIFO103_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`fifo103::R`](R) reader structure"]
impl crate::Readable for FIFO103_SPEC {}
#[doc = "`write(|w| ..)` method takes [`fifo103::W`](W) writer structure"]
impl crate::Writable for FIFO103_SPEC {
