...
pub type R = crate::R<FIFO170_SPEC>;
#[doc = "Register `FIFO170` writer"]
pub type W = crate::W<FIFO170_SPEC>;
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        write!(f, "{}", self.bits())
    }
}
impl core::fmt::Debug for crate::generic::Reg<FIFO170_SPEC> {
...
pub struct FIFO170_SPEC;
impl crate::RegisterSpec for FIFO170_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`fifo170::R`](R) reader structure"]
impl crate::Readable for FIFO170_SPEC {}
#[doc = "`write(|w| ..)` method takes [`fifo170::W`](W) writer structure"]
impl crate::Writable for FIFO170_SPEC {
