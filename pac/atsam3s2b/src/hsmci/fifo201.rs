...
pub type R = crate::R<FIFO201_SPEC>;
#[doc = "Register `FIFO201` writer"]
pub type W = crate::W<FIFO201_SPEC>;
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        write!(f, "{}", self.bits())
    }
}
impl core::fmt::Debug for crate::generic::Reg<FIFO201_SPEC> {
...
pub struct FIFO201_SPEC;
impl crate::RegisterSpec for FIFO201_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`fifo201::R`](R) reader structure"]
impl crate::Readable for FIFO201_SPEC {}
#[doc = "`write(|w| ..)` method takes [`fifo201::W`](W) writer structure"]
impl crate::Writable for FIFO201_SPEC {
