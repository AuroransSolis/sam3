...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn chann_enb(&mut self) -> CHANN_ENB_W<DMACONTROL3_SPEC> {
        CHANN_ENB_W::new(self, 0)
    }
    #[doc = "Bit 1 - Load Next Channel Transfer Descriptor Enable (Command)"]
    #[inline(always)]
    #[must_use]
    pub fn ldnxt_dsc(&mut self) -> LDNXT_DSC_W<DMACONTROL3_SPEC> {
        LDNXT_DSC_W::new(self, 1)
    }
    #[doc = "Bit 2 - End of Transfer Enable (Control)"]
    #[inline(always)]
    #[must_use]
    pub fn end_tr_en(&mut self) -> END_TR_EN_W<DMACONTROL3_SPEC> {
        END_TR_EN_W::new(self, 2)
    }
    #[doc = "Bit 3 - End of Buffer Enable (Control)"]
    #[inline(always)]
    #[must_use]
    pub fn end_b_en(&mut self) -> END_B_EN_W<DMACONTROL3_SPEC> {
        END_B_EN_W::new(self, 3)
    }
    #[doc = "Bit 4 - End of Transfer Interrupt Enable"]
    #[inline(always)]
    #[must_use]
    pub fn end_tr_it(&mut self) -> END_TR_IT_W<DMACONTROL3_SPEC> {
        END_TR_IT_W::new(self, 4)
    }
    #[doc = "Bit 5 - End of Buffer Interrupt Enable"]
    #[inline(always)]
    #[must_use]
    pub fn end_buffit(&mut self) -> END_BUFFIT_W<DMACONTROL3_SPEC> {
        END_BUFFIT_W::new(self, 5)
    }
    #[doc = "Bit 6 - Descriptor Loaded Interrupt Enable"]
    #[inline(always)]
    #[must_use]
    pub fn desc_ld_it(&mut self) -> DESC_LD_IT_W<DMACONTROL3_SPEC> {
        DESC_LD_IT_W::new(self, 6)
    }
    #[doc = "Bit 7 - Burst Lock Enable"]
    #[inline(always)]
    #[must_use]
    pub fn burst_lck(&mut self) -> BURST_LCK_W<DMACONTROL3_SPEC> {
        BURST_LCK_W::new(self, 7)
    }
    #[doc = "Bits 16:31 - Buffer Byte Length (Write-only)"]
    #[inline(always)]
    #[must_use]
    pub fn buff_length(&mut self) -> BUFF_LENGTH_W<DMACONTROL3_SPEC> {
