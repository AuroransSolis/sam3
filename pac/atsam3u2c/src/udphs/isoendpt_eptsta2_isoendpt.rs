#[doc = "Register `EPTSTA2_ISOENDPT` reader"]
pub struct R(crate::R<ISOENDPT_EPTSTA2_ISOENDPT_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<ISOENDPT_EPTSTA2_ISOENDPT_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<ISOENDPT_EPTSTA2_ISOENDPT_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<ISOENDPT_EPTSTA2_ISOENDPT_SPEC>) -> Self {
        R(reader)
    }
}
...
#[doc = "UDPHS Endpoint Status Register (endpoint = 2)\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [isoendpt_eptsta2_isoendpt](index.html) module"]
pub struct ISOENDPT_EPTSTA2_ISOENDPT_SPEC;
impl crate::RegisterSpec for ISOENDPT_EPTSTA2_ISOENDPT_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [isoendpt_eptsta2_isoendpt::R](R) reader structure"]
impl crate::Readable for ISOENDPT_EPTSTA2_ISOENDPT_SPEC {
    type Reader = R;
}
#[doc = "`reset()` method sets EPTSTA2_ISOENDPT to value 0x40"]
impl crate::Resettable for ISOENDPT_EPTSTA2_ISOENDPT_SPEC {
    #[inline(always)]
