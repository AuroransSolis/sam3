...
pub type R = crate::R<Eptctl1Spec>;
...
#[doc = "UDPHS Endpoint Control Register (endpoint = 1)\n\nYou can [`read`](crate::Reg::read) this register and get [`eptctl1::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Eptctl1Spec;
impl crate::RegisterSpec for Eptctl1Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`eptctl1::R`](R) reader structure"]
impl crate::Readable for Eptctl1Spec {}
#[doc = "`reset()` method sets EPTCTL1 to value 0"]
impl crate::Resettable for Eptctl1Spec {
