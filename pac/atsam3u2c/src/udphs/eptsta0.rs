...
pub type R = crate::R<EPTSTA0_SPEC>;
...
#[doc = "UDPHS Endpoint Status Register (endpoint = 0)\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`eptsta0::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
