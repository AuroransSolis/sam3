...
pub type R = crate::R<IsoendptEptsta3IsoendptSpec>;
...
#[doc = "UDPHS Endpoint Status Register (endpoint = 3)\n\nYou can [`read`](crate::Reg::read) this register and get [`isoendpt_eptsta3_isoendpt::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct IsoendptEptsta3IsoendptSpec;
impl crate::RegisterSpec for IsoendptEptsta3IsoendptSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`isoendpt_eptsta3_isoendpt::R`](R) reader structure"]
impl crate::Readable for IsoendptEptsta3IsoendptSpec {}
#[doc = "`reset()` method sets EPTSTA3_ISOENDPT to value 0x40"]
impl crate::Resettable for IsoendptEptsta3IsoendptSpec {
