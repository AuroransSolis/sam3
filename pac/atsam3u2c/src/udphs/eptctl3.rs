...
pub struct R(crate::R<EPTCTL3_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<EPTCTL3_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<EPTCTL3_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<EPTCTL3_SPEC>) -> Self {
        R(reader)
    }
}
...
#[doc = "UDPHS Endpoint Control Register (endpoint = 3)\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [eptctl3](index.html) module"]
pub struct EPTCTL3_SPEC;
impl crate::RegisterSpec for EPTCTL3_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [eptctl3::R](R) reader structure"]
impl crate::Readable for EPTCTL3_SPEC {
    type Reader = R;
}
#[doc = "`reset()` method sets EPTCTL3 to value 0"]
impl crate::Resettable for EPTCTL3_SPEC {
    #[inline(always)]
