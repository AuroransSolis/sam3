...
pub type R = crate::R<IsoendptEptctl0IsoendptSpec>;
...
#[doc = "UDPHS Endpoint Control Register (endpoint = 0)\n\nYou can [`read`](crate::Reg::read) this register and get [`isoendpt_eptctl0_isoendpt::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct IsoendptEptctl0IsoendptSpec;
impl crate::RegisterSpec for IsoendptEptctl0IsoendptSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`isoendpt_eptctl0_isoendpt::R`](R) reader structure"]
impl crate::Readable for IsoendptEptctl0IsoendptSpec {}
#[doc = "`reset()` method sets EPTCTL0_ISOENDPT to value 0"]
impl crate::Resettable for IsoendptEptctl0IsoendptSpec {
