#[doc = "Register `DMASTATUS4` reader"]
pub struct R(crate::R<DMASTATUS4_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<DMASTATUS4_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<DMASTATUS4_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<DMASTATUS4_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `DMASTATUS4` writer"]
pub struct W(crate::W<DMASTATUS4_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<DMASTATUS4_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<DMASTATUS4_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<DMASTATUS4_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type CHANN_ENB_W<'a, const O: u8> = crate::BitWriter<'a, u32, DMASTATUS4_SPEC, bool, O>;
...
pub type CHANN_ACT_W<'a, const O: u8> = crate::BitWriter<'a, u32, DMASTATUS4_SPEC, bool, O>;
...
pub type END_TR_ST_W<'a, const O: u8> = crate::BitWriter<'a, u32, DMASTATUS4_SPEC, bool, O>;
...
pub type END_BF_ST_W<'a, const O: u8> = crate::BitWriter<'a, u32, DMASTATUS4_SPEC, bool, O>;
...
pub type DESC_LDST_W<'a, const O: u8> = crate::BitWriter<'a, u32, DMASTATUS4_SPEC, bool, O>;
...
pub type BUFF_COUNT_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, DMASTATUS4_SPEC, u16, u16, 16, O>;
impl R {
...
#[doc = "UDPHS DMA Channel Status Register (channel = 4)\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [dmastatus4](index.html) module"]
pub struct DMASTATUS4_SPEC;
impl crate::RegisterSpec for DMASTATUS4_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [dmastatus4::R](R) reader structure"]
impl crate::Readable for DMASTATUS4_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [dmastatus4::W](W) writer structure"]
impl crate::Writable for DMASTATUS4_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets DMASTATUS4 to value 0"]
impl crate::Resettable for DMASTATUS4_SPEC {
    #[inline(always)]
