...
pub type EPT_0_W<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type EPT_1_W<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type EPT_2_W<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type EPT_3_W<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type EPT_4_W<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type EPT_5_W<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type EPT_6_W<'a, REG> = crate::BitWriter<'a, REG>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn det_suspd(&mut self) -> DET_SUSPD_W<IEN_SPEC> {
        DET_SUSPD_W::new(self, 1)
    }
    #[doc = "Bit 2 - Micro-SOF Interrupt Enable"]
    #[inline(always)]
    #[must_use]
    pub fn micro_sof(&mut self) -> MICRO_SOF_W<IEN_SPEC> {
        MICRO_SOF_W::new(self, 2)
    }
    #[doc = "Bit 3 - SOF Interrupt Enable"]
    #[inline(always)]
    #[must_use]
    pub fn int_sof(&mut self) -> INT_SOF_W<IEN_SPEC> {
        INT_SOF_W::new(self, 3)
    }
    #[doc = "Bit 4 - End Of Reset Interrupt Enable"]
    #[inline(always)]
    #[must_use]
    pub fn endreset(&mut self) -> ENDRESET_W<IEN_SPEC> {
        ENDRESET_W::new(self, 4)
    }
    #[doc = "Bit 5 - Wake Up CPU Interrupt Enable"]
    #[inline(always)]
    #[must_use]
    pub fn wake_up(&mut self) -> WAKE_UP_W<IEN_SPEC> {
        WAKE_UP_W::new(self, 5)
    }
    #[doc = "Bit 6 - End Of Resume Interrupt Enable"]
    #[inline(always)]
    #[must_use]
    pub fn endofrsm(&mut self) -> ENDOFRSM_W<IEN_SPEC> {
        ENDOFRSM_W::new(self, 6)
    }
    #[doc = "Bit 7 - Upstream Resume Interrupt Enable"]
    #[inline(always)]
    #[must_use]
    pub fn upstr_res(&mut self) -> UPSTR_RES_W<IEN_SPEC> {
        UPSTR_RES_W::new(self, 7)
    }
    #[doc = "Bit 8 - Endpoint 0 Interrupt Enable"]
    #[inline(always)]
    #[must_use]
    pub fn ept_0(&mut self) -> EPT_0_W<IEN_SPEC> {
        EPT_0_W::new(self, 8)
    }
    #[doc = "Bit 9 - Endpoint 1 Interrupt Enable"]
    #[inline(always)]
    #[must_use]
    pub fn ept_1(&mut self) -> EPT_1_W<IEN_SPEC> {
        EPT_1_W::new(self, 9)
    }
    #[doc = "Bit 10 - Endpoint 2 Interrupt Enable"]
    #[inline(always)]
    #[must_use]
    pub fn ept_2(&mut self) -> EPT_2_W<IEN_SPEC> {
        EPT_2_W::new(self, 10)
    }
    #[doc = "Bit 11 - Endpoint 3 Interrupt Enable"]
    #[inline(always)]
    #[must_use]
    pub fn ept_3(&mut self) -> EPT_3_W<IEN_SPEC> {
        EPT_3_W::new(self, 11)
    }
    #[doc = "Bit 12 - Endpoint 4 Interrupt Enable"]
    #[inline(always)]
    #[must_use]
    pub fn ept_4(&mut self) -> EPT_4_W<IEN_SPEC> {
        EPT_4_W::new(self, 12)
    }
    #[doc = "Bit 13 - Endpoint 5 Interrupt Enable"]
    #[inline(always)]
    #[must_use]
    pub fn ept_5(&mut self) -> EPT_5_W<IEN_SPEC> {
        EPT_5_W::new(self, 13)
    }
    #[doc = "Bit 14 - Endpoint 6 Interrupt Enable"]
    #[inline(always)]
    #[must_use]
    pub fn ept_6(&mut self) -> EPT_6_W<IEN_SPEC> {
        EPT_6_W::new(self, 14)
    }
    #[doc = "Bit 25 - DMA Channel 1 Interrupt Enable"]
    #[inline(always)]
    #[must_use]
    pub fn dma_1(&mut self) -> DMA_1_W<IEN_SPEC> {
        DMA_1_W::new(self, 25)
    }
    #[doc = "Bit 26 - DMA Channel 2 Interrupt Enable"]
    #[inline(always)]
    #[must_use]
    pub fn dma_2(&mut self) -> DMA_2_W<IEN_SPEC> {
        DMA_2_W::new(self, 26)
    }
    #[doc = "Bit 27 - DMA Channel 3 Interrupt Enable"]
    #[inline(always)]
    #[must_use]
    pub fn dma_3(&mut self) -> DMA_3_W<IEN_SPEC> {
        DMA_3_W::new(self, 27)
    }
    #[doc = "Bit 28 - DMA Channel 4 Interrupt Enable"]
    #[inline(always)]
    #[must_use]
    pub fn dma_4(&mut self) -> DMA_4_W<IEN_SPEC> {
        DMA_4_W::new(self, 28)
    }
    #[doc = "Bit 29 - DMA Channel 5 Interrupt Enable"]
    #[inline(always)]
    #[must_use]
    pub fn dma_5(&mut self) -> DMA_5_W<IEN_SPEC> {
        DMA_5_W::new(self, 29)
    }
    #[doc = "Bit 30 - DMA Channel 6 Interrupt Enable"]
    #[inline(always)]
    #[must_use]
    pub fn dma_6(&mut self) -> DMA_6_W<IEN_SPEC> {
        DMA_6_W::new(self, 30)
    }
