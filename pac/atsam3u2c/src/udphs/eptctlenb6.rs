...
pub type W = crate::W<Eptctlenb6Spec>;
...
pub struct Eptctlenb6Spec;
impl crate::RegisterSpec for Eptctlenb6Spec {
    type Ux = u32;
}
#[doc = "`write(|w| ..)` method takes [`eptctlenb6::W`](W) writer structure"]
impl crate::Writable for Eptctlenb6Spec {
