...
pub type R = crate::R<DMAADDRESS5_SPEC>;
#[doc = "Register `DMAADDRESS5` writer"]
pub type W = crate::W<DMAADDRESS5_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn buff_add(&mut self) -> BUFF_ADD_W<DMAADDRESS5_SPEC, 0> {
        BUFF_ADD_W::new(self)
    }
