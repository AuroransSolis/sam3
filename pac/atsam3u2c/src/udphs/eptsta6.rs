...
pub struct R(crate::R<EPTSTA6_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<EPTSTA6_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<EPTSTA6_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<EPTSTA6_SPEC>) -> Self {
        R(reader)
    }
}
...
#[doc = "UDPHS Endpoint Status Register (endpoint = 6)\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [eptsta6](index.html) module"]
