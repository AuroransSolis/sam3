#[doc = "Register `PRAS5` reader"]
pub struct R(crate::R<PRAS5_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<PRAS5_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<PRAS5_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<PRAS5_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `PRAS5` writer"]
pub struct W(crate::W<PRAS5_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<PRAS5_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<PRAS5_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<PRAS5_SPEC>) -> Self {
        W(writer)
    }
}
...
#[doc = "Priority Register A for Slave 5\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [pras5](index.html) module"]
pub struct PRAS5_SPEC;
impl crate::RegisterSpec for PRAS5_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [pras5::R](R) reader structure"]
impl crate::Readable for PRAS5_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [pras5::W](W) writer structure"]
impl crate::Writable for PRAS5_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets PRAS5 to value 0"]
impl crate::Resettable for PRAS5_SPEC {
    #[inline(always)]
