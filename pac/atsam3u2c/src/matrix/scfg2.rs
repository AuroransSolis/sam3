...
pub type R = crate::R<SCFG2_SPEC>;
#[doc = "Register `SCFG2` writer"]
pub type W = crate::W<SCFG2_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn slot_cycle(&mut self) -> SLOT_CYCLE_W<SCFG2_SPEC, 0> {
        SLOT_CYCLE_W::new(self)
    }
    #[doc = "Bits 16:17 - Default Master Type"]
    #[inline(always)]
    #[must_use]
    pub fn defmstr_type(&mut self) -> DEFMSTR_TYPE_W<SCFG2_SPEC, 16> {
        DEFMSTR_TYPE_W::new(self)
    }
    #[doc = "Bits 18:20 - Fixed Default Master"]
    #[inline(always)]
    #[must_use]
    pub fn fixed_defmstr(&mut self) -> FIXED_DEFMSTR_W<SCFG2_SPEC, 18> {
        FIXED_DEFMSTR_W::new(self)
    }
    #[doc = "Bits 24:25 - Arbitration Type"]
    #[inline(always)]
    #[must_use]
    pub fn arbt(&mut self) -> ARBT_W<SCFG2_SPEC, 24> {
        ARBT_W::new(self)
    }
...
#[doc = "Slave Configuration Register 2\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`scfg2::R`](R).  You can [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`scfg2::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct SCFG2_SPEC;
impl crate::RegisterSpec for SCFG2_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`scfg2::R`](R) reader structure"]
impl crate::Readable for SCFG2_SPEC {}
#[doc = "`write(|w| ..)` method takes [`scfg2::W`](W) writer structure"]
impl crate::Writable for SCFG2_SPEC {
