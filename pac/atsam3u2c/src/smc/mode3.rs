...
pub type R = crate::R<Mode3Spec>;
#[doc = "Register `MODE3` writer"]
pub type W = crate::W<Mode3Spec>;
#[doc = "\n\nValue on reset: 1"]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn read_mode(&mut self) -> ReadModeW<Mode3Spec> {
        ReadModeW::new(self, 0)
    }
    #[doc = "Bit 1"]
    #[inline(always)]
    #[must_use]
    pub fn write_mode(&mut self) -> WriteModeW<Mode3Spec> {
        WriteModeW::new(self, 1)
    }
    #[doc = "Bits 4:5 - NWAIT Mode"]
    #[inline(always)]
    #[must_use]
    pub fn exnw_mode(&mut self) -> ExnwModeW<Mode3Spec> {
        ExnwModeW::new(self, 4)
    }
    #[doc = "Bit 8 - Byte Access Type"]
    #[inline(always)]
    #[must_use]
    pub fn bat(&mut self) -> BatW<Mode3Spec> {
        BatW::new(self, 8)
    }
    #[doc = "Bit 12 - Data Bus Width"]
    #[inline(always)]
    #[must_use]
    pub fn dbw(&mut self) -> DbwW<Mode3Spec> {
        DbwW::new(self, 12)
    }
    #[doc = "Bits 16:19 - Data Float Time"]
    #[inline(always)]
    #[must_use]
    pub fn tdf_cycles(&mut self) -> TdfCyclesW<Mode3Spec> {
        TdfCyclesW::new(self, 16)
    }
    #[doc = "Bit 20 - TDF Optimization"]
    #[inline(always)]
    #[must_use]
    pub fn tdf_mode(&mut self) -> TdfModeW<Mode3Spec> {
        TdfModeW::new(self, 20)
    }
}
#[doc = "SMC Mode Register (CS_number = 3)\n\nYou can [`read`](crate::Reg::read) this register and get [`mode3::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`mode3::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Mode3Spec;
impl crate::RegisterSpec for Mode3Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`mode3::R`](R) reader structure"]
impl crate::Readable for Mode3Spec {}
#[doc = "`write(|w| ..)` method takes [`mode3::W`](W) writer structure"]
impl crate::Writable for Mode3Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets MODE3 to value 0x1000_0003"]
impl crate::Resettable for Mode3Spec {
