...
pub type W = crate::W<DTUPD1_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn dthupd(&mut self) -> DTHUPD_W<DTUPD1_SPEC, 0> {
        DTHUPD_W::new(self)
    }
    #[doc = "Bits 16:31 - Dead-Time Value Update for PWMLx Output"]
    #[inline(always)]
    #[must_use]
    pub fn dtlupd(&mut self) -> DTLUPD_W<DTUPD1_SPEC, 16> {
        DTLUPD_W::new(self)
    }
...
#[doc = "PWM Channel Dead Time Update Register (ch_num = 1)\n\nYou can [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`dtupd1::W`](W). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
