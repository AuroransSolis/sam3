...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn p0(&mut self) -> P0W<PpderSpec> {
        P0W::new(self, 0)
    }
    #[doc = "Bit 1 - Pull Down Enable."]
    #[inline(always)]
    #[must_use]
    pub fn p1(&mut self) -> P1W<PpderSpec> {
        P1W::new(self, 1)
    }
    #[doc = "Bit 2 - Pull Down Enable."]
    #[inline(always)]
    #[must_use]
    pub fn p2(&mut self) -> P2W<PpderSpec> {
        P2W::new(self, 2)
    }
    #[doc = "Bit 3 - Pull Down Enable."]
    #[inline(always)]
    #[must_use]
    pub fn p3(&mut self) -> P3W<PpderSpec> {
        P3W::new(self, 3)
    }
    #[doc = "Bit 4 - Pull Down Enable."]
    #[inline(always)]
    #[must_use]
    pub fn p4(&mut self) -> P4W<PpderSpec> {
        P4W::new(self, 4)
    }
    #[doc = "Bit 5 - Pull Down Enable."]
    #[inline(always)]
    #[must_use]
    pub fn p5(&mut self) -> P5W<PpderSpec> {
        P5W::new(self, 5)
    }
    #[doc = "Bit 6 - Pull Down Enable."]
    #[inline(always)]
    #[must_use]
    pub fn p6(&mut self) -> P6W<PpderSpec> {
        P6W::new(self, 6)
    }
    #[doc = "Bit 7 - Pull Down Enable."]
    #[inline(always)]
    #[must_use]
    pub fn p7(&mut self) -> P7W<PpderSpec> {
        P7W::new(self, 7)
    }
    #[doc = "Bit 8 - Pull Down Enable."]
    #[inline(always)]
    #[must_use]
    pub fn p8(&mut self) -> P8W<PpderSpec> {
        P8W::new(self, 8)
    }
    #[doc = "Bit 9 - Pull Down Enable."]
    #[inline(always)]
    #[must_use]
    pub fn p9(&mut self) -> P9W<PpderSpec> {
        P9W::new(self, 9)
    }
    #[doc = "Bit 10 - Pull Down Enable."]
    #[inline(always)]
    #[must_use]
    pub fn p10(&mut self) -> P10W<PpderSpec> {
        P10W::new(self, 10)
    }
    #[doc = "Bit 11 - Pull Down Enable."]
    #[inline(always)]
    #[must_use]
    pub fn p11(&mut self) -> P11W<PpderSpec> {
        P11W::new(self, 11)
    }
    #[doc = "Bit 12 - Pull Down Enable."]
    #[inline(always)]
    #[must_use]
    pub fn p12(&mut self) -> P12W<PpderSpec> {
        P12W::new(self, 12)
    }
    #[doc = "Bit 13 - Pull Down Enable."]
    #[inline(always)]
    #[must_use]
    pub fn p13(&mut self) -> P13W<PpderSpec> {
        P13W::new(self, 13)
    }
    #[doc = "Bit 14 - Pull Down Enable."]
    #[inline(always)]
    #[must_use]
    pub fn p14(&mut self) -> P14W<PpderSpec> {
        P14W::new(self, 14)
    }
    #[doc = "Bit 15 - Pull Down Enable."]
    #[inline(always)]
    #[must_use]
    pub fn p15(&mut self) -> P15W<PpderSpec> {
        P15W::new(self, 15)
    }
    #[doc = "Bit 16 - Pull Down Enable."]
    #[inline(always)]
    #[must_use]
    pub fn p16(&mut self) -> P16W<PpderSpec> {
        P16W::new(self, 16)
    }
    #[doc = "Bit 17 - Pull Down Enable."]
    #[inline(always)]
    #[must_use]
    pub fn p17(&mut self) -> P17W<PpderSpec> {
        P17W::new(self, 17)
    }
    #[doc = "Bit 18 - Pull Down Enable."]
    #[inline(always)]
    #[must_use]
    pub fn p18(&mut self) -> P18W<PpderSpec> {
        P18W::new(self, 18)
    }
    #[doc = "Bit 19 - Pull Down Enable."]
    #[inline(always)]
    #[must_use]
    pub fn p19(&mut self) -> P19W<PpderSpec> {
        P19W::new(self, 19)
    }
    #[doc = "Bit 20 - Pull Down Enable."]
    #[inline(always)]
    #[must_use]
    pub fn p20(&mut self) -> P20W<PpderSpec> {
        P20W::new(self, 20)
    }
    #[doc = "Bit 21 - Pull Down Enable."]
    #[inline(always)]
    #[must_use]
    pub fn p21(&mut self) -> P21W<PpderSpec> {
        P21W::new(self, 21)
    }
    #[doc = "Bit 22 - Pull Down Enable."]
    #[inline(always)]
    #[must_use]
    pub fn p22(&mut self) -> P22W<PpderSpec> {
        P22W::new(self, 22)
    }
    #[doc = "Bit 23 - Pull Down Enable."]
    #[inline(always)]
    #[must_use]
    pub fn p23(&mut self) -> P23W<PpderSpec> {
        P23W::new(self, 23)
    }
    #[doc = "Bit 24 - Pull Down Enable."]
    #[inline(always)]
    #[must_use]
    pub fn p24(&mut self) -> P24W<PpderSpec> {
        P24W::new(self, 24)
    }
    #[doc = "Bit 25 - Pull Down Enable."]
    #[inline(always)]
    #[must_use]
    pub fn p25(&mut self) -> P25W<PpderSpec> {
        P25W::new(self, 25)
    }
    #[doc = "Bit 26 - Pull Down Enable."]
    #[inline(always)]
    #[must_use]
    pub fn p26(&mut self) -> P26W<PpderSpec> {
        P26W::new(self, 26)
    }
    #[doc = "Bit 27 - Pull Down Enable."]
    #[inline(always)]
    #[must_use]
    pub fn p27(&mut self) -> P27W<PpderSpec> {
        P27W::new(self, 27)
    }
    #[doc = "Bit 28 - Pull Down Enable."]
    #[inline(always)]
    #[must_use]
    pub fn p28(&mut self) -> P28W<PpderSpec> {
        P28W::new(self, 28)
    }
    #[doc = "Bit 29 - Pull Down Enable."]
    #[inline(always)]
    #[must_use]
    pub fn p29(&mut self) -> P29W<PpderSpec> {
        P29W::new(self, 29)
    }
    #[doc = "Bit 30 - Pull Down Enable."]
    #[inline(always)]
    #[must_use]
    pub fn p30(&mut self) -> P30W<PpderSpec> {
        P30W::new(self, 30)
    }
    #[doc = "Bit 31 - Pull Down Enable."]
    #[inline(always)]
    #[must_use]
    pub fn p31(&mut self) -> P31W<PpderSpec> {
        P31W::new(self, 31)
    }
}
#[doc = "Pad Pull-down Enable Register\n\nYou can [`write_with_zero`](crate::Reg::write_with_zero) this register using [`ppder::W`](W). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct PpderSpec;
impl crate::RegisterSpec for PpderSpec {
    type Ux = u32;
}
#[doc = "`write(|w| ..)` method takes [`ppder::W`](W) writer structure"]
impl crate::Writable for PpderSpec {
