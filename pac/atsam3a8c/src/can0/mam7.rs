...
pub type R = crate::R<MAM7_SPEC>;
#[doc = "Register `MAM7` writer"]
pub type W = crate::W<MAM7_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn midv_b(&mut self) -> MIDV_B_W<MAM7_SPEC, 0> {
        MIDV_B_W::new(self)
    }
    #[doc = "Bits 18:28 - Identifier for standard frame mode"]
    #[inline(always)]
    #[must_use]
    pub fn midv_a(&mut self) -> MIDV_A_W<MAM7_SPEC, 18> {
        MIDV_A_W::new(self)
    }
    #[doc = "Bit 29 - Identifier Version"]
    #[inline(always)]
    #[must_use]
    pub fn mide(&mut self) -> MIDE_W<MAM7_SPEC, 29> {
        MIDE_W::new(self)
    }
...
#[doc = "Mailbox Acceptance Mask Register (MB = 7)\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`mam7::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`mam7::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
