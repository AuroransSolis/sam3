...
pub type TIMRST_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
impl W {
    #[doc = "Bit 0 - Transfer Request for Mailbox 0"]
    #[inline(always)]
    #[must_use]
    pub fn mb0(&mut self) -> MB0_W<TCR_SPEC, 0> {
        MB0_W::new(self)
    }
    #[doc = "Bit 1 - Transfer Request for Mailbox 1"]
    #[inline(always)]
    #[must_use]
    pub fn mb1(&mut self) -> MB1_W<TCR_SPEC, 1> {
        MB1_W::new(self)
    }
    #[doc = "Bit 2 - Transfer Request for Mailbox 2"]
    #[inline(always)]
    #[must_use]
    pub fn mb2(&mut self) -> MB2_W<TCR_SPEC, 2> {
        MB2_W::new(self)
    }
    #[doc = "Bit 3 - Transfer Request for Mailbox 3"]
    #[inline(always)]
    #[must_use]
    pub fn mb3(&mut self) -> MB3_W<TCR_SPEC, 3> {
        MB3_W::new(self)
    }
    #[doc = "Bit 4 - Transfer Request for Mailbox 4"]
    #[inline(always)]
    #[must_use]
    pub fn mb4(&mut self) -> MB4_W<TCR_SPEC, 4> {
        MB4_W::new(self)
    }
    #[doc = "Bit 5 - Transfer Request for Mailbox 5"]
    #[inline(always)]
    #[must_use]
    pub fn mb5(&mut self) -> MB5_W<TCR_SPEC, 5> {
        MB5_W::new(self)
    }
    #[doc = "Bit 6 - Transfer Request for Mailbox 6"]
    #[inline(always)]
    #[must_use]
    pub fn mb6(&mut self) -> MB6_W<TCR_SPEC, 6> {
        MB6_W::new(self)
    }
    #[doc = "Bit 7 - Transfer Request for Mailbox 7"]
    #[inline(always)]
    #[must_use]
    pub fn mb7(&mut self) -> MB7_W<TCR_SPEC, 7> {
        MB7_W::new(self)
    }
    #[doc = "Bit 31 - Timer Reset"]
    #[inline(always)]
    #[must_use]
    pub fn timrst(&mut self) -> TIMRST_W<TCR_SPEC, 31> {
        TIMRST_W::new(self)
    }
