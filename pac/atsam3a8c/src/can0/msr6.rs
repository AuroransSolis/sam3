...
#[doc = "Mailbox Status Register (MB = 6)\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`msr6::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Msr6Spec;
impl crate::RegisterSpec for Msr6Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`msr6::R`](R) reader structure"]
impl crate::Readable for Msr6Spec {}
#[doc = "`reset()` method sets MSR6 to value 0"]
impl crate::Resettable for Msr6Spec {
