...
pub type R = crate::R<CTRLB5_SPEC>;
#[doc = "Register `CTRLB5` writer"]
pub type W = crate::W<CTRLB5_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn src_dscr(&mut self) -> SRC_DSCR_W<CTRLB5_SPEC, 16> {
        SRC_DSCR_W::new(self)
    }
    #[doc = "Bit 20 - Destination Address Descriptor"]
    #[inline(always)]
    #[must_use]
    pub fn dst_dscr(&mut self) -> DST_DSCR_W<CTRLB5_SPEC, 20> {
        DST_DSCR_W::new(self)
    }
    #[doc = "Bits 21:22 - Flow Control"]
    #[inline(always)]
    #[must_use]
    pub fn fc(&mut self) -> FC_W<CTRLB5_SPEC, 21> {
        FC_W::new(self)
    }
    #[doc = "Bits 24:25 - Incrementing, Decrementing or Fixed Address for the Source"]
    #[inline(always)]
    #[must_use]
    pub fn src_incr(&mut self) -> SRC_INCR_W<CTRLB5_SPEC, 24> {
        SRC_INCR_W::new(self)
    }
    #[doc = "Bits 28:29 - Incrementing, Decrementing or Fixed Address for the Destination"]
    #[inline(always)]
    #[must_use]
    pub fn dst_incr(&mut self) -> DST_INCR_W<CTRLB5_SPEC, 28> {
        DST_INCR_W::new(self)
    }
    #[doc = "Bit 30 - Interrupt Enable Not"]
    #[inline(always)]
    #[must_use]
    pub fn ien(&mut self) -> IEN_W<CTRLB5_SPEC, 30> {
        IEN_W::new(self)
    }
...
#[doc = "DMAC Channel Control B Register (ch_num = 5)\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`ctrlb5::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`ctrlb5::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
