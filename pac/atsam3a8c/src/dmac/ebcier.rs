...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn btc4(&mut self) -> BTC4_W<EBCIER_SPEC, 4> {
        BTC4_W::new(self)
    }
    #[doc = "Bit 5 - Buffer Transfer Completed \\[5:0\\]"]
    #[inline(always)]
    #[must_use]
    pub fn btc5(&mut self) -> BTC5_W<EBCIER_SPEC, 5> {
        BTC5_W::new(self)
    }
    ...
    #[inline(always)]
    #[must_use]
    pub fn cbtc4(&mut self) -> CBTC4_W<EBCIER_SPEC, 12> {
        CBTC4_W::new(self)
    }
    #[doc = "Bit 13 - Chained Buffer Transfer Completed \\[5:0\\]"]
    #[inline(always)]
    #[must_use]
    pub fn cbtc5(&mut self) -> CBTC5_W<EBCIER_SPEC, 13> {
        CBTC5_W::new(self)
    }
    ...
    #[inline(always)]
    #[must_use]
    pub fn err4(&mut self) -> ERR4_W<EBCIER_SPEC, 20> {
        ERR4_W::new(self)
    }
    #[doc = "Bit 21 - Access Error \\[5:0\\]"]
    #[inline(always)]
    #[must_use]
    pub fn err5(&mut self) -> ERR5_W<EBCIER_SPEC, 21> {
        ERR5_W::new(self)
    }
