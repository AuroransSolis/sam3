...
pub type R = crate::R<PmcPck1Spec>;
#[doc = "Register `PMC_PCK1` writer"]
pub type W = crate::W<PmcPck1Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn css(&mut self) -> CssW<PmcPck1Spec> {
        CssW::new(self, 0)
    }
    #[doc = "Bits 4:6 - Programmable Clock Prescaler"]
    #[inline(always)]
    #[must_use]
    pub fn pres(&mut self) -> PresW<PmcPck1Spec> {
        PresW::new(self, 4)
    }
}
...
impl crate::Readable for PmcPck1Spec {}
#[doc = "`write(|w| ..)` method takes [`pmc_pck1::W`](W) writer structure"]
impl crate::Writable for PmcPck1Spec {
