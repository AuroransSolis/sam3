...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn sdioirqfor_slot_a(&mut self) -> SDIOIRQFOR_SLOT_A_W<IDR_SPEC, 8> {
        SDIOIRQFOR_SLOT_A_W::new(self)
    }
    #[doc = "Bit 9"]
    #[inline(always)]
    #[must_use]
    pub fn sdioirqfor_slot_b(&mut self) -> SDIOIRQFOR_SLOT_B_W<IDR_SPEC, 9> {
    ...
    #[inline(always)]
    #[must_use]
    pub fn dmadone(&mut self) -> DMADONE_W<IDR_SPEC, 25> {
        DMADONE_W::new(self)
    }
