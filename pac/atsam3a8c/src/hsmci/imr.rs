...
pub type SDIOIRQFOR_SLOT_A_R = crate::BitReader<bool>;
#[doc = "Field `SDIOIRQforSlotB` reader - "]
pub type SDIOIRQFOR_SLOT_B_R = crate::BitReader<bool>;
...
impl R {
    ...
    #[doc = "Bit 8"]
    #[inline(always)]
    pub fn sdioirqfor_slot_a(&self) -> SDIOIRQFOR_SLOT_A_R {
        SDIOIRQFOR_SLOT_A_R::new(((self.bits >> 8) & 1) != 0)
    }
    #[doc = "Bit 9"]
    #[inline(always)]
    pub fn sdioirqfor_slot_b(&self) -> SDIOIRQFOR_SLOT_B_R {
        SDIOIRQFOR_SLOT_B_R::new(((self.bits >> 9) & 1) != 0)
    }
    ...
    pub fn dmadone(&self) -> DMADONE_R {
        DMADONE_R::new(((self.bits >> 25) & 1) != 0)
    }
