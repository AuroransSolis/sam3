#[doc = "Register `MATRIX_SCFG7` reader"]
pub type R = crate::R<MATRIX_SCFG7_SPEC>;
#[doc = "Register `MATRIX_SCFG7` writer"]
pub type W = crate::W<MATRIX_SCFG7_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn slot_cycle(&mut self) -> SLOT_CYCLE_W<MATRIX_SCFG7_SPEC, 0> {
        SLOT_CYCLE_W::new(self)
    }
    #[doc = "Bits 16:17 - Default Master Type"]
    #[inline(always)]
    #[must_use]
    pub fn defmstr_type(&mut self) -> DEFMSTR_TYPE_W<MATRIX_SCFG7_SPEC, 16> {
        DEFMSTR_TYPE_W::new(self)
    }
    #[doc = "Bits 18:20 - Fixed Default Master"]
    #[inline(always)]
    #[must_use]
    pub fn fixed_defmstr(&mut self) -> FIXED_DEFMSTR_W<MATRIX_SCFG7_SPEC, 18> {
        FIXED_DEFMSTR_W::new(self)
    }
    #[doc = "Bits 24:25 - Arbitration Type"]
    #[inline(always)]
    #[must_use]
    pub fn arbt(&mut self) -> ARBT_W<MATRIX_SCFG7_SPEC, 24> {
        ARBT_W::new(self)
    }
...
#[doc = "Slave Configuration Register 7\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`matrix_scfg7::R`](R).  You can [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`matrix_scfg7::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct MATRIX_SCFG7_SPEC;
impl crate::RegisterSpec for MATRIX_SCFG7_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`matrix_scfg7::R`](R) reader structure"]
impl crate::Readable for MATRIX_SCFG7_SPEC {}
#[doc = "`write(|w| ..)` method takes [`matrix_scfg7::W`](W) writer structure"]
impl crate::Writable for MATRIX_SCFG7_SPEC {
