...
pub type R = crate::R<MatrixPras3Spec>;
#[doc = "Register `MATRIX_PRAS3` writer"]
pub type W = crate::W<MatrixPras3Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn m0pr(&mut self) -> M0prW<MatrixPras3Spec> {
        M0prW::new(self, 0)
    }
    #[doc = "Bits 4:5 - Master 1 Priority"]
    #[inline(always)]
    #[must_use]
    pub fn m1pr(&mut self) -> M1prW<MatrixPras3Spec> {
        M1prW::new(self, 4)
    }
    #[doc = "Bits 8:9 - Master 2 Priority"]
    #[inline(always)]
    #[must_use]
    pub fn m2pr(&mut self) -> M2prW<MatrixPras3Spec> {
        M2prW::new(self, 8)
    }
    #[doc = "Bits 12:13 - Master 3 Priority"]
    #[inline(always)]
    #[must_use]
    pub fn m3pr(&mut self) -> M3prW<MatrixPras3Spec> {
        M3prW::new(self, 12)
    }
    #[doc = "Bits 16:17 - Master 4 Priority"]
    #[inline(always)]
    #[must_use]
    pub fn m4pr(&mut self) -> M4prW<MatrixPras3Spec> {
        M4prW::new(self, 16)
    }
    #[doc = "Bits 20:21 - Master 5 Priority"]
    #[inline(always)]
    #[must_use]
    pub fn m5pr(&mut self) -> M5prW<MatrixPras3Spec> {
        M5prW::new(self, 20)
    }
}
#[doc = "Priority Register A for Slave 3\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`matrix_pras3::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`matrix_pras3::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct MatrixPras3Spec;
impl crate::RegisterSpec for MatrixPras3Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`matrix_pras3::R`](R) reader structure"]
impl crate::Readable for MatrixPras3Spec {}
#[doc = "`write(|w| ..)` method takes [`matrix_pras3::W`](W) writer structure"]
impl crate::Writable for MatrixPras3Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets MATRIX_PRAS3 to value 0"]
impl crate::Resettable for MatrixPras3Spec {
