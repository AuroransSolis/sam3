...
pub type R = crate::R<MatrixPras6Spec>;
#[doc = "Register `MATRIX_PRAS6` writer"]
pub type W = crate::W<MatrixPras6Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn m0pr(&mut self) -> M0prW<MatrixPras6Spec> {
        M0prW::new(self, 0)
    }
    #[doc = "Bits 4:5 - Master 1 Priority"]
    #[inline(always)]
    #[must_use]
    pub fn m1pr(&mut self) -> M1prW<MatrixPras6Spec> {
        M1prW::new(self, 4)
    }
    #[doc = "Bits 8:9 - Master 2 Priority"]
    #[inline(always)]
    #[must_use]
    pub fn m2pr(&mut self) -> M2prW<MatrixPras6Spec> {
        M2prW::new(self, 8)
    }
    #[doc = "Bits 12:13 - Master 3 Priority"]
    #[inline(always)]
    #[must_use]
    pub fn m3pr(&mut self) -> M3prW<MatrixPras6Spec> {
        M3prW::new(self, 12)
    }
    #[doc = "Bits 16:17 - Master 4 Priority"]
    #[inline(always)]
    #[must_use]
    pub fn m4pr(&mut self) -> M4prW<MatrixPras6Spec> {
        M4prW::new(self, 16)
    }
    #[doc = "Bits 20:21 - Master 5 Priority"]
    #[inline(always)]
    #[must_use]
    pub fn m5pr(&mut self) -> M5prW<MatrixPras6Spec> {
        M5prW::new(self, 20)
    }
}
#[doc = "Priority Register A for Slave 6\n\nYou can [`read`](crate::Reg::read) this register and get [`matrix_pras6::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`matrix_pras6::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct MatrixPras6Spec;
impl crate::RegisterSpec for MatrixPras6Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`matrix_pras6::R`](R) reader structure"]
impl crate::Readable for MatrixPras6Spec {}
#[doc = "`write(|w| ..)` method takes [`matrix_pras6::W`](W) writer structure"]
impl crate::Writable for MatrixPras6Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets MATRIX_PRAS6 to value 0"]
impl crate::Resettable for MatrixPras6Spec {
