...
pub type R = crate::R<MDH5_SPEC>;
#[doc = "Register `MDH5` writer"]
pub type W = crate::W<MDH5_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn mdh(&mut self) -> MDH_W<MDH5_SPEC, 0> {
        MDH_W::new(self)
    }
...
#[doc = "Mailbox Data High Register (MB = 5)\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`mdh5::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`mdh5::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
