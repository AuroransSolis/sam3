...
pub type OSH0_W<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type OSH1_W<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type OSH2_W<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type OSH3_W<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type OSH4_W<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type OSH5_W<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type OSH6_W<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type OSH7_W<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type OSL0_W<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type OSL1_W<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type OSL2_W<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type OSL3_W<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type OSL4_W<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type OSL5_W<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type OSL6_W<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type OSL7_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn osh0(&mut self) -> OSH0_W<OS_SPEC> {
        OSH0_W::new(self, 0)
    }
    #[doc = "Bit 1 - Output Selection for PWMH output of the channel 1"]
    #[inline(always)]
    #[must_use]
    pub fn osh1(&mut self) -> OSH1_W<OS_SPEC> {
        OSH1_W::new(self, 1)
    }
    #[doc = "Bit 2 - Output Selection for PWMH output of the channel 2"]
    #[inline(always)]
    #[must_use]
    pub fn osh2(&mut self) -> OSH2_W<OS_SPEC> {
        OSH2_W::new(self, 2)
    }
    #[doc = "Bit 3 - Output Selection for PWMH output of the channel 3"]
    #[inline(always)]
    #[must_use]
    pub fn osh3(&mut self) -> OSH3_W<OS_SPEC> {
        OSH3_W::new(self, 3)
    }
    #[doc = "Bit 4 - Output Selection for PWMH output of the channel 4"]
    #[inline(always)]
    #[must_use]
    pub fn osh4(&mut self) -> OSH4_W<OS_SPEC> {
        OSH4_W::new(self, 4)
    }
    #[doc = "Bit 5 - Output Selection for PWMH output of the channel 5"]
    #[inline(always)]
    #[must_use]
    pub fn osh5(&mut self) -> OSH5_W<OS_SPEC> {
        OSH5_W::new(self, 5)
    }
    #[doc = "Bit 6 - Output Selection for PWMH output of the channel 6"]
    #[inline(always)]
    #[must_use]
    pub fn osh6(&mut self) -> OSH6_W<OS_SPEC> {
        OSH6_W::new(self, 6)
    }
    #[doc = "Bit 7 - Output Selection for PWMH output of the channel 7"]
    #[inline(always)]
    #[must_use]
    pub fn osh7(&mut self) -> OSH7_W<OS_SPEC> {
        OSH7_W::new(self, 7)
    }
    #[doc = "Bit 16 - Output Selection for PWML output of the channel 0"]
    #[inline(always)]
    #[must_use]
    pub fn osl0(&mut self) -> OSL0_W<OS_SPEC> {
        OSL0_W::new(self, 16)
    }
    #[doc = "Bit 17 - Output Selection for PWML output of the channel 1"]
    #[inline(always)]
    #[must_use]
    pub fn osl1(&mut self) -> OSL1_W<OS_SPEC> {
        OSL1_W::new(self, 17)
    }
    #[doc = "Bit 18 - Output Selection for PWML output of the channel 2"]
    #[inline(always)]
    #[must_use]
    pub fn osl2(&mut self) -> OSL2_W<OS_SPEC> {
        OSL2_W::new(self, 18)
    }
    #[doc = "Bit 19 - Output Selection for PWML output of the channel 3"]
    #[inline(always)]
    #[must_use]
    pub fn osl3(&mut self) -> OSL3_W<OS_SPEC> {
        OSL3_W::new(self, 19)
    }
    #[doc = "Bit 20 - Output Selection for PWML output of the channel 4"]
    #[inline(always)]
    #[must_use]
    pub fn osl4(&mut self) -> OSL4_W<OS_SPEC> {
        OSL4_W::new(self, 20)
    }
    #[doc = "Bit 21 - Output Selection for PWML output of the channel 5"]
    #[inline(always)]
    #[must_use]
    pub fn osl5(&mut self) -> OSL5_W<OS_SPEC> {
        OSL5_W::new(self, 21)
    }
    #[doc = "Bit 22 - Output Selection for PWML output of the channel 6"]
    #[inline(always)]
    #[must_use]
    pub fn osl6(&mut self) -> OSL6_W<OS_SPEC> {
        OSL6_W::new(self, 22)
    }
    #[doc = "Bit 23 - Output Selection for PWML output of the channel 7"]
    #[inline(always)]
    #[must_use]
    pub fn osl7(&mut self) -> OSL7_W<OS_SPEC> {
        OSL7_W::new(self, 23)
    }
