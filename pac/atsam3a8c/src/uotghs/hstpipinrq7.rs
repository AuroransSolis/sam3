...
#[doc = "Host Pipe IN Request Register (n = 0) 7\n\nYou can [`read`](crate::Reg::read) this register and get [`hstpipinrq7::R`](R). You can [`write_with_zero`](crate::Reg::write_with_zero) this register using [`hstpipinrq7::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
