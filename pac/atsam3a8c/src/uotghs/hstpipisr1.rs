#[doc = "Register `HSTPIPISR1` reader"]
pub type R = crate::R<HSTPIPISR1_SPEC>;
...
#[doc = "Host Pipe Status Register (n = 0) 1\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`hstpipisr1::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct HSTPIPISR1_SPEC;
impl crate::RegisterSpec for HSTPIPISR1_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`hstpipisr1::R`](R) reader structure"]
impl crate::Readable for HSTPIPISR1_SPEC {}
