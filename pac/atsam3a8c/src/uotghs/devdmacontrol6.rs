...
pub struct R(crate::R<DEVDMACONTROL6_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<DEVDMACONTROL6_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<DEVDMACONTROL6_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<DEVDMACONTROL6_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `DEVDMACONTROL6` writer"]
pub struct W(crate::W<DEVDMACONTROL6_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<DEVDMACONTROL6_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<DEVDMACONTROL6_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<DEVDMACONTROL6_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type CHANN_ENB_W<'a, const O: u8> = crate::BitWriter<'a, u32, DEVDMACONTROL6_SPEC, bool, O>;
...
pub type LDNXT_DSC_W<'a, const O: u8> = crate::BitWriter<'a, u32, DEVDMACONTROL6_SPEC, bool, O>;
...
pub type END_TR_EN_W<'a, const O: u8> = crate::BitWriter<'a, u32, DEVDMACONTROL6_SPEC, bool, O>;
...
pub type END_B_EN_W<'a, const O: u8> = crate::BitWriter<'a, u32, DEVDMACONTROL6_SPEC, bool, O>;
...
pub type END_TR_IT_W<'a, const O: u8> = crate::BitWriter<'a, u32, DEVDMACONTROL6_SPEC, bool, O>;
...
pub type END_BUFFIT_W<'a, const O: u8> = crate::BitWriter<'a, u32, DEVDMACONTROL6_SPEC, bool, O>;
...
pub type DESC_LD_IT_W<'a, const O: u8> = crate::BitWriter<'a, u32, DEVDMACONTROL6_SPEC, bool, O>;
...
pub type BURST_LCK_W<'a, const O: u8> = crate::BitWriter<'a, u32, DEVDMACONTROL6_SPEC, bool, O>;
...
pub type BUFF_LENGTH_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, DEVDMACONTROL6_SPEC, u16, u16, 16, O>;
impl R {
