#[doc = "Register `HSTPIPERR7` reader"]
pub type R = crate::R<HSTPIPERR7_SPEC>;
#[doc = "Register `HSTPIPERR7` writer"]
pub type W = crate::W<HSTPIPERR7_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn datatgl(&mut self) -> DATATGL_W<HSTPIPERR7_SPEC, 0> {
        DATATGL_W::new(self)
    }
    #[doc = "Bit 1 - Data PID Error"]
    #[inline(always)]
    #[must_use]
    pub fn datapid(&mut self) -> DATAPID_W<HSTPIPERR7_SPEC, 1> {
        DATAPID_W::new(self)
    }
    #[doc = "Bit 2 - PID Error"]
    #[inline(always)]
    #[must_use]
    pub fn pid(&mut self) -> PID_W<HSTPIPERR7_SPEC, 2> {
        PID_W::new(self)
    }
    #[doc = "Bit 3 - Time-Out Error"]
    #[inline(always)]
    #[must_use]
    pub fn timeout(&mut self) -> TIMEOUT_W<HSTPIPERR7_SPEC, 3> {
        TIMEOUT_W::new(self)
    }
    #[doc = "Bit 4 - CRC16 Error"]
    #[inline(always)]
    #[must_use]
    pub fn crc16(&mut self) -> CRC16_W<HSTPIPERR7_SPEC, 4> {
        CRC16_W::new(self)
    }
    #[doc = "Bits 5:6 - Error Counter"]
    #[inline(always)]
    #[must_use]
    pub fn counter(&mut self) -> COUNTER_W<HSTPIPERR7_SPEC, 5> {
        COUNTER_W::new(self)
    }
...
#[doc = "Host Pipe Error Register (n = 0) 7\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`hstpiperr7::R`](R).  You can [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`hstpiperr7::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct HSTPIPERR7_SPEC;
impl crate::RegisterSpec for HSTPIPERR7_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`hstpiperr7::R`](R) reader structure"]
impl crate::Readable for HSTPIPERR7_SPEC {}
#[doc = "`write(|w| ..)` method takes [`hstpiperr7::W`](W) writer structure"]
impl crate::Writable for HSTPIPERR7_SPEC {
