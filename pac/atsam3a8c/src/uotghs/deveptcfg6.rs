...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn alloc(&mut self) -> ALLOC_W<DEVEPTCFG6_SPEC> {
        ALLOC_W::new(self, 1)
    }
    #[doc = "Bits 2:3 - Endpoint Banks"]
    #[inline(always)]
    #[must_use]
    pub fn epbk(&mut self) -> EPBK_W<DEVEPTCFG6_SPEC> {
        EPBK_W::new(self, 2)
    }
    #[doc = "Bits 4:6 - Endpoint Size"]
    #[inline(always)]
    #[must_use]
    pub fn epsize(&mut self) -> EPSIZE_W<DEVEPTCFG6_SPEC> {
        EPSIZE_W::new(self, 4)
    }
    #[doc = "Bit 8 - Endpoint Direction"]
    #[inline(always)]
    #[must_use]
    pub fn epdir(&mut self) -> EPDIR_W<DEVEPTCFG6_SPEC> {
        EPDIR_W::new(self, 8)
    }
    #[doc = "Bit 9 - Automatic Switch"]
    #[inline(always)]
    #[must_use]
    pub fn autosw(&mut self) -> AUTOSW_W<DEVEPTCFG6_SPEC> {
        AUTOSW_W::new(self, 9)
    }
    #[doc = "Bits 11:12 - Endpoint Type"]
    #[inline(always)]
    #[must_use]
    pub fn eptype(&mut self) -> EPTYPE_W<DEVEPTCFG6_SPEC> {
        EPTYPE_W::new(self, 11)
    }
    #[doc = "Bits 13:14 - Number of transaction per microframe for isochronous endpoint"]
    #[inline(always)]
    #[must_use]
    pub fn nbtrans(&mut self) -> NBTRANS_W<DEVEPTCFG6_SPEC> {
