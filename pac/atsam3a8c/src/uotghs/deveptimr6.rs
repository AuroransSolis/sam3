#[doc = "Register `DEVEPTIMR6` reader"]
pub type R = crate::R<DEVEPTIMR6_SPEC>;
...
#[doc = "Device Endpoint Mask Register (n = 0) 6\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`deveptimr6::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DEVEPTIMR6_SPEC;
impl crate::RegisterSpec for DEVEPTIMR6_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`deveptimr6::R`](R) reader structure"]
impl crate::Readable for DEVEPTIMR6_SPEC {}
