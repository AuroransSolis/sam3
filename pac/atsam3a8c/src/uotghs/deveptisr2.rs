#[doc = "Register `DEVEPTISR2` reader"]
pub type R = crate::R<DEVEPTISR2_SPEC>;
...
pub struct DEVEPTISR2_SPEC;
impl crate::RegisterSpec for DEVEPTISR2_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`deveptisr2::R`](R) reader structure"]
impl crate::Readable for DEVEPTISR2_SPEC {}
