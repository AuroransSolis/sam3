...
pub type R = crate::R<DEVDMANXTDSC6_SPEC>;
#[doc = "Register `DEVDMANXTDSC6` writer"]
pub type W = crate::W<DEVDMANXTDSC6_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn nxt_dsc_add(&mut self) -> NXT_DSC_ADD_W<DEVDMANXTDSC6_SPEC, 0> {
...
#[doc = "Device DMA Channel Next Descriptor Address Register (n = 6)\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`devdmanxtdsc6::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`devdmanxtdsc6::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
