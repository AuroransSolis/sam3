...
pub type R = crate::R<HSTPIPCFG3_SPEC>;
#[doc = "Register `HSTPIPCFG3` writer"]
pub type W = crate::W<HSTPIPCFG3_SPEC>;
...
pub struct HSTPIPCFG3_SPEC;
impl crate::RegisterSpec for HSTPIPCFG3_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`hstpipcfg3::R`](R) reader structure"]
impl crate::Readable for HSTPIPCFG3_SPEC {}
#[doc = "`write(|w| ..)` method takes [`hstpipcfg3::W`](W) writer structure"]
impl crate::Writable for HSTPIPCFG3_SPEC {
