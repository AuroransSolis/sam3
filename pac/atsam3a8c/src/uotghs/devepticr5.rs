...
pub type W = crate::W<Devepticr5Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn txinic(&mut self) -> TxinicW<Devepticr5Spec> {
        TxinicW::new(self, 0)
    }
    #[doc = "Bit 1 - Received OUT Data Interrupt Clear"]
    #[inline(always)]
    #[must_use]
    pub fn rxoutic(&mut self) -> RxouticW<Devepticr5Spec> {
        RxouticW::new(self, 1)
    }
    #[doc = "Bit 2 - Received SETUP Interrupt Clear"]
    #[inline(always)]
    #[must_use]
    pub fn rxstpic(&mut self) -> RxstpicW<Devepticr5Spec> {
        RxstpicW::new(self, 2)
    }
    #[doc = "Bit 3 - NAKed OUT Interrupt Clear"]
    #[inline(always)]
    #[must_use]
    pub fn nakoutic(&mut self) -> NakouticW<Devepticr5Spec> {
        NakouticW::new(self, 3)
    }
    #[doc = "Bit 4 - NAKed IN Interrupt Clear"]
    #[inline(always)]
    #[must_use]
    pub fn nakinic(&mut self) -> NakinicW<Devepticr5Spec> {
        NakinicW::new(self, 4)
    }
    #[doc = "Bit 5 - Overflow Interrupt Clear"]
    #[inline(always)]
    #[must_use]
    pub fn overfic(&mut self) -> OverficW<Devepticr5Spec> {
        OverficW::new(self, 5)
    }
    #[doc = "Bit 6 - STALLed Interrupt Clear"]
    #[inline(always)]
    #[must_use]
    pub fn stalledic(&mut self) -> StalledicW<Devepticr5Spec> {
        StalledicW::new(self, 6)
    }
    #[doc = "Bit 7 - Short Packet Interrupt Clear"]
    #[inline(always)]
    #[must_use]
    pub fn shortpacketc(&mut self) -> ShortpacketcW<Devepticr5Spec> {
...
pub struct Devepticr5Spec;
impl crate::RegisterSpec for Devepticr5Spec {
    type Ux = u32;
}
#[doc = "`write(|w| ..)` method takes [`devepticr5::W`](W) writer structure"]
impl crate::Writable for Devepticr5Spec {
