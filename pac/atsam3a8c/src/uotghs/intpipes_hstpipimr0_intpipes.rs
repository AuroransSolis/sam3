...
pub type R = crate::R<IntpipesHstpipimr0IntpipesSpec>;
...
pub struct IntpipesHstpipimr0IntpipesSpec;
impl crate::RegisterSpec for IntpipesHstpipimr0IntpipesSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`intpipes_hstpipimr0_intpipes::R`](R) reader structure"]
impl crate::Readable for IntpipesHstpipimr0IntpipesSpec {}
