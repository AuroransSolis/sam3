#[doc = "Register `HSTPIPIMR0_INTPIPES` reader"]
pub struct R(crate::R<INTPIPES_HSTPIPIMR0_INTPIPES_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<INTPIPES_HSTPIPIMR0_INTPIPES_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<INTPIPES_HSTPIPIMR0_INTPIPES_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<INTPIPES_HSTPIPIMR0_INTPIPES_SPEC>) -> Self {
        R(reader)
    }
}
...
#[doc = "Host Pipe Mask Register (n = 0)\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [intpipes_hstpipimr0_intpipes](index.html) module"]
pub struct INTPIPES_HSTPIPIMR0_INTPIPES_SPEC;
impl crate::RegisterSpec for INTPIPES_HSTPIPIMR0_INTPIPES_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [intpipes_hstpipimr0_intpipes::R](R) reader structure"]
impl crate::Readable for INTPIPES_HSTPIPIMR0_INTPIPES_SPEC {
    type Reader = R;
}
