#[doc = "Register `HSTPIPIMR6` reader"]
pub type R = crate::R<HSTPIPIMR6_SPEC>;
...
#[doc = "Host Pipe Mask Register (n = 0) 6\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`hstpipimr6::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct HSTPIPIMR6_SPEC;
impl crate::RegisterSpec for HSTPIPIMR6_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`hstpipimr6::R`](R) reader structure"]
impl crate::Readable for HSTPIPIMR6_SPEC {}
