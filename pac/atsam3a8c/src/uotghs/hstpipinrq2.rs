...
pub type R = crate::R<Hstpipinrq2Spec>;
#[doc = "Register `HSTPIPINRQ2` writer"]
pub type W = crate::W<Hstpipinrq2Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn inrq(&mut self) -> InrqW<Hstpipinrq2Spec> {
        InrqW::new(self, 0)
    }
    #[doc = "Bit 8 - IN Request Mode"]
    #[inline(always)]
    #[must_use]
    pub fn inmode(&mut self) -> InmodeW<Hstpipinrq2Spec> {
        InmodeW::new(self, 8)
    }
}
#[doc = "Host Pipe IN Request Register (n = 0) 2\n\nYou can [`read`](crate::Reg::read) this register and get [`hstpipinrq2::R`](R). You can [`write_with_zero`](crate::Reg::write_with_zero) this register using [`hstpipinrq2::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Hstpipinrq2Spec;
impl crate::RegisterSpec for Hstpipinrq2Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`hstpipinrq2::R`](R) reader structure"]
impl crate::Readable for Hstpipinrq2Spec {}
#[doc = "`write(|w| ..)` method takes [`hstpipinrq2::W`](W) writer structure"]
impl crate::Writable for Hstpipinrq2Spec {
