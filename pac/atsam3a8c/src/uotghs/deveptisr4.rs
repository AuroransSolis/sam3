#[doc = "Register `DEVEPTISR4` reader"]
pub type R = crate::R<DEVEPTISR4_SPEC>;
...
#[doc = "Device Endpoint Status Register (n = 0) 4\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`deveptisr4::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DEVEPTISR4_SPEC;
impl crate::RegisterSpec for DEVEPTISR4_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`deveptisr4::R`](R) reader structure"]
impl crate::Readable for DEVEPTISR4_SPEC {}
