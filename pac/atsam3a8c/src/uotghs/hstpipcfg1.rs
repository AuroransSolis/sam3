#[doc = "Register `HSTPIPCFG1` reader"]
pub type R = crate::R<HSTPIPCFG1_SPEC>;
#[doc = "Register `HSTPIPCFG1` writer"]
pub type W = crate::W<HSTPIPCFG1_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn alloc(&mut self) -> ALLOC_W<HSTPIPCFG1_SPEC, 1> {
        ALLOC_W::new(self)
    }
    #[doc = "Bits 2:3 - Pipe Banks"]
    #[inline(always)]
    #[must_use]
    pub fn pbk(&mut self) -> PBK_W<HSTPIPCFG1_SPEC, 2> {
        PBK_W::new(self)
    }
    #[doc = "Bits 4:6 - Pipe Size"]
    #[inline(always)]
    #[must_use]
    pub fn psize(&mut self) -> PSIZE_W<HSTPIPCFG1_SPEC, 4> {
        PSIZE_W::new(self)
    }
    #[doc = "Bits 8:9 - Pipe Token"]
    #[inline(always)]
    #[must_use]
    pub fn ptoken(&mut self) -> PTOKEN_W<HSTPIPCFG1_SPEC, 8> {
        PTOKEN_W::new(self)
    }
    #[doc = "Bit 10 - Automatic Switch"]
    #[inline(always)]
    #[must_use]
    pub fn autosw(&mut self) -> AUTOSW_W<HSTPIPCFG1_SPEC, 10> {
        AUTOSW_W::new(self)
    }
    #[doc = "Bits 12:13 - Pipe Type"]
    #[inline(always)]
    #[must_use]
    pub fn ptype(&mut self) -> PTYPE_W<HSTPIPCFG1_SPEC, 12> {
        PTYPE_W::new(self)
    }
    #[doc = "Bits 16:19 - Pipe Endpoint Number"]
    #[inline(always)]
    #[must_use]
    pub fn pepnum(&mut self) -> PEPNUM_W<HSTPIPCFG1_SPEC, 16> {
        PEPNUM_W::new(self)
    }
    #[doc = "Bits 24:31 - Pipe Interrupt Request Frequency"]
    #[inline(always)]
    #[must_use]
    pub fn intfrq(&mut self) -> INTFRQ_W<HSTPIPCFG1_SPEC, 24> {
        INTFRQ_W::new(self)
    }
...
#[doc = "Host Pipe Configuration Register (n = 0) 1\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`hstpipcfg1::R`](R).  You can [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`hstpipcfg1::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct HSTPIPCFG1_SPEC;
impl crate::RegisterSpec for HSTPIPCFG1_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`hstpipcfg1::R`](R) reader structure"]
impl crate::Readable for HSTPIPCFG1_SPEC {}
#[doc = "`write(|w| ..)` method takes [`hstpipcfg1::W`](W) writer structure"]
impl crate::Writable for HSTPIPCFG1_SPEC {
