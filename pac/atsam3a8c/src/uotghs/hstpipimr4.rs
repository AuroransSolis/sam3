#[doc = "Register `HSTPIPIMR4` reader"]
pub type R = crate::R<HSTPIPIMR4_SPEC>;
...
#[doc = "Host Pipe Mask Register (n = 0) 4\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`hstpipimr4::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct HSTPIPIMR4_SPEC;
impl crate::RegisterSpec for HSTPIPIMR4_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`hstpipimr4::R`](R) reader structure"]
impl crate::Readable for HSTPIPIMR4_SPEC {}
