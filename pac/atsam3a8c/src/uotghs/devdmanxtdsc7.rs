...
pub type R = crate::R<Devdmanxtdsc7Spec>;
#[doc = "Register `DEVDMANXTDSC7` writer"]
pub type W = crate::W<Devdmanxtdsc7Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn nxt_dsc_add(&mut self) -> NxtDscAddW<Devdmanxtdsc7Spec> {
        NxtDscAddW::new(self, 0)
    }
}
#[doc = "Device DMA Channel Next Descriptor Address Register (n = 7)\n\nYou can [`read`](crate::Reg::read) this register and get [`devdmanxtdsc7::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`devdmanxtdsc7::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Devdmanxtdsc7Spec;
impl crate::RegisterSpec for Devdmanxtdsc7Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`devdmanxtdsc7::R`](R) reader structure"]
impl crate::Readable for Devdmanxtdsc7Spec {}
#[doc = "`write(|w| ..)` method takes [`devdmanxtdsc7::W`](W) writer structure"]
impl crate::Writable for Devdmanxtdsc7Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DEVDMANXTDSC7 to value 0"]
impl crate::Resettable for Devdmanxtdsc7Spec {
