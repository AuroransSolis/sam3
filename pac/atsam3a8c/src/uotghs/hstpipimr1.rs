#[doc = "Register `HSTPIPIMR1` reader"]
pub type R = crate::R<HSTPIPIMR1_SPEC>;
...
#[doc = "Host Pipe Mask Register (n = 0) 1\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`hstpipimr1::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct HSTPIPIMR1_SPEC;
impl crate::RegisterSpec for HSTPIPIMR1_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`hstpipimr1::R`](R) reader structure"]
impl crate::Readable for HSTPIPIMR1_SPEC {}
