...
pub type R = crate::R<MATRIX_MCFG0_SPEC>;
#[doc = "Register `MATRIX_MCFG0` writer"]
pub type W = crate::W<MATRIX_MCFG0_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn ulbt(&mut self) -> ULBT_W<MATRIX_MCFG0_SPEC, 0> {
        ULBT_W::new(self)
    }
...
pub struct MATRIX_MCFG0_SPEC;
impl crate::RegisterSpec for MATRIX_MCFG0_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`matrix_mcfg0::R`](R) reader structure"]
impl crate::Readable for MATRIX_MCFG0_SPEC {}
#[doc = "`write(|w| ..)` method takes [`matrix_mcfg0::W`](W) writer structure"]
impl crate::Writable for MATRIX_MCFG0_SPEC {
