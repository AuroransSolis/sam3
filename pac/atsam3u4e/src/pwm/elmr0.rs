...
pub type R = crate::R<Elmr0Spec>;
#[doc = "Register `ELMR0` writer"]
pub type W = crate::W<Elmr0Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn csel0(&mut self) -> Csel0W<Elmr0Spec> {
        Csel0W::new(self, 0)
    }
    #[doc = "Bit 1 - Comparison 1 Selection"]
    #[inline(always)]
    #[must_use]
    pub fn csel1(&mut self) -> Csel1W<Elmr0Spec> {
        Csel1W::new(self, 1)
    }
    #[doc = "Bit 2 - Comparison 2 Selection"]
    #[inline(always)]
    #[must_use]
    pub fn csel2(&mut self) -> Csel2W<Elmr0Spec> {
        Csel2W::new(self, 2)
    }
    #[doc = "Bit 3 - Comparison 3 Selection"]
    #[inline(always)]
    #[must_use]
    pub fn csel3(&mut self) -> Csel3W<Elmr0Spec> {
        Csel3W::new(self, 3)
    }
    #[doc = "Bit 4 - Comparison 4 Selection"]
    #[inline(always)]
    #[must_use]
    pub fn csel4(&mut self) -> Csel4W<Elmr0Spec> {
        Csel4W::new(self, 4)
    }
    #[doc = "Bit 5 - Comparison 5 Selection"]
    #[inline(always)]
    #[must_use]
    pub fn csel5(&mut self) -> Csel5W<Elmr0Spec> {
        Csel5W::new(self, 5)
    }
    #[doc = "Bit 6 - Comparison 6 Selection"]
    #[inline(always)]
    #[must_use]
    pub fn csel6(&mut self) -> Csel6W<Elmr0Spec> {
        Csel6W::new(self, 6)
    }
    #[doc = "Bit 7 - Comparison 7 Selection"]
    #[inline(always)]
    #[must_use]
    pub fn csel7(&mut self) -> Csel7W<Elmr0Spec> {
        Csel7W::new(self, 7)
    }
}
#[doc = "PWM Event Line 0 Mode Register 0\n\nYou can [`read`](crate::Reg::read) this register and get [`elmr0::R`](R). You can [`write_with_zero`](crate::Reg::write_with_zero) this register using [`elmr0::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Elmr0Spec;
impl crate::RegisterSpec for Elmr0Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`elmr0::R`](R) reader structure"]
impl crate::Readable for Elmr0Spec {}
#[doc = "`write(|w| ..)` method takes [`elmr0::W`](W) writer structure"]
impl crate::Writable for Elmr0Spec {
