...
pub type R = crate::R<ELMR1_SPEC>;
#[doc = "Register `ELMR1` writer"]
pub type W = crate::W<ELMR1_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn csel0(&mut self) -> CSEL0_W<ELMR1_SPEC, 0> {
        CSEL0_W::new(self)
    }
    #[doc = "Bit 1 - Comparison 1 Selection"]
    #[inline(always)]
    #[must_use]
    pub fn csel1(&mut self) -> CSEL1_W<ELMR1_SPEC, 1> {
        CSEL1_W::new(self)
    }
    #[doc = "Bit 2 - Comparison 2 Selection"]
    #[inline(always)]
    #[must_use]
    pub fn csel2(&mut self) -> CSEL2_W<ELMR1_SPEC, 2> {
        CSEL2_W::new(self)
    }
    #[doc = "Bit 3 - Comparison 3 Selection"]
    #[inline(always)]
    #[must_use]
    pub fn csel3(&mut self) -> CSEL3_W<ELMR1_SPEC, 3> {
        CSEL3_W::new(self)
    }
    #[doc = "Bit 4 - Comparison 4 Selection"]
    #[inline(always)]
    #[must_use]
    pub fn csel4(&mut self) -> CSEL4_W<ELMR1_SPEC, 4> {
        CSEL4_W::new(self)
    }
    #[doc = "Bit 5 - Comparison 5 Selection"]
    #[inline(always)]
    #[must_use]
    pub fn csel5(&mut self) -> CSEL5_W<ELMR1_SPEC, 5> {
        CSEL5_W::new(self)
    }
    #[doc = "Bit 6 - Comparison 6 Selection"]
    #[inline(always)]
    #[must_use]
    pub fn csel6(&mut self) -> CSEL6_W<ELMR1_SPEC, 6> {
        CSEL6_W::new(self)
    }
    #[doc = "Bit 7 - Comparison 7 Selection"]
    #[inline(always)]
    #[must_use]
    pub fn csel7(&mut self) -> CSEL7_W<ELMR1_SPEC, 7> {
        CSEL7_W::new(self)
    }
...
#[doc = "PWM Event Line 0 Mode Register 1\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`elmr1::R`](R).  You can [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`elmr1::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct ELMR1_SPEC;
impl crate::RegisterSpec for ELMR1_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`elmr1::R`](R) reader structure"]
impl crate::Readable for ELMR1_SPEC {}
#[doc = "`write(|w| ..)` method takes [`elmr1::W`](W) writer structure"]
impl crate::Writable for ELMR1_SPEC {
