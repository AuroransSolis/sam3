...
pub type Eccerr8R = crate::FieldReader;
...
pub type Eccerr12R = crate::FieldReader;
...
pub type Eccerr13R = crate::FieldReader;
...
pub type Eccerr14R = crate::FieldReader;
...
pub type Eccerr15R = crate::FieldReader;
impl R {
    ...
    pub fn eccerr8(&self) -> Eccerr8R {
        Eccerr8R::new(((self.bits >> 1) & 3) as u8)
    }
    ...
    pub fn eccerr12(&self) -> Eccerr12R {
        Eccerr12R::new(((self.bits >> 17) & 3) as u8)
    }
    ...
    pub fn eccerr13(&self) -> Eccerr13R {
        Eccerr13R::new(((self.bits >> 21) & 3) as u8)
    }
    ...
    pub fn eccerr14(&self) -> Eccerr14R {
        Eccerr14R::new(((self.bits >> 25) & 3) as u8)
    }
    ...
    pub fn eccerr15(&self) -> Eccerr15R {
        Eccerr15R::new(((self.bits >> 29) & 3) as u8)
    }
}
