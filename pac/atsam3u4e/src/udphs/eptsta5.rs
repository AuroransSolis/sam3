#[doc = "Register `EPTSTA5` reader"]
pub struct R(crate::R<EPTSTA5_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<EPTSTA5_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<EPTSTA5_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<EPTSTA5_SPEC>) -> Self {
        R(reader)
    }
}
...
#[doc = "UDPHS Endpoint Status Register (endpoint = 5)\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [eptsta5](index.html) module"]
pub struct EPTSTA5_SPEC;
impl crate::RegisterSpec for EPTSTA5_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [eptsta5::R](R) reader structure"]
impl crate::Readable for EPTSTA5_SPEC {
    type Reader = R;
}
#[doc = "`reset()` method sets EPTSTA5 to value 0x40"]
impl crate::Resettable for EPTSTA5_SPEC {
    #[inline(always)]
