...
pub type R = crate::R<EPTSTA5_SPEC>;
...
#[doc = "UDPHS Endpoint Status Register (endpoint = 5)\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`eptsta5::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
