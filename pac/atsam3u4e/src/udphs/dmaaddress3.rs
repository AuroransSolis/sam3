...
pub type R = crate::R<DMAADDRESS3_SPEC>;
#[doc = "Register `DMAADDRESS3` writer"]
pub type W = crate::W<DMAADDRESS3_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn buff_add(&mut self) -> BUFF_ADD_W<DMAADDRESS3_SPEC, 0> {
        BUFF_ADD_W::new(self)
    }
...
#[doc = "UDPHS DMA Channel Address Register (channel = 3)\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`dmaaddress3::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`dmaaddress3::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
