...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn ept_0(&mut self) -> EPT_0_W<EPTRST_SPEC> {
        EPT_0_W::new(self, 0)
    }
    #[doc = "Bit 1 - Endpoint 1 Reset"]
    #[inline(always)]
    #[must_use]
    pub fn ept_1(&mut self) -> EPT_1_W<EPTRST_SPEC> {
        EPT_1_W::new(self, 1)
    }
    #[doc = "Bit 2 - Endpoint 2 Reset"]
    #[inline(always)]
    #[must_use]
    pub fn ept_2(&mut self) -> EPT_2_W<EPTRST_SPEC> {
        EPT_2_W::new(self, 2)
    }
    #[doc = "Bit 3 - Endpoint 3 Reset"]
    #[inline(always)]
    #[must_use]
    pub fn ept_3(&mut self) -> EPT_3_W<EPTRST_SPEC> {
        EPT_3_W::new(self, 3)
    }
    #[doc = "Bit 4 - Endpoint 4 Reset"]
    #[inline(always)]
    #[must_use]
    pub fn ept_4(&mut self) -> EPT_4_W<EPTRST_SPEC> {
        EPT_4_W::new(self, 4)
    }
    #[doc = "Bit 5 - Endpoint 5 Reset"]
    #[inline(always)]
    #[must_use]
    pub fn ept_5(&mut self) -> EPT_5_W<EPTRST_SPEC> {
        EPT_5_W::new(self, 5)
    }
    #[doc = "Bit 6 - Endpoint 6 Reset"]
    #[inline(always)]
    #[must_use]
    pub fn ept_6(&mut self) -> EPT_6_W<EPTRST_SPEC> {
        EPT_6_W::new(self, 6)
    }
