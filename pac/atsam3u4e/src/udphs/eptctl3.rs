...
pub type R = crate::R<EPTCTL3_SPEC>;
...
#[doc = "UDPHS Endpoint Control Register (endpoint = 3)\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`eptctl3::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
