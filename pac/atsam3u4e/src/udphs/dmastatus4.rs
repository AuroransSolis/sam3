...
pub type R = crate::R<Dmastatus4Spec>;
#[doc = "Register `DMASTATUS4` writer"]
pub type W = crate::W<Dmastatus4Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn chann_enb(&mut self) -> ChannEnbW<Dmastatus4Spec> {
        ChannEnbW::new(self, 0)
    }
    #[doc = "Bit 1 - Channel Active Status"]
    #[inline(always)]
    #[must_use]
    pub fn chann_act(&mut self) -> ChannActW<Dmastatus4Spec> {
        ChannActW::new(self, 1)
    }
    #[doc = "Bit 4 - End of Channel Transfer Status"]
    #[inline(always)]
    #[must_use]
    pub fn end_tr_st(&mut self) -> EndTrStW<Dmastatus4Spec> {
        EndTrStW::new(self, 4)
    }
    #[doc = "Bit 5 - End of Channel Buffer Status"]
    #[inline(always)]
    #[must_use]
    pub fn end_bf_st(&mut self) -> EndBfStW<Dmastatus4Spec> {
        EndBfStW::new(self, 5)
    }
    #[doc = "Bit 6 - Descriptor Loaded Status"]
    #[inline(always)]
    #[must_use]
    pub fn desc_ldst(&mut self) -> DescLdstW<Dmastatus4Spec> {
        DescLdstW::new(self, 6)
    }
    #[doc = "Bits 16:31 - Buffer Byte Count"]
    #[inline(always)]
    #[must_use]
    pub fn buff_count(&mut self) -> BuffCountW<Dmastatus4Spec> {
        BuffCountW::new(self, 16)
    }
}
#[doc = "UDPHS DMA Channel Status Register (channel = 4)\n\nYou can [`read`](crate::Reg::read) this register and get [`dmastatus4::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`dmastatus4::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Dmastatus4Spec;
impl crate::RegisterSpec for Dmastatus4Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`dmastatus4::R`](R) reader structure"]
impl crate::Readable for Dmastatus4Spec {}
#[doc = "`write(|w| ..)` method takes [`dmastatus4::W`](W) writer structure"]
impl crate::Writable for Dmastatus4Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DMASTATUS4 to value 0"]
impl crate::Resettable for Dmastatus4Spec {
