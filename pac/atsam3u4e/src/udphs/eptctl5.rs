#[doc = "Register `EPTCTL5` reader"]
pub type R = crate::R<Eptctl5Spec>;
...
#[doc = "UDPHS Endpoint Control Register (endpoint = 5)\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`eptctl5::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Eptctl5Spec;
impl crate::RegisterSpec for Eptctl5Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`eptctl5::R`](R) reader structure"]
impl crate::Readable for Eptctl5Spec {}
#[doc = "`reset()` method sets EPTCTL5 to value 0"]
impl crate::Resettable for Eptctl5Spec {
