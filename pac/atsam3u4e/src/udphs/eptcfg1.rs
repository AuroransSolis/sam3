...
impl core::ops::Deref for R {
    type Target = crate::R<EPTCFG1_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<EPTCFG1_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<EPTCFG1_SPEC>) -> Self {
        R(reader)
    }
}
...
impl core::ops::Deref for W {
    type Target = crate::W<EPTCFG1_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<EPTCFG1_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<EPTCFG1_SPEC>) -> Self {
        W(writer)
    }
}
#[doc = "Endpoint Size\n\nValue on reset: 0"]
