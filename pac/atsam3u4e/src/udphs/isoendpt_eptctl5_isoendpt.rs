...
pub type R = crate::R<IsoendptEptctl5IsoendptSpec>;
...
#[doc = "UDPHS Endpoint Control Register (endpoint = 5)\n\nYou can [`read`](crate::Reg::read) this register and get [`isoendpt_eptctl5_isoendpt::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct IsoendptEptctl5IsoendptSpec;
impl crate::RegisterSpec for IsoendptEptctl5IsoendptSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`isoendpt_eptctl5_isoendpt::R`](R) reader structure"]
impl crate::Readable for IsoendptEptctl5IsoendptSpec {}
#[doc = "`reset()` method sets EPTCTL5_ISOENDPT to value 0"]
impl crate::Resettable for IsoendptEptctl5IsoendptSpec {
