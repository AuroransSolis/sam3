...
pub type R = crate::R<IsoendptEptsta2IsoendptSpec>;
...
pub struct IsoendptEptsta2IsoendptSpec;
impl crate::RegisterSpec for IsoendptEptsta2IsoendptSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`isoendpt_eptsta2_isoendpt::R`](R) reader structure"]
impl crate::Readable for IsoendptEptsta2IsoendptSpec {}
#[doc = "`reset()` method sets EPTSTA2_ISOENDPT to value 0x40"]
impl crate::Resettable for IsoendptEptsta2IsoendptSpec {
