...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn ept_disabl(&mut self) -> EPT_DISABL_W<ISOENDPT_EPTCTLDIS6_ISOENDPT_SPEC> {
        EPT_DISABL_W::new(self, 0)
    }
    #[doc = "Bit 1 - Packet Auto-Valid Disable"]
    #[inline(always)]
    #[must_use]
    pub fn auto_valid(&mut self) -> AUTO_VALID_W<ISOENDPT_EPTCTLDIS6_ISOENDPT_SPEC> {
        AUTO_VALID_W::new(self, 1)
    }
    #[doc = "Bit 3 - Interrupts Disable DMA"]
    #[inline(always)]
    #[must_use]
    pub fn intdis_dma(&mut self) -> INTDIS_DMA_W<ISOENDPT_EPTCTLDIS6_ISOENDPT_SPEC> {
        INTDIS_DMA_W::new(self, 3)
    }
    #[doc = "Bit 6 - DATAx Interrupt Disable (Only for High Bandwidth Isochronous OUT endpoints)"]
    #[inline(always)]
    #[must_use]
    pub fn datax_rx(&mut self) -> DATAX_RX_W<ISOENDPT_EPTCTLDIS6_ISOENDPT_SPEC> {
        DATAX_RX_W::new(self, 6)
    }
    #[doc = "Bit 7 - MDATA Interrupt Disable (Only for High Bandwidth Isochronous OUT endpoints)"]
    #[inline(always)]
    #[must_use]
    pub fn mdata_rx(&mut self) -> MDATA_RX_W<ISOENDPT_EPTCTLDIS6_ISOENDPT_SPEC> {
        MDATA_RX_W::new(self, 7)
    }
    #[doc = "Bit 8 - Overflow Error Interrupt Disable"]
    #[inline(always)]
    #[must_use]
    pub fn err_ovflw(&mut self) -> ERR_OVFLW_W<ISOENDPT_EPTCTLDIS6_ISOENDPT_SPEC> {
        ERR_OVFLW_W::new(self, 8)
    }
    #[doc = "Bit 9 - Received OUT Data Interrupt Disable"]
    #[inline(always)]
    #[must_use]
    pub fn rxrdy_txkl(&mut self) -> RXRDY_TXKL_W<ISOENDPT_EPTCTLDIS6_ISOENDPT_SPEC> {
        RXRDY_TXKL_W::new(self, 9)
    }
    #[doc = "Bit 10 - Transmitted IN Data Complete Interrupt Disable"]
    #[inline(always)]
    #[must_use]
    pub fn tx_complt(&mut self) -> TX_COMPLT_W<ISOENDPT_EPTCTLDIS6_ISOENDPT_SPEC> {
        TX_COMPLT_W::new(self, 10)
    }
    #[doc = "Bit 11 - TX Packet Ready/Transaction Error Interrupt Disable"]
    #[inline(always)]
    #[must_use]
    pub fn txrdy_trer(&mut self) -> TXRDY_TRER_W<ISOENDPT_EPTCTLDIS6_ISOENDPT_SPEC> {
        TXRDY_TRER_W::new(self, 11)
    }
    #[doc = "Bit 12 - Error Flow Interrupt Disable"]
    #[inline(always)]
    #[must_use]
    pub fn err_fl_iso(&mut self) -> ERR_FL_ISO_W<ISOENDPT_EPTCTLDIS6_ISOENDPT_SPEC> {
        ERR_FL_ISO_W::new(self, 12)
    }
    #[doc = "Bit 13 - ISO CRC Error/Number of Transaction Error Interrupt Disable"]
    #[inline(always)]
    #[must_use]
    pub fn err_crc_ntr(&mut self) -> ERR_CRC_NTR_W<ISOENDPT_EPTCTLDIS6_ISOENDPT_SPEC> {
        ERR_CRC_NTR_W::new(self, 13)
    }
    #[doc = "Bit 14 - bank flush error Interrupt Disable"]
    #[inline(always)]
    #[must_use]
    pub fn err_flush(&mut self) -> ERR_FLUSH_W<ISOENDPT_EPTCTLDIS6_ISOENDPT_SPEC> {
        ERR_FLUSH_W::new(self, 14)
    }
    #[doc = "Bit 18 - Busy Bank Interrupt Disable"]
    #[inline(always)]
    #[must_use]
    pub fn busy_bank(&mut self) -> BUSY_BANK_W<ISOENDPT_EPTCTLDIS6_ISOENDPT_SPEC> {
        BUSY_BANK_W::new(self, 18)
    }
    #[doc = "Bit 31 - Short Packet Interrupt Disable"]
    #[inline(always)]
    #[must_use]
    pub fn shrt_pckt(&mut self) -> SHRT_PCKT_W<ISOENDPT_EPTCTLDIS6_ISOENDPT_SPEC> {
