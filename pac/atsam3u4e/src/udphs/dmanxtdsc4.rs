...
pub struct R(crate::R<DMANXTDSC4_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<DMANXTDSC4_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<DMANXTDSC4_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<DMANXTDSC4_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `DMANXTDSC4` writer"]
pub struct W(crate::W<DMANXTDSC4_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<DMANXTDSC4_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<DMANXTDSC4_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<DMANXTDSC4_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type NXT_DSC_ADD_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, DMANXTDSC4_SPEC, u32, u32, 32, O>;
impl R {
