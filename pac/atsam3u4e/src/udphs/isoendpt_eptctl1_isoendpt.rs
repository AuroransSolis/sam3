...
pub type R = crate::R<IsoendptEptctl1IsoendptSpec>;
...
#[doc = "UDPHS Endpoint Control Register (endpoint = 1)\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`isoendpt_eptctl1_isoendpt::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct IsoendptEptctl1IsoendptSpec;
impl crate::RegisterSpec for IsoendptEptctl1IsoendptSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`isoendpt_eptctl1_isoendpt::R`](R) reader structure"]
impl crate::Readable for IsoendptEptctl1IsoendptSpec {}
#[doc = "`reset()` method sets EPTCTL1_ISOENDPT to value 0"]
impl crate::Resettable for IsoendptEptctl1IsoendptSpec {
