...
pub type R = crate::R<SCFG0_SPEC>;
#[doc = "Register `SCFG0` writer"]
pub type W = crate::W<SCFG0_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn slot_cycle(&mut self) -> SLOT_CYCLE_W<SCFG0_SPEC, 0> {
        SLOT_CYCLE_W::new(self)
    }
    #[doc = "Bits 16:17 - Default Master Type"]
    #[inline(always)]
    #[must_use]
    pub fn defmstr_type(&mut self) -> DEFMSTR_TYPE_W<SCFG0_SPEC, 16> {
        DEFMSTR_TYPE_W::new(self)
    }
    #[doc = "Bits 18:20 - Fixed Default Master"]
    #[inline(always)]
    #[must_use]
    pub fn fixed_defmstr(&mut self) -> FIXED_DEFMSTR_W<SCFG0_SPEC, 18> {
        FIXED_DEFMSTR_W::new(self)
    }
    #[doc = "Bits 24:25 - Arbitration Type"]
    #[inline(always)]
    #[must_use]
    pub fn arbt(&mut self) -> ARBT_W<SCFG0_SPEC, 24> {
        ARBT_W::new(self)
    }
...
pub struct SCFG0_SPEC;
impl crate::RegisterSpec for SCFG0_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`scfg0::R`](R) reader structure"]
impl crate::Readable for SCFG0_SPEC {}
#[doc = "`write(|w| ..)` method takes [`scfg0::W`](W) writer structure"]
impl crate::Writable for SCFG0_SPEC {
