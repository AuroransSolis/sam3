...
pub type R = crate::R<Pras9Spec>;
#[doc = "Register `PRAS9` writer"]
pub type W = crate::W<Pras9Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn m0pr(&mut self) -> M0prW<Pras9Spec> {
        M0prW::new(self, 0)
    }
    #[doc = "Bits 4:5 - Master 1 Priority"]
    #[inline(always)]
    #[must_use]
    pub fn m1pr(&mut self) -> M1prW<Pras9Spec> {
        M1prW::new(self, 4)
    }
    #[doc = "Bits 8:9 - Master 2 Priority"]
    #[inline(always)]
    #[must_use]
    pub fn m2pr(&mut self) -> M2prW<Pras9Spec> {
        M2prW::new(self, 8)
    }
    #[doc = "Bits 12:13 - Master 3 Priority"]
    #[inline(always)]
    #[must_use]
    pub fn m3pr(&mut self) -> M3prW<Pras9Spec> {
        M3prW::new(self, 12)
    }
    #[doc = "Bits 16:17 - Master 4 Priority"]
    #[inline(always)]
    #[must_use]
    pub fn m4pr(&mut self) -> M4prW<Pras9Spec> {
        M4prW::new(self, 16)
    }
}
#[doc = "Priority Register A for Slave 9\n\nYou can [`read`](crate::Reg::read) this register and get [`pras9::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`pras9::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Pras9Spec;
impl crate::RegisterSpec for Pras9Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`pras9::R`](R) reader structure"]
impl crate::Readable for Pras9Spec {}
#[doc = "`write(|w| ..)` method takes [`pras9::W`](W) writer structure"]
impl crate::Writable for Pras9Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets PRAS9 to value 0"]
impl crate::Resettable for Pras9Spec {
