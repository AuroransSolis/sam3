...
pub type R = crate::R<PRAS4_SPEC>;
#[doc = "Register `PRAS4` writer"]
pub type W = crate::W<PRAS4_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn m0pr(&mut self) -> M0PR_W<PRAS4_SPEC, 0> {
        M0PR_W::new(self)
    }
    #[doc = "Bits 4:5 - Master 1 Priority"]
    #[inline(always)]
    #[must_use]
    pub fn m1pr(&mut self) -> M1PR_W<PRAS4_SPEC, 4> {
        M1PR_W::new(self)
    }
    #[doc = "Bits 8:9 - Master 2 Priority"]
    #[inline(always)]
    #[must_use]
    pub fn m2pr(&mut self) -> M2PR_W<PRAS4_SPEC, 8> {
        M2PR_W::new(self)
    }
    #[doc = "Bits 12:13 - Master 3 Priority"]
    #[inline(always)]
    #[must_use]
    pub fn m3pr(&mut self) -> M3PR_W<PRAS4_SPEC, 12> {
        M3PR_W::new(self)
    }
    #[doc = "Bits 16:17 - Master 4 Priority"]
    #[inline(always)]
    #[must_use]
    pub fn m4pr(&mut self) -> M4PR_W<PRAS4_SPEC, 16> {
        M4PR_W::new(self)
    }
...
#[doc = "Priority Register A for Slave 4\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`pras4::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`pras4::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
